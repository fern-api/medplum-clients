...
export const Capabilitystatement_resourceReferencepolicyItem = {
    Literal: "literal" as Capabilitystatement_resourceReferencepolicyItem.Literal,
    Logical: "logical" as Capabilitystatement_resourceReferencepolicyItem.Logical,
    Resolves: "resolves" as Capabilitystatement_resourceReferencepolicyItem.Resolves,
    Enforced: "enforced" as Capabilitystatement_resourceReferencepolicyItem.Enforced,
    ...
    _visit: <Result>(value: Capabilitystatement_resourceReferencepolicyItem, visitor: Capabilitystatement_resourceReferencepolicyItem._Visitor<Result>): Result => {
        switch (value) {
            case Capabilitystatement_resourceReferencepolicyItem.Literal: return visitor.literal();
            case Capabilitystatement_resourceReferencepolicyItem.Logical: return visitor.logical();
            case Capabilitystatement_resourceReferencepolicyItem.Resolves: return visitor.resolves();
            case Capabilitystatement_resourceReferencepolicyItem.Enforced: return visitor.enforced();
            case Capabilitystatement_resourceReferencepolicyItem.Local: return visitor.local();
