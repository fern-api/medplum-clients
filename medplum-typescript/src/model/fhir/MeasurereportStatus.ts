...
export const MeasurereportStatus = {
    ...
    _visit: <Result>(value: MeasurereportStatus, visitor: MeasurereportStatus._Visitor<Result>): Result => {
        switch (value) {
            case MeasurereportStatus.Complete: return visitor.complete();
            case MeasurereportStatus.Pending: return visitor.pending();
            case MeasurereportStatus.Error: return visitor.error();
