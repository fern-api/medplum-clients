...
export const PlandefinitionStatus = {
    ...
    _visit: <Result>(value: PlandefinitionStatus, visitor: PlandefinitionStatus._Visitor<Result>): Result => {
        switch (value) {
            case PlandefinitionStatus.Draft: return visitor.draft();
            case PlandefinitionStatus.Active: return visitor.active();
            case PlandefinitionStatus.Retired: return visitor.retired();
