...
export const CapabilitystatementStatus = {
    ...
    _visit: <Result>(
        value: CapabilitystatementStatus,
        visitor: CapabilitystatementStatus._Visitor<Result>
    ): Result => {
        switch (value) {
            case CapabilitystatementStatus.Draft:
                return visitor.draft();
            case CapabilitystatementStatus.Active:
                return visitor.active();
            case CapabilitystatementStatus.Retired:
