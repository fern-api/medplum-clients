...
export const Researchelementdefinition_characteristicParticipanteffectivegroupmeasure =
    {
        ...
        _visit: <Result>(
            value: Researchelementdefinition_characteristicParticipanteffectivegroupmeasure,
            visitor: Researchelementdefinition_characteristicParticipanteffectivegroupmeasure._Visitor<Result>
        ): Result => {
            switch (value) {
                case Researchelementdefinition_characteristicParticipanteffectivegroupmeasure.Mean:
                    return visitor.mean();
                case Researchelementdefinition_characteristicParticipanteffectivegroupmeasure.Median:
