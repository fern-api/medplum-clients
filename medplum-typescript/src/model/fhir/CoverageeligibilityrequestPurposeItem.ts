...
export const CoverageeligibilityrequestPurposeItem = {
    ...
    Validation:
        "validation" as CoverageeligibilityrequestPurposeItem.Validation,

    _visit: <Result>(
        value: CoverageeligibilityrequestPurposeItem,
        visitor: CoverageeligibilityrequestPurposeItem._Visitor<Result>
    ): Result => {
        switch (value) {
            case CoverageeligibilityrequestPurposeItem.Benefits:
                return visitor.benefits();
            case CoverageeligibilityrequestPurposeItem.Discovery:
                return visitor.discovery();
            case CoverageeligibilityrequestPurposeItem.Validation:
