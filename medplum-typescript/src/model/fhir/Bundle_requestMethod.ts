...
export const Bundle_requestMethod = {
    ...
    _visit: <Result>(
        value: Bundle_requestMethod,
        visitor: Bundle_requestMethod._Visitor<Result>
    ): Result => {
        switch (value) {
            case Bundle_requestMethod.Get:
                return visitor.get();
            case Bundle_requestMethod.Head:
                return visitor.head();
            case Bundle_requestMethod.Post:
                return visitor.post();
            case Bundle_requestMethod.Put:
                return visitor.put();
            case Bundle_requestMethod.Delete:
                return visitor.delete();
            case Bundle_requestMethod.Patch:
