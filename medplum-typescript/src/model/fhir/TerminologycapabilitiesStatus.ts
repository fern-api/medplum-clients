...
export const TerminologycapabilitiesStatus = {
    ...
    _visit: <Result>(value: TerminologycapabilitiesStatus, visitor: TerminologycapabilitiesStatus._Visitor<Result>): Result => {
        switch (value) {
            case TerminologycapabilitiesStatus.Draft: return visitor.draft();
            case TerminologycapabilitiesStatus.Active: return visitor.active();
            case TerminologycapabilitiesStatus.Retired: return visitor.retired();
