...
export const Testscript_assertResponse = {
    ...
    MethodNotAllowed:
        "methodNotAllowed" as Testscript_assertResponse.MethodNotAllowed,
    Conflict: "conflict" as Testscript_assertResponse.Conflict,
    Gone: "gone" as Testscript_assertResponse.Gone,
    PreconditionFailed:
        "preconditionFailed" as Testscript_assertResponse.PreconditionFailed,
    Unprocessable: "unprocessable" as Testscript_assertResponse.Unprocessable,

    _visit: <Result>(
        value: Testscript_assertResponse,
        visitor: Testscript_assertResponse._Visitor<Result>
    ): Result => {
        switch (value) {
            case Testscript_assertResponse.Okay:
                return visitor.okay();
            case Testscript_assertResponse.Created:
                return visitor.created();
            case Testscript_assertResponse.NoContent:
                return visitor.noContent();
            case Testscript_assertResponse.NotModified:
                return visitor.notModified();
            case Testscript_assertResponse.Bad:
                return visitor.bad();
            case Testscript_assertResponse.Forbidden:
                return visitor.forbidden();
            case Testscript_assertResponse.NotFound:
                return visitor.notFound();
            case Testscript_assertResponse.MethodNotAllowed:
                return visitor.methodNotAllowed();
            case Testscript_assertResponse.Conflict:
                return visitor.conflict();
            case Testscript_assertResponse.Gone:
                return visitor.gone();
            case Testscript_assertResponse.PreconditionFailed:
                return visitor.preconditionFailed();
            case Testscript_assertResponse.Unprocessable:
