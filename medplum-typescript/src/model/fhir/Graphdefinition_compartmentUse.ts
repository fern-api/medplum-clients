...
export const Graphdefinition_compartmentUse = {
    ...
    _visit: <Result>(
        value: Graphdefinition_compartmentUse,
        visitor: Graphdefinition_compartmentUse._Visitor<Result>
    ): Result => {
        switch (value) {
            case Graphdefinition_compartmentUse.Condition:
                return visitor.condition();
            case Graphdefinition_compartmentUse.Requirement:
