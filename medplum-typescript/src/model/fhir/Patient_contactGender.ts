...
export const Patient_contactGender = {
    ...
    _visit: <Result>(value: Patient_contactGender, visitor: Patient_contactGender._Visitor<Result>): Result => {
        switch (value) {
            case Patient_contactGender.Male: return visitor.male();
            case Patient_contactGender.Female: return visitor.female();
            case Patient_contactGender.Other: return visitor.other();
