...
export const Examplescenario_actorType = {
    ...
    _visit: <Result>(
        value: Examplescenario_actorType,
        visitor: Examplescenario_actorType._Visitor<Result>
    ): Result => {
        switch (value) {
            case Examplescenario_actorType.Person:
                return visitor.person();
            case Examplescenario_actorType.Entity:
