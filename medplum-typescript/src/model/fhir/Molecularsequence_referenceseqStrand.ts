...
export const Molecularsequence_referenceseqStrand = {
    ...
    _visit: <Result>(
        value: Molecularsequence_referenceseqStrand,
        visitor: Molecularsequence_referenceseqStrand._Visitor<Result>
    ): Result => {
        switch (value) {
            case Molecularsequence_referenceseqStrand.Watson:
                return visitor.watson();
            case Molecularsequence_referenceseqStrand.Crick:
