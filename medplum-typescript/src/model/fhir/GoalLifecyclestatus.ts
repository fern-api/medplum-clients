...
export const GoalLifecyclestatus = {
    ...
    _visit: <Result>(value: GoalLifecyclestatus, visitor: GoalLifecyclestatus._Visitor<Result>): Result => {
        switch (value) {
            case GoalLifecyclestatus.Proposed: return visitor.proposed();
            case GoalLifecyclestatus.Planned: return visitor.planned();
            case GoalLifecyclestatus.Accepted: return visitor.accepted();
            case GoalLifecyclestatus.Active: return visitor.active();
            case GoalLifecyclestatus.Completed: return visitor.completed();
            case GoalLifecyclestatus.Cancelled: return visitor.cancelled();
            case GoalLifecyclestatus.Rejected: return visitor.rejected();
