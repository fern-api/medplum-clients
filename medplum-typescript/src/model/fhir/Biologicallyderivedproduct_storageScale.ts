...
export const Biologicallyderivedproduct_storageScale = {
    ...
    _visit: <Result>(value: Biologicallyderivedproduct_storageScale, visitor: Biologicallyderivedproduct_storageScale._Visitor<Result>): Result => {
        switch (value) {
            case Biologicallyderivedproduct_storageScale.Farenheit: return visitor.farenheit();
            case Biologicallyderivedproduct_storageScale.Celsius: return visitor.celsius();
            case Biologicallyderivedproduct_storageScale.Kelvin: return visitor.kelvin();
