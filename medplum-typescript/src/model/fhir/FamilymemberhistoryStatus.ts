...
export const FamilymemberhistoryStatus = {
    ...
    _visit: <Result>(
        value: FamilymemberhistoryStatus,
        visitor: FamilymemberhistoryStatus._Visitor<Result>
    ): Result => {
        switch (value) {
            case FamilymemberhistoryStatus.Partial:
                return visitor.partial();
            case FamilymemberhistoryStatus.Completed:
