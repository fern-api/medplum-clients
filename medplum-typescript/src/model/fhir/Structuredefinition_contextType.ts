...
export const Structuredefinition_contextType = {
    ...
    _visit: <Result>(value: Structuredefinition_contextType, visitor: Structuredefinition_contextType._Visitor<Result>): Result => {
        switch (value) {
            case Structuredefinition_contextType.Fhirpath: return visitor.fhirpath();
            case Structuredefinition_contextType.Element: return visitor.element();
            case Structuredefinition_contextType.Extension: return visitor.extension();
