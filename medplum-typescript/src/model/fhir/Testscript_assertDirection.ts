...
export const Testscript_assertDirection = {
    ...
    _visit: <Result>(
        value: Testscript_assertDirection,
        visitor: Testscript_assertDirection._Visitor<Result>
    ): Result => {
        switch (value) {
            case Testscript_assertDirection.Response:
                return visitor.response();
            case Testscript_assertDirection.Request:
