...
export const Person_linkAssurance = {
    ...
    _visit: <Result>(value: Person_linkAssurance, visitor: Person_linkAssurance._Visitor<Result>): Result => {
        switch (value) {
            case Person_linkAssurance.Level1: return visitor.level1();
            case Person_linkAssurance.Level2: return visitor.level2();
            case Person_linkAssurance.Level3: return visitor.level3();
            case Person_linkAssurance.Level4: return visitor.level4();
