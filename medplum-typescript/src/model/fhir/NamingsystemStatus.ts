...
export const NamingsystemStatus = {
    ...
    _visit: <Result>(value: NamingsystemStatus, visitor: NamingsystemStatus._Visitor<Result>): Result => {
        switch (value) {
            case NamingsystemStatus.Draft: return visitor.draft();
            case NamingsystemStatus.Active: return visitor.active();
            case NamingsystemStatus.Retired: return visitor.retired();
