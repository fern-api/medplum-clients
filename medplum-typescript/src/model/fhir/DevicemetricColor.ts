...
export const DevicemetricColor = {
    ...
    _visit: <Result>(
        ...
        visitor: DevicemetricColor._Visitor<Result>
    ): Result => {
        switch (value) {
            case DevicemetricColor.Black:
                return visitor.black();
            case DevicemetricColor.Red:
                return visitor.red();
            case DevicemetricColor.Green:
                return visitor.green();
            case DevicemetricColor.Yellow:
                return visitor.yellow();
            case DevicemetricColor.Blue:
                return visitor.blue();
            case DevicemetricColor.Magenta:
                return visitor.magenta();
            case DevicemetricColor.Cyan:
                return visitor.cyan();
            case DevicemetricColor.White:
