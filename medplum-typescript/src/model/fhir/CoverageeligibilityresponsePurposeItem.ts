...
export const CoverageeligibilityresponsePurposeItem = {
    ...
    Validation: "validation" as CoverageeligibilityresponsePurposeItem.Validation,
    ...
    _visit: <Result>(value: CoverageeligibilityresponsePurposeItem, visitor: CoverageeligibilityresponsePurposeItem._Visitor<Result>): Result => {
        switch (value) {
            case CoverageeligibilityresponsePurposeItem.Benefits: return visitor.benefits();
            case CoverageeligibilityresponsePurposeItem.Discovery: return visitor.discovery();
            case CoverageeligibilityresponsePurposeItem.Validation: return visitor.validation();
