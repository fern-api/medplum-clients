...
export const TaskIntent = {
    ...
    _visit: <Result>(value: TaskIntent, visitor: TaskIntent._Visitor<Result>): Result => {
        switch (value) {
            case TaskIntent.Proposal: return visitor.proposal();
            case TaskIntent.Plan: return visitor.plan();
            case TaskIntent.Order: return visitor.order();
            case TaskIntent.Option: return visitor.option();
