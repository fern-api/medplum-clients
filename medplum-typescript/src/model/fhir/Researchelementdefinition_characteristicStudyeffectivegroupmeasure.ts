...
export const Researchelementdefinition_characteristicStudyeffectivegroupmeasure =
    {
        ...
        _visit: <Result>(
            value: Researchelementdefinition_characteristicStudyeffectivegroupmeasure,
            visitor: Researchelementdefinition_characteristicStudyeffectivegroupmeasure._Visitor<Result>
        ): Result => {
            switch (value) {
                case Researchelementdefinition_characteristicStudyeffectivegroupmeasure.Mean:
                    return visitor.mean();
                case Researchelementdefinition_characteristicStudyeffectivegroupmeasure.Median:
