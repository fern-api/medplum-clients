...
export const Structuremap_targetListmodeItem = {
    ...
    _visit: <Result>(value: Structuremap_targetListmodeItem, visitor: Structuremap_targetListmodeItem._Visitor<Result>): Result => {
        switch (value) {
            case Structuremap_targetListmodeItem.First: return visitor.first();
            case Structuremap_targetListmodeItem.Share: return visitor.share();
            case Structuremap_targetListmodeItem.Last: return visitor.last();
            case Structuremap_targetListmodeItem.Collate: return visitor.collate();
