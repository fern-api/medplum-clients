...
export const Valueset_filterOp = {
    ...
    _visit: <Result>(
        value: Valueset_filterOp,
        visitor: Valueset_filterOp._Visitor<Result>
    ): Result => {
        switch (value) {
            case Valueset_filterOp.Regex:
                return visitor.regex();
            case Valueset_filterOp.In:
                return visitor.in();
            case Valueset_filterOp.Generalizes:
                return visitor.generalizes();
            case Valueset_filterOp.Exists:
