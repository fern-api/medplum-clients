...
export const Capabilitystatement_interaction1Code = {
    Transaction: "transaction" as Capabilitystatement_interaction1Code.Transaction,
    ...
    _visit: <Result>(value: Capabilitystatement_interaction1Code, visitor: Capabilitystatement_interaction1Code._Visitor<Result>): Result => {
        switch (value) {
            case Capabilitystatement_interaction1Code.Transaction: return visitor.transaction();
            case Capabilitystatement_interaction1Code.Batch: return visitor.batch();
