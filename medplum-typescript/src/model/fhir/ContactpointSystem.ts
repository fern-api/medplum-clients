...
export const ContactpointSystem = {
    ...
    _visit: <Result>(value: ContactpointSystem, visitor: ContactpointSystem._Visitor<Result>): Result => {
        switch (value) {
            case ContactpointSystem.Phone: return visitor.phone();
            case ContactpointSystem.Fax: return visitor.fax();
            case ContactpointSystem.Email: return visitor.email();
            case ContactpointSystem.Pager: return visitor.pager();
            case ContactpointSystem.Url: return visitor.url();
            case ContactpointSystem.Sms: return visitor.sms();
            case ContactpointSystem.Other: return visitor.other();
