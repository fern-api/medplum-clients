...
export const StructuredefinitionStatus = {
    ...
    _visit: <Result>(value: StructuredefinitionStatus, visitor: StructuredefinitionStatus._Visitor<Result>): Result => {
        switch (value) {
            case StructuredefinitionStatus.Draft: return visitor.draft();
            case StructuredefinitionStatus.Active: return visitor.active();
            case StructuredefinitionStatus.Retired: return visitor.retired();
