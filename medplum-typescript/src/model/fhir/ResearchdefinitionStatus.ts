...
export const ResearchdefinitionStatus = {
    ...
    _visit: <Result>(
        value: ResearchdefinitionStatus,
        visitor: ResearchdefinitionStatus._Visitor<Result>
    ): Result => {
        switch (value) {
            case ResearchdefinitionStatus.Draft:
                return visitor.draft();
            case ResearchdefinitionStatus.Active:
                return visitor.active();
            case ResearchdefinitionStatus.Retired:
