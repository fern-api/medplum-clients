...
export const ActivitydefinitionStatus = {
    ...
    _visit: <Result>(
        value: ActivitydefinitionStatus,
        visitor: ActivitydefinitionStatus._Visitor<Result>
    ): Result => {
        switch (value) {
            case ActivitydefinitionStatus.Draft:
                return visitor.draft();
            case ActivitydefinitionStatus.Active:
                return visitor.active();
            case ActivitydefinitionStatus.Retired:
