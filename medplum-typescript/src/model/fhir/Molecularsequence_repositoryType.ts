...
export const Molecularsequence_repositoryType = {
    ...
    _visit: <Result>(
        value: Molecularsequence_repositoryType,
        visitor: Molecularsequence_repositoryType._Visitor<Result>
    ): Result => {
        switch (value) {
            case Molecularsequence_repositoryType.Directlink:
                return visitor.directlink();
            case Molecularsequence_repositoryType.Openapi:
                return visitor.openapi();
            case Molecularsequence_repositoryType.Login:
                return visitor.login();
            case Molecularsequence_repositoryType.Oauth:
                return visitor.oauth();
            case Molecularsequence_repositoryType.Other:
