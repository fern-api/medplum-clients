...
export const Episodeofcare_statushistoryStatus = {
    ...
    _visit: <Result>(
        value: Episodeofcare_statushistoryStatus,
        visitor: Episodeofcare_statushistoryStatus._Visitor<Result>
    ): Result => {
        switch (value) {
            case Episodeofcare_statushistoryStatus.Planned:
                return visitor.planned();
            case Episodeofcare_statushistoryStatus.Waitlist:
                return visitor.waitlist();
            case Episodeofcare_statushistoryStatus.Active:
                return visitor.active();
            case Episodeofcare_statushistoryStatus.Onhold:
                return visitor.onhold();
            case Episodeofcare_statushistoryStatus.Finished:
                return visitor.finished();
            case Episodeofcare_statushistoryStatus.Cancelled:
