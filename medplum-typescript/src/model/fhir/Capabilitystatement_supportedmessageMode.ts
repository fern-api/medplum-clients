...
export const Capabilitystatement_supportedmessageMode = {
    ...
    _visit: <Result>(value: Capabilitystatement_supportedmessageMode, visitor: Capabilitystatement_supportedmessageMode._Visitor<Result>): Result => {
        switch (value) {
            case Capabilitystatement_supportedmessageMode.Sender: return visitor.sender();
            case Capabilitystatement_supportedmessageMode.Receiver: return visitor.receiver();
