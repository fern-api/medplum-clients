...
export const Structuremap_sourceListmode = {
    ...
    _visit: <Result>(
        value: Structuremap_sourceListmode,
        visitor: Structuremap_sourceListmode._Visitor<Result>
    ): Result => {
        switch (value) {
            case Structuremap_sourceListmode.First:
                return visitor.first();
            case Structuremap_sourceListmode.Last:
                return visitor.last();
            default:
