...
export const Elementdefinition_typeAggregationItem = {
    ...
    Referenced: "referenced" as Elementdefinition_typeAggregationItem.Referenced,
    ...
    _visit: <Result>(value: Elementdefinition_typeAggregationItem, visitor: Elementdefinition_typeAggregationItem._Visitor<Result>): Result => {
        switch (value) {
            case Elementdefinition_typeAggregationItem.Contained: return visitor.contained();
            case Elementdefinition_typeAggregationItem.Referenced: return visitor.referenced();
            case Elementdefinition_typeAggregationItem.Bundled: return visitor.bundled();
