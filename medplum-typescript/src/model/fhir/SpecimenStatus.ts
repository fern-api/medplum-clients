...
export const SpecimenStatus = {
    ...
    _visit: <Result>(value: SpecimenStatus, visitor: SpecimenStatus._Visitor<Result>): Result => {
        switch (value) {
            case SpecimenStatus.Available: return visitor.available();
            case SpecimenStatus.Unavailable: return visitor.unavailable();
            case SpecimenStatus.Unsatisfactory: return visitor.unsatisfactory();
