...
export const BiologicallyderivedproductProductcategory = {
    ...
    BiologicalAgent: "biologicalAgent" as BiologicallyderivedproductProductcategory.BiologicalAgent,
    ...
    _visit: <Result>(value: BiologicallyderivedproductProductcategory, visitor: BiologicallyderivedproductProductcategory._Visitor<Result>): Result => {
        switch (value) {
            case BiologicallyderivedproductProductcategory.Organ: return visitor.organ();
            case BiologicallyderivedproductProductcategory.Tissue: return visitor.tissue();
            case BiologicallyderivedproductProductcategory.Fluid: return visitor.fluid();
            case BiologicallyderivedproductProductcategory.Cells: return visitor.cells();
            case BiologicallyderivedproductProductcategory.BiologicalAgent: return visitor.biologicalAgent();
