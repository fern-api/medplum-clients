...
export const Claimresponse_processnoteType = {
    ...
    _visit: <Result>(value: Claimresponse_processnoteType, visitor: Claimresponse_processnoteType._Visitor<Result>): Result => {
        switch (value) {
            case Claimresponse_processnoteType.Display: return visitor.display();
            case Claimresponse_processnoteType.Print: return visitor.print();
            case Claimresponse_processnoteType.Printoper: return visitor.printoper();
