...
export const Plandefinition_actionCardinalitybehavior = {
    ...
    _visit: <Result>(
        value: Plandefinition_actionCardinalitybehavior,
        visitor: Plandefinition_actionCardinalitybehavior._Visitor<Result>
    ): Result => {
        switch (value) {
            case Plandefinition_actionCardinalitybehavior.Single:
                return visitor.single();
            case Plandefinition_actionCardinalitybehavior.Multiple:
