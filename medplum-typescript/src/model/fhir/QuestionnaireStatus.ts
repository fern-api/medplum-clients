...
export const QuestionnaireStatus = {
    ...
    _visit: <Result>(value: QuestionnaireStatus, visitor: QuestionnaireStatus._Visitor<Result>): Result => {
        switch (value) {
            case QuestionnaireStatus.Draft: return visitor.draft();
            case QuestionnaireStatus.Active: return visitor.active();
            case QuestionnaireStatus.Retired: return visitor.retired();
