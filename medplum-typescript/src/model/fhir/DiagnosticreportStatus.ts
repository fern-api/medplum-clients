...
export const DiagnosticreportStatus = {
    ...
    _visit: <Result>(value: DiagnosticreportStatus, visitor: DiagnosticreportStatus._Visitor<Result>): Result => {
        switch (value) {
            case DiagnosticreportStatus.Registered: return visitor.registered();
            case DiagnosticreportStatus.Partial: return visitor.partial();
            case DiagnosticreportStatus.Preliminary: return visitor.preliminary();
            case DiagnosticreportStatus.Final: return visitor.final();
            case DiagnosticreportStatus.Amended: return visitor.amended();
            case DiagnosticreportStatus.Corrected: return visitor.corrected();
            case DiagnosticreportStatus.Appended: return visitor.appended();
            case DiagnosticreportStatus.Cancelled: return visitor.cancelled();
