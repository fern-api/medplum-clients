...
export const CompartmentdefinitionStatus = {
    ...
    _visit: <Result>(value: CompartmentdefinitionStatus, visitor: CompartmentdefinitionStatus._Visitor<Result>): Result => {
        switch (value) {
            case CompartmentdefinitionStatus.Draft: return visitor.draft();
            case CompartmentdefinitionStatus.Active: return visitor.active();
            case CompartmentdefinitionStatus.Retired: return visitor.retired();
