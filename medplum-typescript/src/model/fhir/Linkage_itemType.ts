...
export const Linkage_itemType = {
    ...
    _visit: <Result>(
        value: Linkage_itemType,
        visitor: Linkage_itemType._Visitor<Result>
    ): Result => {
        switch (value) {
            case Linkage_itemType.Source:
                return visitor.source();
            case Linkage_itemType.Alternate:
                return visitor.alternate();
            case Linkage_itemType.Historical:
