...
export const Composition_attesterMode = {
    ...
    _visit: <Result>(value: Composition_attesterMode, visitor: Composition_attesterMode._Visitor<Result>): Result => {
        switch (value) {
            case Composition_attesterMode.Personal: return visitor.personal();
            case Composition_attesterMode.Professional: return visitor.professional();
            case Composition_attesterMode.Legal: return visitor.legal();
            case Composition_attesterMode.Official: return visitor.official();
