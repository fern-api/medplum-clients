...
export const InsuranceplanStatus = {
    ...
    _visit: <Result>(value: InsuranceplanStatus, visitor: InsuranceplanStatus._Visitor<Result>): Result => {
        switch (value) {
            case InsuranceplanStatus.Draft: return visitor.draft();
            case InsuranceplanStatus.Active: return visitor.active();
            case InsuranceplanStatus.Retired: return visitor.retired();
