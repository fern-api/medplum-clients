...
export const StructuredefinitionDerivation = {
    Specialization:
        "specialization" as StructuredefinitionDerivation.Specialization,
    Constraint: "constraint" as StructuredefinitionDerivation.Constraint,

    _visit: <Result>(
        value: StructuredefinitionDerivation,
        visitor: StructuredefinitionDerivation._Visitor<Result>
    ): Result => {
        switch (value) {
            case StructuredefinitionDerivation.Specialization:
                return visitor.specialization();
            case StructuredefinitionDerivation.Constraint:
