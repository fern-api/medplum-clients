...
export const ElementdefinitionRepresentationItem = {
    ...
    _visit: <Result>(value: ElementdefinitionRepresentationItem, visitor: ElementdefinitionRepresentationItem._Visitor<Result>): Result => {
        switch (value) {
            case ElementdefinitionRepresentationItem.XmlAttr: return visitor.xmlAttr();
            case ElementdefinitionRepresentationItem.XmlText: return visitor.xmlText();
            case ElementdefinitionRepresentationItem.TypeAttr: return visitor.typeAttr();
            case ElementdefinitionRepresentationItem.CdaText: return visitor.cdaText();
            case ElementdefinitionRepresentationItem.Xhtml: return visitor.xhtml();
