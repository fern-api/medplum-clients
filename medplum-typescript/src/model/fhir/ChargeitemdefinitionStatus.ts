...
export const ChargeitemdefinitionStatus = {
    ...
    _visit: <Result>(value: ChargeitemdefinitionStatus, visitor: ChargeitemdefinitionStatus._Visitor<Result>): Result => {
        switch (value) {
            case ChargeitemdefinitionStatus.Draft: return visitor.draft();
            case ChargeitemdefinitionStatus.Active: return visitor.active();
            case ChargeitemdefinitionStatus.Retired: return visitor.retired();
