...
export const TerminologycapabilitiesCodesearch = {
    ...
    _visit: <Result>(
        value: TerminologycapabilitiesCodesearch,
        visitor: TerminologycapabilitiesCodesearch._Visitor<Result>
    ): Result => {
        switch (value) {
            case TerminologycapabilitiesCodesearch.Explicit:
                return visitor.explicit();
            case TerminologycapabilitiesCodesearch.All:
                return visitor.all();
            default:
