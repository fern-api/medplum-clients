...
export const ObservationdefinitionPermitteddatatypeItem = {
    ...
    CodeableConcept:
        "CodeableConcept" as ObservationdefinitionPermitteddatatypeItem.CodeableConcept,
    ...
    SampledData:
        "SampledData" as ObservationdefinitionPermitteddatatypeItem.SampledData,
    ...
    _visit: <Result>(
        value: ObservationdefinitionPermitteddatatypeItem,
        visitor: ObservationdefinitionPermitteddatatypeItem._Visitor<Result>
    ): Result => {
        switch (value) {
            case ObservationdefinitionPermitteddatatypeItem.Quantity:
                return visitor.quantity();
            case ObservationdefinitionPermitteddatatypeItem.CodeableConcept:
                return visitor.codeableConcept();
            case ObservationdefinitionPermitteddatatypeItem.String:
                return visitor.string();
            case ObservationdefinitionPermitteddatatypeItem.Boolean:
                return visitor.boolean();
            case ObservationdefinitionPermitteddatatypeItem.Integer:
                return visitor.integer();
            case ObservationdefinitionPermitteddatatypeItem.Range:
                return visitor.range();
            case ObservationdefinitionPermitteddatatypeItem.Ratio:
                return visitor.ratio();
            case ObservationdefinitionPermitteddatatypeItem.SampledData:
                return visitor.sampledData();
            case ObservationdefinitionPermitteddatatypeItem.Time:
                return visitor.time();
            case ObservationdefinitionPermitteddatatypeItem.DateTime:
                return visitor.dateTime();
            case ObservationdefinitionPermitteddatatypeItem.Period:
