...
export const Observationdefinition_qualifiedintervalCategory = {
    Reference: "reference" as Observationdefinition_qualifiedintervalCategory.Reference,
    Critical: "critical" as Observationdefinition_qualifiedintervalCategory.Critical,
    Absolute: "absolute" as Observationdefinition_qualifiedintervalCategory.Absolute,
    ...
    _visit: <Result>(value: Observationdefinition_qualifiedintervalCategory, visitor: Observationdefinition_qualifiedintervalCategory._Visitor<Result>): Result => {
        switch (value) {
            case Observationdefinition_qualifiedintervalCategory.Reference: return visitor.reference();
            case Observationdefinition_qualifiedintervalCategory.Critical: return visitor.critical();
            case Observationdefinition_qualifiedintervalCategory.Absolute: return visitor.absolute();
