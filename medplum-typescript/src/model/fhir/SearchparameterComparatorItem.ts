...
export const SearchparameterComparatorItem = {
    ...
    _visit: <Result>(value: SearchparameterComparatorItem, visitor: SearchparameterComparatorItem._Visitor<Result>): Result => {
        switch (value) {
            case SearchparameterComparatorItem.Eq: return visitor.eq();
            case SearchparameterComparatorItem.Ne: return visitor.ne();
            case SearchparameterComparatorItem.Gt: return visitor.gt();
            case SearchparameterComparatorItem.Lt: return visitor.lt();
            case SearchparameterComparatorItem.Ge: return visitor.ge();
            case SearchparameterComparatorItem.Le: return visitor.le();
            case SearchparameterComparatorItem.Sa: return visitor.sa();
            case SearchparameterComparatorItem.Eb: return visitor.eb();
            case SearchparameterComparatorItem.Ap: return visitor.ap();
