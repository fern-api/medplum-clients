...
export const Plandefinition_conditionKind = {
    Applicability:
        "applicability" as Plandefinition_conditionKind.Applicability,
    Start: "start" as Plandefinition_conditionKind.Start,
    Stop: "stop" as Plandefinition_conditionKind.Stop,

    _visit: <Result>(
        value: Plandefinition_conditionKind,
        visitor: Plandefinition_conditionKind._Visitor<Result>
    ): Result => {
        switch (value) {
            case Plandefinition_conditionKind.Applicability:
                return visitor.applicability();
            case Plandefinition_conditionKind.Start:
                return visitor.start();
            case Plandefinition_conditionKind.Stop:
                return visitor.stop();
            default:
