...
export const Molecularsequence_referenceseqOrientation = {
    ...
    Antisense:
        "antisense" as Molecularsequence_referenceseqOrientation.Antisense,

    _visit: <Result>(
        value: Molecularsequence_referenceseqOrientation,
        visitor: Molecularsequence_referenceseqOrientation._Visitor<Result>
    ): Result => {
        switch (value) {
            case Molecularsequence_referenceseqOrientation.Sense:
                return visitor.sense();
            case Molecularsequence_referenceseqOrientation.Antisense:
