...
export const Appointment_participantStatus = {
    ...
    _visit: <Result>(
        value: Appointment_participantStatus,
        visitor: Appointment_participantStatus._Visitor<Result>
    ): Result => {
        switch (value) {
            case Appointment_participantStatus.Accepted:
                return visitor.accepted();
            case Appointment_participantStatus.Declined:
                return visitor.declined();
            case Appointment_participantStatus.Tentative:
