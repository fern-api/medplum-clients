...
export const Provenance_entityRole = {
    ...
    _visit: <Result>(value: Provenance_entityRole, visitor: Provenance_entityRole._Visitor<Result>): Result => {
        switch (value) {
            case Provenance_entityRole.Derivation: return visitor.derivation();
            case Provenance_entityRole.Revision: return visitor.revision();
            case Provenance_entityRole.Quotation: return visitor.quotation();
            case Provenance_entityRole.Source: return visitor.source();
            case Provenance_entityRole.Removal: return visitor.removal();
