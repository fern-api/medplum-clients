...
export const Evidencevariable_characteristicGroupmeasure = {
    ...
    _visit: <Result>(value: Evidencevariable_characteristicGroupmeasure, visitor: Evidencevariable_characteristicGroupmeasure._Visitor<Result>): Result => {
        switch (value) {
            case Evidencevariable_characteristicGroupmeasure.Mean: return visitor.mean();
            case Evidencevariable_characteristicGroupmeasure.Median: return visitor.median();
