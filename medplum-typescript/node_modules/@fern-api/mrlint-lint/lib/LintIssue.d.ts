export declare type LintIssue = LintIssue.IncorrectFileContents | LintIssue.MissingFile | LintIssue.UnexpectedFile;
export declare namespace LintIssue {
    interface IncorrectFileContents {
...
export declare enum LintIssueType {
