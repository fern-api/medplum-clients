...
export const Effectevidencesynthesis_resultsbyexposureExposurestate = {
    Exposure:
        "exposure" as Effectevidencesynthesis_resultsbyexposureExposurestate.Exposure,

    _visit: <Result>(
        value: Effectevidencesynthesis_resultsbyexposureExposurestate,
        visitor: Effectevidencesynthesis_resultsbyexposureExposurestate._Visitor<Result>
    ): Result => {
        switch (value) {
            case Effectevidencesynthesis_resultsbyexposureExposurestate.Exposure:
