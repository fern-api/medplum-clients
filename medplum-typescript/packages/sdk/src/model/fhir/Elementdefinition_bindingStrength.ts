...
export const Elementdefinition_bindingStrength = {
    ...
    _visit: <Result>(
        value: Elementdefinition_bindingStrength,
        visitor: Elementdefinition_bindingStrength._Visitor<Result>
    ): Result => {
        switch (value) {
            case Elementdefinition_bindingStrength.Required:
                return visitor.required();
            case Elementdefinition_bindingStrength.Extensible:
                return visitor.extensible();
            case Elementdefinition_bindingStrength.Preferred:
                return visitor.preferred();
            case Elementdefinition_bindingStrength.Example:
