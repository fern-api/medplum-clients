...
export const Capabilitystatement_resourceConditionaldelete = {
    ...
    Multiple:
        "multiple" as Capabilitystatement_resourceConditionaldelete.Multiple,

    _visit: <Result>(
        value: Capabilitystatement_resourceConditionaldelete,
        visitor: Capabilitystatement_resourceConditionaldelete._Visitor<Result>
    ): Result => {
        switch (value) {
            case Capabilitystatement_resourceConditionaldelete.Single:
                return visitor.single();
            case Capabilitystatement_resourceConditionaldelete.Multiple:
