...
export const Specimendefinition_typetestedPreference = {
    ...
    _visit: <Result>(
        value: Specimendefinition_typetestedPreference,
        visitor: Specimendefinition_typetestedPreference._Visitor<Result>
    ): Result => {
        switch (value) {
            case Specimendefinition_typetestedPreference.Preferred:
                return visitor.preferred();
            case Specimendefinition_typetestedPreference.Alternate:
