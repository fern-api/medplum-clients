...
export const Devicemetric_calibrationState = {
    ...
    _visit: <Result>(
        value: Devicemetric_calibrationState,
        visitor: Devicemetric_calibrationState._Visitor<Result>
    ): Result => {
        switch (value) {
            case Devicemetric_calibrationState.Calibrated:
                return visitor.calibrated();
            case Devicemetric_calibrationState.Unspecified:
