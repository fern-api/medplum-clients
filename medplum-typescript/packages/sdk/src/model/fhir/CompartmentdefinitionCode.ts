...
export const CompartmentdefinitionCode = {
    ...
    _visit: <Result>(
        value: CompartmentdefinitionCode,
        visitor: CompartmentdefinitionCode._Visitor<Result>
    ): Result => {
        switch (value) {
            case CompartmentdefinitionCode.Patient:
                return visitor.patient();
            case CompartmentdefinitionCode.Encounter:
                return visitor.encounter();
            case CompartmentdefinitionCode.RelatedPerson:
                return visitor.relatedPerson();
            case CompartmentdefinitionCode.Practitioner:
                return visitor.practitioner();
            case CompartmentdefinitionCode.Device:
