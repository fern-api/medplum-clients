...
export const RiskevidencesynthesisStatus = {
    ...
    _visit: <Result>(
        value: RiskevidencesynthesisStatus,
        visitor: RiskevidencesynthesisStatus._Visitor<Result>
    ): Result => {
        switch (value) {
            case RiskevidencesynthesisStatus.Draft:
                return visitor.draft();
            case RiskevidencesynthesisStatus.Active:
                return visitor.active();
            case RiskevidencesynthesisStatus.Retired:
