...
export const Plandefinition_actionRequiredbehavior = {
    ...
    _visit: <Result>(
        value: Plandefinition_actionRequiredbehavior,
        visitor: Plandefinition_actionRequiredbehavior._Visitor<Result>
    ): Result => {
        switch (value) {
            case Plandefinition_actionRequiredbehavior.Must:
                return visitor.must();
            case Plandefinition_actionRequiredbehavior.Could:
