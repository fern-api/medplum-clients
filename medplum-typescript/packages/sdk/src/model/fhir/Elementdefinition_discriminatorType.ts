...
export const Elementdefinition_discriminatorType = {
    ...
    _visit: <Result>(
        value: Elementdefinition_discriminatorType,
        visitor: Elementdefinition_discriminatorType._Visitor<Result>
    ): Result => {
        switch (value) {
            case Elementdefinition_discriminatorType.Value:
                return visitor.value();
            case Elementdefinition_discriminatorType.Exists:
                return visitor.exists();
            case Elementdefinition_discriminatorType.Pattern:
                return visitor.pattern();
            case Elementdefinition_discriminatorType.Type:
                return visitor.type();
            case Elementdefinition_discriminatorType.Profile:
