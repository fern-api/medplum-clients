...
export const MessagedefinitionCategory = {
    ...
    _visit: <Result>(
        value: MessagedefinitionCategory,
        visitor: MessagedefinitionCategory._Visitor<Result>
    ): Result => {
        switch (value) {
            case MessagedefinitionCategory.Consequence:
                return visitor.consequence();
            case MessagedefinitionCategory.Currency:
                return visitor.currency();
            case MessagedefinitionCategory.Notification:
