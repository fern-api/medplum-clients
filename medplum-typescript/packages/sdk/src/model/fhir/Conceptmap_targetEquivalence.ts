...
export const Conceptmap_targetEquivalence = {
    ...
    _visit: <Result>(
        value: Conceptmap_targetEquivalence,
        visitor: Conceptmap_targetEquivalence._Visitor<Result>
    ): Result => {
        switch (value) {
            case Conceptmap_targetEquivalence.Relatedto:
                return visitor.relatedto();
            case Conceptmap_targetEquivalence.Equivalent:
                return visitor.equivalent();
            case Conceptmap_targetEquivalence.Equal:
                return visitor.equal();
            case Conceptmap_targetEquivalence.Wider:
                return visitor.wider();
            case Conceptmap_targetEquivalence.Subsumes:
                return visitor.subsumes();
            case Conceptmap_targetEquivalence.Narrower:
                return visitor.narrower();
            case Conceptmap_targetEquivalence.Specializes:
                return visitor.specializes();
            case Conceptmap_targetEquivalence.Inexact:
                return visitor.inexact();
            case Conceptmap_targetEquivalence.Unmatched:
                return visitor.unmatched();
            case Conceptmap_targetEquivalence.Disjoint:
