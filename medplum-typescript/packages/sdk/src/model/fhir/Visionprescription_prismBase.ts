...
export const Visionprescription_prismBase = {
    ...
    _visit: <Result>(
        value: Visionprescription_prismBase,
        visitor: Visionprescription_prismBase._Visitor<Result>
    ): Result => {
        switch (value) {
            case Visionprescription_prismBase.Up:
                return visitor.up();
            case Visionprescription_prismBase.Down:
                return visitor.down();
            case Visionprescription_prismBase.In:
                return visitor.in();
            case Visionprescription_prismBase.Out:
                return visitor.out();
            default:
