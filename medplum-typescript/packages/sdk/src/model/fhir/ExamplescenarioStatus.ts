...
export const ExamplescenarioStatus = {
    ...
    _visit: <Result>(
        value: ExamplescenarioStatus,
        visitor: ExamplescenarioStatus._Visitor<Result>
    ): Result => {
        switch (value) {
            case ExamplescenarioStatus.Draft:
                return visitor.draft();
            case ExamplescenarioStatus.Active:
                return visitor.active();
            case ExamplescenarioStatus.Retired:
