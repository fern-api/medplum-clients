...
final class ImmutableSupplyRequest_Parameter implements SupplyRequest_Parameter {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code valueBoolean}, {@code extension}, {@code modifierExtension}, {@code code}, {@code valueQuantity}, {@code valueCodeableConcept}, {@code valueRange}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SupplyRequest_Parameter#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SupplyRequest_Parameter#modifierExtension() modifierExtension}
   *    .code(com.fhir.types.fhir.CodeableConcept) // optional {@link SupplyRequest_Parameter#code() code}
   *    .valueQuantity(com.fhir.types.fhir.Quantity) // optional {@link SupplyRequest_Parameter#valueQuantity() valueQuantity}
   *    .valueCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link SupplyRequest_Parameter#valueCodeableConcept() valueCodeableConcept}
   *    .valueRange(com.fhir.types.fhir.Range) // optional {@link SupplyRequest_Parameter#valueRange() valueRange}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_VALUE_RANGE = 0x80L;
