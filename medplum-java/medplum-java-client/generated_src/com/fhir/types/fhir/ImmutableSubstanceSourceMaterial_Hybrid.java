...
final class ImmutableSubstanceSourceMaterial_Hybrid
    implements SubstanceSourceMaterial_Hybrid {
  ...
  private boolean equalTo(ImmutableSubstanceSourceMaterial_Hybrid another) {
    return Objects.equals(paternalOrganismName, another.paternalOrganismName)
        && Objects.equals(modifierExtension, another.modifierExtension)
        && Objects.equals(paternalOrganismId, another.paternalOrganismId)
        && Objects.equals(maternalOrganismName, another.maternalOrganismName)
  ...
  /**
   * Computes a hash code from attributes: {@code paternalOrganismName}, {@code modifierExtension}, {@code paternalOrganismId}, {@code maternalOrganismName}, {@code extension}, {@code hybridType}, {@code maternalOrganismId}, {@code id}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSourceMaterial_Hybrid#modifierExtension() modifierExtension}
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSourceMaterial_Hybrid#extension() extension}
   *    .hybridType(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSourceMaterial_Hybrid#hybridType() hybridType}
  ...
  public static final class Builder {
    private static final long OPT_BIT_PATERNAL_ORGANISM_NAME = 0x1L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x2L;
    private static final long OPT_BIT_PATERNAL_ORGANISM_ID = 0x4L;
    private static final long OPT_BIT_MATERNAL_ORGANISM_NAME = 0x8L;
    private static final long OPT_BIT_EXTENSION = 0x10L;
    private static final long OPT_BIT_HYBRID_TYPE = 0x20L;
    private static final long OPT_BIT_MATERNAL_ORGANISM_ID = 0x40L;
