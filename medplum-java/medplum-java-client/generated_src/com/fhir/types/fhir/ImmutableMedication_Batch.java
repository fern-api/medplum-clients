...
final class ImmutableMedication_Batch implements Medication_Batch {
  ...
  public final ImmutableMedication_Batch withExpirationDate(DateTime value) {
    ...
    return new ImmutableMedication_Batch(newValue, this.modifierExtension, this.extension, this.id, this.lotNumber);
  }
  ...
  public final ImmutableMedication_Batch withExpirationDate(Optional<? extends DateTime> optional) {
    ...
    return new ImmutableMedication_Batch(value, this.modifierExtension, this.extension, this.id, this.lotNumber);
  }
  ...
  public final ImmutableMedication_Batch withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedication_Batch(this.expirationDate, newValue, this.extension, this.id, this.lotNumber);
  }
  ...
  public final ImmutableMedication_Batch withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedication_Batch(this.expirationDate, value, this.extension, this.id, this.lotNumber);
  }
  ...
  public final ImmutableMedication_Batch withExtension(List<Extension> value) {
    ...
    return new ImmutableMedication_Batch(this.expirationDate, this.modifierExtension, newValue, this.id, this.lotNumber);
  }
  ...
  public final ImmutableMedication_Batch withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedication_Batch(this.expirationDate, this.modifierExtension, value, this.id, this.lotNumber);
  }
  ...
  public final ImmutableMedication_Batch withId(String value) {
    ...
    return new ImmutableMedication_Batch(this.expirationDate, this.modifierExtension, this.extension, newValue, this.lotNumber);
  }
  ...
  public final ImmutableMedication_Batch withId(Optional<String> optional) {
    ...
    return new ImmutableMedication_Batch(this.expirationDate, this.modifierExtension, this.extension, value, this.lotNumber);
  }
  ...
  public final ImmutableMedication_Batch withLotNumber(String value) {
    ...
    return new ImmutableMedication_Batch(this.expirationDate, this.modifierExtension, this.extension, this.id, newValue);
  }
  ...
  public final ImmutableMedication_Batch withLotNumber(Optional<String> optional) {
    ...
    return new ImmutableMedication_Batch(this.expirationDate, this.modifierExtension, this.extension, this.id, value);
  }
  ...
  private boolean equalTo(ImmutableMedication_Batch another) {
    return Objects.equals(expirationDate, another.expirationDate)
  ...
  /**
   * Computes a hash code from attributes: {@code expirationDate}, {@code modifierExtension}, {@code extension}, {@code id}, {@code lotNumber}.
   ...
   *    .expirationDate(com.fhir.types.fhir.DateTime) // optional {@link Medication_Batch#expirationDate() expirationDate}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Medication_Batch#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Medication_Batch#extension() extension}
  ...
  public static final class Builder {
    private static final long OPT_BIT_EXPIRATION_DATE = 0x1L;
    ...
    public Medication_Batch build() {
      return new ImmutableMedication_Batch(expirationDate, modifierExtension, extension, id, lotNumber);
    }
