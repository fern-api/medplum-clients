...
final class ImmutableComposition implements Composition {
  ...
  /**
   * Computes a hash code from attributes: {@code identifier}, {@code category}, {@code id}, {@code contained}, {@code type}, {@code confidentiality}, {@code meta}, {@code status}, {@code implicitRules}, {@code encounter}, {@code relatesTo}, {@code custodian}, {@code section}, {@code modifierExtension}, {@code author}, {@code attester}, {@code event}, {@code resourceType}, {@code title}, {@code extension}, {@code language}, {@code date}, {@code subject}, {@code text}.
   ...
   *    .identifier(com.fhir.types.fhir.Identifier) // optional {@link Composition#identifier() identifier}
   *    .category(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link Composition#category() category}
   *    .id(com.fhir.types.fhir.Id) // optional {@link Composition#id() id}
   *    .contained(List&amp;lt;com.fhir.types.fhir.ResourceList&amp;gt;) // optional {@link Composition#contained() contained}
   *    .type(com.fhir.types.fhir.CodeableConcept) // required {@link Composition#type() type}
   *    .confidentiality(com.fhir.types.fhir.Code) // optional {@link Composition#confidentiality() confidentiality}
   *    .meta(com.fhir.types.fhir.Meta) // optional {@link Composition#meta() meta}
   *    .status(com.fhir.types.fhir.CompositionStatus) // optional {@link Composition#status() status}
   *    .implicitRules(com.fhir.types.fhir.Uri) // optional {@link Composition#implicitRules() implicitRules}
   *    .encounter(com.fhir.types.fhir.Reference) // optional {@link Composition#encounter() encounter}
   *    .relatesTo(List&amp;lt;com.fhir.types.fhir.Composition_RelatesTo&amp;gt;) // optional {@link Composition#relatesTo() relatesTo}
   *    .custodian(com.fhir.types.fhir.Reference) // optional {@link Composition#custodian() custodian}
   *    .section(List&amp;lt;com.fhir.types.fhir.Composition_Section&amp;gt;) // optional {@link Composition#section() section}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Composition#modifierExtension() modifierExtension}
   *    .addAuthor|addAllAuthor(com.fhir.types.fhir.Reference) // {@link Composition#author() author} elements
   *    .attester(List&amp;lt;com.fhir.types.fhir.Composition_Attester&amp;gt;) // optional {@link Composition#attester() attester}
   *    .event(List&amp;lt;com.fhir.types.fhir.Composition_Event&amp;gt;) // optional {@link Composition#event() event}
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Composition#extension() extension}
   *    .language(com.fhir.types.fhir.Code) // optional {@link Composition#language() language}
   *    .date(com.fhir.types.fhir.DateTime) // optional {@link Composition#date() date}
   *    .subject(com.fhir.types.fhir.Reference) // optional {@link Composition#subject() subject}
   *    .text(com.fhir.types.fhir.Narrative) // optional {@link Composition#text() text}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements TypeBuildStage, ResourceTypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_RELATES_TO = 0x200L;
    private static final long OPT_BIT_CUSTODIAN = 0x400L;
    private static final long OPT_BIT_SECTION = 0x800L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x1000L;
    private static final long OPT_BIT_ATTESTER = 0x2000L;
    private static final long OPT_BIT_EVENT = 0x4000L;
