...
final class ImmutableMeasureReport_Stratum implements MeasureReport_Stratum {
  ...
  public final ImmutableMeasureReport_Stratum withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Stratum(this.id, this.measureScore, value, this.value, this.extension, this.component, this.population);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code measureScore}, {@code modifierExtension}, {@code value}, {@code extension}, {@code component}, {@code population}.
   ...
   *    .measureScore(com.fhir.types.fhir.Quantity) // optional {@link MeasureReport_Stratum#measureScore() measureScore}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Stratum#modifierExtension() modifierExtension}
   *    .value(com.fhir.types.fhir.CodeableConcept) // optional {@link MeasureReport_Stratum#value() value}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Stratum#extension() extension}
   *    .component(List&amp;lt;com.fhir.types.fhir.MeasureReport_Component&amp;gt;) // optional {@link MeasureReport_Stratum#component() component}
   *    .population(List&amp;lt;com.fhir.types.fhir.MeasureReport_Population1&amp;gt;) // optional {@link MeasureReport_Stratum#population() population}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public MeasureReport_Stratum build() {
      return new ImmutableMeasureReport_Stratum(id, measureScore, modifierExtension, value, extension, component, population);
    }
