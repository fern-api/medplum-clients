...
final class ImmutableAuditEvent_Entity implements AuditEvent_Entity {
  ...
  /**
   * Computes a hash code from attributes: {@code role}, {@code extension}, {@code name}, {@code description}, {@code lifecycle}, {@code modifierExtension}, {@code detail}, {@code securityLabel}, {@code id}, {@code type}, {@code what}, {@code query}.
   ...
   *    .role(com.fhir.types.fhir.Coding) // optional {@link AuditEvent_Entity#role() role}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link AuditEvent_Entity#extension() extension}
   ...
   *    .lifecycle(com.fhir.types.fhir.Coding) // optional {@link AuditEvent_Entity#lifecycle() lifecycle}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link AuditEvent_Entity#modifierExtension() modifierExtension}
   *    .detail(List&amp;lt;com.fhir.types.fhir.AuditEvent_Detail&amp;gt;) // optional {@link AuditEvent_Entity#detail() detail}
   *    .securityLabel(List&amp;lt;com.fhir.types.fhir.Coding&amp;gt;) // optional {@link AuditEvent_Entity#securityLabel() securityLabel}
   *    .id(String) // optional {@link AuditEvent_Entity#id() id}
   *    .type(com.fhir.types.fhir.Coding) // optional {@link AuditEvent_Entity#type() type}
   *    .what(com.fhir.types.fhir.Reference) // optional {@link AuditEvent_Entity#what() what}
   *    .query(com.fhir.types.fhir.Base64Binary) // optional {@link AuditEvent_Entity#query() query}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_LIFECYCLE = 0x10L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x20L;
    private static final long OPT_BIT_DETAIL = 0x40L;
    ...
    private static final long OPT_BIT_WHAT = 0x400L;
    private static final long OPT_BIT_QUERY = 0x800L;
