...
final class ImmutableExplanationOfBenefit implements ExplanationOfBenefit {
  ...
  private boolean equalTo(ImmutableExplanationOfBenefit another) {
    return Objects.equals(payee, another.payee)
        ...
        && Objects.equals(preAuthRefPeriod, another.preAuthRefPeriod)
  ...
  /**
   * Computes a hash code from attributes: {@code payee}, {@code form}, {@code insurer}, {@code addItem}, {@code implicitRules}, {@code processNote}, {@code resourceType}, {@code total}, {@code type}, {@code priority}, {@code related}, {@code precedence}, {@code procedure}, {@code referral}, {@code careTeam}, {@code insurance}, {@code originalPrescription}, {@code disposition}, {@code diagnosis}, {@code outcome}, {@code accident}, {@code fundsReserveRequested}, {@code subType}, {@code enterer}, {@code payment}, {@code extension}, {@code status}, {@code use}, {@code preAuthRefPeriod}, {@code language}, {@code identifier}, {@code prescription}, {@code text}, {@code fundsReserve}, {@code benefitBalance}, {@code claimResponse}, {@code claim}, {@code created}, {@code preAuthRef}, {@code adjudication}, {@code formCode}, {@code billablePeriod}, {@code meta}, {@code modifierExtension}, {@code item}, {@code contained}, {@code supportingInfo}, {@code patient}, {@code id}, {@code provider}, {@code facility}, {@code benefitPeriod}.
   ...
   *    .payee(com.fhir.types.fhir.ExplanationOfBenefit_Payee) // optional {@link ExplanationOfBenefit#payee() payee}
   *    .form(com.fhir.types.fhir.Attachment) // optional {@link ExplanationOfBenefit#form() form}
   *    .insurer(com.fhir.types.fhir.Reference) // required {@link ExplanationOfBenefit#insurer() insurer}
   *    .addItem(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_AddItem&amp;gt;) // optional {@link ExplanationOfBenefit#addItem() addItem}
   *    .implicitRules(com.fhir.types.fhir.Uri) // optional {@link ExplanationOfBenefit#implicitRules() implicitRules}
   *    .processNote(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_ProcessNote&amp;gt;) // optional {@link ExplanationOfBenefit#processNote() processNote}
   *    .resourceType(String) // required {@link ExplanationOfBenefit#resourceType() resourceType}
   *    .total(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_Total&amp;gt;) // optional {@link ExplanationOfBenefit#total() total}
   *    .type(com.fhir.types.fhir.CodeableConcept) // required {@link ExplanationOfBenefit#type() type}
   *    .priority(com.fhir.types.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit#priority() priority}
   *    .related(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_Related&amp;gt;) // optional {@link ExplanationOfBenefit#related() related}
   *    .precedence(com.fhir.types.fhir.PositiveInt) // optional {@link ExplanationOfBenefit#precedence() precedence}
   *    .procedure(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_Procedure&amp;gt;) // optional {@link ExplanationOfBenefit#procedure() procedure}
   *    .referral(com.fhir.types.fhir.Reference) // optional {@link ExplanationOfBenefit#referral() referral}
   *    .careTeam(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_CareTeam&amp;gt;) // optional {@link ExplanationOfBenefit#careTeam() careTeam}
   *    .addInsurance|addAllInsurance(com.fhir.types.fhir.ExplanationOfBenefit_Insurance) // {@link ExplanationOfBenefit#insurance() insurance} elements
   *    .originalPrescription(com.fhir.types.fhir.Reference) // optional {@link ExplanationOfBenefit#originalPrescription() originalPrescription}
   *    .disposition(String) // optional {@link ExplanationOfBenefit#disposition() disposition}
   *    .diagnosis(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_Diagnosis&amp;gt;) // optional {@link ExplanationOfBenefit#diagnosis() diagnosis}
   *    .outcome(com.fhir.types.fhir.Code) // optional {@link ExplanationOfBenefit#outcome() outcome}
   *    .accident(com.fhir.types.fhir.ExplanationOfBenefit_Accident) // optional {@link ExplanationOfBenefit#accident() accident}
   *    .fundsReserveRequested(com.fhir.types.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit#fundsReserveRequested() fundsReserveRequested}
   *    .subType(com.fhir.types.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit#subType() subType}
   *    .enterer(com.fhir.types.fhir.Reference) // optional {@link ExplanationOfBenefit#enterer() enterer}
   *    .payment(com.fhir.types.fhir.ExplanationOfBenefit_Payment) // optional {@link ExplanationOfBenefit#payment() payment}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit#extension() extension}
   *    .status(com.fhir.types.fhir.ExplanationofbenefitStatus) // optional {@link ExplanationOfBenefit#status() status}
   *    .use(com.fhir.types.fhir.Code) // optional {@link ExplanationOfBenefit#use() use}
   *    .preAuthRefPeriod(List&amp;lt;com.fhir.types.fhir.Period&amp;gt;) // optional {@link ExplanationOfBenefit#preAuthRefPeriod() preAuthRefPeriod}
   *    .language(com.fhir.types.fhir.Code) // optional {@link ExplanationOfBenefit#language() language}
   *    .identifier(List&amp;lt;com.fhir.types.fhir.Identifier&amp;gt;) // optional {@link ExplanationOfBenefit#identifier() identifier}
   *    .prescription(com.fhir.types.fhir.Reference) // optional {@link ExplanationOfBenefit#prescription() prescription}
   *    .text(com.fhir.types.fhir.Narrative) // optional {@link ExplanationOfBenefit#text() text}
   *    .fundsReserve(com.fhir.types.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit#fundsReserve() fundsReserve}
   *    .benefitBalance(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_BenefitBalance&amp;gt;) // optional {@link ExplanationOfBenefit#benefitBalance() benefitBalance}
   *    .claimResponse(com.fhir.types.fhir.Reference) // optional {@link ExplanationOfBenefit#claimResponse() claimResponse}
   *    .claim(com.fhir.types.fhir.Reference) // optional {@link ExplanationOfBenefit#claim() claim}
   *    .created(com.fhir.types.fhir.DateTime) // optional {@link ExplanationOfBenefit#created() created}
   *    .preAuthRef(List&amp;lt;String&amp;gt;) // optional {@link ExplanationOfBenefit#preAuthRef() preAuthRef}
   *    .adjudication(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_Adjudication&amp;gt;) // optional {@link ExplanationOfBenefit#adjudication() adjudication}
   *    .formCode(com.fhir.types.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit#formCode() formCode}
   *    .billablePeriod(com.fhir.types.fhir.Period) // optional {@link ExplanationOfBenefit#billablePeriod() billablePeriod}
   *    .meta(com.fhir.types.fhir.Meta) // optional {@link ExplanationOfBenefit#meta() meta}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit#modifierExtension() modifierExtension}
   *    .item(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_Item&amp;gt;) // optional {@link ExplanationOfBenefit#item() item}
   *    .contained(List&amp;lt;com.fhir.types.fhir.ResourceList&amp;gt;) // optional {@link ExplanationOfBenefit#contained() contained}
   *    .supportingInfo(List&amp;lt;com.fhir.types.fhir.ExplanationOfBenefit_SupportingInfo&amp;gt;) // optional {@link ExplanationOfBenefit#supportingInfo() supportingInfo}
   *    .patient(com.fhir.types.fhir.Reference) // required {@link ExplanationOfBenefit#patient() patient}
   *    .id(com.fhir.types.fhir.Id) // optional {@link ExplanationOfBenefit#id() id}
   *    .provider(com.fhir.types.fhir.Reference) // required {@link ExplanationOfBenefit#provider() provider}
   *    .facility(com.fhir.types.fhir.Reference) // optional {@link ExplanationOfBenefit#facility() facility}
   *    .benefitPeriod(com.fhir.types.fhir.Period) // optional {@link ExplanationOfBenefit#benefitPeriod() benefitPeriod}
   *    .build();
   * </pre>
  ...
  public static final class Builder
      implements InsurerBuildStage, ResourceTypeBuildStage, TypeBuildStage, PatientBuildStage, ProviderBuildStage, BuildFinal {
    ...
    private static final long INIT_BIT_PROVIDER = 0x10L;
    private static final long OPT_BIT_PAYEE = 0x1L;
    private static final long OPT_BIT_FORM = 0x2L;
    private static final long OPT_BIT_ADD_ITEM = 0x4L;
    private static final long OPT_BIT_IMPLICIT_RULES = 0x8L;
    private static final long OPT_BIT_PROCESS_NOTE = 0x10L;
    ...
    private static final long OPT_BIT_PRECEDENCE = 0x100L;
    private static final long OPT_BIT_PROCEDURE = 0x200L;
    private static final long OPT_BIT_REFERRAL = 0x400L;
    private static final long OPT_BIT_CARE_TEAM = 0x800L;
    private static final long OPT_BIT_ORIGINAL_PRESCRIPTION = 0x1000L;
    private static final long OPT_BIT_DISPOSITION = 0x2000L;
    private static final long OPT_BIT_DIAGNOSIS = 0x4000L;
    private static final long OPT_BIT_OUTCOME = 0x8000L;
    private static final long OPT_BIT_ACCIDENT = 0x10000L;
    private static final long OPT_BIT_FUNDS_RESERVE_REQUESTED = 0x20000L;
    private static final long OPT_BIT_SUB_TYPE = 0x40000L;
    private static final long OPT_BIT_ENTERER = 0x80000L;
    private static final long OPT_BIT_PAYMENT = 0x100000L;
    private static final long OPT_BIT_EXTENSION = 0x200000L;
    private static final long OPT_BIT_STATUS = 0x400000L;
    private static final long OPT_BIT_USE = 0x800000L;
    private static final long OPT_BIT_PRE_AUTH_REF_PERIOD = 0x1000000L;
    private static final long OPT_BIT_LANGUAGE = 0x2000000L;
    private static final long OPT_BIT_IDENTIFIER = 0x4000000L;
    private static final long OPT_BIT_PRESCRIPTION = 0x8000000L;
    private static final long OPT_BIT_TEXT = 0x10000000L;
    private static final long OPT_BIT_FUNDS_RESERVE = 0x20000000L;
    private static final long OPT_BIT_BENEFIT_BALANCE = 0x40000000L;
    private static final long OPT_BIT_CLAIM_RESPONSE = 0x80000000L;
    private static final long OPT_BIT_CLAIM = 0x100000000L;
    private static final long OPT_BIT_CREATED = 0x200000000L;
    private static final long OPT_BIT_PRE_AUTH_REF = 0x400000000L;
    private static final long OPT_BIT_ADJUDICATION = 0x800000000L;
    private static final long OPT_BIT_FORM_CODE = 0x1000000000L;
    private static final long OPT_BIT_BILLABLE_PERIOD = 0x2000000000L;
    private static final long OPT_BIT_META = 0x4000000000L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x8000000000L;
    private static final long OPT_BIT_ITEM = 0x10000000000L;
    private static final long OPT_BIT_CONTAINED = 0x20000000000L;
    private static final long OPT_BIT_SUPPORTING_INFO = 0x40000000000L;
    private static final long OPT_BIT_ID = 0x80000000000L;
    private static final long OPT_BIT_FACILITY = 0x100000000000L;
    private static final long OPT_BIT_BENEFIT_PERIOD = 0x200000000000L;
