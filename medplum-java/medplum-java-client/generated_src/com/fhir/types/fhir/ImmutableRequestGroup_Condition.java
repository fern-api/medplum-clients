...
final class ImmutableRequestGroup_Condition implements RequestGroup_Condition {
   ...
   *    .kind(com.fhir.types.fhir.Code) // optional {@link RequestGroup_Condition#kind() kind}
   *    .expression(com.fhir.types.fhir.Expression) // optional {@link RequestGroup_Condition#expression() expression}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link RequestGroup_Condition#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link RequestGroup_Condition#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link RequestGroup_Condition#extension() extension}
   *    .build();
   * </pre>
