...
final class ImmutableTestReport_Setup implements TestReport_Setup {
  ...
  public final ImmutableTestReport_Setup withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Setup(newValue, this.id, this.extension, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Setup(value, this.id, this.extension, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withId(String value) {
    ...
    return new ImmutableTestReport_Setup(this.modifierExtension, newValue, this.extension, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withId(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Setup(this.modifierExtension, value, this.extension, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Setup(this.modifierExtension, this.id, newValue, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Setup(this.modifierExtension, this.id, value, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withAction(TestReport_Action... elements) {
    ...
    return new ImmutableTestReport_Setup(this.modifierExtension, this.id, this.extension, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code id}, {@code extension}, {@code action}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Setup#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link TestReport_Setup#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Setup#extension() extension}
   *    .addAction|addAllAction(com.fhir.types.fhir.TestReport_Action) // {@link TestReport_Setup#action() action} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TestReport_Setup build() {
      return new ImmutableTestReport_Setup(modifierExtension, id, extension, createUnmodifiableList(true, action));
    }
