...
final class ImmutablePopulation implements Population {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code ageRange}, {@code gender}, {@code extension}, {@code race}, {@code modifierExtension}, {@code ageCodeableConcept}, {@code physiologicalCondition}.
   ...
   *    .ageRange(com.fhir.types.fhir.Range) // optional {@link Population#ageRange() ageRange}
   *    .gender(com.fhir.types.fhir.CodeableConcept) // optional {@link Population#gender() gender}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Population#extension() extension}
   *    .race(com.fhir.types.fhir.CodeableConcept) // optional {@link Population#race() race}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Population#modifierExtension() modifierExtension}
   *    .ageCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link Population#ageCodeableConcept() ageCodeableConcept}
   *    .physiologicalCondition(com.fhir.types.fhir.CodeableConcept) // optional {@link Population#physiologicalCondition() physiologicalCondition}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_AGE_RANGE = 0x2L;
    private static final long OPT_BIT_GENDER = 0x4L;
    private static final long OPT_BIT_EXTENSION = 0x8L;
    private static final long OPT_BIT_RACE = 0x10L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x20L;
    private static final long OPT_BIT_AGE_CODEABLE_CONCEPT = 0x40L;
    private static final long OPT_BIT_PHYSIOLOGICAL_CONDITION = 0x80L;
