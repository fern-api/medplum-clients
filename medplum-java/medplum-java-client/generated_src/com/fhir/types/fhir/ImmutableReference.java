...
final class ImmutableReference implements Reference {
  ...
  public final ImmutableReference withIdentifier(Identifier value) {
    ...
    return new ImmutableReference(newValue, this.id, this.extension, this.type, this.reference, this.display, this.resource);
  }
  ...
  public final ImmutableReference withIdentifier(Optional<? extends Identifier> optional) {
    ...
    return new ImmutableReference(value, this.id, this.extension, this.type, this.reference, this.display, this.resource);
  }
  ...
  public final ImmutableReference withId(Optional<String> optional) {
    ...
    return new ImmutableReference(this.identifier, value, this.extension, this.type, this.reference, this.display, this.resource);
  }
  ...
  public final ImmutableReference withExtension(List<Extension> value) {
    ...
    return new ImmutableReference(this.identifier, this.id, newValue, this.type, this.reference, this.display, this.resource);
  }
  ...
  public final ImmutableReference withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableReference(this.identifier, this.id, value, this.type, this.reference, this.display, this.resource);
  }
  ...
  public final ImmutableReference withType(Uri value) {
    ...
    return new ImmutableReference(this.identifier, this.id, this.extension, newValue, this.reference, this.display, this.resource);
  }
  ...
  public final ImmutableReference withType(Optional<? extends Uri> optional) {
    ...
    return new ImmutableReference(this.identifier, this.id, this.extension, value, this.reference, this.display, this.resource);
  }
  ...
  public final ImmutableReference withReference(String value) {
    ...
    return new ImmutableReference(this.identifier, this.id, this.extension, this.type, newValue, this.display, this.resource);
  }
  ...
  public final ImmutableReference withReference(Optional<String> optional) {
    ...
    return new ImmutableReference(this.identifier, this.id, this.extension, this.type, value, this.display, this.resource);
  }
  ...
  public final ImmutableReference withDisplay(String value) {
    ...
    return new ImmutableReference(this.identifier, this.id, this.extension, this.type, this.reference, newValue, this.resource);
  }
  ...
  public final ImmutableReference withDisplay(Optional<String> optional) {
    ...
    return new ImmutableReference(this.identifier, this.id, this.extension, this.type, this.reference, value, this.resource);
  }
  ...
  public final ImmutableReference withResource(ResourceList value) {
    ...
    return new ImmutableReference(this.identifier, this.id, this.extension, this.type, this.reference, this.display, newValue);
  }
  ...
  public final ImmutableReference withResource(Optional<? extends ResourceList> optional) {
    ...
    return new ImmutableReference(this.identifier, this.id, this.extension, this.type, this.reference, this.display, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code identifier}, {@code id}, {@code extension}, {@code type}, {@code reference}, {@code display}, {@code resource}.
   ...
   *    .identifier(com.fhir.types.fhir.Identifier) // optional {@link Reference#identifier() identifier}
   *    .id(String) // optional {@link Reference#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Reference#extension() extension}
   *    .type(com.fhir.types.fhir.Uri) // optional {@link Reference#type() type}
   *    .reference(String) // optional {@link Reference#reference() reference}
   *    .display(String) // optional {@link Reference#display() display}
   *    .resource(com.fhir.types.fhir.ResourceList) // optional {@link Reference#resource() resource}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Reference build() {
      return new ImmutableReference(identifier, id, extension, type, reference, display, resource);
    }
