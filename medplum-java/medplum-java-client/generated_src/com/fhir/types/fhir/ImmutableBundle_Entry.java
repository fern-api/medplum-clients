...
final class ImmutableBundle_Entry implements Bundle_Entry {
  ...
  /**
   * Computes a hash code from attributes: {@code link}, {@code fullUrl}, {@code resource}, {@code response}, {@code request}, {@code extension}, {@code id}, {@code search}, {@code modifierExtension}.
   ...
   *    .link(List&amp;lt;com.fhir.types.fhir.Bundle_Link&amp;gt;) // optional {@link Bundle_Entry#link() link}
   *    .fullUrl(com.fhir.types.fhir.Uri) // optional {@link Bundle_Entry#fullUrl() fullUrl}
   *    .resource(com.fhir.types.fhir.ResourceList) // optional {@link Bundle_Entry#resource() resource}
   *    .response(com.fhir.types.fhir.Bundle_Response) // optional {@link Bundle_Entry#response() response}
   *    .request(com.fhir.types.fhir.Bundle_Request) // optional {@link Bundle_Entry#request() request}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Bundle_Entry#extension() extension}
   *    .id(String) // optional {@link Bundle_Entry#id() id}
   *    .search(com.fhir.types.fhir.Bundle_Search) // optional {@link Bundle_Entry#search() search}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Bundle_Entry#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_FULL_URL = 0x2L;
    private static final long OPT_BIT_RESOURCE = 0x4L;
    private static final long OPT_BIT_RESPONSE = 0x8L;
    private static final long OPT_BIT_REQUEST = 0x10L;
    private static final long OPT_BIT_EXTENSION = 0x20L;
    private static final long OPT_BIT_ID = 0x40L;
    private static final long OPT_BIT_SEARCH = 0x80L;
    ...
    public Bundle_Entry build() {
      return new ImmutableBundle_Entry(link, fullUrl, resource, response, request, extension, id, search, modifierExtension);
    }
