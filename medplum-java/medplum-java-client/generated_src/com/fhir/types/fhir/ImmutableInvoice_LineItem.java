...
final class ImmutableInvoice_LineItem implements Invoice_LineItem {
  ...
  private boolean equalTo(ImmutableInvoice_LineItem another) {
    return Objects.equals(priceComponent, another.priceComponent)
        && Objects.equals(sequence, another.sequence)
        && Objects.equals(chargeItemReference, another.chargeItemReference)
        && Objects.equals(id, another.id)
        && Objects.equals(chargeItemCodeableConcept, another.chargeItemCodeableConcept)
        && Objects.equals(modifierExtension, another.modifierExtension)
        && Objects.equals(extension, another.extension);
  }

  /**
   * Computes a hash code from attributes: {@code priceComponent}, {@code sequence}, {@code chargeItemReference}, {@code id}, {@code chargeItemCodeableConcept}, {@code modifierExtension}, {@code extension}.
   ...
   *    .priceComponent(List&amp;lt;com.fhir.types.fhir.Invoice_PriceComponent&amp;gt;) // optional {@link Invoice_LineItem#priceComponent() priceComponent}
   *    .sequence(com.fhir.types.fhir.PositiveInt) // optional {@link Invoice_LineItem#sequence() sequence}
   *    .chargeItemReference(com.fhir.types.fhir.Reference) // optional {@link Invoice_LineItem#chargeItemReference() chargeItemReference}
   *    .id(String) // optional {@link Invoice_LineItem#id() id}
   *    .chargeItemCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link Invoice_LineItem#chargeItemCodeableConcept() chargeItemCodeableConcept}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Invoice_LineItem#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Invoice_LineItem#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_PRICE_COMPONENT = 0x1L;
    private static final long OPT_BIT_SEQUENCE = 0x2L;
    private static final long OPT_BIT_CHARGE_ITEM_REFERENCE = 0x4L;
    private static final long OPT_BIT_ID = 0x8L;
    private static final long OPT_BIT_CHARGE_ITEM_CODEABLE_CONCEPT = 0x10L;
