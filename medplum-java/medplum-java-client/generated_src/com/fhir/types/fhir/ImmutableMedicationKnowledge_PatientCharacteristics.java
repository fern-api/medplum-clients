...
final class ImmutableMedicationKnowledge_PatientCharacteristics
  ...
  public final ImmutableMedicationKnowledge_PatientCharacteristics withCharacteristicCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableMedicationKnowledge_PatientCharacteristics(this.id, this.modifierExtension, this.extension, value, this.characteristicQuantity, this.value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code extension}, {@code characteristicCodeableConcept}, {@code characteristicQuantity}, {@code value}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_PatientCharacteristics#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_PatientCharacteristics#extension() extension}
   *    .characteristicCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link MedicationKnowledge_PatientCharacteristics#characteristicCodeableConcept() characteristicCodeableConcept}
   *    .characteristicQuantity(com.fhir.types.fhir.Quantity) // optional {@link MedicationKnowledge_PatientCharacteristics#characteristicQuantity() characteristicQuantity}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_CHARACTERISTIC_CODEABLE_CONCEPT = 0x8L;
    private static final long OPT_BIT_CHARACTERISTIC_QUANTITY = 0x10L;
