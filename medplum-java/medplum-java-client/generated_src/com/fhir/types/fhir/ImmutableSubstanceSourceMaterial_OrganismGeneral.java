...
final class ImmutableSubstanceSourceMaterial_OrganismGeneral
  ...
  public final ImmutableSubstanceSourceMaterial_OrganismGeneral with_class(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_OrganismGeneral(value, this.order, this.extension, this.modifierExtension, this.id, this.kingdom, this.phylum);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_OrganismGeneral withOrder(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_OrganismGeneral(this._class, value, this.extension, this.modifierExtension, this.id, this.kingdom, this.phylum);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_OrganismGeneral withExtension(List<Extension> value) {
    ...
    return new ImmutableSubstanceSourceMaterial_OrganismGeneral(this._class, this.order, newValue, this.modifierExtension, this.id, this.kingdom, this.phylum);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_OrganismGeneral withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_OrganismGeneral(this._class, this.order, value, this.modifierExtension, this.id, this.kingdom, this.phylum);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_OrganismGeneral withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSubstanceSourceMaterial_OrganismGeneral(this._class, this.order, this.extension, newValue, this.id, this.kingdom, this.phylum);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_OrganismGeneral withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_OrganismGeneral(this._class, this.order, this.extension, value, this.id, this.kingdom, this.phylum);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_OrganismGeneral withKingdom(CodeableConcept value) {
    ...
    return new ImmutableSubstanceSourceMaterial_OrganismGeneral(this._class, this.order, this.extension, this.modifierExtension, this.id, newValue, this.phylum);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_OrganismGeneral withKingdom(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_OrganismGeneral(this._class, this.order, this.extension, this.modifierExtension, this.id, value, this.phylum);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_OrganismGeneral withPhylum(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_OrganismGeneral(this._class, this.order, this.extension, this.modifierExtension, this.id, this.kingdom, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code _class}, {@code order}, {@code extension}, {@code modifierExtension}, {@code id}, {@code kingdom}, {@code phylum}.
   ...
   *    ._class(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSourceMaterial_OrganismGeneral#_class() _class}
   *    .order(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSourceMaterial_OrganismGeneral#order() order}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSourceMaterial_OrganismGeneral#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSourceMaterial_OrganismGeneral#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link SubstanceSourceMaterial_OrganismGeneral#id() id}
   *    .kingdom(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSourceMaterial_OrganismGeneral#kingdom() kingdom}
   *    .phylum(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSourceMaterial_OrganismGeneral#phylum() phylum}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_ORDER = 0x2L;
    private static final long OPT_BIT_EXTENSION = 0x4L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x8L;
    private static final long OPT_BIT_ID = 0x10L;
    private static final long OPT_BIT_KINGDOM = 0x20L;
    private static final long OPT_BIT_PHYLUM = 0x40L;
    ...
    public SubstanceSourceMaterial_OrganismGeneral build() {
      return new ImmutableSubstanceSourceMaterial_OrganismGeneral(_class, order, extension, modifierExtension, id, kingdom, phylum);
    }
