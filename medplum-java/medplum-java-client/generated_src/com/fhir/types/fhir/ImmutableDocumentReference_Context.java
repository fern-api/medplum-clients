...
final class ImmutableDocumentReference_Context implements DocumentReference_Context {
  ...
  /**
   * Computes a hash code from attributes: {@code period}, {@code id}, {@code facilityType}, {@code sourcePatientInfo}, {@code practiceSetting}, {@code event}, {@code encounter}, {@code extension}, {@code modifierExtension}, {@code related}.
   ...
   *    .period(com.fhir.types.fhir.Period) // optional {@link DocumentReference_Context#period() period}
   *    .id(String) // optional {@link DocumentReference_Context#id() id}
   *    .facilityType(com.fhir.types.fhir.CodeableConcept) // optional {@link DocumentReference_Context#facilityType() facilityType}
   *    .sourcePatientInfo(com.fhir.types.fhir.Reference) // optional {@link DocumentReference_Context#sourcePatientInfo() sourcePatientInfo}
   *    .practiceSetting(com.fhir.types.fhir.CodeableConcept) // optional {@link DocumentReference_Context#practiceSetting() practiceSetting}
   *    .event(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link DocumentReference_Context#event() event}
   *    .encounter(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link DocumentReference_Context#encounter() encounter}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link DocumentReference_Context#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link DocumentReference_Context#modifierExtension() modifierExtension}
   *    .related(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link DocumentReference_Context#related() related}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_FACILITY_TYPE = 0x4L;
    private static final long OPT_BIT_SOURCE_PATIENT_INFO = 0x8L;
    private static final long OPT_BIT_PRACTICE_SETTING = 0x10L;
    private static final long OPT_BIT_EVENT = 0x20L;
    private static final long OPT_BIT_ENCOUNTER = 0x40L;
    private static final long OPT_BIT_EXTENSION = 0x80L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x100L;
    private static final long OPT_BIT_RELATED = 0x200L;
