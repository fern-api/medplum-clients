...
final class ImmutableMedicinalProductPackaged implements MedicinalProductPackaged {
  ...
  /**
   * Computes a hash code from attributes: {@code meta}, {@code subject}, {@code implicitRules}, {@code marketingStatus}, {@code marketingAuthorization}, {@code batchIdentifier}, {@code packageItem}, {@code manufacturer}, {@code resourceType}, {@code description}, {@code text}, {@code extension}, {@code identifier}, {@code contained}, {@code id}, {@code modifierExtension}, {@code language}, {@code legalStatusOfSupply}.
   ...
   *    .meta(com.fhir.types.fhir.Meta) // optional {@link MedicinalProductPackaged#meta() meta}
   *    .subject(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link MedicinalProductPackaged#subject() subject}
   *    .implicitRules(com.fhir.types.fhir.Uri) // optional {@link MedicinalProductPackaged#implicitRules() implicitRules}
   *    .marketingStatus(List&amp;lt;com.fhir.types.fhir.MarketingStatus&amp;gt;) // optional {@link MedicinalProductPackaged#marketingStatus() marketingStatus}
   *    .marketingAuthorization(com.fhir.types.fhir.Reference) // optional {@link MedicinalProductPackaged#marketingAuthorization() marketingAuthorization}
   *    .batchIdentifier(List&amp;lt;com.fhir.types.fhir.MedicinalProductPackaged_BatchIdentifier&amp;gt;) // optional {@link MedicinalProductPackaged#batchIdentifier() batchIdentifier}
   *    .addPackageItem|addAllPackageItem(com.fhir.types.fhir.MedicinalProductPackaged_PackageItem) // {@link MedicinalProductPackaged#packageItem() packageItem} elements
   *    .manufacturer(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link MedicinalProductPackaged#manufacturer() manufacturer}
   ...
   *    .text(com.fhir.types.fhir.Narrative) // optional {@link MedicinalProductPackaged#text() text}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicinalProductPackaged#extension() extension}
   *    .identifier(List&amp;lt;com.fhir.types.fhir.Identifier&amp;gt;) // optional {@link MedicinalProductPackaged#identifier() identifier}
   *    .contained(List&amp;lt;com.fhir.types.fhir.ResourceList&amp;gt;) // optional {@link MedicinalProductPackaged#contained() contained}
   *    .id(com.fhir.types.fhir.Id) // optional {@link MedicinalProductPackaged#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicinalProductPackaged#modifierExtension() modifierExtension}
   *    .language(com.fhir.types.fhir.Code) // optional {@link MedicinalProductPackaged#language() language}
   *    .legalStatusOfSupply(com.fhir.types.fhir.CodeableConcept) // optional {@link MedicinalProductPackaged#legalStatusOfSupply() legalStatusOfSupply}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ResourceTypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_BATCH_IDENTIFIER = 0x20L;
    private static final long OPT_BIT_MANUFACTURER = 0x40L;
    ...
    private static final long OPT_BIT_LEGAL_STATUS_OF_SUPPLY = 0x8000L;
