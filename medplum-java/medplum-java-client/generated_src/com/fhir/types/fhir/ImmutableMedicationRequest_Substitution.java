...
final class ImmutableMedicationRequest_Substitution
  ...
  public final ImmutableMedicationRequest_Substitution withAllowedCodeableConcept(CodeableConcept value) {
    ...
    return new ImmutableMedicationRequest_Substitution(this.id, this.extension, newValue, this.allowedBoolean, this.modifierExtension, this.reason);
  }
  ...
  public final ImmutableMedicationRequest_Substitution withAllowedCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableMedicationRequest_Substitution(this.id, this.extension, value, this.allowedBoolean, this.modifierExtension, this.reason);
  }
  ...
  public final ImmutableMedicationRequest_Substitution withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationRequest_Substitution(this.id, this.extension, this.allowedCodeableConcept, this.allowedBoolean, value, this.reason);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code allowedCodeableConcept}, {@code allowedBoolean}, {@code modifierExtension}, {@code reason}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationRequest_Substitution#extension() extension}
   *    .allowedCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link MedicationRequest_Substitution#allowedCodeableConcept() allowedCodeableConcept}
   *    .allowedBoolean(Boolean) // optional {@link MedicationRequest_Substitution#allowedBoolean() allowedBoolean}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationRequest_Substitution#modifierExtension() modifierExtension}
   *    .reason(com.fhir.types.fhir.CodeableConcept) // optional {@link MedicationRequest_Substitution#reason() reason}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_ALLOWED_CODEABLE_CONCEPT = 0x4L;
    ...
    public MedicationRequest_Substitution build() {
      return new ImmutableMedicationRequest_Substitution(id, extension, allowedCodeableConcept, allowedBoolean, modifierExtension, reason);
    }
