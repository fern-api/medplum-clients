...
final class ImmutableSubstanceSpecification_Property
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code amountString}, {@code code}, {@code definingSubstanceCodeableConcept}, {@code parameters}, {@code definingSubstanceReference}, {@code extension}, {@code amountQuantity}, {@code id}, {@code category}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Property#modifierExtension() modifierExtension}
   *    .amountString(String) // optional {@link SubstanceSpecification_Property#amountString() amountString}
   *    .code(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Property#code() code}
   *    .definingSubstanceCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Property#definingSubstanceCodeableConcept() definingSubstanceCodeableConcept}
   *    .parameters(String) // optional {@link SubstanceSpecification_Property#parameters() parameters}
   *    .definingSubstanceReference(com.fhir.types.fhir.Reference) // optional {@link SubstanceSpecification_Property#definingSubstanceReference() definingSubstanceReference}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Property#extension() extension}
   *    .amountQuantity(com.fhir.types.fhir.Quantity) // optional {@link SubstanceSpecification_Property#amountQuantity() amountQuantity}
   *    .id(String) // optional {@link SubstanceSpecification_Property#id() id}
   *    .category(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Property#category() category}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_AMOUNT_STRING = 0x2L;
    private static final long OPT_BIT_CODE = 0x4L;
    private static final long OPT_BIT_DEFINING_SUBSTANCE_CODEABLE_CONCEPT = 0x8L;
    private static final long OPT_BIT_PARAMETERS = 0x10L;
