...
final class ImmutableDocumentManifest implements DocumentManifest {
  ...
  /**
   * Computes a hash code from attributes: {@code identifier}, {@code recipient}, {@code type}, {@code created}, {@code text}, {@code masterIdentifier}, {@code meta}, {@code description}, {@code status}, {@code resourceType}, {@code id}, {@code modifierExtension}, {@code author}, {@code source}, {@code contained}, {@code language}, {@code subject}, {@code related}, {@code extension}, {@code implicitRules}, {@code content}.
   ...
   *    .identifier(List&amp;lt;com.fhir.types.fhir.Identifier&amp;gt;) // optional {@link DocumentManifest#identifier() identifier}
   *    .recipient(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link DocumentManifest#recipient() recipient}
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link DocumentManifest#type() type}
   *    .created(com.fhir.types.fhir.DateTime) // optional {@link DocumentManifest#created() created}
   *    .text(com.fhir.types.fhir.Narrative) // optional {@link DocumentManifest#text() text}
   *    .masterIdentifier(com.fhir.types.fhir.Identifier) // optional {@link DocumentManifest#masterIdentifier() masterIdentifier}
   *    .meta(com.fhir.types.fhir.Meta) // optional {@link DocumentManifest#meta() meta}
   *    .description(String) // optional {@link DocumentManifest#description() description}
   *    .status(com.fhir.types.fhir.DocumentmanifestStatus) // optional {@link DocumentManifest#status() status}
   *    .resourceType(String) // required {@link DocumentManifest#resourceType() resourceType}
   *    .id(com.fhir.types.fhir.Id) // optional {@link DocumentManifest#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link DocumentManifest#modifierExtension() modifierExtension}
   *    .author(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link DocumentManifest#author() author}
   *    .source(com.fhir.types.fhir.Uri) // optional {@link DocumentManifest#source() source}
   *    .contained(List&amp;lt;com.fhir.types.fhir.ResourceList&amp;gt;) // optional {@link DocumentManifest#contained() contained}
   *    .language(com.fhir.types.fhir.Code) // optional {@link DocumentManifest#language() language}
   *    .subject(com.fhir.types.fhir.Reference) // optional {@link DocumentManifest#subject() subject}
   *    .related(List&amp;lt;com.fhir.types.fhir.DocumentManifest_Related&amp;gt;) // optional {@link DocumentManifest#related() related}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link DocumentManifest#extension() extension}
   *    .implicitRules(com.fhir.types.fhir.Uri) // optional {@link DocumentManifest#implicitRules() implicitRules}
   *    .addContent|addAllContent(com.fhir.types.fhir.Reference) // {@link DocumentManifest#content() content} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ResourceTypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_MASTER_IDENTIFIER = 0x20L;
    ...
    private static final long OPT_BIT_SOURCE = 0x1000L;
    ...
    private static final long OPT_BIT_RELATED = 0x10000L;
