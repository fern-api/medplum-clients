...
final class ImmutableContributor implements Contributor {
  ...
  public final ImmutableContributor withName(String value) {
    ...
    return new ImmutableContributor(newValue, this.id, this.extension, this.type, this.contact);
  }
  ...
  public final ImmutableContributor withName(Optional<String> optional) {
    ...
    return new ImmutableContributor(value, this.id, this.extension, this.type, this.contact);
  }
  ...
  public final ImmutableContributor withId(String value) {
    ...
    return new ImmutableContributor(this.name, newValue, this.extension, this.type, this.contact);
  }
  ...
  public final ImmutableContributor withId(Optional<String> optional) {
    ...
    return new ImmutableContributor(this.name, value, this.extension, this.type, this.contact);
  }
  ...
  public final ImmutableContributor withExtension(List<Extension> value) {
    ...
    return new ImmutableContributor(this.name, this.id, newValue, this.type, this.contact);
  }
  ...
  public final ImmutableContributor withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableContributor(this.name, this.id, value, this.type, this.contact);
  }
  ...
  public final ImmutableContributor withType(ContributorType value) {
    ...
    return new ImmutableContributor(this.name, this.id, this.extension, newValue, this.contact);
  }
  ...
  public final ImmutableContributor withType(Optional<? extends ContributorType> optional) {
    ...
    return new ImmutableContributor(this.name, this.id, this.extension, value, this.contact);
  }
  ...
  public final ImmutableContributor withContact(List<ContactDetail> value) {
    ...
    return new ImmutableContributor(this.name, this.id, this.extension, this.type, newValue);
  }
  ...
  public final ImmutableContributor withContact(Optional<? extends List<ContactDetail>> optional) {
    ...
    return new ImmutableContributor(this.name, this.id, this.extension, this.type, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code name}, {@code id}, {@code extension}, {@code type}, {@code contact}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Contributor#extension() extension}
   *    .type(com.fhir.types.fhir.ContributorType) // optional {@link Contributor#type() type}
   *    .contact(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link Contributor#contact() contact}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Contributor build() {
      return new ImmutableContributor(name, id, extension, type, contact);
    }
