...
final class ImmutableClaim_Procedure implements Claim_Procedure {
  ...
  private boolean equalTo(ImmutableClaim_Procedure another) {
    return Objects.equals(procedureReference, another.procedureReference)
  ...
  /**
   * Computes a hash code from attributes: {@code procedureReference}, {@code udi}, {@code date}, {@code sequence}, {@code procedureCodeableConcept}, {@code extension}, {@code id}, {@code modifierExtension}, {@code type}.
   ...
   *    .procedureReference(com.fhir.types.fhir.Reference) // optional {@link Claim_Procedure#procedureReference() procedureReference}
   *    .udi(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link Claim_Procedure#udi() udi}
   *    .date(com.fhir.types.fhir.DateTime) // optional {@link Claim_Procedure#date() date}
   *    .sequence(com.fhir.types.fhir.PositiveInt) // optional {@link Claim_Procedure#sequence() sequence}
   *    .procedureCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link Claim_Procedure#procedureCodeableConcept() procedureCodeableConcept}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Claim_Procedure#extension() extension}
   *    .id(String) // optional {@link Claim_Procedure#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Claim_Procedure#modifierExtension() modifierExtension}
   *    .type(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link Claim_Procedure#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_PROCEDURE_REFERENCE = 0x1L;
    private static final long OPT_BIT_UDI = 0x2L;
