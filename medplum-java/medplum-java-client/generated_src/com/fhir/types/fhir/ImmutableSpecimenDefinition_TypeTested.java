...
final class ImmutableSpecimenDefinition_TypeTested
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code isDerived}, {@code retentionTime}, {@code type}, {@code handling}, {@code requirement}, {@code id}, {@code extension}, {@code preference}, {@code container}, {@code rejectionCriterion}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_TypeTested#modifierExtension() modifierExtension}
   *    .isDerived(Boolean) // optional {@link SpecimenDefinition_TypeTested#isDerived() isDerived}
   *    .retentionTime(com.fhir.types.fhir.Duration) // optional {@link SpecimenDefinition_TypeTested#retentionTime() retentionTime}
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link SpecimenDefinition_TypeTested#type() type}
   *    .handling(List&amp;lt;com.fhir.types.fhir.SpecimenDefinition_Handling&amp;gt;) // optional {@link SpecimenDefinition_TypeTested#handling() handling}
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_TypeTested#extension() extension}
   *    .preference(Specimendefinition_TypetestedPreference) // optional {@link SpecimenDefinition_TypeTested#preference() preference}
   *    .container(com.fhir.types.fhir.SpecimenDefinition_Container) // optional {@link SpecimenDefinition_TypeTested#container() container}
   *    .rejectionCriterion(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link SpecimenDefinition_TypeTested#rejectionCriterion() rejectionCriterion}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_IS_DERIVED = 0x2L;
    private static final long OPT_BIT_RETENTION_TIME = 0x4L;
    private static final long OPT_BIT_TYPE = 0x8L;
    private static final long OPT_BIT_HANDLING = 0x10L;
    private static final long OPT_BIT_REQUIREMENT = 0x20L;
    private static final long OPT_BIT_ID = 0x40L;
    private static final long OPT_BIT_EXTENSION = 0x80L;
    private static final long OPT_BIT_PREFERENCE = 0x100L;
    private static final long OPT_BIT_CONTAINER = 0x200L;
