...
final class ImmutableMedicationKnowledge_RelatedMedicationKnowledge
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(newValue, this.modifierExtension, this.reference, this.id, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(value, this.modifierExtension, this.reference, this.id, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.extension, newValue, this.reference, this.id, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.extension, value, this.reference, this.id, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withReference(Reference... elements) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.extension, this.modifierExtension, newValue, this.id, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withId(String value) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.extension, this.modifierExtension, this.reference, newValue, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withId(Optional<String> optional) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.extension, this.modifierExtension, this.reference, value, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withType(CodeableConcept value) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.extension, this.modifierExtension, this.reference, this.id, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code modifierExtension}, {@code reference}, {@code id}, {@code type}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_RelatedMedicationKnowledge#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_RelatedMedicationKnowledge#modifierExtension() modifierExtension}
   *    .addReference|addAllReference(com.fhir.types.fhir.Reference) // {@link MedicationKnowledge_RelatedMedicationKnowledge#reference() reference} elements
   *    .id(String) // optional {@link MedicationKnowledge_RelatedMedicationKnowledge#id() id}
   *    .type(com.fhir.types.fhir.CodeableConcept) // required {@link MedicationKnowledge_RelatedMedicationKnowledge#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements TypeBuildStage, BuildFinal {
    ...
    public MedicationKnowledge_RelatedMedicationKnowledge build() {
      ...
      return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(extension, modifierExtension, createUnmodifiableList(true, reference), id, type);
    }
