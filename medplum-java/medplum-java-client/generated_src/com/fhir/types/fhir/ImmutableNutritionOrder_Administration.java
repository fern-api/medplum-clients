...
final class ImmutableNutritionOrder_Administration
  ...
  public final ImmutableNutritionOrder_Administration withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableNutritionOrder_Administration(this.extension, this.rateRatio, value, this.quantity, this.rateQuantity, this.id, this.schedule);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code rateRatio}, {@code modifierExtension}, {@code quantity}, {@code rateQuantity}, {@code id}, {@code schedule}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_Administration#extension() extension}
   *    .rateRatio(com.fhir.types.fhir.Ratio) // optional {@link NutritionOrder_Administration#rateRatio() rateRatio}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_Administration#modifierExtension() modifierExtension}
   *    .quantity(com.fhir.types.fhir.Quantity) // optional {@link NutritionOrder_Administration#quantity() quantity}
   *    .rateQuantity(com.fhir.types.fhir.Quantity) // optional {@link NutritionOrder_Administration#rateQuantity() rateQuantity}
   *    .id(String) // optional {@link NutritionOrder_Administration#id() id}
   *    .schedule(com.fhir.types.fhir.Timing) // optional {@link NutritionOrder_Administration#schedule() schedule}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_RATE_QUANTITY = 0x10L;
    private static final long OPT_BIT_ID = 0x20L;
    private static final long OPT_BIT_SCHEDULE = 0x40L;
    ...
    public NutritionOrder_Administration build() {
      return new ImmutableNutritionOrder_Administration(extension, rateRatio, modifierExtension, quantity, rateQuantity, id, schedule);
    }
