...
final class ImmutableEvidenceVariable implements EvidenceVariable {
  ...
  private boolean equalTo(ImmutableEvidenceVariable another) {
    return Objects.equals(effectivePeriod, another.effectivePeriod)
  ...
  /**
   * Computes a hash code from attributes: {@code effectivePeriod}, {@code implicitRules}, {@code relatedArtifact}, {@code meta}, {@code language}, {@code title}, {@code subtitle}, {@code endorser}, {@code useContext}, {@code type}, {@code status}, {@code id}, {@code version}, {@code publisher}, {@code date}, {@code note}, {@code contact}, {@code copyright}, {@code author}, {@code shortTitle}, {@code characteristic}, {@code modifierExtension}, {@code description}, {@code resourceType}, {@code reviewer}, {@code topic}, {@code url}, {@code extension}, {@code name}, {@code jurisdiction}, {@code text}, {@code approvalDate}, {@code identifier}, {@code lastReviewDate}, {@code contained}, {@code editor}.
   ...
   *    .effectivePeriod(com.fhir.types.fhir.Period) // optional {@link EvidenceVariable#effectivePeriod() effectivePeriod}
   *    .implicitRules(com.fhir.types.fhir.Uri) // optional {@link EvidenceVariable#implicitRules() implicitRules}
   *    .relatedArtifact(List&amp;lt;com.fhir.types.fhir.RelatedArtifact&amp;gt;) // optional {@link EvidenceVariable#relatedArtifact() relatedArtifact}
   *    .meta(com.fhir.types.fhir.Meta) // optional {@link EvidenceVariable#meta() meta}
   *    .language(com.fhir.types.fhir.Code) // optional {@link EvidenceVariable#language() language}
   *    .title(String) // optional {@link EvidenceVariable#title() title}
   *    .subtitle(String) // optional {@link EvidenceVariable#subtitle() subtitle}
   *    .endorser(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EvidenceVariable#endorser() endorser}
   *    .useContext(List&amp;lt;com.fhir.types.fhir.UsageContext&amp;gt;) // optional {@link EvidenceVariable#useContext() useContext}
   *    .type(com.fhir.types.fhir.EvidencevariableType) // optional {@link EvidenceVariable#type() type}
   *    .status(com.fhir.types.fhir.EvidencevariableStatus) // optional {@link EvidenceVariable#status() status}
   *    .id(com.fhir.types.fhir.Id) // optional {@link EvidenceVariable#id() id}
   ...
   *    .date(com.fhir.types.fhir.DateTime) // optional {@link EvidenceVariable#date() date}
   *    .note(List&amp;lt;com.fhir.types.fhir.Annotation&amp;gt;) // optional {@link EvidenceVariable#note() note}
   *    .contact(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EvidenceVariable#contact() contact}
   *    .copyright(com.fhir.types.fhir.Markdown) // optional {@link EvidenceVariable#copyright() copyright}
   *    .author(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EvidenceVariable#author() author}
   *    .shortTitle(String) // optional {@link EvidenceVariable#shortTitle() shortTitle}
   *    .addCharacteristic|addAllCharacteristic(com.fhir.types.fhir.EvidenceVariable_Characteristic) // {@link EvidenceVariable#characteristic() characteristic} elements
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EvidenceVariable#modifierExtension() modifierExtension}
   *    .description(com.fhir.types.fhir.Markdown) // optional {@link EvidenceVariable#description() description}
   *    .resourceType(String) // required {@link EvidenceVariable#resourceType() resourceType}
   *    .reviewer(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EvidenceVariable#reviewer() reviewer}
   *    .topic(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link EvidenceVariable#topic() topic}
   *    .url(com.fhir.types.fhir.Uri) // optional {@link EvidenceVariable#url() url}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EvidenceVariable#extension() extension}
   *    .name(String) // optional {@link EvidenceVariable#name() name}
   *    .jurisdiction(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link EvidenceVariable#jurisdiction() jurisdiction}
   *    .text(com.fhir.types.fhir.Narrative) // optional {@link EvidenceVariable#text() text}
   *    .approvalDate(com.fhir.types.fhir.Date) // optional {@link EvidenceVariable#approvalDate() approvalDate}
   *    .identifier(List&amp;lt;com.fhir.types.fhir.Identifier&amp;gt;) // optional {@link EvidenceVariable#identifier() identifier}
   *    .lastReviewDate(com.fhir.types.fhir.Date) // optional {@link EvidenceVariable#lastReviewDate() lastReviewDate}
   *    .contained(List&amp;lt;com.fhir.types.fhir.ResourceList&amp;gt;) // optional {@link EvidenceVariable#contained() contained}
   *    .editor(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EvidenceVariable#editor() editor}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ResourceTypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_SUBTITLE = 0x40L;
    ...
    private static final long OPT_BIT_PUBLISHER = 0x2000L;
    ...
    private static final long OPT_BIT_SHORT_TITLE = 0x80000L;
    ...
    private static final long OPT_BIT_TOPIC = 0x800000L;
