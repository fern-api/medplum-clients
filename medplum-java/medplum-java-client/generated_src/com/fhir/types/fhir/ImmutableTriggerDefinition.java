...
final class ImmutableTriggerDefinition implements TriggerDefinition {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code timingDate}, {@code timingReference}, {@code type}, {@code data}, {@code timingTiming}, {@code timingDateTime}, {@code condition}, {@code id}, {@code name}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TriggerDefinition#extension() extension}
   *    .timingDate(String) // optional {@link TriggerDefinition#timingDate() timingDate}
   *    .timingReference(com.fhir.types.fhir.Reference) // optional {@link TriggerDefinition#timingReference() timingReference}
   *    .type(com.fhir.types.fhir.TriggerdefinitionType) // optional {@link TriggerDefinition#type() type}
   *    .data(List&amp;lt;com.fhir.types.fhir.DataRequirement&amp;gt;) // optional {@link TriggerDefinition#data() data}
   *    .timingTiming(com.fhir.types.fhir.Timing) // optional {@link TriggerDefinition#timingTiming() timingTiming}
   *    .timingDateTime(String) // optional {@link TriggerDefinition#timingDateTime() timingDateTime}
   *    .condition(com.fhir.types.fhir.Expression) // optional {@link TriggerDefinition#condition() condition}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_TIMING_DATE = 0x2L;
    private static final long OPT_BIT_TIMING_REFERENCE = 0x4L;
    ...
    private static final long OPT_BIT_TIMING_DATE_TIME = 0x40L;
    private static final long OPT_BIT_CONDITION = 0x80L;
