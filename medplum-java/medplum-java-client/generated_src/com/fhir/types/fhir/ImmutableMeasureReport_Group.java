...
final class ImmutableMeasureReport_Group implements MeasureReport_Group {
  ...
  public final ImmutableMeasureReport_Group withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Group(this.id, value, this.code, this.population, this.extension, this.measureScore, this.stratifier);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code code}, {@code population}, {@code extension}, {@code measureScore}, {@code stratifier}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Group#modifierExtension() modifierExtension}
   *    .code(com.fhir.types.fhir.CodeableConcept) // optional {@link MeasureReport_Group#code() code}
   *    .population(List&amp;lt;com.fhir.types.fhir.MeasureReport_Population&amp;gt;) // optional {@link MeasureReport_Group#population() population}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Group#extension() extension}
   *    .measureScore(com.fhir.types.fhir.Quantity) // optional {@link MeasureReport_Group#measureScore() measureScore}
   *    .stratifier(List&amp;lt;com.fhir.types.fhir.MeasureReport_Stratifier&amp;gt;) // optional {@link MeasureReport_Group#stratifier() stratifier}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_MEASURE_SCORE = 0x20L;
    private static final long OPT_BIT_STRATIFIER = 0x40L;
    ...
    public MeasureReport_Group build() {
      return new ImmutableMeasureReport_Group(id, modifierExtension, code, population, extension, measureScore, stratifier);
    }
