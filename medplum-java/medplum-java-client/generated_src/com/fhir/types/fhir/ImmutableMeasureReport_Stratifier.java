...
final class ImmutableMeasureReport_Stratifier implements MeasureReport_Stratifier {
  ...
  public final ImmutableMeasureReport_Stratifier withCode(List<CodeableConcept> value) {
    ...
    return new ImmutableMeasureReport_Stratifier(newValue, this.id, this.extension, this.modifierExtension, this.stratum);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withCode(Optional<? extends List<CodeableConcept>> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(value, this.id, this.extension, this.modifierExtension, this.stratum);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withId(String value) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.code, newValue, this.extension, this.modifierExtension, this.stratum);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withId(Optional<String> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.code, value, this.extension, this.modifierExtension, this.stratum);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.code, this.id, newValue, this.modifierExtension, this.stratum);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.code, this.id, value, this.modifierExtension, this.stratum);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.code, this.id, this.extension, newValue, this.stratum);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.code, this.id, this.extension, value, this.stratum);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withStratum(List<MeasureReport_Stratum> value) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.code, this.id, this.extension, this.modifierExtension, newValue);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withStratum(Optional<? extends List<MeasureReport_Stratum>> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.code, this.id, this.extension, this.modifierExtension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code code}, {@code id}, {@code extension}, {@code modifierExtension}, {@code stratum}.
   ...
   *    .code(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link MeasureReport_Stratifier#code() code}
   *    .id(String) // optional {@link MeasureReport_Stratifier#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Stratifier#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Stratifier#modifierExtension() modifierExtension}
   *    .stratum(List&amp;lt;com.fhir.types.fhir.MeasureReport_Stratum&amp;gt;) // optional {@link MeasureReport_Stratifier#stratum() stratum}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_STRATUM = 0x10L;
    ...
    public MeasureReport_Stratifier build() {
      return new ImmutableMeasureReport_Stratifier(code, id, extension, modifierExtension, stratum);
    }
