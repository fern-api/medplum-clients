...
final class ImmutableTestScript_Test implements TestScript_Test {
  ...
  public final ImmutableTestScript_Test withName(String value) {
    ...
    return new ImmutableTestScript_Test(newValue, this.id, this.extension, this.action, this.modifierExtension, this.description);
  }
  ...
  public final ImmutableTestScript_Test withName(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Test(value, this.id, this.extension, this.action, this.modifierExtension, this.description);
  }
  ...
  public final ImmutableTestScript_Test withId(String value) {
    ...
    return new ImmutableTestScript_Test(this.name, newValue, this.extension, this.action, this.modifierExtension, this.description);
  }
  ...
  public final ImmutableTestScript_Test withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Test(this.name, value, this.extension, this.action, this.modifierExtension, this.description);
  }
  ...
  public final ImmutableTestScript_Test withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Test(this.name, this.id, newValue, this.action, this.modifierExtension, this.description);
  }
  ...
  public final ImmutableTestScript_Test withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Test(this.name, this.id, value, this.action, this.modifierExtension, this.description);
  }
  ...
  public final ImmutableTestScript_Test withAction(TestScript_Action1... elements) {
    ...
    return new ImmutableTestScript_Test(this.name, this.id, this.extension, newValue, this.modifierExtension, this.description);
  }
  ...
  public final ImmutableTestScript_Test withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Test(this.name, this.id, this.extension, this.action, newValue, this.description);
  }
  ...
  public final ImmutableTestScript_Test withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Test(this.name, this.id, this.extension, this.action, value, this.description);
  }
  ...
  public final ImmutableTestScript_Test withDescription(String value) {
    ...
    return new ImmutableTestScript_Test(this.name, this.id, this.extension, this.action, this.modifierExtension, newValue);
  }
  ...
  public final ImmutableTestScript_Test withDescription(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Test(this.name, this.id, this.extension, this.action, this.modifierExtension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code name}, {@code id}, {@code extension}, {@code action}, {@code modifierExtension}, {@code description}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Test#extension() extension}
   *    .addAction|addAllAction(com.fhir.types.fhir.TestScript_Action1) // {@link TestScript_Test#action() action} elements
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Test#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    public TestScript_Test build() {
      return new ImmutableTestScript_Test(name, id, extension, createUnmodifiableList(true, action), modifierExtension, description);
    }
