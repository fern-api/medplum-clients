...
final class ImmutableUserConfiguration_Search implements UserConfiguration_Search {
  ...
  public final ImmutableUserConfiguration_Search withCriteria(String value) {
    ...
    return new ImmutableUserConfiguration_Search(newValue, this.name);
  }
  ...
  public final ImmutableUserConfiguration_Search withCriteria(Optional<String> optional) {
    ...
    return new ImmutableUserConfiguration_Search(value, this.name);
  }
  ...
  public final ImmutableUserConfiguration_Search withName(String value) {
    ...
    return new ImmutableUserConfiguration_Search(this.criteria, newValue);
  }
  ...
  public final ImmutableUserConfiguration_Search withName(Optional<String> optional) {
    ...
    return new ImmutableUserConfiguration_Search(this.criteria, value);
  }
  ...
  private boolean equalTo(ImmutableUserConfiguration_Search another) {
    return Objects.equals(criteria, another.criteria)
        && Objects.equals(name, another.name);
  }

  /**
   * Computes a hash code from attributes: {@code criteria}, {@code name}.
  ...
  public static final class Builder {
    private static final long OPT_BIT_CRITERIA = 0x1L;
    ...
    public UserConfiguration_Search build() {
      return new ImmutableUserConfiguration_Search(criteria, name);
    }
