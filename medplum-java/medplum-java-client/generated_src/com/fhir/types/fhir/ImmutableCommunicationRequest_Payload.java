...
final class ImmutableCommunicationRequest_Payload
  ...
  private boolean equalTo(ImmutableCommunicationRequest_Payload another) {
    return Objects.equals(contentString, another.contentString)
  ...
  /**
   * Computes a hash code from attributes: {@code contentString}, {@code contentAttachment}, {@code contentReference}, {@code id}, {@code extension}, {@code modifierExtension}.
   ...
   *    .contentAttachment(com.fhir.types.fhir.Attachment) // optional {@link CommunicationRequest_Payload#contentAttachment() contentAttachment}
   *    .contentReference(com.fhir.types.fhir.Reference) // optional {@link CommunicationRequest_Payload#contentReference() contentReference}
   *    .id(String) // optional {@link CommunicationRequest_Payload#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CommunicationRequest_Payload#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CommunicationRequest_Payload#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_CONTENT_STRING = 0x1L;
    ...
    public CommunicationRequest_Payload build() {
      return new ImmutableCommunicationRequest_Payload(contentString, contentAttachment, contentReference, id, extension, modifierExtension);
    }
