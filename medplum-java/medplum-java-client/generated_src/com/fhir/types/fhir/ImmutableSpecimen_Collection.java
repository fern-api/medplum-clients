...
final class ImmutableSpecimen_Collection implements Specimen_Collection {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code bodySite}, {@code method}, {@code fastingStatusCodeableConcept}, {@code quantity}, {@code duration}, {@code collectedDateTime}, {@code modifierExtension}, {@code collector}, {@code collectedPeriod}, {@code fastingStatusDuration}, {@code extension}.
   ...
   *    .bodySite(com.fhir.types.fhir.CodeableConcept) // optional {@link Specimen_Collection#bodySite() bodySite}
   *    .method(com.fhir.types.fhir.CodeableConcept) // optional {@link Specimen_Collection#method() method}
   *    .fastingStatusCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link Specimen_Collection#fastingStatusCodeableConcept() fastingStatusCodeableConcept}
   *    .quantity(com.fhir.types.fhir.Quantity) // optional {@link Specimen_Collection#quantity() quantity}
   *    .duration(com.fhir.types.fhir.Duration) // optional {@link Specimen_Collection#duration() duration}
   *    .collectedDateTime(String) // optional {@link Specimen_Collection#collectedDateTime() collectedDateTime}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Specimen_Collection#modifierExtension() modifierExtension}
   *    .collector(com.fhir.types.fhir.Reference) // optional {@link Specimen_Collection#collector() collector}
   *    .collectedPeriod(com.fhir.types.fhir.Period) // optional {@link Specimen_Collection#collectedPeriod() collectedPeriod}
   *    .fastingStatusDuration(com.fhir.types.fhir.Duration) // optional {@link Specimen_Collection#fastingStatusDuration() fastingStatusDuration}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Specimen_Collection#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_FASTING_STATUS_CODEABLE_CONCEPT = 0x8L;
    private static final long OPT_BIT_QUANTITY = 0x10L;
    private static final long OPT_BIT_DURATION = 0x20L;
    private static final long OPT_BIT_COLLECTED_DATE_TIME = 0x40L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x80L;
    private static final long OPT_BIT_COLLECTOR = 0x100L;
    private static final long OPT_BIT_COLLECTED_PERIOD = 0x200L;
    private static final long OPT_BIT_FASTING_STATUS_DURATION = 0x400L;
