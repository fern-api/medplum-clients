...
final class ImmutableSubstance_Ingredient implements Substance_Ingredient {
  ...
  public final ImmutableSubstance_Ingredient withSubstanceCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstance_Ingredient(this.id, this.extension, this.quantity, this.substanceReference, value, this.modifierExtension);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code quantity}, {@code substanceReference}, {@code substanceCodeableConcept}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Substance_Ingredient#extension() extension}
   *    .quantity(com.fhir.types.fhir.Ratio) // optional {@link Substance_Ingredient#quantity() quantity}
   *    .substanceReference(com.fhir.types.fhir.Reference) // optional {@link Substance_Ingredient#substanceReference() substanceReference}
   *    .substanceCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link Substance_Ingredient#substanceCodeableConcept() substanceCodeableConcept}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Substance_Ingredient#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SUBSTANCE_REFERENCE = 0x8L;
    private static final long OPT_BIT_SUBSTANCE_CODEABLE_CONCEPT = 0x10L;
    ...
    public Substance_Ingredient build() {
      return new ImmutableSubstance_Ingredient(id, extension, quantity, substanceReference, substanceCodeableConcept, modifierExtension);
    }
