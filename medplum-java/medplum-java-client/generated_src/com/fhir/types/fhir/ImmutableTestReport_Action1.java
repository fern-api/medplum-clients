...
final class ImmutableTestReport_Action1 implements TestReport_Action1 {
  ...
  public final ImmutableTestReport_Action1 with_assert(TestReport_Assert value) {
    ...
    return new ImmutableTestReport_Action1(newValue, this.operation, this.extension, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Action1 with_assert(Optional<? extends TestReport_Assert> optional) {
    ...
    return new ImmutableTestReport_Action1(value, this.operation, this.extension, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Action1 withOperation(TestReport_Operation value) {
    ...
    return new ImmutableTestReport_Action1(this._assert, newValue, this.extension, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Action1 withOperation(Optional<? extends TestReport_Operation> optional) {
    ...
    return new ImmutableTestReport_Action1(this._assert, value, this.extension, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Action1 withExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Action1(this._assert, this.operation, newValue, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Action1 withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Action1(this._assert, this.operation, value, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Action1 withId(String value) {
    ...
    return new ImmutableTestReport_Action1(this._assert, this.operation, this.extension, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Action1 withId(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Action1(this._assert, this.operation, this.extension, value, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Action1 withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Action1(this._assert, this.operation, this.extension, this.id, newValue);
  }
  ...
  public final ImmutableTestReport_Action1 withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Action1(this._assert, this.operation, this.extension, this.id, value);
  }
  ...
  private boolean equalTo(ImmutableTestReport_Action1 another) {
    return Objects.equals(_assert, another._assert)
  ...
  /**
   * Computes a hash code from attributes: {@code _assert}, {@code operation}, {@code extension}, {@code id}, {@code modifierExtension}.
   ...
   *    ._assert(com.fhir.types.fhir.TestReport_Assert) // optional {@link TestReport_Action1#_assert() _assert}
   *    .operation(com.fhir.types.fhir.TestReport_Operation) // optional {@link TestReport_Action1#operation() operation}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Action1#extension() extension}
   *    .id(String) // optional {@link TestReport_Action1#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Action1#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT__ASSERT = 0x1L;
    ...
    public TestReport_Action1 build() {
      return new ImmutableTestReport_Action1(_assert, operation, extension, id, modifierExtension);
    }
