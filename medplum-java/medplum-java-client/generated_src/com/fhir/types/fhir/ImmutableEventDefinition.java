...
final class ImmutableEventDefinition implements EventDefinition {
  ...
  private boolean equalTo(ImmutableEventDefinition another) {
    return Objects.equals(subjectReference, another.subjectReference)
  ...
  /**
   * Computes a hash code from attributes: {@code subjectReference}, {@code url}, {@code resourceType}, {@code version}, {@code author}, {@code modifierExtension}, {@code status}, {@code name}, {@code subjectCodeableConcept}, {@code date}, {@code lastReviewDate}, {@code purpose}, {@code copyright}, {@code identifier}, {@code editor}, {@code id}, {@code description}, {@code title}, {@code contact}, {@code extension}, {@code endorser}, {@code trigger}, {@code text}, {@code relatedArtifact}, {@code jurisdiction}, {@code approvalDate}, {@code meta}, {@code useContext}, {@code topic}, {@code experimental}, {@code usage}, {@code implicitRules}, {@code language}, {@code contained}, {@code subtitle}, {@code publisher}, {@code reviewer}, {@code effectivePeriod}.
   ...
   *    .subjectReference(com.fhir.types.fhir.Reference) // optional {@link EventDefinition#subjectReference() subjectReference}
   *    .url(com.fhir.types.fhir.Uri) // optional {@link EventDefinition#url() url}
   ...
   *    .author(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EventDefinition#author() author}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EventDefinition#modifierExtension() modifierExtension}
   *    .status(com.fhir.types.fhir.EventdefinitionStatus) // optional {@link EventDefinition#status() status}
   *    .name(String) // optional {@link EventDefinition#name() name}
   *    .subjectCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link EventDefinition#subjectCodeableConcept() subjectCodeableConcept}
   *    .date(com.fhir.types.fhir.DateTime) // optional {@link EventDefinition#date() date}
   *    .lastReviewDate(com.fhir.types.fhir.Date) // optional {@link EventDefinition#lastReviewDate() lastReviewDate}
   *    .purpose(com.fhir.types.fhir.Markdown) // optional {@link EventDefinition#purpose() purpose}
   *    .copyright(com.fhir.types.fhir.Markdown) // optional {@link EventDefinition#copyright() copyright}
   *    .identifier(List&amp;lt;com.fhir.types.fhir.Identifier&amp;gt;) // optional {@link EventDefinition#identifier() identifier}
   *    .editor(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EventDefinition#editor() editor}
   *    .id(com.fhir.types.fhir.Id) // optional {@link EventDefinition#id() id}
   *    .description(com.fhir.types.fhir.Markdown) // optional {@link EventDefinition#description() description}
   *    .title(String) // optional {@link EventDefinition#title() title}
   *    .contact(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EventDefinition#contact() contact}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EventDefinition#extension() extension}
   *    .endorser(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EventDefinition#endorser() endorser}
   *    .addTrigger|addAllTrigger(com.fhir.types.fhir.TriggerDefinition) // {@link EventDefinition#trigger() trigger} elements
   *    .text(com.fhir.types.fhir.Narrative) // optional {@link EventDefinition#text() text}
   *    .relatedArtifact(List&amp;lt;com.fhir.types.fhir.RelatedArtifact&amp;gt;) // optional {@link EventDefinition#relatedArtifact() relatedArtifact}
   *    .jurisdiction(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link EventDefinition#jurisdiction() jurisdiction}
   *    .approvalDate(com.fhir.types.fhir.Date) // optional {@link EventDefinition#approvalDate() approvalDate}
   *    .meta(com.fhir.types.fhir.Meta) // optional {@link EventDefinition#meta() meta}
   *    .useContext(List&amp;lt;com.fhir.types.fhir.UsageContext&amp;gt;) // optional {@link EventDefinition#useContext() useContext}
   *    .topic(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link EventDefinition#topic() topic}
   ...
   *    .implicitRules(com.fhir.types.fhir.Uri) // optional {@link EventDefinition#implicitRules() implicitRules}
   *    .language(com.fhir.types.fhir.Code) // optional {@link EventDefinition#language() language}
   *    .contained(List&amp;lt;com.fhir.types.fhir.ResourceList&amp;gt;) // optional {@link EventDefinition#contained() contained}
   ...
   *    .reviewer(List&amp;lt;com.fhir.types.fhir.ContactDetail&amp;gt;) // optional {@link EventDefinition#reviewer() reviewer}
   *    .effectivePeriod(com.fhir.types.fhir.Period) // optional {@link EventDefinition#effectivePeriod() effectivePeriod}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ResourceTypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_SUBJECT_REFERENCE = 0x1L;
    ...
    private static final long OPT_BIT_LAST_REVIEW_DATE = 0x200L;
    ...
    private static final long OPT_BIT_REVIEWER = 0x400000000L;
    private static final long OPT_BIT_EFFECTIVE_PERIOD = 0x800000000L;
