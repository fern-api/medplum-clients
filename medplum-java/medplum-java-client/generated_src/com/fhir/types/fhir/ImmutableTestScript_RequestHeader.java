...
final class ImmutableTestScript_RequestHeader implements TestScript_RequestHeader {
  ...
  public final ImmutableTestScript_RequestHeader withId(String value) {
    ...
    return new ImmutableTestScript_RequestHeader(newValue, this.extension, this.modifierExtension, this.value, this.field);
  }
  ...
  public final ImmutableTestScript_RequestHeader withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_RequestHeader(value, this.extension, this.modifierExtension, this.value, this.field);
  }
  ...
  public final ImmutableTestScript_RequestHeader withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_RequestHeader(this.id, newValue, this.modifierExtension, this.value, this.field);
  }
  ...
  public final ImmutableTestScript_RequestHeader withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_RequestHeader(this.id, value, this.modifierExtension, this.value, this.field);
  }
  ...
  public final ImmutableTestScript_RequestHeader withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_RequestHeader(this.id, this.extension, newValue, this.value, this.field);
  }
  ...
  public final ImmutableTestScript_RequestHeader withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_RequestHeader(this.id, this.extension, value, this.value, this.field);
  }
  ...
  public final ImmutableTestScript_RequestHeader withValue(String value) {
    ...
    return new ImmutableTestScript_RequestHeader(this.id, this.extension, this.modifierExtension, newValue, this.field);
  }
  ...
  public final ImmutableTestScript_RequestHeader withValue(Optional<String> optional) {
    ...
    return new ImmutableTestScript_RequestHeader(this.id, this.extension, this.modifierExtension, value, this.field);
  }
  ...
  public final ImmutableTestScript_RequestHeader withField(String value) {
    ...
    return new ImmutableTestScript_RequestHeader(this.id, this.extension, this.modifierExtension, this.value, newValue);
  }
  ...
  public final ImmutableTestScript_RequestHeader withField(Optional<String> optional) {
    ...
    return new ImmutableTestScript_RequestHeader(this.id, this.extension, this.modifierExtension, this.value, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code modifierExtension}, {@code value}, {@code field}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_RequestHeader#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_RequestHeader#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_FIELD = 0x10L;
    ...
    public TestScript_RequestHeader build() {
      return new ImmutableTestScript_RequestHeader(id, extension, modifierExtension, value, field);
    }
