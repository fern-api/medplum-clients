...
final class ImmutableImplementationGuide_Manifest
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code rendering}, {@code other}, {@code image}, {@code id}, {@code modifierExtension}, {@code resource}, {@code page}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ImplementationGuide_Manifest#extension() extension}
   *    .rendering(com.fhir.types.fhir.Url) // optional {@link ImplementationGuide_Manifest#rendering() rendering}
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ImplementationGuide_Manifest#modifierExtension() modifierExtension}
   *    .addResource|addAllResource(com.fhir.types.fhir.ImplementationGuide_Resource1) // {@link ImplementationGuide_Manifest#resource() resource} elements
   *    .page(List&amp;lt;com.fhir.types.fhir.ImplementationGuide_Page1&amp;gt;) // optional {@link ImplementationGuide_Manifest#page() page}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_OTHER = 0x4L;
    private static final long OPT_BIT_IMAGE = 0x8L;
    private static final long OPT_BIT_ID = 0x10L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x20L;
    private static final long OPT_BIT_PAGE = 0x40L;
