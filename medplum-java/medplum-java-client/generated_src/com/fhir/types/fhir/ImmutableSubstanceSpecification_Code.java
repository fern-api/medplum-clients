...
final class ImmutableSubstanceSpecification_Code
  ...
  /**
   * Computes a hash code from attributes: {@code statusDate}, {@code comment}, {@code extension}, {@code status}, {@code code}, {@code id}, {@code modifierExtension}, {@code source}.
   ...
   *    .statusDate(com.fhir.types.fhir.DateTime) // optional {@link SubstanceSpecification_Code#statusDate() statusDate}
   *    .comment(String) // optional {@link SubstanceSpecification_Code#comment() comment}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Code#extension() extension}
   *    .status(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Code#status() status}
   *    .code(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Code#code() code}
   *    .id(String) // optional {@link SubstanceSpecification_Code#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Code#modifierExtension() modifierExtension}
   *    .source(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link SubstanceSpecification_Code#source() source}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public SubstanceSpecification_Code build() {
      return new ImmutableSubstanceSpecification_Code(statusDate, comment, extension, status, code, id, modifierExtension, source);
    }
