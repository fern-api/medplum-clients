...
final class ImmutableTestScript_Action1 implements TestScript_Action1 {
  ...
  public final ImmutableTestScript_Action1 withId(String value) {
    ...
    return new ImmutableTestScript_Action1(newValue, this._assert, this.extension, this.operation, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Action1 withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Action1(value, this._assert, this.extension, this.operation, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Action1 with_assert(TestScript_Assert value) {
    ...
    return new ImmutableTestScript_Action1(this.id, newValue, this.extension, this.operation, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Action1 with_assert(Optional<? extends TestScript_Assert> optional) {
    ...
    return new ImmutableTestScript_Action1(this.id, value, this.extension, this.operation, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Action1 withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Action1(this.id, this._assert, newValue, this.operation, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Action1 withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Action1(this.id, this._assert, value, this.operation, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Action1 withOperation(TestScript_Operation value) {
    ...
    return new ImmutableTestScript_Action1(this.id, this._assert, this.extension, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Action1 withOperation(Optional<? extends TestScript_Operation> optional) {
    ...
    return new ImmutableTestScript_Action1(this.id, this._assert, this.extension, value, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Action1 withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Action1(this.id, this._assert, this.extension, this.operation, newValue);
  }
  ...
  public final ImmutableTestScript_Action1 withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Action1(this.id, this._assert, this.extension, this.operation, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code _assert}, {@code extension}, {@code operation}, {@code modifierExtension}.
   ...
   *    ._assert(com.fhir.types.fhir.TestScript_Assert) // optional {@link TestScript_Action1#_assert() _assert}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Action1#extension() extension}
   *    .operation(com.fhir.types.fhir.TestScript_Operation) // optional {@link TestScript_Action1#operation() operation}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Action1#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TestScript_Action1 build() {
      return new ImmutableTestScript_Action1(id, _assert, extension, operation, modifierExtension);
    }
