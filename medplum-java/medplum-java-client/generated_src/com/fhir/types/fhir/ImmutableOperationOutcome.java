...
final class ImmutableOperationOutcome implements OperationOutcome {
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code language}, {@code status}, {@code issue}, {@code implicitRules}, {@code text}, {@code extension}, {@code resourceType}, {@code meta}, {@code id}, {@code resource}, {@code contained}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link OperationOutcome#modifierExtension() modifierExtension}
   *    .language(com.fhir.types.fhir.Code) // optional {@link OperationOutcome#language() language}
   *    .status(Integer) // optional {@link OperationOutcome#status() status}
   *    .addIssue|addAllIssue(com.fhir.types.fhir.OperationOutcome_Issue) // {@link OperationOutcome#issue() issue} elements
   *    .implicitRules(com.fhir.types.fhir.Uri) // optional {@link OperationOutcome#implicitRules() implicitRules}
   *    .text(com.fhir.types.fhir.Narrative) // optional {@link OperationOutcome#text() text}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link OperationOutcome#extension() extension}
   *    .resourceType(String) // required {@link OperationOutcome#resourceType() resourceType}
   *    .meta(com.fhir.types.fhir.Meta) // optional {@link OperationOutcome#meta() meta}
   *    .id(com.fhir.types.fhir.Id) // optional {@link OperationOutcome#id() id}
   *    .resource(com.fhir.types.fhir.ResourceList) // optional {@link OperationOutcome#resource() resource}
   *    .contained(List&amp;lt;com.fhir.types.fhir.ResourceList&amp;gt;) // optional {@link OperationOutcome#contained() contained}
   *    .build();
   * </pre>
