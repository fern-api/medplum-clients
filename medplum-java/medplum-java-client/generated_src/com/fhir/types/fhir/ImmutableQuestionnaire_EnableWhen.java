...
final class ImmutableQuestionnaire_EnableWhen implements Questionnaire_EnableWhen {
  ...
  /**
   * Computes a hash code from attributes: {@code answerInteger}, {@code question}, {@code answerTime}, {@code answerDecimal}, {@code answerQuantity}, {@code extension}, {@code answerDateTime}, {@code operator}, {@code answerReference}, {@code modifierExtension}, {@code id}, {@code answerCoding}, {@code answerDate}, {@code answerString}, {@code answerBoolean}.
   ...
   *    .answerQuantity(com.fhir.types.fhir.Quantity) // optional {@link Questionnaire_EnableWhen#answerQuantity() answerQuantity}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Questionnaire_EnableWhen#extension() extension}
   *    .answerDateTime(String) // optional {@link Questionnaire_EnableWhen#answerDateTime() answerDateTime}
   *    .operator(Questionnaire_EnablewhenOperator) // optional {@link Questionnaire_EnableWhen#operator() operator}
   *    .answerReference(com.fhir.types.fhir.Reference) // optional {@link Questionnaire_EnableWhen#answerReference() answerReference}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Questionnaire_EnableWhen#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link Questionnaire_EnableWhen#id() id}
   *    .answerCoding(com.fhir.types.fhir.Coding) // optional {@link Questionnaire_EnableWhen#answerCoding() answerCoding}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_QUESTION = 0x2L;
    private static final long OPT_BIT_ANSWER_TIME = 0x4L;
    private static final long OPT_BIT_ANSWER_DECIMAL = 0x8L;
    private static final long OPT_BIT_ANSWER_QUANTITY = 0x10L;
    private static final long OPT_BIT_EXTENSION = 0x20L;
    private static final long OPT_BIT_ANSWER_DATE_TIME = 0x40L;
    private static final long OPT_BIT_OPERATOR = 0x80L;
    private static final long OPT_BIT_ANSWER_REFERENCE = 0x100L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x200L;
    private static final long OPT_BIT_ID = 0x400L;
    private static final long OPT_BIT_ANSWER_CODING = 0x800L;
    private static final long OPT_BIT_ANSWER_DATE = 0x1000L;
    private static final long OPT_BIT_ANSWER_STRING = 0x2000L;
    private static final long OPT_BIT_ANSWER_BOOLEAN = 0x4000L;
