...
final class ImmutableObservationDefinition_QuantitativeDetails
  ...
  private boolean equalTo(ImmutableObservationDefinition_QuantitativeDetails another) {
    return Objects.equals(customaryUnit, another.customaryUnit)
  ...
  /**
   * Computes a hash code from attributes: {@code customaryUnit}, {@code id}, {@code conversionFactor}, {@code modifierExtension}, {@code unit}, {@code extension}, {@code decimalPrecision}.
   ...
   *    .customaryUnit(com.fhir.types.fhir.CodeableConcept) // optional {@link ObservationDefinition_QuantitativeDetails#customaryUnit() customaryUnit}
   *    .id(String) // optional {@link ObservationDefinition_QuantitativeDetails#id() id}
   *    .conversionFactor(com.fhir.types.fhir.Decimal) // optional {@link ObservationDefinition_QuantitativeDetails#conversionFactor() conversionFactor}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ObservationDefinition_QuantitativeDetails#modifierExtension() modifierExtension}
   *    .unit(com.fhir.types.fhir.CodeableConcept) // optional {@link ObservationDefinition_QuantitativeDetails#unit() unit}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ObservationDefinition_QuantitativeDetails#extension() extension}
  ...
  public static final class Builder {
    private static final long OPT_BIT_CUSTOMARY_UNIT = 0x1L;
    private static final long OPT_BIT_ID = 0x2L;
    private static final long OPT_BIT_CONVERSION_FACTOR = 0x4L;
    ...
    public ObservationDefinition_QuantitativeDetails build() {
      return new ImmutableObservationDefinition_QuantitativeDetails(customaryUnit, id, conversionFactor, modifierExtension, unit, extension, decimalPrecision);
    }
