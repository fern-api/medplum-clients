...
final class ImmutableClinicalImpression_Finding
  ...
  public final ImmutableClinicalImpression_Finding withItemCodeableConcept(CodeableConcept value) {
    ...
    return new ImmutableClinicalImpression_Finding(newValue, this.basis, this.modifierExtension, this.itemReference, this.id, this.extension);
  }
  ...
  public final ImmutableClinicalImpression_Finding withItemCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableClinicalImpression_Finding(value, this.basis, this.modifierExtension, this.itemReference, this.id, this.extension);
  }
  ...
  public final ImmutableClinicalImpression_Finding withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableClinicalImpression_Finding(this.itemCodeableConcept, this.basis, newValue, this.itemReference, this.id, this.extension);
  }
  ...
  public final ImmutableClinicalImpression_Finding withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableClinicalImpression_Finding(this.itemCodeableConcept, this.basis, value, this.itemReference, this.id, this.extension);
  }
  ...
  public final ImmutableClinicalImpression_Finding withItemReference(Reference value) {
    ...
    return new ImmutableClinicalImpression_Finding(this.itemCodeableConcept, this.basis, this.modifierExtension, newValue, this.id, this.extension);
  }
  ...
  public final ImmutableClinicalImpression_Finding withItemReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableClinicalImpression_Finding(this.itemCodeableConcept, this.basis, this.modifierExtension, value, this.id, this.extension);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code itemCodeableConcept}, {@code basis}, {@code modifierExtension}, {@code itemReference}, {@code id}, {@code extension}.
   ...
   *    .itemCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link ClinicalImpression_Finding#itemCodeableConcept() itemCodeableConcept}
   *    .basis(String) // optional {@link ClinicalImpression_Finding#basis() basis}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ClinicalImpression_Finding#modifierExtension() modifierExtension}
   *    .itemReference(com.fhir.types.fhir.Reference) // optional {@link ClinicalImpression_Finding#itemReference() itemReference}
   *    .id(String) // optional {@link ClinicalImpression_Finding#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ClinicalImpression_Finding#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_BASIS = 0x2L;
    ...
    public ClinicalImpression_Finding build() {
      return new ImmutableClinicalImpression_Finding(itemCodeableConcept, basis, modifierExtension, itemReference, id, extension);
    }
