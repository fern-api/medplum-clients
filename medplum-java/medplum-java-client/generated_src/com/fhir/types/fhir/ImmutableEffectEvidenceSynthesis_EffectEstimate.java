...
final class ImmutableEffectEvidenceSynthesis_EffectEstimate
  ...
  /**
   * Computes a hash code from attributes: {@code type}, {@code extension}, {@code unitOfMeasure}, {@code value}, {@code modifierExtension}, {@code precisionEstimate}, {@code id}, {@code description}, {@code variantState}.
   ...
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link EffectEvidenceSynthesis_EffectEstimate#type() type}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EffectEvidenceSynthesis_EffectEstimate#extension() extension}
   *    .unitOfMeasure(com.fhir.types.fhir.CodeableConcept) // optional {@link EffectEvidenceSynthesis_EffectEstimate#unitOfMeasure() unitOfMeasure}
   *    .value(com.fhir.types.fhir.Decimal) // optional {@link EffectEvidenceSynthesis_EffectEstimate#value() value}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EffectEvidenceSynthesis_EffectEstimate#modifierExtension() modifierExtension}
   *    .precisionEstimate(List&amp;lt;com.fhir.types.fhir.EffectEvidenceSynthesis_PrecisionEstimate&amp;gt;) // optional {@link EffectEvidenceSynthesis_EffectEstimate#precisionEstimate() precisionEstimate}
   ...
   *    .variantState(com.fhir.types.fhir.CodeableConcept) // optional {@link EffectEvidenceSynthesis_EffectEstimate#variantState() variantState}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_PRECISION_ESTIMATE = 0x20L;
