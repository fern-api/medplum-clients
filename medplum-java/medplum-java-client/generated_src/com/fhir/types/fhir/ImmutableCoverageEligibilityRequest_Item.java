...
final class ImmutableCoverageEligibilityRequest_Item
  ...
  private boolean equalTo(ImmutableCoverageEligibilityRequest_Item another) {
    return Objects.equals(diagnosis, another.diagnosis)
  ...
  /**
   * Computes a hash code from attributes: {@code diagnosis}, {@code category}, {@code provider}, {@code facility}, {@code productOrService}, {@code quantity}, {@code modifierExtension}, {@code detail}, {@code unitPrice}, {@code modifier}, {@code id}, {@code supportingInfoSequence}, {@code extension}.
   ...
   *    .diagnosis(List&amp;lt;com.fhir.types.fhir.CoverageEligibilityRequest_Diagnosis&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#diagnosis() diagnosis}
   *    .category(com.fhir.types.fhir.CodeableConcept) // optional {@link CoverageEligibilityRequest_Item#category() category}
   *    .provider(com.fhir.types.fhir.Reference) // optional {@link CoverageEligibilityRequest_Item#provider() provider}
   *    .facility(com.fhir.types.fhir.Reference) // optional {@link CoverageEligibilityRequest_Item#facility() facility}
   *    .productOrService(com.fhir.types.fhir.CodeableConcept) // optional {@link CoverageEligibilityRequest_Item#productOrService() productOrService}
   *    .quantity(com.fhir.types.fhir.Quantity) // optional {@link CoverageEligibilityRequest_Item#quantity() quantity}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#modifierExtension() modifierExtension}
   *    .detail(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#detail() detail}
   *    .unitPrice(com.fhir.types.fhir.Money) // optional {@link CoverageEligibilityRequest_Item#unitPrice() unitPrice}
   *    .modifier(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#modifier() modifier}
   *    .id(String) // optional {@link CoverageEligibilityRequest_Item#id() id}
   *    .supportingInfoSequence(List&amp;lt;com.fhir.types.fhir.PositiveInt&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#supportingInfoSequence() supportingInfoSequence}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_DIAGNOSIS = 0x1L;
    private static final long OPT_BIT_CATEGORY = 0x2L;
    private static final long OPT_BIT_PROVIDER = 0x4L;
    private static final long OPT_BIT_FACILITY = 0x8L;
    private static final long OPT_BIT_PRODUCT_OR_SERVICE = 0x10L;
    ...
    private static final long OPT_BIT_SUPPORTING_INFO_SEQUENCE = 0x800L;
