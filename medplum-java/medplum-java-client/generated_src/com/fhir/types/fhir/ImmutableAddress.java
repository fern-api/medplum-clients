...
final class ImmutableAddress implements Address {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code use}, {@code city}, {@code postalCode}, {@code country}, {@code type}, {@code id}, {@code period}, {@code text}, {@code district}, {@code line}, {@code state}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Address#extension() extension}
   *    .use(com.fhir.types.fhir.AddressUse) // optional {@link Address#use() use}
   ...
   *    .type(com.fhir.types.fhir.AddressType) // optional {@link Address#type() type}
   *    .id(String) // optional {@link Address#id() id}
   *    .period(com.fhir.types.fhir.Period) // optional {@link Address#period() period}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_CITY = 0x4L;
    private static final long OPT_BIT_POSTAL_CODE = 0x8L;
    ...
    private static final long OPT_BIT_LINE = 0x400L;
    private static final long OPT_BIT_STATE = 0x800L;
    ...
    public Address build() {
      return new ImmutableAddress(extension, use, city, postalCode, country, type, id, period, text, district, line, state);
    }
