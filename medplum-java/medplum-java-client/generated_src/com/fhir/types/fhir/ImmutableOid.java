 ...
 */
@Generated(from = "Oid", generator = "Immutables")
@SuppressWarnings({"all"})
@SuppressFBWarnings
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@Immutable
final class ImmutableOid implements Oid {
  private final String value;

  private ImmutableOid(String value) {
    this.value = value;
  }
   ...
   */
  public final ImmutableOid withValue(String value) {
  ...
  static ImmutableOid fromJson(String jsonValue) {
  ...
  public static final class Builder implements ValueBuildStage, BuildFinal {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new IllegalStateException("Builder of Oid is strict, attribute is already set: ".concat(name));
    }
