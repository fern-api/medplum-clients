...
final class ImmutableTestScript_Action implements TestScript_Action {
  ...
  public final ImmutableTestScript_Action withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Action(newValue, this.operation, this._assert, this.modifierExtension, this.id);
  }
  ...
  public final ImmutableTestScript_Action withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Action(value, this.operation, this._assert, this.modifierExtension, this.id);
  }
  ...
  public final ImmutableTestScript_Action withOperation(TestScript_Operation value) {
    ...
    return new ImmutableTestScript_Action(this.extension, newValue, this._assert, this.modifierExtension, this.id);
  }
  ...
  public final ImmutableTestScript_Action withOperation(Optional<? extends TestScript_Operation> optional) {
    ...
    return new ImmutableTestScript_Action(this.extension, value, this._assert, this.modifierExtension, this.id);
  }
  ...
  public final ImmutableTestScript_Action with_assert(TestScript_Assert value) {
    ...
    return new ImmutableTestScript_Action(this.extension, this.operation, newValue, this.modifierExtension, this.id);
  }
  ...
  public final ImmutableTestScript_Action with_assert(Optional<? extends TestScript_Assert> optional) {
    ...
    return new ImmutableTestScript_Action(this.extension, this.operation, value, this.modifierExtension, this.id);
  }
  ...
  public final ImmutableTestScript_Action withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Action(this.extension, this.operation, this._assert, newValue, this.id);
  }
  ...
  public final ImmutableTestScript_Action withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Action(this.extension, this.operation, this._assert, value, this.id);
  }
  ...
  public final ImmutableTestScript_Action withId(String value) {
    ...
    return new ImmutableTestScript_Action(this.extension, this.operation, this._assert, this.modifierExtension, newValue);
  }
  ...
  public final ImmutableTestScript_Action withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Action(this.extension, this.operation, this._assert, this.modifierExtension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code operation}, {@code _assert}, {@code modifierExtension}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Action#extension() extension}
   *    .operation(com.fhir.types.fhir.TestScript_Operation) // optional {@link TestScript_Action#operation() operation}
   *    ._assert(com.fhir.types.fhir.TestScript_Assert) // optional {@link TestScript_Action#_assert() _assert}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Action#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    public TestScript_Action build() {
      return new ImmutableTestScript_Action(extension, operation, _assert, modifierExtension, id);
    }
