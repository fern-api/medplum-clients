 ...
 */
@Generated(from = "Url", generator = "Immutables")
@SuppressWarnings({"all"})
@SuppressFBWarnings
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@Immutable
final class ImmutableUrl implements Url {
  private final String value;

  private ImmutableUrl(String value) {
    this.value = value;
  }
   ...
   */
  public final ImmutableUrl withValue(String value) {
  ...
  static ImmutableUrl fromJson(String jsonValue) {
  ...
  public static final class Builder implements ValueBuildStage, BuildFinal {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new IllegalStateException("Builder of Url is strict, attribute is already set: ".concat(name));
    }
