...
final class ImmutableRatio implements Ratio {
  ...
  public final ImmutableRatio withNumerator(Quantity value) {
    ...
    return new ImmutableRatio(newValue, this.denominator, this.extension, this.id);
  }
  ...
  public final ImmutableRatio withNumerator(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableRatio(value, this.denominator, this.extension, this.id);
  }
  ...
  public final ImmutableRatio withDenominator(Quantity value) {
    ...
    return new ImmutableRatio(this.numerator, newValue, this.extension, this.id);
  }
  ...
  public final ImmutableRatio withDenominator(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableRatio(this.numerator, value, this.extension, this.id);
  }
  ...
  public final ImmutableRatio withExtension(List<Extension> value) {
    ...
    return new ImmutableRatio(this.numerator, this.denominator, newValue, this.id);
  }
  ...
  public final ImmutableRatio withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableRatio(this.numerator, this.denominator, value, this.id);
  }
  ...
  public final ImmutableRatio withId(String value) {
    ...
    return new ImmutableRatio(this.numerator, this.denominator, this.extension, newValue);
  }
  ...
  public final ImmutableRatio withId(Optional<String> optional) {
    ...
    return new ImmutableRatio(this.numerator, this.denominator, this.extension, value);
  }
  ...
  private boolean equalTo(ImmutableRatio another) {
    return Objects.equals(numerator, another.numerator)
        && Objects.equals(denominator, another.denominator)
        && Objects.equals(extension, another.extension)
        && Objects.equals(id, another.id);
  }

  /**
   * Computes a hash code from attributes: {@code numerator}, {@code denominator}, {@code extension}, {@code id}.
   ...
   *    .numerator(com.fhir.types.fhir.Quantity) // optional {@link Ratio#numerator() numerator}
   *    .denominator(com.fhir.types.fhir.Quantity) // optional {@link Ratio#denominator() denominator}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Ratio#extension() extension}
  ...
  public static final class Builder {
    private static final long OPT_BIT_NUMERATOR = 0x1L;
    private static final long OPT_BIT_DENOMINATOR = 0x2L;
     ...
     */
    public Ratio build() {
      return new ImmutableRatio(numerator, denominator, extension, id);
    }
