...
final class ImmutableCarePlan_Activity implements CarePlan_Activity {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code id}, {@code modifierExtension}, {@code progress}, {@code outcomeCodeableConcept}, {@code outcomeReference}, {@code reference}, {@code detail}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CarePlan_Activity#extension() extension}
   *    .id(String) // optional {@link CarePlan_Activity#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CarePlan_Activity#modifierExtension() modifierExtension}
   *    .progress(List&amp;lt;com.fhir.types.fhir.Annotation&amp;gt;) // optional {@link CarePlan_Activity#progress() progress}
   *    .outcomeCodeableConcept(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link CarePlan_Activity#outcomeCodeableConcept() outcomeCodeableConcept}
   *    .outcomeReference(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link CarePlan_Activity#outcomeReference() outcomeReference}
   *    .reference(com.fhir.types.fhir.Reference) // optional {@link CarePlan_Activity#reference() reference}
   *    .detail(com.fhir.types.fhir.CarePlan_Detail) // optional {@link CarePlan_Activity#detail() detail}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_PROGRESS = 0x8L;
    private static final long OPT_BIT_OUTCOME_CODEABLE_CONCEPT = 0x10L;
