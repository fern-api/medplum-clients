...
final class ImmutableEvidenceVariable_Characteristic
  ...
  /**
   * Computes a hash code from attributes: {@code exclude}, {@code modifierExtension}, {@code timeFromStart}, {@code participantEffectivePeriod}, {@code id}, {@code participantEffectiveTiming}, {@code definitionReference}, {@code usageContext}, {@code groupMeasure}, {@code extension}, {@code participantEffectiveDuration}, {@code definitionExpression}, {@code participantEffectiveDateTime}, {@code description}, {@code definitionDataRequirement}, {@code definitionCodeableConcept}, {@code definitionCanonical}, {@code definitionTriggerDefinition}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EvidenceVariable_Characteristic#modifierExtension() modifierExtension}
   *    .timeFromStart(com.fhir.types.fhir.Duration) // optional {@link EvidenceVariable_Characteristic#timeFromStart() timeFromStart}
   *    .participantEffectivePeriod(com.fhir.types.fhir.Period) // optional {@link EvidenceVariable_Characteristic#participantEffectivePeriod() participantEffectivePeriod}
   *    .id(String) // optional {@link EvidenceVariable_Characteristic#id() id}
   *    .participantEffectiveTiming(com.fhir.types.fhir.Timing) // optional {@link EvidenceVariable_Characteristic#participantEffectiveTiming() participantEffectiveTiming}
   *    .definitionReference(com.fhir.types.fhir.Reference) // optional {@link EvidenceVariable_Characteristic#definitionReference() definitionReference}
   *    .usageContext(List&amp;lt;com.fhir.types.fhir.UsageContext&amp;gt;) // optional {@link EvidenceVariable_Characteristic#usageContext() usageContext}
   *    .groupMeasure(Evidencevariable_CharacteristicGroupmeasure) // optional {@link EvidenceVariable_Characteristic#groupMeasure() groupMeasure}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EvidenceVariable_Characteristic#extension() extension}
   *    .participantEffectiveDuration(com.fhir.types.fhir.Duration) // optional {@link EvidenceVariable_Characteristic#participantEffectiveDuration() participantEffectiveDuration}
   *    .definitionExpression(com.fhir.types.fhir.Expression) // optional {@link EvidenceVariable_Characteristic#definitionExpression() definitionExpression}
   ...
   *    .definitionDataRequirement(com.fhir.types.fhir.DataRequirement) // optional {@link EvidenceVariable_Characteristic#definitionDataRequirement() definitionDataRequirement}
   *    .definitionCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link EvidenceVariable_Characteristic#definitionCodeableConcept() definitionCodeableConcept}
   *    .definitionCanonical(String) // optional {@link EvidenceVariable_Characteristic#definitionCanonical() definitionCanonical}
   *    .definitionTriggerDefinition(com.fhir.types.fhir.TriggerDefinition) // optional {@link EvidenceVariable_Characteristic#definitionTriggerDefinition() definitionTriggerDefinition}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_TIME_FROM_START = 0x4L;
    private static final long OPT_BIT_PARTICIPANT_EFFECTIVE_PERIOD = 0x8L;
    private static final long OPT_BIT_ID = 0x10L;
    private static final long OPT_BIT_PARTICIPANT_EFFECTIVE_TIMING = 0x20L;
    private static final long OPT_BIT_DEFINITION_REFERENCE = 0x40L;
    private static final long OPT_BIT_USAGE_CONTEXT = 0x80L;
    private static final long OPT_BIT_GROUP_MEASURE = 0x100L;
    private static final long OPT_BIT_EXTENSION = 0x200L;
    private static final long OPT_BIT_PARTICIPANT_EFFECTIVE_DURATION = 0x400L;
    ...
    private static final long OPT_BIT_DEFINITION_DATA_REQUIREMENT = 0x4000L;
    private static final long OPT_BIT_DEFINITION_CODEABLE_CONCEPT = 0x8000L;
    private static final long OPT_BIT_DEFINITION_CANONICAL = 0x10000L;
