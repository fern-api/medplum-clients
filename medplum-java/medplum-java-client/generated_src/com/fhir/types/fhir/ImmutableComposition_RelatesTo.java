...
final class ImmutableComposition_RelatesTo implements Composition_RelatesTo {
  ...
  public final ImmutableComposition_RelatesTo withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableComposition_RelatesTo(value, this.code, this.targetReference, this.id, this.modifierExtension, this.targetIdentifier);
  }
  ...
  public final ImmutableComposition_RelatesTo withTargetReference(Reference value) {
    ...
    return new ImmutableComposition_RelatesTo(this.extension, this.code, newValue, this.id, this.modifierExtension, this.targetIdentifier);
  }
  ...
  public final ImmutableComposition_RelatesTo withTargetReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableComposition_RelatesTo(this.extension, this.code, value, this.id, this.modifierExtension, this.targetIdentifier);
  }
  ...
  public final ImmutableComposition_RelatesTo withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableComposition_RelatesTo(this.extension, this.code, this.targetReference, this.id, newValue, this.targetIdentifier);
  }
  ...
  public final ImmutableComposition_RelatesTo withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableComposition_RelatesTo(this.extension, this.code, this.targetReference, this.id, value, this.targetIdentifier);
  }
  ...
  public final ImmutableComposition_RelatesTo withTargetIdentifier(Identifier value) {
    ...
    return new ImmutableComposition_RelatesTo(this.extension, this.code, this.targetReference, this.id, this.modifierExtension, newValue);
  }
  ...
  public final ImmutableComposition_RelatesTo withTargetIdentifier(Optional<? extends Identifier> optional) {
    ...
    return new ImmutableComposition_RelatesTo(this.extension, this.code, this.targetReference, this.id, this.modifierExtension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code code}, {@code targetReference}, {@code id}, {@code modifierExtension}, {@code targetIdentifier}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Composition_RelatesTo#extension() extension}
   *    .code(com.fhir.types.fhir.Code) // optional {@link Composition_RelatesTo#code() code}
   *    .targetReference(com.fhir.types.fhir.Reference) // optional {@link Composition_RelatesTo#targetReference() targetReference}
   *    .id(String) // optional {@link Composition_RelatesTo#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Composition_RelatesTo#modifierExtension() modifierExtension}
   *    .targetIdentifier(com.fhir.types.fhir.Identifier) // optional {@link Composition_RelatesTo#targetIdentifier() targetIdentifier}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_TARGET_REFERENCE = 0x4L;
    ...
    public Composition_RelatesTo build() {
      return new ImmutableComposition_RelatesTo(extension, code, targetReference, id, modifierExtension, targetIdentifier);
    }
