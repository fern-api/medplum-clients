...
final class ImmutableMeasureReport_Population1 implements MeasureReport_Population1 {
  ...
  public final ImmutableMeasureReport_Population1 withCode(CodeableConcept value) {
    ...
    return new ImmutableMeasureReport_Population1(newValue, this.id, this.count, this.subjectResults, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withCode(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableMeasureReport_Population1(value, this.id, this.count, this.subjectResults, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withId(String value) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, newValue, this.count, this.subjectResults, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withId(Optional<String> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, value, this.count, this.subjectResults, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withCount(int value) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, this.id, newValue, this.subjectResults, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withCount(Optional<Integer> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, this.id, value, this.subjectResults, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withSubjectResults(Reference value) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, this.id, this.count, newValue, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withSubjectResults(Optional<? extends Reference> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, this.id, this.count, value, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, this.id, this.count, this.subjectResults, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, this.id, this.count, this.subjectResults, value, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population1 withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, this.id, this.count, this.subjectResults, this.extension, newValue);
  }
  ...
  public final ImmutableMeasureReport_Population1 withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.code, this.id, this.count, this.subjectResults, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code code}, {@code id}, {@code count}, {@code subjectResults}, {@code extension}, {@code modifierExtension}.
   ...
   *    .code(com.fhir.types.fhir.CodeableConcept) // optional {@link MeasureReport_Population1#code() code}
   *    .id(String) // optional {@link MeasureReport_Population1#id() id}
   *    .count(Integer) // optional {@link MeasureReport_Population1#count() count}
   *    .subjectResults(com.fhir.types.fhir.Reference) // optional {@link MeasureReport_Population1#subjectResults() subjectResults}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Population1#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Population1#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_COUNT = 0x4L;
    ...
    public MeasureReport_Population1 build() {
      return new ImmutableMeasureReport_Population1(code, id, count, subjectResults, extension, modifierExtension);
    }
