...
final class ImmutableClaim_Accident implements Claim_Accident {
  ...
  /**
   * Computes a hash code from attributes: {@code locationReference}, {@code extension}, {@code date}, {@code type}, {@code locationAddress}, {@code id}, {@code modifierExtension}.
   ...
   *    .locationReference(com.fhir.types.fhir.Reference) // optional {@link Claim_Accident#locationReference() locationReference}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Claim_Accident#extension() extension}
   *    .date(com.fhir.types.fhir.Date) // optional {@link Claim_Accident#date() date}
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link Claim_Accident#type() type}
   *    .locationAddress(com.fhir.types.fhir.Address) // optional {@link Claim_Accident#locationAddress() locationAddress}
   *    .id(String) // optional {@link Claim_Accident#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Claim_Accident#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Claim_Accident build() {
      return new ImmutableClaim_Accident(locationReference, extension, date, type, locationAddress, id, modifierExtension);
    }
