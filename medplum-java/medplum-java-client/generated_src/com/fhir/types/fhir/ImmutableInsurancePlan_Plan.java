...
final class ImmutableInsurancePlan_Plan implements InsurancePlan_Plan {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code type}, {@code id}, {@code modifierExtension}, {@code coverageArea}, {@code generalCost}, {@code network}, {@code identifier}, {@code specificCost}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link InsurancePlan_Plan#extension() extension}
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link InsurancePlan_Plan#type() type}
   *    .id(String) // optional {@link InsurancePlan_Plan#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link InsurancePlan_Plan#modifierExtension() modifierExtension}
   *    .coverageArea(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link InsurancePlan_Plan#coverageArea() coverageArea}
   *    .generalCost(List&amp;lt;com.fhir.types.fhir.InsurancePlan_GeneralCost&amp;gt;) // optional {@link InsurancePlan_Plan#generalCost() generalCost}
   *    .network(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link InsurancePlan_Plan#network() network}
   *    .identifier(List&amp;lt;com.fhir.types.fhir.Identifier&amp;gt;) // optional {@link InsurancePlan_Plan#identifier() identifier}
   *    .specificCost(List&amp;lt;com.fhir.types.fhir.InsurancePlan_SpecificCost&amp;gt;) // optional {@link InsurancePlan_Plan#specificCost() specificCost}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_GENERAL_COST = 0x20L;
    private static final long OPT_BIT_NETWORK = 0x40L;
    private static final long OPT_BIT_IDENTIFIER = 0x80L;
    private static final long OPT_BIT_SPECIFIC_COST = 0x100L;
