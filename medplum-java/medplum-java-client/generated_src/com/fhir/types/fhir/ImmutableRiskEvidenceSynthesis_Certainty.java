...
final class ImmutableRiskEvidenceSynthesis_Certainty
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withRating(Optional<? extends List<CodeableConcept>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(value, this.extension, this.note, this.id, this.modifierExtension, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withExtension(List<Extension> value) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.rating, newValue, this.note, this.id, this.modifierExtension, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.rating, value, this.note, this.id, this.modifierExtension, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withNote(Optional<? extends List<Annotation>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.rating, this.extension, value, this.id, this.modifierExtension, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.rating, this.extension, this.note, this.id, newValue, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.rating, this.extension, this.note, this.id, value, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withCertaintySubcomponent(List<RiskEvidenceSynthesis_CertaintySubcomponent> value) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.rating, this.extension, this.note, this.id, this.modifierExtension, newValue);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withCertaintySubcomponent(Optional<? extends List<RiskEvidenceSynthesis_CertaintySubcomponent>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.rating, this.extension, this.note, this.id, this.modifierExtension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code rating}, {@code extension}, {@code note}, {@code id}, {@code modifierExtension}, {@code certaintySubcomponent}.
   ...
   *    .rating(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#rating() rating}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#extension() extension}
   *    .note(List&amp;lt;com.fhir.types.fhir.Annotation&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#note() note}
   *    .id(String) // optional {@link RiskEvidenceSynthesis_Certainty#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#modifierExtension() modifierExtension}
   *    .certaintySubcomponent(List&amp;lt;com.fhir.types.fhir.RiskEvidenceSynthesis_CertaintySubcomponent&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#certaintySubcomponent() certaintySubcomponent}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_CERTAINTY_SUBCOMPONENT = 0x20L;
    ...
    public RiskEvidenceSynthesis_Certainty build() {
      return new ImmutableRiskEvidenceSynthesis_Certainty(rating, extension, note, id, modifierExtension, certaintySubcomponent);
    }
