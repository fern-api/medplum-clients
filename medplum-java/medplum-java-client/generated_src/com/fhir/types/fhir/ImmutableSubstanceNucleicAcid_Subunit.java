...
final class ImmutableSubstanceNucleicAcid_Subunit
  ...
  /**
   * Computes a hash code from attributes: {@code sequence}, {@code extension}, {@code modifierExtension}, {@code subunit}, {@code threePrime}, {@code sugar}, {@code linkage}, {@code id}, {@code length}, {@code sequenceAttachment}, {@code fivePrime}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceNucleicAcid_Subunit#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceNucleicAcid_Subunit#modifierExtension() modifierExtension}
   *    .subunit(Integer) // optional {@link SubstanceNucleicAcid_Subunit#subunit() subunit}
   *    .threePrime(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceNucleicAcid_Subunit#threePrime() threePrime}
   *    .sugar(List&amp;lt;com.fhir.types.fhir.SubstanceNucleicAcid_Sugar&amp;gt;) // optional {@link SubstanceNucleicAcid_Subunit#sugar() sugar}
   *    .linkage(List&amp;lt;com.fhir.types.fhir.SubstanceNucleicAcid_Linkage&amp;gt;) // optional {@link SubstanceNucleicAcid_Subunit#linkage() linkage}
   ...
   *    .sequenceAttachment(com.fhir.types.fhir.Attachment) // optional {@link SubstanceNucleicAcid_Subunit#sequenceAttachment() sequenceAttachment}
   *    .fivePrime(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceNucleicAcid_Subunit#fivePrime() fivePrime}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_THREE_PRIME = 0x10L;
    private static final long OPT_BIT_SUGAR = 0x20L;
    private static final long OPT_BIT_LINKAGE = 0x40L;
