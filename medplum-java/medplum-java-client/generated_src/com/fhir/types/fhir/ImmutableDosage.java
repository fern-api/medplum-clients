...
final class ImmutableDosage implements Dosage {
  ...
  private boolean equalTo(ImmutableDosage another) {
    return Objects.equals(maxDosePerPeriod, another.maxDosePerPeriod)
  ...
  /**
   * Computes a hash code from attributes: {@code maxDosePerPeriod}, {@code additionalInstruction}, {@code site}, {@code id}, {@code method}, {@code timing}, {@code maxDosePerLifetime}, {@code sequence}, {@code asNeededCodeableConcept}, {@code maxDosePerAdministration}, {@code patientInstruction}, {@code asNeededBoolean}, {@code modifierExtension}, {@code route}, {@code doseAndRate}, {@code extension}, {@code text}.
   ...
   *    .maxDosePerPeriod(com.fhir.types.fhir.Ratio) // optional {@link Dosage#maxDosePerPeriod() maxDosePerPeriod}
   *    .additionalInstruction(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link Dosage#additionalInstruction() additionalInstruction}
   *    .site(com.fhir.types.fhir.CodeableConcept) // optional {@link Dosage#site() site}
   *    .id(String) // optional {@link Dosage#id() id}
   *    .method(com.fhir.types.fhir.CodeableConcept) // optional {@link Dosage#method() method}
   *    .timing(com.fhir.types.fhir.Timing) // optional {@link Dosage#timing() timing}
   *    .maxDosePerLifetime(com.fhir.types.fhir.Quantity) // optional {@link Dosage#maxDosePerLifetime() maxDosePerLifetime}
   *    .sequence(Integer) // optional {@link Dosage#sequence() sequence}
   *    .asNeededCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link Dosage#asNeededCodeableConcept() asNeededCodeableConcept}
   *    .maxDosePerAdministration(com.fhir.types.fhir.Quantity) // optional {@link Dosage#maxDosePerAdministration() maxDosePerAdministration}
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Dosage#modifierExtension() modifierExtension}
   *    .route(com.fhir.types.fhir.CodeableConcept) // optional {@link Dosage#route() route}
   *    .doseAndRate(List&amp;lt;com.fhir.types.fhir.Dosage_DoseAndRate&amp;gt;) // optional {@link Dosage#doseAndRate() doseAndRate}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Dosage#extension() extension}
  ...
  public static final class Builder {
    private static final long OPT_BIT_MAX_DOSE_PER_PERIOD = 0x1L;
    private static final long OPT_BIT_ADDITIONAL_INSTRUCTION = 0x2L;
    private static final long OPT_BIT_SITE = 0x4L;
    private static final long OPT_BIT_ID = 0x8L;
    private static final long OPT_BIT_METHOD = 0x10L;
    private static final long OPT_BIT_TIMING = 0x20L;
    private static final long OPT_BIT_MAX_DOSE_PER_LIFETIME = 0x40L;
    private static final long OPT_BIT_SEQUENCE = 0x80L;
    private static final long OPT_BIT_AS_NEEDED_CODEABLE_CONCEPT = 0x100L;
    ...
    private static final long OPT_BIT_AS_NEEDED_BOOLEAN = 0x800L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x1000L;
    private static final long OPT_BIT_ROUTE = 0x2000L;
    private static final long OPT_BIT_DOSE_AND_RATE = 0x4000L;
