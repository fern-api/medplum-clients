...
final class ImmutableGraphDefinition_Compartment
  ...
  /**
   * Computes a hash code from attributes: {@code expression}, {@code use}, {@code code}, {@code id}, {@code extension}, {@code rule}, {@code description}, {@code modifierExtension}.
   ...
   *    .use(Graphdefinition_CompartmentUse) // optional {@link GraphDefinition_Compartment#use() use}
   *    .code(com.fhir.types.fhir.Code) // optional {@link GraphDefinition_Compartment#code() code}
   *    .id(String) // optional {@link GraphDefinition_Compartment#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link GraphDefinition_Compartment#extension() extension}
   *    .rule(Graphdefinition_CompartmentRule) // optional {@link GraphDefinition_Compartment#rule() rule}
   *    .description(String) // optional {@link GraphDefinition_Compartment#description() description}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link GraphDefinition_Compartment#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_RULE = 0x20L;
    ...
    public GraphDefinition_Compartment build() {
      return new ImmutableGraphDefinition_Compartment(expression, use, code, id, extension, rule, description, modifierExtension);
    }
