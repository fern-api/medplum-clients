...
final class ImmutableSubstanceSpecification_Structure
  ...
  /**
   * Computes a hash code from attributes: {@code source}, {@code extension}, {@code opticalActivity}, {@code isotope}, {@code stereochemistry}, {@code molecularWeight}, {@code modifierExtension}, {@code molecularFormulaByMoiety}, {@code representation}, {@code id}, {@code molecularFormula}.
   ...
   *    .source(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link SubstanceSpecification_Structure#source() source}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Structure#extension() extension}
   *    .opticalActivity(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Structure#opticalActivity() opticalActivity}
   *    .isotope(List&amp;lt;com.fhir.types.fhir.SubstanceSpecification_Isotope&amp;gt;) // optional {@link SubstanceSpecification_Structure#isotope() isotope}
   *    .stereochemistry(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Structure#stereochemistry() stereochemistry}
   *    .molecularWeight(com.fhir.types.fhir.SubstanceSpecification_MolecularWeight) // optional {@link SubstanceSpecification_Structure#molecularWeight() molecularWeight}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Structure#modifierExtension() modifierExtension}
   ...
   *    .representation(List&amp;lt;com.fhir.types.fhir.SubstanceSpecification_Representation&amp;gt;) // optional {@link SubstanceSpecification_Structure#representation() representation}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_OPTICAL_ACTIVITY = 0x4L;
    private static final long OPT_BIT_ISOTOPE = 0x8L;
    ...
    private static final long OPT_BIT_MOLECULAR_FORMULA_BY_MOIETY = 0x80L;
    private static final long OPT_BIT_REPRESENTATION = 0x100L;
    private static final long OPT_BIT_ID = 0x200L;
    private static final long OPT_BIT_MOLECULAR_FORMULA = 0x400L;
