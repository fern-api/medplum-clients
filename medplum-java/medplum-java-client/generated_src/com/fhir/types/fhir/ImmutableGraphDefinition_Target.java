...
final class ImmutableGraphDefinition_Target implements GraphDefinition_Target {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code compartment}, {@code type}, {@code extension}, {@code profile}, {@code link}, {@code modifierExtension}, {@code params}.
   ...
   *    .compartment(List&amp;lt;com.fhir.types.fhir.GraphDefinition_Compartment&amp;gt;) // optional {@link GraphDefinition_Target#compartment() compartment}
   *    .type(com.fhir.types.fhir.Code) // optional {@link GraphDefinition_Target#type() type}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link GraphDefinition_Target#extension() extension}
   *    .profile(com.fhir.types.fhir.Canonical) // optional {@link GraphDefinition_Target#profile() profile}
   *    .link(List&amp;lt;com.fhir.types.fhir.GraphDefinition_Link&amp;gt;) // optional {@link GraphDefinition_Target#link() link}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link GraphDefinition_Target#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    public GraphDefinition_Target build() {
      return new ImmutableGraphDefinition_Target(id, compartment, type, extension, profile, link, modifierExtension, params);
    }
