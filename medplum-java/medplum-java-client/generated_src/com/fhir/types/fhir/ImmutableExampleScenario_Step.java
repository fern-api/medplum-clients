...
final class ImmutableExampleScenario_Step implements ExampleScenario_Step {
  ...
  public final ImmutableExampleScenario_Step withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableExampleScenario_Step(this.id, this.extension, this.process, newValue, this.alternative, this.operation, this.pause);
  }
  ...
  public final ImmutableExampleScenario_Step withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableExampleScenario_Step(this.id, this.extension, this.process, value, this.alternative, this.operation, this.pause);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code process}, {@code modifierExtension}, {@code alternative}, {@code operation}, {@code pause}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Step#extension() extension}
   *    .process(List&amp;lt;com.fhir.types.fhir.ExampleScenario_Process&amp;gt;) // optional {@link ExampleScenario_Step#process() process}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Step#modifierExtension() modifierExtension}
   *    .alternative(List&amp;lt;com.fhir.types.fhir.ExampleScenario_Alternative&amp;gt;) // optional {@link ExampleScenario_Step#alternative() alternative}
   *    .operation(com.fhir.types.fhir.ExampleScenario_Operation) // optional {@link ExampleScenario_Step#operation() operation}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_PROCESS = 0x4L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x8L;
    private static final long OPT_BIT_ALTERNATIVE = 0x10L;
    private static final long OPT_BIT_OPERATION = 0x20L;
    private static final long OPT_BIT_PAUSE = 0x40L;
    ...
    public ExampleScenario_Step build() {
      return new ImmutableExampleScenario_Step(id, extension, process, modifierExtension, alternative, operation, pause);
    }
