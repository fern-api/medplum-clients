...
final class ImmutableInsurancePlan_Coverage implements InsurancePlan_Coverage {
  ...
  public final ImmutableInsurancePlan_Coverage withType(CodeableConcept value) {
    ...
    return new ImmutableInsurancePlan_Coverage(newValue, this.benefit, this.network, this.id, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableInsurancePlan_Coverage withBenefit(InsurancePlan_Benefit... elements) {
    ...
    return new ImmutableInsurancePlan_Coverage(this.type, newValue, this.network, this.id, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableInsurancePlan_Coverage withNetwork(List<Reference> value) {
    ...
    return new ImmutableInsurancePlan_Coverage(this.type, this.benefit, newValue, this.id, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableInsurancePlan_Coverage withNetwork(Optional<? extends List<Reference>> optional) {
    ...
    return new ImmutableInsurancePlan_Coverage(this.type, this.benefit, value, this.id, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableInsurancePlan_Coverage withId(String value) {
    ...
    return new ImmutableInsurancePlan_Coverage(this.type, this.benefit, this.network, newValue, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableInsurancePlan_Coverage withId(Optional<String> optional) {
    ...
    return new ImmutableInsurancePlan_Coverage(this.type, this.benefit, this.network, value, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableInsurancePlan_Coverage withExtension(List<Extension> value) {
    ...
    return new ImmutableInsurancePlan_Coverage(this.type, this.benefit, this.network, this.id, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableInsurancePlan_Coverage withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableInsurancePlan_Coverage(this.type, this.benefit, this.network, this.id, value, this.modifierExtension);
  }
  ...
  public final ImmutableInsurancePlan_Coverage withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableInsurancePlan_Coverage(this.type, this.benefit, this.network, this.id, this.extension, newValue);
  }
  ...
  public final ImmutableInsurancePlan_Coverage withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableInsurancePlan_Coverage(this.type, this.benefit, this.network, this.id, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code type}, {@code benefit}, {@code network}, {@code id}, {@code extension}, {@code modifierExtension}.
   ...
   *    .type(com.fhir.types.fhir.CodeableConcept) // required {@link InsurancePlan_Coverage#type() type}
   *    .addBenefit|addAllBenefit(com.fhir.types.fhir.InsurancePlan_Benefit) // {@link InsurancePlan_Coverage#benefit() benefit} elements
   *    .network(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link InsurancePlan_Coverage#network() network}
   *    .id(String) // optional {@link InsurancePlan_Coverage#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link InsurancePlan_Coverage#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link InsurancePlan_Coverage#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements TypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_NETWORK = 0x1L;
    ...
    public InsurancePlan_Coverage build() {
      ...
      return new ImmutableInsurancePlan_Coverage(type, createUnmodifiableList(true, benefit), network, id, extension, modifierExtension);
    }
