...
final class ImmutableCoding implements Coding {
  ...
  public final ImmutableCoding withExtension(List<Extension> value) {
    ...
    return new ImmutableCoding(newValue, this.system, this.code, this.userSelected, this.display, this.version, this.id);
  }
  ...
  public final ImmutableCoding withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCoding(value, this.system, this.code, this.userSelected, this.display, this.version, this.id);
  }
  ...
  public final ImmutableCoding withSystem(Uri value) {
    ...
    return new ImmutableCoding(this.extension, newValue, this.code, this.userSelected, this.display, this.version, this.id);
  }
  ...
  public final ImmutableCoding withSystem(Optional<? extends Uri> optional) {
    ...
    return new ImmutableCoding(this.extension, value, this.code, this.userSelected, this.display, this.version, this.id);
  }
  ...
  public final ImmutableCoding withCode(Code value) {
    ...
    return new ImmutableCoding(this.extension, this.system, newValue, this.userSelected, this.display, this.version, this.id);
  }
  ...
  public final ImmutableCoding withCode(Optional<? extends Code> optional) {
    ...
    return new ImmutableCoding(this.extension, this.system, value, this.userSelected, this.display, this.version, this.id);
  }
  ...
  public final ImmutableCoding withUserSelected(boolean value) {
    ...
    return new ImmutableCoding(this.extension, this.system, this.code, newValue, this.display, this.version, this.id);
  }
  ...
  public final ImmutableCoding withUserSelected(Optional<Boolean> optional) {
    ...
    return new ImmutableCoding(this.extension, this.system, this.code, value, this.display, this.version, this.id);
  }
  ...
  public final ImmutableCoding withDisplay(String value) {
    ...
    return new ImmutableCoding(this.extension, this.system, this.code, this.userSelected, newValue, this.version, this.id);
  }
  ...
  public final ImmutableCoding withDisplay(Optional<String> optional) {
    ...
    return new ImmutableCoding(this.extension, this.system, this.code, this.userSelected, value, this.version, this.id);
  }
  ...
  public final ImmutableCoding withVersion(String value) {
    ...
    return new ImmutableCoding(this.extension, this.system, this.code, this.userSelected, this.display, newValue, this.id);
  }
  ...
  public final ImmutableCoding withVersion(Optional<String> optional) {
    ...
    return new ImmutableCoding(this.extension, this.system, this.code, this.userSelected, this.display, value, this.id);
  }
  ...
  public final ImmutableCoding withId(String value) {
    ...
    return new ImmutableCoding(this.extension, this.system, this.code, this.userSelected, this.display, this.version, newValue);
  }
  ...
  public final ImmutableCoding withId(Optional<String> optional) {
    ...
    return new ImmutableCoding(this.extension, this.system, this.code, this.userSelected, this.display, this.version, value);
  }
  ...
  private boolean equalTo(ImmutableCoding another) {
    return Objects.equals(extension, another.extension)
        ...
        && Objects.equals(userSelected, another.userSelected)
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code system}, {@code code}, {@code userSelected}, {@code display}, {@code version}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Coding#extension() extension}
   *    .system(com.fhir.types.fhir.Uri) // optional {@link Coding#system() system}
   *    .code(com.fhir.types.fhir.Code) // optional {@link Coding#code() code}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_USER_SELECTED = 0x8L;
     ...
     */
    public Coding build() {
      return new ImmutableCoding(extension, system, code, userSelected, display, version, id);
    }
