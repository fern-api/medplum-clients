...
final class ImmutablePeriod implements Period {
  ...
  public final ImmutablePeriod withExtension(List<Extension> value) {
    ...
    return new ImmutablePeriod(newValue, this.id, this.end, this.start);
  }
  ...
  public final ImmutablePeriod withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutablePeriod(value, this.id, this.end, this.start);
  }
  ...
  public final ImmutablePeriod withId(String value) {
    ...
    return new ImmutablePeriod(this.extension, newValue, this.end, this.start);
  }
  ...
  public final ImmutablePeriod withId(Optional<String> optional) {
    ...
    return new ImmutablePeriod(this.extension, value, this.end, this.start);
  }
  ...
  public final ImmutablePeriod withEnd(DateTime value) {
    ...
    return new ImmutablePeriod(this.extension, this.id, newValue, this.start);
  }
  ...
  public final ImmutablePeriod withEnd(Optional<? extends DateTime> optional) {
    ...
    return new ImmutablePeriod(this.extension, this.id, value, this.start);
  }
  ...
  public final ImmutablePeriod withStart(DateTime value) {
    ...
    return new ImmutablePeriod(this.extension, this.id, this.end, newValue);
  }
  ...
  public final ImmutablePeriod withStart(Optional<? extends DateTime> optional) {
    ...
    return new ImmutablePeriod(this.extension, this.id, this.end, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code id}, {@code end}, {@code start}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Period#extension() extension}
   *    .id(String) // optional {@link Period#id() id}
   *    .end(com.fhir.types.fhir.DateTime) // optional {@link Period#end() end}
   *    .start(com.fhir.types.fhir.DateTime) // optional {@link Period#start() start}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
     ...
     */
    public Period build() {
      return new ImmutablePeriod(extension, id, end, start);
    }
