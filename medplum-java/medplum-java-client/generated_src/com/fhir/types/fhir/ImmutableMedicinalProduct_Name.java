...
final class ImmutableMedicinalProduct_Name implements MedicinalProduct_Name {
  ...
  public final ImmutableMedicinalProduct_Name withProductName(String value) {
    ...
    return new ImmutableMedicinalProduct_Name(newValue, this.modifierExtension, this.namePart, this.id, this.extension, this.countryLanguage);
  }
  ...
  public final ImmutableMedicinalProduct_Name withProductName(Optional<String> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(value, this.modifierExtension, this.namePart, this.id, this.extension, this.countryLanguage);
  }
  ...
  public final ImmutableMedicinalProduct_Name withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedicinalProduct_Name(this.productName, newValue, this.namePart, this.id, this.extension, this.countryLanguage);
  }
  ...
  public final ImmutableMedicinalProduct_Name withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(this.productName, value, this.namePart, this.id, this.extension, this.countryLanguage);
  }
  ...
  public final ImmutableMedicinalProduct_Name withNamePart(Optional<? extends List<MedicinalProduct_NamePart>> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(this.productName, this.modifierExtension, value, this.id, this.extension, this.countryLanguage);
  }
  ...
  public final ImmutableMedicinalProduct_Name withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(this.productName, this.modifierExtension, this.namePart, this.id, value, this.countryLanguage);
  }
  ...
  public final ImmutableMedicinalProduct_Name withCountryLanguage(List<MedicinalProduct_CountryLanguage> value) {
    ...
    return new ImmutableMedicinalProduct_Name(this.productName, this.modifierExtension, this.namePart, this.id, this.extension, newValue);
  }
  ...
  public final ImmutableMedicinalProduct_Name withCountryLanguage(Optional<? extends List<MedicinalProduct_CountryLanguage>> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(this.productName, this.modifierExtension, this.namePart, this.id, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code productName}, {@code modifierExtension}, {@code namePart}, {@code id}, {@code extension}, {@code countryLanguage}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicinalProduct_Name#modifierExtension() modifierExtension}
   *    .namePart(List&amp;lt;com.fhir.types.fhir.MedicinalProduct_NamePart&amp;gt;) // optional {@link MedicinalProduct_Name#namePart() namePart}
   *    .id(String) // optional {@link MedicinalProduct_Name#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicinalProduct_Name#extension() extension}
   *    .countryLanguage(List&amp;lt;com.fhir.types.fhir.MedicinalProduct_CountryLanguage&amp;gt;) // optional {@link MedicinalProduct_Name#countryLanguage() countryLanguage}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_NAME_PART = 0x4L;
    private static final long OPT_BIT_ID = 0x8L;
    private static final long OPT_BIT_EXTENSION = 0x10L;
    private static final long OPT_BIT_COUNTRY_LANGUAGE = 0x20L;
    ...
    public MedicinalProduct_Name build() {
      return new ImmutableMedicinalProduct_Name(productName, modifierExtension, namePart, id, extension, countryLanguage);
    }
