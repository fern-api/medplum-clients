...
final class ImmutableStructureDefinition_Snapshot
  ...
  public final ImmutableStructureDefinition_Snapshot withId(String value) {
    ...
    return new ImmutableStructureDefinition_Snapshot(newValue, this.element, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableStructureDefinition_Snapshot withId(Optional<String> optional) {
    ...
    return new ImmutableStructureDefinition_Snapshot(value, this.element, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableStructureDefinition_Snapshot withElement(ElementDefinition... elements) {
    ...
    return new ImmutableStructureDefinition_Snapshot(this.id, newValue, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableStructureDefinition_Snapshot withExtension(List<Extension> value) {
    ...
    return new ImmutableStructureDefinition_Snapshot(this.id, this.element, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableStructureDefinition_Snapshot withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableStructureDefinition_Snapshot(this.id, this.element, value, this.modifierExtension);
  }
  ...
  public final ImmutableStructureDefinition_Snapshot withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableStructureDefinition_Snapshot(this.id, this.element, this.extension, newValue);
  }
  ...
  public final ImmutableStructureDefinition_Snapshot withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableStructureDefinition_Snapshot(this.id, this.element, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code element}, {@code extension}, {@code modifierExtension}.
   ...
   *    .addElement|addAllElement(com.fhir.types.fhir.ElementDefinition) // {@link StructureDefinition_Snapshot#element() element} elements
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link StructureDefinition_Snapshot#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link StructureDefinition_Snapshot#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public StructureDefinition_Snapshot build() {
      return new ImmutableStructureDefinition_Snapshot(id, createUnmodifiableList(true, element), extension, modifierExtension);
    }
