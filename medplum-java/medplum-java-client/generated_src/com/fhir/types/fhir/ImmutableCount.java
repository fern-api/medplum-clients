...
final class ImmutableCount implements Count {
  ...
  public final ImmutableCount withComparator(CountComparator value) {
    ...
    return new ImmutableCount(newValue, this.system, this.unit, this.extension, this.value, this.id, this.code);
  }
  ...
  public final ImmutableCount withComparator(Optional<? extends CountComparator> optional) {
    ...
    return new ImmutableCount(value, this.system, this.unit, this.extension, this.value, this.id, this.code);
  }
  ...
  public final ImmutableCount withSystem(Uri value) {
    ...
    return new ImmutableCount(this.comparator, newValue, this.unit, this.extension, this.value, this.id, this.code);
  }
  ...
  public final ImmutableCount withSystem(Optional<? extends Uri> optional) {
    ...
    return new ImmutableCount(this.comparator, value, this.unit, this.extension, this.value, this.id, this.code);
  }
  ...
  public final ImmutableCount withUnit(String value) {
    ...
    return new ImmutableCount(this.comparator, this.system, newValue, this.extension, this.value, this.id, this.code);
  }
  ...
  public final ImmutableCount withUnit(Optional<String> optional) {
    ...
    return new ImmutableCount(this.comparator, this.system, value, this.extension, this.value, this.id, this.code);
  }
  ...
  public final ImmutableCount withExtension(List<Extension> value) {
    ...
    return new ImmutableCount(this.comparator, this.system, this.unit, newValue, this.value, this.id, this.code);
  }
  ...
  public final ImmutableCount withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCount(this.comparator, this.system, this.unit, value, this.value, this.id, this.code);
  }
  ...
  public final ImmutableCount withValue(Decimal value) {
    ...
    return new ImmutableCount(this.comparator, this.system, this.unit, this.extension, newValue, this.id, this.code);
  }
  ...
  public final ImmutableCount withValue(Optional<? extends Decimal> optional) {
    ...
    return new ImmutableCount(this.comparator, this.system, this.unit, this.extension, value, this.id, this.code);
  }
  ...
  public final ImmutableCount withId(String value) {
    ...
    return new ImmutableCount(this.comparator, this.system, this.unit, this.extension, this.value, newValue, this.code);
  }
  ...
  public final ImmutableCount withId(Optional<String> optional) {
    ...
    return new ImmutableCount(this.comparator, this.system, this.unit, this.extension, this.value, value, this.code);
  }
  ...
  public final ImmutableCount withCode(Code value) {
    ...
    return new ImmutableCount(this.comparator, this.system, this.unit, this.extension, this.value, this.id, newValue);
  }
  ...
  public final ImmutableCount withCode(Optional<? extends Code> optional) {
    ...
    return new ImmutableCount(this.comparator, this.system, this.unit, this.extension, this.value, this.id, value);
  }
  ...
  private boolean equalTo(ImmutableCount another) {
    return Objects.equals(comparator, another.comparator)
  ...
  /**
   * Computes a hash code from attributes: {@code comparator}, {@code system}, {@code unit}, {@code extension}, {@code value}, {@code id}, {@code code}.
   ...
   *    .comparator(com.fhir.types.fhir.CountComparator) // optional {@link Count#comparator() comparator}
   *    .system(com.fhir.types.fhir.Uri) // optional {@link Count#system() system}
   *    .unit(String) // optional {@link Count#unit() unit}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Count#extension() extension}
   *    .value(com.fhir.types.fhir.Decimal) // optional {@link Count#value() value}
   *    .id(String) // optional {@link Count#id() id}
   *    .code(com.fhir.types.fhir.Code) // optional {@link Count#code() code}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_COMPARATOR = 0x1L;
    private static final long OPT_BIT_SYSTEM = 0x2L;
    private static final long OPT_BIT_UNIT = 0x4L;
     ...
     */
    public Count build() {
      return new ImmutableCount(comparator, system, unit, extension, value, id, code);
    }
