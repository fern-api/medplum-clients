...
final class ImmutableEffectEvidenceSynthesis_SampleSize
  ...
  public final ImmutableEffectEvidenceSynthesis_SampleSize withNumberOfParticipants(Optional<Integer> optional) {
    ...
    return new ImmutableEffectEvidenceSynthesis_SampleSize(this.id, this.numberOfStudies, this.extension, this.modifierExtension, value, this.description);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code numberOfStudies}, {@code extension}, {@code modifierExtension}, {@code numberOfParticipants}, {@code description}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EffectEvidenceSynthesis_SampleSize#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link EffectEvidenceSynthesis_SampleSize#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    public EffectEvidenceSynthesis_SampleSize build() {
      return new ImmutableEffectEvidenceSynthesis_SampleSize(id, numberOfStudies, extension, modifierExtension, numberOfParticipants, description);
    }
