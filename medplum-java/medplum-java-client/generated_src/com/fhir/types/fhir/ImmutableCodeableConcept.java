...
final class ImmutableCodeableConcept implements CodeableConcept {
  ...
  public final ImmutableCodeableConcept withId(String value) {
    ...
    return new ImmutableCodeableConcept(newValue, this.coding, this.text, this.extension);
  }
  ...
  public final ImmutableCodeableConcept withId(Optional<String> optional) {
    ...
    return new ImmutableCodeableConcept(value, this.coding, this.text, this.extension);
  }
  ...
  public final ImmutableCodeableConcept withCoding(List<Coding> value) {
    ...
    return new ImmutableCodeableConcept(this.id, newValue, this.text, this.extension);
  }
  ...
  public final ImmutableCodeableConcept withCoding(Optional<? extends List<Coding>> optional) {
    ...
    return new ImmutableCodeableConcept(this.id, value, this.text, this.extension);
  }
  ...
  public final ImmutableCodeableConcept withText(String value) {
    ...
    return new ImmutableCodeableConcept(this.id, this.coding, newValue, this.extension);
  }
  ...
  public final ImmutableCodeableConcept withText(Optional<String> optional) {
    ...
    return new ImmutableCodeableConcept(this.id, this.coding, value, this.extension);
  }
  ...
  public final ImmutableCodeableConcept withExtension(List<Extension> value) {
    ...
    return new ImmutableCodeableConcept(this.id, this.coding, this.text, newValue);
  }
  ...
  public final ImmutableCodeableConcept withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCodeableConcept(this.id, this.coding, this.text, value);
  }
  ...
  private boolean equalTo(ImmutableCodeableConcept another) {
    return Objects.equals(id, another.id)
        && Objects.equals(coding, another.coding)
        && Objects.equals(text, another.text)
        && Objects.equals(extension, another.extension);
  }

  /**
   * Computes a hash code from attributes: {@code id}, {@code coding}, {@code text}, {@code extension}.
   ...
   *    .coding(List&amp;lt;com.fhir.types.fhir.Coding&amp;gt;) // optional {@link CodeableConcept#coding() coding}
   *    .text(String) // optional {@link CodeableConcept#text() text}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CodeableConcept#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_CODING = 0x2L;
    ...
    public CodeableConcept build() {
      return new ImmutableCodeableConcept(id, coding, text, extension);
    }
