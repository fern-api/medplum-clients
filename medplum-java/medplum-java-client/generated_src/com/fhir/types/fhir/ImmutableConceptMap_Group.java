...
final class ImmutableConceptMap_Group implements ConceptMap_Group {
  ...
  private boolean equalTo(ImmutableConceptMap_Group another) {
    return Objects.equals(targetVersion, another.targetVersion)
  ...
  /**
   * Computes a hash code from attributes: {@code targetVersion}, {@code extension}, {@code modifierExtension}, {@code sourceVersion}, {@code target}, {@code unmapped}, {@code source}, {@code id}, {@code element}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ConceptMap_Group#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ConceptMap_Group#modifierExtension() modifierExtension}
   *    .sourceVersion(String) // optional {@link ConceptMap_Group#sourceVersion() sourceVersion}
   *    .target(com.fhir.types.fhir.Uri) // optional {@link ConceptMap_Group#target() target}
   *    .unmapped(com.fhir.types.fhir.ConceptMap_Unmapped) // optional {@link ConceptMap_Group#unmapped() unmapped}
   *    .source(com.fhir.types.fhir.Uri) // optional {@link ConceptMap_Group#source() source}
   *    .id(String) // optional {@link ConceptMap_Group#id() id}
   *    .addElement|addAllElement(com.fhir.types.fhir.ConceptMap_Element) // {@link ConceptMap_Group#element() element} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_TARGET_VERSION = 0x1L;
    private static final long OPT_BIT_EXTENSION = 0x2L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x4L;
    private static final long OPT_BIT_SOURCE_VERSION = 0x8L;
    private static final long OPT_BIT_TARGET = 0x10L;
    private static final long OPT_BIT_UNMAPPED = 0x20L;
