...
final class ImmutableClaimResponse_Detail1 implements ClaimResponse_Detail1 {
  ...
  private boolean equalTo(ImmutableClaimResponse_Detail1 another) {
    return Objects.equals(noteNumber, another.noteNumber)
  ...
  /**
   * Computes a hash code from attributes: {@code noteNumber}, {@code extension}, {@code subDetail}, {@code quantity}, {@code modifierExtension}, {@code modifier}, {@code adjudication}, {@code factor}, {@code net}, {@code productOrService}, {@code id}, {@code unitPrice}.
   ...
   *    .noteNumber(List&amp;lt;com.fhir.types.fhir.PositiveInt&amp;gt;) // optional {@link ClaimResponse_Detail1#noteNumber() noteNumber}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_Detail1#extension() extension}
   *    .subDetail(List&amp;lt;com.fhir.types.fhir.ClaimResponse_SubDetail1&amp;gt;) // optional {@link ClaimResponse_Detail1#subDetail() subDetail}
   *    .quantity(com.fhir.types.fhir.Quantity) // optional {@link ClaimResponse_Detail1#quantity() quantity}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_Detail1#modifierExtension() modifierExtension}
   *    .modifier(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link ClaimResponse_Detail1#modifier() modifier}
   *    .addAdjudication|addAllAdjudication(com.fhir.types.fhir.ClaimResponse_Adjudication) // {@link ClaimResponse_Detail1#adjudication() adjudication} elements
   *    .factor(com.fhir.types.fhir.Decimal) // optional {@link ClaimResponse_Detail1#factor() factor}
   *    .net(com.fhir.types.fhir.Money) // optional {@link ClaimResponse_Detail1#net() net}
   *    .productOrService(com.fhir.types.fhir.CodeableConcept) // required {@link ClaimResponse_Detail1#productOrService() productOrService}
   *    .id(String) // optional {@link ClaimResponse_Detail1#id() id}
   *    .unitPrice(com.fhir.types.fhir.Money) // optional {@link ClaimResponse_Detail1#unitPrice() unitPrice}
   *    .build();
   * </pre>
