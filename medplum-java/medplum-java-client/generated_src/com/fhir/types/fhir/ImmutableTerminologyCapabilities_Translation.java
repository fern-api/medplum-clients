...
final class ImmutableTerminologyCapabilities_Translation
  ...
  public final ImmutableTerminologyCapabilities_Translation withNeedsMap(boolean value) {
    ...
    return new ImmutableTerminologyCapabilities_Translation(newValue, this.modifierExtension, this.extension, this.id);
  }
  ...
  public final ImmutableTerminologyCapabilities_Translation withNeedsMap(Optional<Boolean> optional) {
    ...
    return new ImmutableTerminologyCapabilities_Translation(value, this.modifierExtension, this.extension, this.id);
  }
  ...
  public final ImmutableTerminologyCapabilities_Translation withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTerminologyCapabilities_Translation(this.needsMap, newValue, this.extension, this.id);
  }
  ...
  public final ImmutableTerminologyCapabilities_Translation withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTerminologyCapabilities_Translation(this.needsMap, value, this.extension, this.id);
  }
  ...
  public final ImmutableTerminologyCapabilities_Translation withExtension(List<Extension> value) {
    ...
    return new ImmutableTerminologyCapabilities_Translation(this.needsMap, this.modifierExtension, newValue, this.id);
  }
  ...
  public final ImmutableTerminologyCapabilities_Translation withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTerminologyCapabilities_Translation(this.needsMap, this.modifierExtension, value, this.id);
  }
  ...
  public final ImmutableTerminologyCapabilities_Translation withId(String value) {
    ...
    return new ImmutableTerminologyCapabilities_Translation(this.needsMap, this.modifierExtension, this.extension, newValue);
  }
  ...
  public final ImmutableTerminologyCapabilities_Translation withId(Optional<String> optional) {
    ...
    return new ImmutableTerminologyCapabilities_Translation(this.needsMap, this.modifierExtension, this.extension, value);
  }
  ...
  private boolean equalTo(ImmutableTerminologyCapabilities_Translation another) {
    return Objects.equals(needsMap, another.needsMap)
  ...
  /**
   * Computes a hash code from attributes: {@code needsMap}, {@code modifierExtension}, {@code extension}, {@code id}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TerminologyCapabilities_Translation#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TerminologyCapabilities_Translation#extension() extension}
  ...
  public static final class Builder {
    private static final long OPT_BIT_NEEDS_MAP = 0x1L;
    ...
    public TerminologyCapabilities_Translation build() {
      return new ImmutableTerminologyCapabilities_Translation(needsMap, modifierExtension, extension, id);
    }
