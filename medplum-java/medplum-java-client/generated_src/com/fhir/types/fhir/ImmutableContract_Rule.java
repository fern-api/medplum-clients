...
final class ImmutableContract_Rule implements Contract_Rule {
  ...
  public final ImmutableContract_Rule withExtension(List<Extension> value) {
    ...
    return new ImmutableContract_Rule(newValue, this.contentAttachment, this.id, this.modifierExtension, this.contentReference);
  }
  ...
  public final ImmutableContract_Rule withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableContract_Rule(value, this.contentAttachment, this.id, this.modifierExtension, this.contentReference);
  }
  ...
  public final ImmutableContract_Rule withContentAttachment(Attachment value) {
    ...
    return new ImmutableContract_Rule(this.extension, newValue, this.id, this.modifierExtension, this.contentReference);
  }
  ...
  public final ImmutableContract_Rule withContentAttachment(Optional<? extends Attachment> optional) {
    ...
    return new ImmutableContract_Rule(this.extension, value, this.id, this.modifierExtension, this.contentReference);
  }
  ...
  public final ImmutableContract_Rule withId(String value) {
    ...
    return new ImmutableContract_Rule(this.extension, this.contentAttachment, newValue, this.modifierExtension, this.contentReference);
  }
  ...
  public final ImmutableContract_Rule withId(Optional<String> optional) {
    ...
    return new ImmutableContract_Rule(this.extension, this.contentAttachment, value, this.modifierExtension, this.contentReference);
  }
  ...
  public final ImmutableContract_Rule withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableContract_Rule(this.extension, this.contentAttachment, this.id, newValue, this.contentReference);
  }
  ...
  public final ImmutableContract_Rule withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableContract_Rule(this.extension, this.contentAttachment, this.id, value, this.contentReference);
  }
  ...
  public final ImmutableContract_Rule withContentReference(Reference value) {
    ...
    return new ImmutableContract_Rule(this.extension, this.contentAttachment, this.id, this.modifierExtension, newValue);
  }
  ...
  public final ImmutableContract_Rule withContentReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableContract_Rule(this.extension, this.contentAttachment, this.id, this.modifierExtension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code contentAttachment}, {@code id}, {@code modifierExtension}, {@code contentReference}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Contract_Rule#extension() extension}
   *    .contentAttachment(com.fhir.types.fhir.Attachment) // optional {@link Contract_Rule#contentAttachment() contentAttachment}
   *    .id(String) // optional {@link Contract_Rule#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Contract_Rule#modifierExtension() modifierExtension}
   *    .contentReference(com.fhir.types.fhir.Reference) // optional {@link Contract_Rule#contentReference() contentReference}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Contract_Rule build() {
      return new ImmutableContract_Rule(extension, contentAttachment, id, modifierExtension, contentReference);
    }
