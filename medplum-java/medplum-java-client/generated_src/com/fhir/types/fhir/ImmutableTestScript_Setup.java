...
final class ImmutableTestScript_Setup implements TestScript_Setup {
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Setup#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Setup#modifierExtension() modifierExtension}
   *    .addAction|addAllAction(com.fhir.types.fhir.TestScript_Action) // {@link TestScript_Setup#action() action} elements
   *    .build();
   * </pre>
