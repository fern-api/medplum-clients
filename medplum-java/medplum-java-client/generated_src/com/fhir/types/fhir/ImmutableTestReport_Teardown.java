...
final class ImmutableTestReport_Teardown implements TestReport_Teardown {
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Teardown#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Teardown#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link TestReport_Teardown#id() id}
   *    .addAction|addAllAction(com.fhir.types.fhir.TestReport_Action2) // {@link TestReport_Teardown#action() action} elements
   *    .build();
   * </pre>
