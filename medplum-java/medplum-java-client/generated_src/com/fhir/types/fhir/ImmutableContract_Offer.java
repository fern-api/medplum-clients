...
final class ImmutableContract_Offer implements Contract_Offer {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableContract_Offer withSecurityLabelNumber(List<UnsignedInt> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableContract_Offer withSecurityLabelNumber(Optional<? extends List<UnsignedInt>> optional) {
  ...
  private boolean equalTo(ImmutableContract_Offer another) {
    return Objects.equals(topic, another.topic)
        ...
        && Objects.equals(decisionMode, another.decisionMode)
  ...
  /**
   * Computes a hash code from attributes: {@code topic}, {@code party}, {@code decision}, {@code modifierExtension}, {@code extension}, {@code type}, {@code answer}, {@code securityLabelNumber}, {@code text}, {@code decisionMode}, {@code identifier}, {@code linkId}, {@code id}.
   ...
   *    .topic(com.fhir.types.fhir.Reference) // optional {@link Contract_Offer#topic() topic}
   *    .party(List&amp;lt;com.fhir.types.fhir.Contract_Party&amp;gt;) // optional {@link Contract_Offer#party() party}
   *    .decision(com.fhir.types.fhir.CodeableConcept) // optional {@link Contract_Offer#decision() decision}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Contract_Offer#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Contract_Offer#extension() extension}
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link Contract_Offer#type() type}
   *    .answer(List&amp;lt;com.fhir.types.fhir.Contract_Answer&amp;gt;) // optional {@link Contract_Offer#answer() answer}
   *    .securityLabelNumber(List&amp;lt;com.fhir.types.fhir.UnsignedInt&amp;gt;) // optional {@link Contract_Offer#securityLabelNumber() securityLabelNumber}
   *    .text(String) // optional {@link Contract_Offer#text() text}
   *    .decisionMode(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link Contract_Offer#decisionMode() decisionMode}
   *    .identifier(List&amp;lt;com.fhir.types.fhir.Identifier&amp;gt;) // optional {@link Contract_Offer#identifier() identifier}
  ...
  public static final class Builder {
    private static final long OPT_BIT_TOPIC = 0x1L;
    private static final long OPT_BIT_PARTY = 0x2L;
    private static final long OPT_BIT_DECISION = 0x4L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x8L;
    private static final long OPT_BIT_EXTENSION = 0x10L;
    private static final long OPT_BIT_TYPE = 0x20L;
    private static final long OPT_BIT_ANSWER = 0x40L;
    private static final long OPT_BIT_SECURITY_LABEL_NUMBER = 0x80L;
    private static final long OPT_BIT_TEXT = 0x100L;
    private static final long OPT_BIT_DECISION_MODE = 0x200L;
    private static final long OPT_BIT_IDENTIFIER = 0x400L;
    private static final long OPT_BIT_LINK_ID = 0x800L;
