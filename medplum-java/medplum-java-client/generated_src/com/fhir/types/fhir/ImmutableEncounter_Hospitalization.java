...
final class ImmutableEncounter_Hospitalization implements Encounter_Hospitalization {
  ...
  private boolean equalTo(ImmutableEncounter_Hospitalization another) {
    return Objects.equals(id, another.id)
        ...
        && Objects.equals(specialArrangement, another.specialArrangement)
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code destination}, {@code extension}, {@code preAdmissionIdentifier}, {@code origin}, {@code specialArrangement}, {@code modifierExtension}, {@code dietPreference}, {@code admitSource}, {@code reAdmission}, {@code dischargeDisposition}, {@code specialCourtesy}.
   ...
   *    .destination(com.fhir.types.fhir.Reference) // optional {@link Encounter_Hospitalization#destination() destination}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Encounter_Hospitalization#extension() extension}
   *    .preAdmissionIdentifier(com.fhir.types.fhir.Identifier) // optional {@link Encounter_Hospitalization#preAdmissionIdentifier() preAdmissionIdentifier}
   *    .origin(com.fhir.types.fhir.Reference) // optional {@link Encounter_Hospitalization#origin() origin}
   *    .specialArrangement(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link Encounter_Hospitalization#specialArrangement() specialArrangement}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Encounter_Hospitalization#modifierExtension() modifierExtension}
   *    .dietPreference(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link Encounter_Hospitalization#dietPreference() dietPreference}
   *    .admitSource(com.fhir.types.fhir.CodeableConcept) // optional {@link Encounter_Hospitalization#admitSource() admitSource}
   *    .reAdmission(com.fhir.types.fhir.CodeableConcept) // optional {@link Encounter_Hospitalization#reAdmission() reAdmission}
   *    .dischargeDisposition(com.fhir.types.fhir.CodeableConcept) // optional {@link Encounter_Hospitalization#dischargeDisposition() dischargeDisposition}
   *    .specialCourtesy(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link Encounter_Hospitalization#specialCourtesy() specialCourtesy}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DESTINATION = 0x2L;
    private static final long OPT_BIT_EXTENSION = 0x4L;
    private static final long OPT_BIT_PRE_ADMISSION_IDENTIFIER = 0x8L;
    private static final long OPT_BIT_ORIGIN = 0x10L;
    private static final long OPT_BIT_SPECIAL_ARRANGEMENT = 0x20L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x40L;
    private static final long OPT_BIT_DIET_PREFERENCE = 0x80L;
    private static final long OPT_BIT_ADMIT_SOURCE = 0x100L;
    private static final long OPT_BIT_RE_ADMISSION = 0x200L;
    private static final long OPT_BIT_DISCHARGE_DISPOSITION = 0x400L;
    private static final long OPT_BIT_SPECIAL_COURTESY = 0x800L;
