...
final class ImmutableMolecularSequence_StructureVariant
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code variantType}, {@code outer}, {@code extension}, {@code exact}, {@code inner}, {@code modifierExtension}, {@code length}.
   ...
   *    .variantType(com.fhir.types.fhir.CodeableConcept) // optional {@link MolecularSequence_StructureVariant#variantType() variantType}
   *    .outer(com.fhir.types.fhir.MolecularSequence_Outer) // optional {@link MolecularSequence_StructureVariant#outer() outer}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MolecularSequence_StructureVariant#extension() extension}
   *    .exact(Boolean) // optional {@link MolecularSequence_StructureVariant#exact() exact}
   *    .inner(com.fhir.types.fhir.MolecularSequence_Inner) // optional {@link MolecularSequence_StructureVariant#inner() inner}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MolecularSequence_StructureVariant#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_VARIANT_TYPE = 0x2L;
    private static final long OPT_BIT_OUTER = 0x4L;
    ...
    public MolecularSequence_StructureVariant build() {
      return new ImmutableMolecularSequence_StructureVariant(id, variantType, outer, extension, exact, inner, modifierExtension, length);
    }
