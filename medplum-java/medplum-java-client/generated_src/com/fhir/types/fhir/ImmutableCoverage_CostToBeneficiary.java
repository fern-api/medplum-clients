...
final class ImmutableCoverage_CostToBeneficiary
  ...
  public final ImmutableCoverage_CostToBeneficiary withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCoverage_CostToBeneficiary(this.type, this.id, this.extension, this.valueQuantity, this.exception, value, this.valueMoney);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code type}, {@code id}, {@code extension}, {@code valueQuantity}, {@code exception}, {@code modifierExtension}, {@code valueMoney}.
   ...
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link Coverage_CostToBeneficiary#type() type}
   *    .id(String) // optional {@link Coverage_CostToBeneficiary#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Coverage_CostToBeneficiary#extension() extension}
   *    .valueQuantity(com.fhir.types.fhir.Quantity) // optional {@link Coverage_CostToBeneficiary#valueQuantity() valueQuantity}
   *    .exception(List&amp;lt;com.fhir.types.fhir.Coverage_Exception&amp;gt;) // optional {@link Coverage_CostToBeneficiary#exception() exception}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Coverage_CostToBeneficiary#modifierExtension() modifierExtension}
   *    .valueMoney(com.fhir.types.fhir.Money) // optional {@link Coverage_CostToBeneficiary#valueMoney() valueMoney}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_EXCEPTION = 0x10L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x20L;
    private static final long OPT_BIT_VALUE_MONEY = 0x40L;
    ...
    public Coverage_CostToBeneficiary build() {
      return new ImmutableCoverage_CostToBeneficiary(type, id, extension, valueQuantity, exception, modifierExtension, valueMoney);
    }
