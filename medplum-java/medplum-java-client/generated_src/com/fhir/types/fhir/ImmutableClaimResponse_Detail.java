...
final class ImmutableClaimResponse_Detail implements ClaimResponse_Detail {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code modifierExtension}, {@code adjudication}, {@code noteNumber}, {@code id}, {@code subDetail}, {@code detailSequence}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_Detail#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_Detail#modifierExtension() modifierExtension}
   *    .addAdjudication|addAllAdjudication(com.fhir.types.fhir.ClaimResponse_Adjudication) // {@link ClaimResponse_Detail#adjudication() adjudication} elements
   *    .noteNumber(List&amp;lt;com.fhir.types.fhir.PositiveInt&amp;gt;) // optional {@link ClaimResponse_Detail#noteNumber() noteNumber}
   *    .id(String) // optional {@link ClaimResponse_Detail#id() id}
   *    .subDetail(List&amp;lt;com.fhir.types.fhir.ClaimResponse_SubDetail&amp;gt;) // optional {@link ClaimResponse_Detail#subDetail() subDetail}
   *    .detailSequence(com.fhir.types.fhir.PositiveInt) // optional {@link ClaimResponse_Detail#detailSequence() detailSequence}
   *    .build();
   * </pre>
