...
final class ImmutableCapabilityStatement_Messaging
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code endpoint}, {@code documentation}, {@code extension}, {@code reliableCache}, {@code modifierExtension}, {@code supportedMessage}.
   ...
   *    .endpoint(List&amp;lt;com.fhir.types.fhir.CapabilityStatement_Endpoint&amp;gt;) // optional {@link CapabilityStatement_Messaging#endpoint() endpoint}
   *    .documentation(com.fhir.types.fhir.Markdown) // optional {@link CapabilityStatement_Messaging#documentation() documentation}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CapabilityStatement_Messaging#extension() extension}
   *    .reliableCache(com.fhir.types.fhir.UnsignedInt) // optional {@link CapabilityStatement_Messaging#reliableCache() reliableCache}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CapabilityStatement_Messaging#modifierExtension() modifierExtension}
   *    .supportedMessage(List&amp;lt;com.fhir.types.fhir.CapabilityStatement_SupportedMessage&amp;gt;) // optional {@link CapabilityStatement_Messaging#supportedMessage() supportedMessage}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_RELIABLE_CACHE = 0x10L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x20L;
    private static final long OPT_BIT_SUPPORTED_MESSAGE = 0x40L;
    ...
    public CapabilityStatement_Messaging build() {
      return new ImmutableCapabilityStatement_Messaging(id, endpoint, documentation, extension, reliableCache, modifierExtension, supportedMessage);
    }
