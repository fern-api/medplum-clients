...
final class ImmutableInsurancePlan_GeneralCost implements InsurancePlan_GeneralCost {
  ...
  public final ImmutableInsurancePlan_GeneralCost withComment(String value) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(newValue, this.groupSize, this.cost, this.type, this.id, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableInsurancePlan_GeneralCost withComment(Optional<String> optional) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(value, this.groupSize, this.cost, this.type, this.id, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableInsurancePlan_GeneralCost withGroupSize(PositiveInt value) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(this.comment, newValue, this.cost, this.type, this.id, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableInsurancePlan_GeneralCost withGroupSize(Optional<? extends PositiveInt> optional) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(this.comment, value, this.cost, this.type, this.id, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableInsurancePlan_GeneralCost withCost(Optional<? extends Money> optional) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(this.comment, this.groupSize, value, this.type, this.id, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableInsurancePlan_GeneralCost withType(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(this.comment, this.groupSize, this.cost, value, this.id, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableInsurancePlan_GeneralCost withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(this.comment, this.groupSize, this.cost, this.type, this.id, newValue, this.extension);
  }
  ...
  public final ImmutableInsurancePlan_GeneralCost withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(this.comment, this.groupSize, this.cost, this.type, this.id, value, this.extension);
  }
  ...
  public final ImmutableInsurancePlan_GeneralCost withExtension(List<Extension> value) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(this.comment, this.groupSize, this.cost, this.type, this.id, this.modifierExtension, newValue);
  }
  ...
  public final ImmutableInsurancePlan_GeneralCost withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableInsurancePlan_GeneralCost(this.comment, this.groupSize, this.cost, this.type, this.id, this.modifierExtension, value);
  }
  ...
  private boolean equalTo(ImmutableInsurancePlan_GeneralCost another) {
    return Objects.equals(comment, another.comment)
        && Objects.equals(groupSize, another.groupSize)
  ...
  /**
   * Computes a hash code from attributes: {@code comment}, {@code groupSize}, {@code cost}, {@code type}, {@code id}, {@code modifierExtension}, {@code extension}.
   ...
   *    .groupSize(com.fhir.types.fhir.PositiveInt) // optional {@link InsurancePlan_GeneralCost#groupSize() groupSize}
   *    .cost(com.fhir.types.fhir.Money) // optional {@link InsurancePlan_GeneralCost#cost() cost}
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link InsurancePlan_GeneralCost#type() type}
   *    .id(String) // optional {@link InsurancePlan_GeneralCost#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link InsurancePlan_GeneralCost#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link InsurancePlan_GeneralCost#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_GROUP_SIZE = 0x2L;
    ...
    public InsurancePlan_GeneralCost build() {
      return new ImmutableInsurancePlan_GeneralCost(comment, groupSize, cost, type, id, modifierExtension, extension);
    }
