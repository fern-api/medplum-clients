...
final class ImmutableTestScript_Fixture implements TestScript_Fixture {
  ...
  public final ImmutableTestScript_Fixture withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Fixture(newValue, this.autodelete, this.id, this.modifierExtension, this.autocreate, this.resource);
  }
  ...
  public final ImmutableTestScript_Fixture withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Fixture(value, this.autodelete, this.id, this.modifierExtension, this.autocreate, this.resource);
  }
  ...
  public final ImmutableTestScript_Fixture withAutodelete(boolean value) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, newValue, this.id, this.modifierExtension, this.autocreate, this.resource);
  }
  ...
  public final ImmutableTestScript_Fixture withAutodelete(Optional<Boolean> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, value, this.id, this.modifierExtension, this.autocreate, this.resource);
  }
  ...
  public final ImmutableTestScript_Fixture withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.autodelete, value, this.modifierExtension, this.autocreate, this.resource);
  }
  ...
  public final ImmutableTestScript_Fixture withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.autodelete, this.id, newValue, this.autocreate, this.resource);
  }
  ...
  public final ImmutableTestScript_Fixture withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.autodelete, this.id, value, this.autocreate, this.resource);
  }
  ...
  public final ImmutableTestScript_Fixture withAutocreate(boolean value) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.autodelete, this.id, this.modifierExtension, newValue, this.resource);
  }
  ...
  public final ImmutableTestScript_Fixture withAutocreate(Optional<Boolean> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.autodelete, this.id, this.modifierExtension, value, this.resource);
  }
  ...
  public final ImmutableTestScript_Fixture withResource(Reference value) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.autodelete, this.id, this.modifierExtension, this.autocreate, newValue);
  }
  ...
  public final ImmutableTestScript_Fixture withResource(Optional<? extends Reference> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.autodelete, this.id, this.modifierExtension, this.autocreate, value);
  }
  ...
  private boolean equalTo(ImmutableTestScript_Fixture another) {
    return Objects.equals(extension, another.extension)
        && Objects.equals(autodelete, another.autodelete)
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code autodelete}, {@code id}, {@code modifierExtension}, {@code autocreate}, {@code resource}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Fixture#extension() extension}
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Fixture#modifierExtension() modifierExtension}
   *    .autocreate(Boolean) // optional {@link TestScript_Fixture#autocreate() autocreate}
   *    .resource(com.fhir.types.fhir.Reference) // optional {@link TestScript_Fixture#resource() resource}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_AUTODELETE = 0x2L;
    private static final long OPT_BIT_ID = 0x4L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x8L;
    private static final long OPT_BIT_AUTOCREATE = 0x10L;
    private static final long OPT_BIT_RESOURCE = 0x20L;
    ...
    public TestScript_Fixture build() {
      return new ImmutableTestScript_Fixture(extension, autodelete, id, modifierExtension, autocreate, resource);
    }
