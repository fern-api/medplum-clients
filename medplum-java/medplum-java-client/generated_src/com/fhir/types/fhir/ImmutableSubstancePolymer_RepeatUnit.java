...
final class ImmutableSubstancePolymer_RepeatUnit
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code repeatUnit}, {@code extension}, {@code structuralRepresentation}, {@code id}, {@code orientationOfPolymerisation}, {@code amount}, {@code degreeOfPolymerisation}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_RepeatUnit#modifierExtension() modifierExtension}
   *    .repeatUnit(String) // optional {@link SubstancePolymer_RepeatUnit#repeatUnit() repeatUnit}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_RepeatUnit#extension() extension}
   *    .structuralRepresentation(List&amp;lt;com.fhir.types.fhir.SubstancePolymer_StructuralRepresentation&amp;gt;) // optional {@link SubstancePolymer_RepeatUnit#structuralRepresentation() structuralRepresentation}
   *    .id(String) // optional {@link SubstancePolymer_RepeatUnit#id() id}
   *    .orientationOfPolymerisation(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstancePolymer_RepeatUnit#orientationOfPolymerisation() orientationOfPolymerisation}
   *    .amount(com.fhir.types.fhir.SubstanceAmount) // optional {@link SubstancePolymer_RepeatUnit#amount() amount}
   *    .degreeOfPolymerisation(List&amp;lt;com.fhir.types.fhir.SubstancePolymer_DegreeOfPolymerisation&amp;gt;) // optional {@link SubstancePolymer_RepeatUnit#degreeOfPolymerisation() degreeOfPolymerisation}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_REPEAT_UNIT = 0x2L;
    private static final long OPT_BIT_EXTENSION = 0x4L;
    private static final long OPT_BIT_STRUCTURAL_REPRESENTATION = 0x8L;
    ...
    private static final long OPT_BIT_DEGREE_OF_POLYMERISATION = 0x80L;
