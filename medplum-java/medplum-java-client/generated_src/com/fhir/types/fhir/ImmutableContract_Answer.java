...
final class ImmutableContract_Answer implements Contract_Answer {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code valueDecimal}, {@code modifierExtension}, {@code valueString}, {@code valueInteger}, {@code valueCoding}, {@code valueDate}, {@code valueTime}, {@code extension}, {@code valueUri}, {@code valueQuantity}, {@code valueBoolean}, {@code valueAttachment}, {@code valueReference}, {@code valueDateTime}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Contract_Answer#modifierExtension() modifierExtension}
   ...
   *    .valueCoding(com.fhir.types.fhir.Coding) // optional {@link Contract_Answer#valueCoding() valueCoding}
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Contract_Answer#extension() extension}
   *    .valueUri(String) // optional {@link Contract_Answer#valueUri() valueUri}
   *    .valueQuantity(com.fhir.types.fhir.Quantity) // optional {@link Contract_Answer#valueQuantity() valueQuantity}
   *    .valueBoolean(Boolean) // optional {@link Contract_Answer#valueBoolean() valueBoolean}
   *    .valueAttachment(com.fhir.types.fhir.Attachment) // optional {@link Contract_Answer#valueAttachment() valueAttachment}
   *    .valueReference(com.fhir.types.fhir.Reference) // optional {@link Contract_Answer#valueReference() valueReference}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_VALUE_CODING = 0x20L;
    private static final long OPT_BIT_VALUE_DATE = 0x40L;
    ...
    private static final long OPT_BIT_VALUE_QUANTITY = 0x400L;
    private static final long OPT_BIT_VALUE_BOOLEAN = 0x800L;
    private static final long OPT_BIT_VALUE_ATTACHMENT = 0x1000L;
    private static final long OPT_BIT_VALUE_REFERENCE = 0x2000L;
