...
final class ImmutableSpecimenDefinition_Container
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code type}, {@code minimumVolumeString}, {@code id}, {@code capacity}, {@code cap}, {@code minimumVolumeQuantity}, {@code extension}, {@code additive}, {@code preparation}, {@code material}, {@code description}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_Container#modifierExtension() modifierExtension}
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link SpecimenDefinition_Container#type() type}
   ...
   *    .capacity(com.fhir.types.fhir.Quantity) // optional {@link SpecimenDefinition_Container#capacity() capacity}
   *    .cap(com.fhir.types.fhir.CodeableConcept) // optional {@link SpecimenDefinition_Container#cap() cap}
   *    .minimumVolumeQuantity(com.fhir.types.fhir.Quantity) // optional {@link SpecimenDefinition_Container#minimumVolumeQuantity() minimumVolumeQuantity}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_Container#extension() extension}
   *    .additive(List&amp;lt;com.fhir.types.fhir.SpecimenDefinition_Additive&amp;gt;) // optional {@link SpecimenDefinition_Container#additive() additive}
   *    .preparation(String) // optional {@link SpecimenDefinition_Container#preparation() preparation}
   *    .material(com.fhir.types.fhir.CodeableConcept) // optional {@link SpecimenDefinition_Container#material() material}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_MINIMUM_VOLUME_STRING = 0x4L;
    private static final long OPT_BIT_ID = 0x8L;
    private static final long OPT_BIT_CAPACITY = 0x10L;
    private static final long OPT_BIT_CAP = 0x20L;
    private static final long OPT_BIT_MINIMUM_VOLUME_QUANTITY = 0x40L;
    private static final long OPT_BIT_EXTENSION = 0x80L;
    private static final long OPT_BIT_ADDITIVE = 0x100L;
    private static final long OPT_BIT_PREPARATION = 0x200L;
    private static final long OPT_BIT_MATERIAL = 0x400L;
