...
final class ImmutableNutritionOrder_Texture implements NutritionOrder_Texture {
  ...
  public final ImmutableNutritionOrder_Texture withId(String value) {
    ...
    return new ImmutableNutritionOrder_Texture(newValue, this.foodType, this.modifier, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableNutritionOrder_Texture withId(Optional<String> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(value, this.foodType, this.modifier, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableNutritionOrder_Texture withFoodType(CodeableConcept value) {
    ...
    return new ImmutableNutritionOrder_Texture(this.id, newValue, this.modifier, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableNutritionOrder_Texture withFoodType(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(this.id, value, this.modifier, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableNutritionOrder_Texture withModifier(CodeableConcept value) {
    ...
    return new ImmutableNutritionOrder_Texture(this.id, this.foodType, newValue, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableNutritionOrder_Texture withModifier(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(this.id, this.foodType, value, this.modifierExtension, this.extension);
  }
  ...
  public final ImmutableNutritionOrder_Texture withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableNutritionOrder_Texture(this.id, this.foodType, this.modifier, newValue, this.extension);
  }
  ...
  public final ImmutableNutritionOrder_Texture withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(this.id, this.foodType, this.modifier, value, this.extension);
  }
  ...
  public final ImmutableNutritionOrder_Texture withExtension(List<Extension> value) {
    ...
    return new ImmutableNutritionOrder_Texture(this.id, this.foodType, this.modifier, this.modifierExtension, newValue);
  }
  ...
  public final ImmutableNutritionOrder_Texture withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(this.id, this.foodType, this.modifier, this.modifierExtension, value);
  }
  ...
  private boolean equalTo(ImmutableNutritionOrder_Texture another) {
    return Objects.equals(id, another.id)
        && Objects.equals(foodType, another.foodType)
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code foodType}, {@code modifier}, {@code modifierExtension}, {@code extension}.
   ...
   *    .foodType(com.fhir.types.fhir.CodeableConcept) // optional {@link NutritionOrder_Texture#foodType() foodType}
   *    .modifier(com.fhir.types.fhir.CodeableConcept) // optional {@link NutritionOrder_Texture#modifier() modifier}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_Texture#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_Texture#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_FOOD_TYPE = 0x2L;
    ...
    public NutritionOrder_Texture build() {
      return new ImmutableNutritionOrder_Texture(id, foodType, modifier, modifierExtension, extension);
    }
