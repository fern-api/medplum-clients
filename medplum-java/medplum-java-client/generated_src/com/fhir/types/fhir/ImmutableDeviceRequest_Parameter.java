...
final class ImmutableDeviceRequest_Parameter implements DeviceRequest_Parameter {
  ...
  /**
   * Computes a hash code from attributes: {@code valueQuantity}, {@code extension}, {@code id}, {@code valueCodeableConcept}, {@code valueRange}, {@code code}, {@code modifierExtension}, {@code valueBoolean}.
   ...
   *    .valueQuantity(com.fhir.types.fhir.Quantity) // optional {@link DeviceRequest_Parameter#valueQuantity() valueQuantity}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link DeviceRequest_Parameter#extension() extension}
   *    .id(String) // optional {@link DeviceRequest_Parameter#id() id}
   *    .valueCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link DeviceRequest_Parameter#valueCodeableConcept() valueCodeableConcept}
   *    .valueRange(com.fhir.types.fhir.Range) // optional {@link DeviceRequest_Parameter#valueRange() valueRange}
   *    .code(com.fhir.types.fhir.CodeableConcept) // optional {@link DeviceRequest_Parameter#code() code}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link DeviceRequest_Parameter#modifierExtension() modifierExtension}
