...
final class ImmutableSpecimenDefinition_Additive
  ...
  public final ImmutableSpecimenDefinition_Additive withExtension(List<Extension> value) {
    ...
    return new ImmutableSpecimenDefinition_Additive(newValue, this.modifierExtension, this.additiveCodeableConcept, this.additiveReference, this.id);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSpecimenDefinition_Additive(value, this.modifierExtension, this.additiveCodeableConcept, this.additiveReference, this.id);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.extension, newValue, this.additiveCodeableConcept, this.additiveReference, this.id);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.extension, value, this.additiveCodeableConcept, this.additiveReference, this.id);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withAdditiveCodeableConcept(CodeableConcept value) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.extension, this.modifierExtension, newValue, this.additiveReference, this.id);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withAdditiveCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.extension, this.modifierExtension, value, this.additiveReference, this.id);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withAdditiveReference(Reference value) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.extension, this.modifierExtension, this.additiveCodeableConcept, newValue, this.id);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withAdditiveReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.extension, this.modifierExtension, this.additiveCodeableConcept, value, this.id);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code modifierExtension}, {@code additiveCodeableConcept}, {@code additiveReference}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_Additive#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_Additive#modifierExtension() modifierExtension}
   *    .additiveCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link SpecimenDefinition_Additive#additiveCodeableConcept() additiveCodeableConcept}
   *    .additiveReference(com.fhir.types.fhir.Reference) // optional {@link SpecimenDefinition_Additive#additiveReference() additiveReference}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_ADDITIVE_REFERENCE = 0x8L;
    ...
    public SpecimenDefinition_Additive build() {
      return new ImmutableSpecimenDefinition_Additive(extension, modifierExtension, additiveCodeableConcept, additiveReference, id);
    }
