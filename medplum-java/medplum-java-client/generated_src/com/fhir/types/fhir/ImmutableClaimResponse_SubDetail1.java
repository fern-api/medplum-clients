...
final class ImmutableClaimResponse_SubDetail1 implements ClaimResponse_SubDetail1 {
  ...
  /**
   * Computes a hash code from attributes: {@code productOrService}, {@code adjudication}, {@code id}, {@code modifierExtension}, {@code net}, {@code extension}, {@code factor}, {@code unitPrice}, {@code noteNumber}, {@code modifier}, {@code quantity}.
   ...
   *    .productOrService(com.fhir.types.fhir.CodeableConcept) // required {@link ClaimResponse_SubDetail1#productOrService() productOrService}
   *    .addAdjudication|addAllAdjudication(com.fhir.types.fhir.ClaimResponse_Adjudication) // {@link ClaimResponse_SubDetail1#adjudication() adjudication} elements
   *    .id(String) // optional {@link ClaimResponse_SubDetail1#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_SubDetail1#modifierExtension() modifierExtension}
   *    .net(com.fhir.types.fhir.Money) // optional {@link ClaimResponse_SubDetail1#net() net}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_SubDetail1#extension() extension}
   *    .factor(com.fhir.types.fhir.Decimal) // optional {@link ClaimResponse_SubDetail1#factor() factor}
   *    .unitPrice(com.fhir.types.fhir.Money) // optional {@link ClaimResponse_SubDetail1#unitPrice() unitPrice}
   *    .noteNumber(List&amp;lt;com.fhir.types.fhir.PositiveInt&amp;gt;) // optional {@link ClaimResponse_SubDetail1#noteNumber() noteNumber}
   *    .modifier(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link ClaimResponse_SubDetail1#modifier() modifier}
   *    .quantity(com.fhir.types.fhir.Quantity) // optional {@link ClaimResponse_SubDetail1#quantity() quantity}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ProductOrServiceBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_NOTE_NUMBER = 0x40L;
