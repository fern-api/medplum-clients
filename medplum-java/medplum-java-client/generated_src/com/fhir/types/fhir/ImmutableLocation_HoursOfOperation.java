...
final class ImmutableLocation_HoursOfOperation implements Location_HoursOfOperation {
  ...
  private boolean equalTo(ImmutableLocation_HoursOfOperation another) {
    return Objects.equals(openingTime, another.openingTime)
  ...
  /**
   * Computes a hash code from attributes: {@code openingTime}, {@code closingTime}, {@code id}, {@code daysOfWeek}, {@code modifierExtension}, {@code extension}, {@code allDay}.
   ...
   *    .openingTime(com.fhir.types.fhir.Time) // optional {@link Location_HoursOfOperation#openingTime() openingTime}
   *    .closingTime(com.fhir.types.fhir.Time) // optional {@link Location_HoursOfOperation#closingTime() closingTime}
   *    .id(String) // optional {@link Location_HoursOfOperation#id() id}
   *    .daysOfWeek(List&amp;lt;com.fhir.types.fhir.Code&amp;gt;) // optional {@link Location_HoursOfOperation#daysOfWeek() daysOfWeek}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Location_HoursOfOperation#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Location_HoursOfOperation#extension() extension}
  ...
  public static final class Builder {
    private static final long OPT_BIT_OPENING_TIME = 0x1L;
    private static final long OPT_BIT_CLOSING_TIME = 0x2L;
    private static final long OPT_BIT_ID = 0x4L;
    private static final long OPT_BIT_DAYS_OF_WEEK = 0x8L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x10L;
    private static final long OPT_BIT_EXTENSION = 0x20L;
    private static final long OPT_BIT_ALL_DAY = 0x40L;
    ...
    public Location_HoursOfOperation build() {
      return new ImmutableLocation_HoursOfOperation(openingTime, closingTime, id, daysOfWeek, modifierExtension, extension, allDay);
    }
