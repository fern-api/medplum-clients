...
final class ImmutablePlanDefinition_Target implements PlanDefinition_Target {
  ...
  private boolean equalTo(ImmutablePlanDefinition_Target another) {
    return Objects.equals(due, another.due)
  ...
  /**
   * Computes a hash code from attributes: {@code due}, {@code id}, {@code extension}, {@code measure}, {@code detailCodeableConcept}, {@code modifierExtension}, {@code detailQuantity}, {@code detailRange}.
   ...
   *    .due(com.fhir.types.fhir.Duration) // optional {@link PlanDefinition_Target#due() due}
   *    .id(String) // optional {@link PlanDefinition_Target#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link PlanDefinition_Target#extension() extension}
   *    .measure(com.fhir.types.fhir.CodeableConcept) // optional {@link PlanDefinition_Target#measure() measure}
   *    .detailCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link PlanDefinition_Target#detailCodeableConcept() detailCodeableConcept}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link PlanDefinition_Target#modifierExtension() modifierExtension}
   *    .detailQuantity(com.fhir.types.fhir.Quantity) // optional {@link PlanDefinition_Target#detailQuantity() detailQuantity}
   *    .detailRange(com.fhir.types.fhir.Range) // optional {@link PlanDefinition_Target#detailRange() detailRange}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_DUE = 0x1L;
    private static final long OPT_BIT_ID = 0x2L;
    private static final long OPT_BIT_EXTENSION = 0x4L;
    private static final long OPT_BIT_MEASURE = 0x8L;
    private static final long OPT_BIT_DETAIL_CODEABLE_CONCEPT = 0x10L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x20L;
    private static final long OPT_BIT_DETAIL_QUANTITY = 0x40L;
    private static final long OPT_BIT_DETAIL_RANGE = 0x80L;
