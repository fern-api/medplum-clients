...
final class ImmutableSubstanceSpecification_Name
  ...
  /**
   * Computes a hash code from attributes: {@code language}, {@code type}, {@code modifierExtension}, {@code translation}, {@code name}, {@code jurisdiction}, {@code extension}, {@code synonym}, {@code source}, {@code status}, {@code id}, {@code official}, {@code domain}, {@code preferred}.
   ...
   *    .language(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link SubstanceSpecification_Name#language() language}
   *    .type(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Name#type() type}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Name#modifierExtension() modifierExtension}
   *    .translation(List&amp;lt;com.fhir.types.fhir.SubstanceSpecification_Name&amp;gt;) // optional {@link SubstanceSpecification_Name#translation() translation}
   *    .name(String) // optional {@link SubstanceSpecification_Name#name() name}
   *    .jurisdiction(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link SubstanceSpecification_Name#jurisdiction() jurisdiction}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Name#extension() extension}
   *    .synonym(List&amp;lt;com.fhir.types.fhir.SubstanceSpecification_Name&amp;gt;) // optional {@link SubstanceSpecification_Name#synonym() synonym}
   *    .source(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link SubstanceSpecification_Name#source() source}
   *    .status(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Name#status() status}
   *    .id(String) // optional {@link SubstanceSpecification_Name#id() id}
   *    .official(List&amp;lt;com.fhir.types.fhir.SubstanceSpecification_Official&amp;gt;) // optional {@link SubstanceSpecification_Name#official() official}
   *    .domain(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link SubstanceSpecification_Name#domain() domain}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SYNONYM = 0x80L;
    ...
    private static final long OPT_BIT_PREFERRED = 0x2000L;
