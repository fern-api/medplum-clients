...
final class ImmutableParameterDefinition implements ParameterDefinition {
  ...
  /**
   * Computes a hash code from attributes: {@code name}, {@code documentation}, {@code id}, {@code max}, {@code type}, {@code profile}, {@code use}, {@code min}, {@code extension}.
   ...
   *    .name(com.fhir.types.fhir.Code) // optional {@link ParameterDefinition#name() name}
   ...
   *    .type(com.fhir.types.fhir.Code) // optional {@link ParameterDefinition#type() type}
   *    .profile(com.fhir.types.fhir.Canonical) // optional {@link ParameterDefinition#profile() profile}
   *    .use(com.fhir.types.fhir.Code) // optional {@link ParameterDefinition#use() use}
   *    .min(Integer) // optional {@link ParameterDefinition#min() min}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link ParameterDefinition#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_MIN = 0x80L;
    ...
    public ParameterDefinition build() {
      return new ImmutableParameterDefinition(name, documentation, id, max, type, profile, use, min, extension);
    }
