...
final class ImmutableCapabilityStatement_Rest implements CapabilityStatement_Rest {
  ...
  private boolean equalTo(ImmutableCapabilityStatement_Rest another) {
    return Objects.equals(security, another.security)
  ...
  /**
   * Computes a hash code from attributes: {@code security}, {@code mode}, {@code interaction}, {@code extension}, {@code compartment}, {@code modifierExtension}, {@code documentation}, {@code operation}, {@code id}, {@code resource}, {@code searchParam}.
   ...
   *    .security(com.fhir.types.fhir.CapabilityStatement_Security) // optional {@link CapabilityStatement_Rest#security() security}
   *    .mode(Capabilitystatement_RestMode) // optional {@link CapabilityStatement_Rest#mode() mode}
   *    .interaction(List&amp;lt;com.fhir.types.fhir.CapabilityStatement_Interaction1&amp;gt;) // optional {@link CapabilityStatement_Rest#interaction() interaction}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CapabilityStatement_Rest#extension() extension}
   *    .compartment(List&amp;lt;com.fhir.types.fhir.Canonical&amp;gt;) // optional {@link CapabilityStatement_Rest#compartment() compartment}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link CapabilityStatement_Rest#modifierExtension() modifierExtension}
   *    .documentation(com.fhir.types.fhir.Markdown) // optional {@link CapabilityStatement_Rest#documentation() documentation}
   *    .operation(List&amp;lt;com.fhir.types.fhir.CapabilityStatement_Operation&amp;gt;) // optional {@link CapabilityStatement_Rest#operation() operation}
   *    .id(String) // optional {@link CapabilityStatement_Rest#id() id}
   *    .resource(List&amp;lt;com.fhir.types.fhir.CapabilityStatement_Resource&amp;gt;) // optional {@link CapabilityStatement_Rest#resource() resource}
   *    .searchParam(List&amp;lt;com.fhir.types.fhir.CapabilityStatement_SearchParam&amp;gt;) // optional {@link CapabilityStatement_Rest#searchParam() searchParam}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_SECURITY = 0x1L;
    private static final long OPT_BIT_MODE = 0x2L;
    private static final long OPT_BIT_INTERACTION = 0x4L;
    private static final long OPT_BIT_EXTENSION = 0x8L;
    private static final long OPT_BIT_COMPARTMENT = 0x10L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x20L;
    private static final long OPT_BIT_DOCUMENTATION = 0x40L;
    private static final long OPT_BIT_OPERATION = 0x80L;
    private static final long OPT_BIT_ID = 0x100L;
    private static final long OPT_BIT_RESOURCE = 0x200L;
    private static final long OPT_BIT_SEARCH_PARAM = 0x400L;
