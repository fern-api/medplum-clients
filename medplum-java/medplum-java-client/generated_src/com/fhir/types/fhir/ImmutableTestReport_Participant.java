...
final class ImmutableTestReport_Participant implements TestReport_Participant {
  ...
  public final ImmutableTestReport_Participant withDisplay(String value) {
    ...
    return new ImmutableTestReport_Participant(newValue, this.extension, this.id, this.modifierExtension, this.type, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withDisplay(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Participant(value, this.extension, this.id, this.modifierExtension, this.type, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Participant(this.display, newValue, this.id, this.modifierExtension, this.type, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Participant(this.display, value, this.id, this.modifierExtension, this.type, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withId(String value) {
    ...
    return new ImmutableTestReport_Participant(this.display, this.extension, newValue, this.modifierExtension, this.type, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withId(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Participant(this.display, this.extension, value, this.modifierExtension, this.type, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Participant(this.display, this.extension, this.id, newValue, this.type, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Participant(this.display, this.extension, this.id, value, this.type, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withType(Testreport_ParticipantType value) {
    ...
    return new ImmutableTestReport_Participant(this.display, this.extension, this.id, this.modifierExtension, newValue, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withType(Optional<? extends Testreport_ParticipantType> optional) {
    ...
    return new ImmutableTestReport_Participant(this.display, this.extension, this.id, this.modifierExtension, value, this.uri);
  }
  ...
  public final ImmutableTestReport_Participant withUri(Uri value) {
    ...
    return new ImmutableTestReport_Participant(this.display, this.extension, this.id, this.modifierExtension, this.type, newValue);
  }
  ...
  public final ImmutableTestReport_Participant withUri(Optional<? extends Uri> optional) {
    ...
    return new ImmutableTestReport_Participant(this.display, this.extension, this.id, this.modifierExtension, this.type, value);
  }
  ...
  private boolean equalTo(ImmutableTestReport_Participant another) {
    return Objects.equals(display, another.display)
  ...
  /**
   * Computes a hash code from attributes: {@code display}, {@code extension}, {@code id}, {@code modifierExtension}, {@code type}, {@code uri}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Participant#extension() extension}
   *    .id(String) // optional {@link TestReport_Participant#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Participant#modifierExtension() modifierExtension}
   *    .type(Testreport_ParticipantType) // optional {@link TestReport_Participant#type() type}
   *    .uri(com.fhir.types.fhir.Uri) // optional {@link TestReport_Participant#uri() uri}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_DISPLAY = 0x1L;
    ...
    public TestReport_Participant build() {
      return new ImmutableTestReport_Participant(display, extension, id, modifierExtension, type, uri);
    }
