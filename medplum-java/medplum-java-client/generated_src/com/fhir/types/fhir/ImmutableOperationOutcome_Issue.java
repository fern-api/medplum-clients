...
final class ImmutableOperationOutcome_Issue implements OperationOutcome_Issue {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code details}, {@code code}, {@code extension}, {@code severity}, {@code diagnostics}, {@code expression}, {@code modifierExtension}, {@code location}.
   ...
   *    .details(com.fhir.types.fhir.CodeableConcept) // optional {@link OperationOutcome_Issue#details() details}
   *    .code(Operationoutcome_IssueCode) // optional {@link OperationOutcome_Issue#code() code}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link OperationOutcome_Issue#extension() extension}
   *    .severity(Operationoutcome_IssueSeverity) // optional {@link OperationOutcome_Issue#severity() severity}
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link OperationOutcome_Issue#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DETAILS = 0x2L;
    ...
    public OperationOutcome_Issue build() {
      return new ImmutableOperationOutcome_Issue(id, details, code, extension, severity, diagnostics, expression, modifierExtension, location);
    }
