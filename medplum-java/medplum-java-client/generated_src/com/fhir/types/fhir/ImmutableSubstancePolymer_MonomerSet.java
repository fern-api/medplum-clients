...
final class ImmutableSubstancePolymer_MonomerSet
  ...
  public final ImmutableSubstancePolymer_MonomerSet withStartingMaterial(List<SubstancePolymer_StartingMaterial> value) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(newValue, this.modifierExtension, this.extension, this.ratioType, this.id);
  }
  ...
  public final ImmutableSubstancePolymer_MonomerSet withStartingMaterial(Optional<? extends List<SubstancePolymer_StartingMaterial>> optional) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(value, this.modifierExtension, this.extension, this.ratioType, this.id);
  }
  ...
  public final ImmutableSubstancePolymer_MonomerSet withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(this.startingMaterial, newValue, this.extension, this.ratioType, this.id);
  }
  ...
  public final ImmutableSubstancePolymer_MonomerSet withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(this.startingMaterial, value, this.extension, this.ratioType, this.id);
  }
  ...
  public final ImmutableSubstancePolymer_MonomerSet withExtension(List<Extension> value) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(this.startingMaterial, this.modifierExtension, newValue, this.ratioType, this.id);
  }
  ...
  public final ImmutableSubstancePolymer_MonomerSet withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(this.startingMaterial, this.modifierExtension, value, this.ratioType, this.id);
  }
  ...
  public final ImmutableSubstancePolymer_MonomerSet withRatioType(CodeableConcept value) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(this.startingMaterial, this.modifierExtension, this.extension, newValue, this.id);
  }
  ...
  public final ImmutableSubstancePolymer_MonomerSet withRatioType(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(this.startingMaterial, this.modifierExtension, this.extension, value, this.id);
  }
  ...
  public final ImmutableSubstancePolymer_MonomerSet withId(String value) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(this.startingMaterial, this.modifierExtension, this.extension, this.ratioType, newValue);
  }
  ...
  public final ImmutableSubstancePolymer_MonomerSet withId(Optional<String> optional) {
    ...
    return new ImmutableSubstancePolymer_MonomerSet(this.startingMaterial, this.modifierExtension, this.extension, this.ratioType, value);
  }
  ...
  private boolean equalTo(ImmutableSubstancePolymer_MonomerSet another) {
    return Objects.equals(startingMaterial, another.startingMaterial)
  ...
  /**
   * Computes a hash code from attributes: {@code startingMaterial}, {@code modifierExtension}, {@code extension}, {@code ratioType}, {@code id}.
   ...
   *    .startingMaterial(List&amp;lt;com.fhir.types.fhir.SubstancePolymer_StartingMaterial&amp;gt;) // optional {@link SubstancePolymer_MonomerSet#startingMaterial() startingMaterial}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_MonomerSet#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_MonomerSet#extension() extension}
   *    .ratioType(com.fhir.types.fhir.CodeableConcept) // optional {@link SubstancePolymer_MonomerSet#ratioType() ratioType}
  ...
  public static final class Builder {
    private static final long OPT_BIT_STARTING_MATERIAL = 0x1L;
    ...
    public SubstancePolymer_MonomerSet build() {
      return new ImmutableSubstancePolymer_MonomerSet(startingMaterial, modifierExtension, extension, ratioType, id);
    }
