...
final class ImmutableSubstanceAmount_ReferenceRange
    implements SubstanceAmount_ReferenceRange {
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(newValue, this.lowLimit, this.highLimit, this.id, this.extension);
  }
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(value, this.lowLimit, this.highLimit, this.id, this.extension);
  }
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withLowLimit(Quantity value) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(this.modifierExtension, newValue, this.highLimit, this.id, this.extension);
  }
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withLowLimit(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(this.modifierExtension, value, this.highLimit, this.id, this.extension);
  }
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withHighLimit(Quantity value) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(this.modifierExtension, this.lowLimit, newValue, this.id, this.extension);
  }
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withHighLimit(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(this.modifierExtension, this.lowLimit, value, this.id, this.extension);
  }
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withId(String value) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(this.modifierExtension, this.lowLimit, this.highLimit, newValue, this.extension);
  }
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withId(Optional<String> optional) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(this.modifierExtension, this.lowLimit, this.highLimit, value, this.extension);
  }
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withExtension(List<Extension> value) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(this.modifierExtension, this.lowLimit, this.highLimit, this.id, newValue);
  }
  ...
  public final ImmutableSubstanceAmount_ReferenceRange withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstanceAmount_ReferenceRange(this.modifierExtension, this.lowLimit, this.highLimit, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code lowLimit}, {@code highLimit}, {@code id}, {@code extension}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceAmount_ReferenceRange#modifierExtension() modifierExtension}
   *    .lowLimit(com.fhir.types.fhir.Quantity) // optional {@link SubstanceAmount_ReferenceRange#lowLimit() lowLimit}
   *    .highLimit(com.fhir.types.fhir.Quantity) // optional {@link SubstanceAmount_ReferenceRange#highLimit() highLimit}
   *    .id(String) // optional {@link SubstanceAmount_ReferenceRange#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceAmount_ReferenceRange#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_LOW_LIMIT = 0x2L;
    private static final long OPT_BIT_HIGH_LIMIT = 0x4L;
    ...
    public SubstanceAmount_ReferenceRange build() {
      return new ImmutableSubstanceAmount_ReferenceRange(modifierExtension, lowLimit, highLimit, id, extension);
    }
