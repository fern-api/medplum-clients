...
final class ImmutableBundle_Request implements Bundle_Request {
  ...
  /**
   * Computes a hash code from attributes: {@code method}, {@code ifNoneMatch}, {@code ifNoneExist}, {@code ifMatch}, {@code ifModifiedSince}, {@code url}, {@code modifierExtension}, {@code id}, {@code extension}.
   ...
   *    .method(Bundle_RequestMethod) // optional {@link Bundle_Request#method() method}
   ...
   *    .ifModifiedSince(com.fhir.types.fhir.Instant) // optional {@link Bundle_Request#ifModifiedSince() ifModifiedSince}
   *    .url(com.fhir.types.fhir.Uri) // optional {@link Bundle_Request#url() url}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Bundle_Request#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link Bundle_Request#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Bundle_Request#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_IF_NONE_MATCH = 0x2L;
    private static final long OPT_BIT_IF_NONE_EXIST = 0x4L;
    private static final long OPT_BIT_IF_MATCH = 0x8L;
    private static final long OPT_BIT_IF_MODIFIED_SINCE = 0x10L;
