...
final class ImmutableSupplyDelivery_SuppliedItem
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withItemCodeableConcept(CodeableConcept value) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(this.id, this.extension, newValue, this.quantity, this.itemReference, this.modifierExtension);
  }
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withItemCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(this.id, this.extension, value, this.quantity, this.itemReference, this.modifierExtension);
  }
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withItemReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(this.id, this.extension, this.itemCodeableConcept, this.quantity, value, this.modifierExtension);
  }
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(this.id, this.extension, this.itemCodeableConcept, this.quantity, this.itemReference, newValue);
  }
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(this.id, this.extension, this.itemCodeableConcept, this.quantity, this.itemReference, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code itemCodeableConcept}, {@code quantity}, {@code itemReference}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SupplyDelivery_SuppliedItem#extension() extension}
   *    .itemCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link SupplyDelivery_SuppliedItem#itemCodeableConcept() itemCodeableConcept}
   *    .quantity(com.fhir.types.fhir.Quantity) // optional {@link SupplyDelivery_SuppliedItem#quantity() quantity}
   *    .itemReference(com.fhir.types.fhir.Reference) // optional {@link SupplyDelivery_SuppliedItem#itemReference() itemReference}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SupplyDelivery_SuppliedItem#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public SupplyDelivery_SuppliedItem build() {
      return new ImmutableSupplyDelivery_SuppliedItem(id, extension, itemCodeableConcept, quantity, itemReference, modifierExtension);
    }
