...
final class ImmutableMessageHeader_Destination implements MessageHeader_Destination {
  ...
  public final ImmutableMessageHeader_Destination withExtension(List<Extension> value) {
    ...
    return new ImmutableMessageHeader_Destination(newValue, this.receiver, this.target, this.name, this.endpoint, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMessageHeader_Destination withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMessageHeader_Destination(value, this.receiver, this.target, this.name, this.endpoint, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMessageHeader_Destination withReceiver(Optional<? extends Reference> optional) {
    ...
    return new ImmutableMessageHeader_Destination(this.extension, value, this.target, this.name, this.endpoint, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMessageHeader_Destination withTarget(Optional<? extends Reference> optional) {
    ...
    return new ImmutableMessageHeader_Destination(this.extension, this.receiver, value, this.name, this.endpoint, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMessageHeader_Destination withEndpoint(Optional<? extends Url> optional) {
    ...
    return new ImmutableMessageHeader_Destination(this.extension, this.receiver, this.target, this.name, value, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMessageHeader_Destination withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMessageHeader_Destination(this.extension, this.receiver, this.target, this.name, this.endpoint, this.id, newValue);
  }
  ...
  public final ImmutableMessageHeader_Destination withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMessageHeader_Destination(this.extension, this.receiver, this.target, this.name, this.endpoint, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code receiver}, {@code target}, {@code name}, {@code endpoint}, {@code id}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MessageHeader_Destination#extension() extension}
   *    .receiver(com.fhir.types.fhir.Reference) // optional {@link MessageHeader_Destination#receiver() receiver}
   *    .target(com.fhir.types.fhir.Reference) // optional {@link MessageHeader_Destination#target() target}
   *    .name(String) // optional {@link MessageHeader_Destination#name() name}
   *    .endpoint(com.fhir.types.fhir.Url) // optional {@link MessageHeader_Destination#endpoint() endpoint}
   *    .id(String) // optional {@link MessageHeader_Destination#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MessageHeader_Destination#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public MessageHeader_Destination build() {
      return new ImmutableMessageHeader_Destination(extension, receiver, target, name, endpoint, id, modifierExtension);
    }
