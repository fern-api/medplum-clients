...
final class ImmutableMeasureReport_Population implements MeasureReport_Population {
  ...
  public final ImmutableMeasureReport_Population withCode(CodeableConcept value) {
    ...
    return new ImmutableMeasureReport_Population(newValue, this.id, this.extension, this.count, this.subjectResults, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withCode(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableMeasureReport_Population(value, this.id, this.extension, this.count, this.subjectResults, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withId(String value) {
    ...
    return new ImmutableMeasureReport_Population(this.code, newValue, this.extension, this.count, this.subjectResults, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withId(Optional<String> optional) {
    ...
    return new ImmutableMeasureReport_Population(this.code, value, this.extension, this.count, this.subjectResults, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Population(this.code, this.id, newValue, this.count, this.subjectResults, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Population(this.code, this.id, value, this.count, this.subjectResults, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withCount(int value) {
    ...
    return new ImmutableMeasureReport_Population(this.code, this.id, this.extension, newValue, this.subjectResults, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withCount(Optional<Integer> optional) {
    ...
    return new ImmutableMeasureReport_Population(this.code, this.id, this.extension, value, this.subjectResults, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withSubjectResults(Reference value) {
    ...
    return new ImmutableMeasureReport_Population(this.code, this.id, this.extension, this.count, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withSubjectResults(Optional<? extends Reference> optional) {
    ...
    return new ImmutableMeasureReport_Population(this.code, this.id, this.extension, this.count, value, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Population withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Population(this.code, this.id, this.extension, this.count, this.subjectResults, newValue);
  }
  ...
  public final ImmutableMeasureReport_Population withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Population(this.code, this.id, this.extension, this.count, this.subjectResults, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code code}, {@code id}, {@code extension}, {@code count}, {@code subjectResults}, {@code modifierExtension}.
   ...
   *    .code(com.fhir.types.fhir.CodeableConcept) // optional {@link MeasureReport_Population#code() code}
   *    .id(String) // optional {@link MeasureReport_Population#id() id}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Population#extension() extension}
   *    .count(Integer) // optional {@link MeasureReport_Population#count() count}
   *    .subjectResults(com.fhir.types.fhir.Reference) // optional {@link MeasureReport_Population#subjectResults() subjectResults}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Population#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SUBJECT_RESULTS = 0x10L;
    ...
    public MeasureReport_Population build() {
      return new ImmutableMeasureReport_Population(code, id, extension, count, subjectResults, modifierExtension);
    }
