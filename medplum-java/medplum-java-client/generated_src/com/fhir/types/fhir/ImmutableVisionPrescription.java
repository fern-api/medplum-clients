...
final class ImmutableVisionPrescription implements VisionPrescription {
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code meta}, {@code implicitRules}, {@code encounter}, {@code dateWritten}, {@code patient}, {@code prescriber}, {@code lensSpecification}, {@code language}, {@code extension}, {@code resourceType}, {@code contained}, {@code id}, {@code identifier}, {@code status}, {@code text}, {@code created}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link VisionPrescription#modifierExtension() modifierExtension}
   *    .meta(com.fhir.types.fhir.Meta) // optional {@link VisionPrescription#meta() meta}
   *    .implicitRules(com.fhir.types.fhir.Uri) // optional {@link VisionPrescription#implicitRules() implicitRules}
   *    .encounter(com.fhir.types.fhir.Reference) // optional {@link VisionPrescription#encounter() encounter}
   *    .dateWritten(com.fhir.types.fhir.DateTime) // optional {@link VisionPrescription#dateWritten() dateWritten}
   *    .patient(com.fhir.types.fhir.Reference) // required {@link VisionPrescription#patient() patient}
   *    .prescriber(com.fhir.types.fhir.Reference) // required {@link VisionPrescription#prescriber() prescriber}
   *    .addLensSpecification|addAllLensSpecification(com.fhir.types.fhir.VisionPrescription_LensSpecification) // {@link VisionPrescription#lensSpecification() lensSpecification} elements
   *    .language(com.fhir.types.fhir.Code) // optional {@link VisionPrescription#language() language}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link VisionPrescription#extension() extension}
   *    .resourceType(String) // required {@link VisionPrescription#resourceType() resourceType}
   *    .contained(List&amp;lt;com.fhir.types.fhir.ResourceList&amp;gt;) // optional {@link VisionPrescription#contained() contained}
   *    .id(com.fhir.types.fhir.Id) // optional {@link VisionPrescription#id() id}
   *    .identifier(List&amp;lt;com.fhir.types.fhir.Identifier&amp;gt;) // optional {@link VisionPrescription#identifier() identifier}
   *    .status(com.fhir.types.fhir.Code) // optional {@link VisionPrescription#status() status}
   *    .text(com.fhir.types.fhir.Narrative) // optional {@link VisionPrescription#text() text}
   *    .created(com.fhir.types.fhir.DateTime) // optional {@link VisionPrescription#created() created}
   *    .build();
   * </pre>
  ...
  @Generated(from = "VisionPrescription", generator = "Immutables")
  @NotThreadSafe
  public static final class Builder implements PatientBuildStage, PrescriberBuildStage, ResourceTypeBuildStage, BuildFinal {
    private static final long INIT_BIT_PATIENT = 0x1L;
    private static final long INIT_BIT_PRESCRIBER = 0x2L;
    ...
    private static final long OPT_BIT_DATE_WRITTEN = 0x10L;
  ...
  public interface PatientBuildStage {
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    PrescriberBuildStage patient(Reference patient);
  }
