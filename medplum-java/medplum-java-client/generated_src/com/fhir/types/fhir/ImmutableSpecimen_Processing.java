...
final class ImmutableSpecimen_Processing implements Specimen_Processing {
  ...
  private boolean equalTo(ImmutableSpecimen_Processing another) {
    return Objects.equals(timeDateTime, another.timeDateTime)
  ...
  /**
   * Computes a hash code from attributes: {@code timeDateTime}, {@code timePeriod}, {@code modifierExtension}, {@code extension}, {@code id}, {@code procedure}, {@code description}, {@code additive}.
   ...
   *    .timePeriod(com.fhir.types.fhir.Period) // optional {@link Specimen_Processing#timePeriod() timePeriod}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Specimen_Processing#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Specimen_Processing#extension() extension}
   *    .id(String) // optional {@link Specimen_Processing#id() id}
   *    .procedure(com.fhir.types.fhir.CodeableConcept) // optional {@link Specimen_Processing#procedure() procedure}
   *    .description(String) // optional {@link Specimen_Processing#description() description}
   *    .additive(List&amp;lt;com.fhir.types.fhir.Reference&amp;gt;) // optional {@link Specimen_Processing#additive() additive}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_TIME_DATE_TIME = 0x1L;
    private static final long OPT_BIT_TIME_PERIOD = 0x2L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x4L;
    private static final long OPT_BIT_EXTENSION = 0x8L;
    private static final long OPT_BIT_ID = 0x10L;
    private static final long OPT_BIT_PROCEDURE = 0x20L;
    ...
    public Specimen_Processing build() {
      return new ImmutableSpecimen_Processing(timeDateTime, timePeriod, modifierExtension, extension, id, procedure, description, additive);
    }
