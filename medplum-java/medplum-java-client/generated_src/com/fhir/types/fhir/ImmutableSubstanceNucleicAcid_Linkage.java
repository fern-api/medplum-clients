...
final class ImmutableSubstanceNucleicAcid_Linkage
  ...
  public final ImmutableSubstanceNucleicAcid_Linkage withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstanceNucleicAcid_Linkage(this.identifier, this.name, this.residueSite, this.connectivity, this.extension, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code identifier}, {@code name}, {@code residueSite}, {@code connectivity}, {@code extension}, {@code id}, {@code modifierExtension}.
   ...
   *    .identifier(com.fhir.types.fhir.Identifier) // optional {@link SubstanceNucleicAcid_Linkage#identifier() identifier}
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceNucleicAcid_Linkage#extension() extension}
   *    .id(String) // optional {@link SubstanceNucleicAcid_Linkage#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link SubstanceNucleicAcid_Linkage#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_RESIDUE_SITE = 0x4L;
    ...
    public SubstanceNucleicAcid_Linkage build() {
      return new ImmutableSubstanceNucleicAcid_Linkage(identifier, name, residueSite, connectivity, extension, id, modifierExtension);
    }
