...
final class ImmutableDocumentManifest_Related implements DocumentManifest_Related {
  ...
  public final ImmutableDocumentManifest_Related withId(String value) {
    ...
    return new ImmutableDocumentManifest_Related(newValue, this.modifierExtension, this.identifier, this.extension, this.ref);
  }
  ...
  public final ImmutableDocumentManifest_Related withId(Optional<String> optional) {
    ...
    return new ImmutableDocumentManifest_Related(value, this.modifierExtension, this.identifier, this.extension, this.ref);
  }
  ...
  public final ImmutableDocumentManifest_Related withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableDocumentManifest_Related(this.id, newValue, this.identifier, this.extension, this.ref);
  }
  ...
  public final ImmutableDocumentManifest_Related withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableDocumentManifest_Related(this.id, value, this.identifier, this.extension, this.ref);
  }
  ...
  public final ImmutableDocumentManifest_Related withIdentifier(Identifier value) {
    ...
    return new ImmutableDocumentManifest_Related(this.id, this.modifierExtension, newValue, this.extension, this.ref);
  }
  ...
  public final ImmutableDocumentManifest_Related withIdentifier(Optional<? extends Identifier> optional) {
    ...
    return new ImmutableDocumentManifest_Related(this.id, this.modifierExtension, value, this.extension, this.ref);
  }
  ...
  public final ImmutableDocumentManifest_Related withExtension(List<Extension> value) {
    ...
    return new ImmutableDocumentManifest_Related(this.id, this.modifierExtension, this.identifier, newValue, this.ref);
  }
  ...
  public final ImmutableDocumentManifest_Related withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableDocumentManifest_Related(this.id, this.modifierExtension, this.identifier, value, this.ref);
  }
  ...
  public final ImmutableDocumentManifest_Related withRef(Reference value) {
    ...
    return new ImmutableDocumentManifest_Related(this.id, this.modifierExtension, this.identifier, this.extension, newValue);
  }
  ...
  public final ImmutableDocumentManifest_Related withRef(Optional<? extends Reference> optional) {
    ...
    return new ImmutableDocumentManifest_Related(this.id, this.modifierExtension, this.identifier, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code identifier}, {@code extension}, {@code ref}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link DocumentManifest_Related#modifierExtension() modifierExtension}
   *    .identifier(com.fhir.types.fhir.Identifier) // optional {@link DocumentManifest_Related#identifier() identifier}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link DocumentManifest_Related#extension() extension}
   *    .ref(com.fhir.types.fhir.Reference) // optional {@link DocumentManifest_Related#ref() ref}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_REF = 0x10L;
    ...
    public DocumentManifest_Related build() {
      return new ImmutableDocumentManifest_Related(id, modifierExtension, identifier, extension, ref);
    }
