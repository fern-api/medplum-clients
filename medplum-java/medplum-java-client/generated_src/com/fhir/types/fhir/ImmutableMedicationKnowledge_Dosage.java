...
final class ImmutableMedicationKnowledge_Dosage
   ...
   *    .type(com.fhir.types.fhir.CodeableConcept) // required {@link MedicationKnowledge_Dosage#type() type}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Dosage#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Dosage#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link MedicationKnowledge_Dosage#id() id}
   *    .addDosage|addAllDosage(com.fhir.types.fhir.Dosage) // {@link MedicationKnowledge_Dosage#dosage() dosage} elements
   *    .build();
   * </pre>
