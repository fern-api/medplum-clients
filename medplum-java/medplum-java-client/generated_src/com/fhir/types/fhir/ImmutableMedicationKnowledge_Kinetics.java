...
final class ImmutableMedicationKnowledge_Kinetics
  ...
  public final ImmutableMedicationKnowledge_Kinetics withAreaUnderCurve(Optional<? extends List<Quantity>> optional) {
    ...
    return new ImmutableMedicationKnowledge_Kinetics(this.extension, this.id, value, this.halfLifePeriod, this.lethalDose50, this.modifierExtension);
  }
  ...
  public final ImmutableMedicationKnowledge_Kinetics withHalfLifePeriod(Optional<? extends Duration> optional) {
    ...
    return new ImmutableMedicationKnowledge_Kinetics(this.extension, this.id, this.areaUnderCurve, value, this.lethalDose50, this.modifierExtension);
  }
  ...
  public final ImmutableMedicationKnowledge_Kinetics withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationKnowledge_Kinetics(this.extension, this.id, this.areaUnderCurve, this.halfLifePeriod, this.lethalDose50, newValue);
  }
  ...
  public final ImmutableMedicationKnowledge_Kinetics withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationKnowledge_Kinetics(this.extension, this.id, this.areaUnderCurve, this.halfLifePeriod, this.lethalDose50, value);
  }
  ...
  private boolean equalTo(ImmutableMedicationKnowledge_Kinetics another) {
    return Objects.equals(extension, another.extension)
        ...
        && Objects.equals(areaUnderCurve, another.areaUnderCurve)
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code id}, {@code areaUnderCurve}, {@code halfLifePeriod}, {@code lethalDose50}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Kinetics#extension() extension}
   *    .id(String) // optional {@link MedicationKnowledge_Kinetics#id() id}
   *    .areaUnderCurve(List&amp;lt;com.fhir.types.fhir.Quantity&amp;gt;) // optional {@link MedicationKnowledge_Kinetics#areaUnderCurve() areaUnderCurve}
   *    .halfLifePeriod(com.fhir.types.fhir.Duration) // optional {@link MedicationKnowledge_Kinetics#halfLifePeriod() halfLifePeriod}
   *    .lethalDose50(List&amp;lt;com.fhir.types.fhir.Quantity&amp;gt;) // optional {@link MedicationKnowledge_Kinetics#lethalDose50() lethalDose50}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Kinetics#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_AREA_UNDER_CURVE = 0x4L;
    private static final long OPT_BIT_HALF_LIFE_PERIOD = 0x8L;
    private static final long OPT_BIT_LETHAL_DOSE50 = 0x10L;
    ...
    public MedicationKnowledge_Kinetics build() {
      return new ImmutableMedicationKnowledge_Kinetics(extension, id, areaUnderCurve, halfLifePeriod, lethalDose50, modifierExtension);
    }
