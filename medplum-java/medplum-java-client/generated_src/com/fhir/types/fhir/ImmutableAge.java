...
final class ImmutableAge implements Age {
  ...
  public final ImmutableAge withId(String value) {
    ...
    return new ImmutableAge(newValue, this.value, this.unit, this.extension, this.comparator, this.system, this.code);
  }
  ...
  public final ImmutableAge withId(Optional<String> optional) {
    ...
    return new ImmutableAge(value, this.value, this.unit, this.extension, this.comparator, this.system, this.code);
  }
  ...
  public final ImmutableAge withValue(Decimal value) {
    ...
    return new ImmutableAge(this.id, newValue, this.unit, this.extension, this.comparator, this.system, this.code);
  }
  ...
  public final ImmutableAge withValue(Optional<? extends Decimal> optional) {
    ...
    return new ImmutableAge(this.id, value, this.unit, this.extension, this.comparator, this.system, this.code);
  }
  ...
  public final ImmutableAge withUnit(String value) {
    ...
    return new ImmutableAge(this.id, this.value, newValue, this.extension, this.comparator, this.system, this.code);
  }
  ...
  public final ImmutableAge withUnit(Optional<String> optional) {
    ...
    return new ImmutableAge(this.id, this.value, value, this.extension, this.comparator, this.system, this.code);
  }
  ...
  public final ImmutableAge withExtension(List<Extension> value) {
    ...
    return new ImmutableAge(this.id, this.value, this.unit, newValue, this.comparator, this.system, this.code);
  }
  ...
  public final ImmutableAge withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableAge(this.id, this.value, this.unit, value, this.comparator, this.system, this.code);
  }
  ...
  public final ImmutableAge withComparator(AgeComparator value) {
    ...
    return new ImmutableAge(this.id, this.value, this.unit, this.extension, newValue, this.system, this.code);
  }
  ...
  public final ImmutableAge withComparator(Optional<? extends AgeComparator> optional) {
    ...
    return new ImmutableAge(this.id, this.value, this.unit, this.extension, value, this.system, this.code);
  }
  ...
  public final ImmutableAge withSystem(Uri value) {
    ...
    return new ImmutableAge(this.id, this.value, this.unit, this.extension, this.comparator, newValue, this.code);
  }
  ...
  public final ImmutableAge withSystem(Optional<? extends Uri> optional) {
    ...
    return new ImmutableAge(this.id, this.value, this.unit, this.extension, this.comparator, value, this.code);
  }
  ...
  public final ImmutableAge withCode(Code value) {
    ...
    return new ImmutableAge(this.id, this.value, this.unit, this.extension, this.comparator, this.system, newValue);
  }
  ...
  public final ImmutableAge withCode(Optional<? extends Code> optional) {
    ...
    return new ImmutableAge(this.id, this.value, this.unit, this.extension, this.comparator, this.system, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code value}, {@code unit}, {@code extension}, {@code comparator}, {@code system}, {@code code}.
   ...
   *    .value(com.fhir.types.fhir.Decimal) // optional {@link Age#value() value}
   *    .unit(String) // optional {@link Age#unit() unit}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Age#extension() extension}
   *    .comparator(com.fhir.types.fhir.AgeComparator) // optional {@link Age#comparator() comparator}
   *    .system(com.fhir.types.fhir.Uri) // optional {@link Age#system() system}
   *    .code(com.fhir.types.fhir.Code) // optional {@link Age#code() code}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
     ...
     */
    public Age build() {
      return new ImmutableAge(id, value, unit, extension, comparator, system, code);
    }
