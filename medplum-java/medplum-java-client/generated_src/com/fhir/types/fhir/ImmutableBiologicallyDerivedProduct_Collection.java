...
final class ImmutableBiologicallyDerivedProduct_Collection
  ...
  /**
   * Computes a hash code from attributes: {@code collector}, {@code extension}, {@code collectedPeriod}, {@code id}, {@code modifierExtension}, {@code collectedDateTime}, {@code source}.
   ...
   *    .collector(com.fhir.types.fhir.Reference) // optional {@link BiologicallyDerivedProduct_Collection#collector() collector}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link BiologicallyDerivedProduct_Collection#extension() extension}
   *    .collectedPeriod(com.fhir.types.fhir.Period) // optional {@link BiologicallyDerivedProduct_Collection#collectedPeriod() collectedPeriod}
   *    .id(String) // optional {@link BiologicallyDerivedProduct_Collection#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link BiologicallyDerivedProduct_Collection#modifierExtension() modifierExtension}
   *    .collectedDateTime(String) // optional {@link BiologicallyDerivedProduct_Collection#collectedDateTime() collectedDateTime}
   *    .source(com.fhir.types.fhir.Reference) // optional {@link BiologicallyDerivedProduct_Collection#source() source}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public BiologicallyDerivedProduct_Collection build() {
      return new ImmutableBiologicallyDerivedProduct_Collection(collector, extension, collectedPeriod, id, modifierExtension, collectedDateTime, source);
    }
