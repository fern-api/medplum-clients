...
final class ImmutableMedicinalProductInteraction_Interactant
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withItemCodeableConcept(CodeableConcept value) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(newValue, this.itemReference, this.extension, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withItemCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(value, this.itemReference, this.extension, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withItemReference(Reference value) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(this.itemCodeableConcept, newValue, this.extension, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withItemReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(this.itemCodeableConcept, value, this.extension, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withExtension(List<Extension> value) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(this.itemCodeableConcept, this.itemReference, newValue, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(this.itemCodeableConcept, this.itemReference, value, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withId(String value) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(this.itemCodeableConcept, this.itemReference, this.extension, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withId(Optional<String> optional) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(this.itemCodeableConcept, this.itemReference, this.extension, value, this.modifierExtension);
  }
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(this.itemCodeableConcept, this.itemReference, this.extension, this.id, newValue);
  }
  ...
  public final ImmutableMedicinalProductInteraction_Interactant withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicinalProductInteraction_Interactant(this.itemCodeableConcept, this.itemReference, this.extension, this.id, value);
  }
  ...
  private boolean equalTo(ImmutableMedicinalProductInteraction_Interactant another) {
    return Objects.equals(itemCodeableConcept, another.itemCodeableConcept)
  ...
  /**
   * Computes a hash code from attributes: {@code itemCodeableConcept}, {@code itemReference}, {@code extension}, {@code id}, {@code modifierExtension}.
   ...
   *    .itemCodeableConcept(com.fhir.types.fhir.CodeableConcept) // optional {@link MedicinalProductInteraction_Interactant#itemCodeableConcept() itemCodeableConcept}
   *    .itemReference(com.fhir.types.fhir.Reference) // optional {@link MedicinalProductInteraction_Interactant#itemReference() itemReference}
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicinalProductInteraction_Interactant#extension() extension}
   *    .id(String) // optional {@link MedicinalProductInteraction_Interactant#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link MedicinalProductInteraction_Interactant#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_ITEM_CODEABLE_CONCEPT = 0x1L;
    ...
    public MedicinalProductInteraction_Interactant build() {
      return new ImmutableMedicinalProductInteraction_Interactant(itemCodeableConcept, itemReference, extension, id, modifierExtension);
    }
