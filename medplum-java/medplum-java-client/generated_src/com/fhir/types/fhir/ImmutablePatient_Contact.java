...
final class ImmutablePatient_Contact implements Patient_Contact {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code modifierExtension}, {@code organization}, {@code id}, {@code address}, {@code gender}, {@code telecom}, {@code period}, {@code name}, {@code relationship}.
   ...
   *    .extension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Patient_Contact#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.types.fhir.Extension&amp;gt;) // optional {@link Patient_Contact#modifierExtension() modifierExtension}
   *    .organization(com.fhir.types.fhir.Reference) // optional {@link Patient_Contact#organization() organization}
   *    .id(String) // optional {@link Patient_Contact#id() id}
   *    .address(com.fhir.types.fhir.Address) // optional {@link Patient_Contact#address() address}
   *    .gender(Patient_ContactGender) // optional {@link Patient_Contact#gender() gender}
   *    .telecom(List&amp;lt;com.fhir.types.fhir.ContactPoint&amp;gt;) // optional {@link Patient_Contact#telecom() telecom}
   *    .period(com.fhir.types.fhir.Period) // optional {@link Patient_Contact#period() period}
   *    .name(com.fhir.types.fhir.HumanName) // optional {@link Patient_Contact#name() name}
   *    .relationship(List&amp;lt;com.fhir.types.fhir.CodeableConcept&amp;gt;) // optional {@link Patient_Contact#relationship() relationship}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_TELECOM = 0x40L;
