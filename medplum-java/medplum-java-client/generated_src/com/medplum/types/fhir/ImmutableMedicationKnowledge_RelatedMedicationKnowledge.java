...
final class ImmutableMedicationKnowledge_RelatedMedicationKnowledge
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withReference(Reference... elements) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(newValue, this.extension, this.id, this.modifierExtension, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.reference, newValue, this.id, this.modifierExtension, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.reference, value, this.id, this.modifierExtension, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withId(String value) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.reference, this.extension, newValue, this.modifierExtension, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withId(Optional<String> optional) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.reference, this.extension, value, this.modifierExtension, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.reference, this.extension, this.id, newValue, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.reference, this.extension, this.id, value, this.type);
  }
  ...
  public final ImmutableMedicationKnowledge_RelatedMedicationKnowledge withType(CodeableConcept value) {
    ...
    return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(this.reference, this.extension, this.id, this.modifierExtension, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code reference}, {@code extension}, {@code id}, {@code modifierExtension}, {@code type}.
   ...
   *    .addReference|addAllReference(com.medplum.types.fhir.Reference) // {@link MedicationKnowledge_RelatedMedicationKnowledge#reference() reference} elements
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_RelatedMedicationKnowledge#extension() extension}
   *    .id(String) // optional {@link MedicationKnowledge_RelatedMedicationKnowledge#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_RelatedMedicationKnowledge#modifierExtension() modifierExtension}
   *    .type(com.medplum.types.fhir.CodeableConcept) // required {@link MedicationKnowledge_RelatedMedicationKnowledge#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements TypeBuildStage, BuildFinal {
    ...
    public MedicationKnowledge_RelatedMedicationKnowledge build() {
      ...
      return new ImmutableMedicationKnowledge_RelatedMedicationKnowledge(createUnmodifiableList(true, reference), extension, id, modifierExtension, type);
    }
