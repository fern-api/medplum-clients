 ...
 */
@Generated(from = "Uuid", generator = "Immutables")
@SuppressWarnings({"all"})
@SuppressFBWarnings
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@Immutable
final class ImmutableUuid implements Uuid {
  private final String value;

  private ImmutableUuid(String value) {
    this.value = value;
  }
   ...
   */
  public final ImmutableUuid withValue(String value) {
  ...
  static ImmutableUuid fromJson(String jsonValue) {
  ...
  public static final class Builder implements ValueBuildStage, BuildFinal {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new IllegalStateException("Builder of Uuid is strict, attribute is already set: ".concat(name));
    }
