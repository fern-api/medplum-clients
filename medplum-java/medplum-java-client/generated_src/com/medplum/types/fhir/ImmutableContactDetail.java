...
final class ImmutableContactDetail implements ContactDetail {
  ...
  public final ImmutableContactDetail withName(String value) {
    ...
    return new ImmutableContactDetail(newValue, this.telecom, this.id, this.extension);
  }
  ...
  public final ImmutableContactDetail withName(Optional<String> optional) {
    ...
    return new ImmutableContactDetail(value, this.telecom, this.id, this.extension);
  }
  ...
  public final ImmutableContactDetail withTelecom(List<ContactPoint> value) {
    ...
    return new ImmutableContactDetail(this.name, newValue, this.id, this.extension);
  }
  ...
  public final ImmutableContactDetail withTelecom(Optional<? extends List<ContactPoint>> optional) {
    ...
    return new ImmutableContactDetail(this.name, value, this.id, this.extension);
  }
  ...
  public final ImmutableContactDetail withId(String value) {
    ...
    return new ImmutableContactDetail(this.name, this.telecom, newValue, this.extension);
  }
  ...
  public final ImmutableContactDetail withId(Optional<String> optional) {
    ...
    return new ImmutableContactDetail(this.name, this.telecom, value, this.extension);
  }
  ...
  public final ImmutableContactDetail withExtension(List<Extension> value) {
    ...
    return new ImmutableContactDetail(this.name, this.telecom, this.id, newValue);
  }
  ...
  public final ImmutableContactDetail withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableContactDetail(this.name, this.telecom, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code name}, {@code telecom}, {@code id}, {@code extension}.
   ...
   *    .telecom(List&amp;lt;com.medplum.types.fhir.ContactPoint&amp;gt;) // optional {@link ContactDetail#telecom() telecom}
   *    .id(String) // optional {@link ContactDetail#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ContactDetail#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public ContactDetail build() {
      return new ImmutableContactDetail(name, telecom, id, extension);
    }
