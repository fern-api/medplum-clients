 ...
 */
@Generated(from = "DateTime", generator = "Immutables")
@SuppressWarnings({"all"})
@SuppressFBWarnings
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@Immutable
final class ImmutableDateTime implements DateTime {
  private final String value;

  private ImmutableDateTime(String value) {
    this.value = value;
  }
   ...
   */
  public final ImmutableDateTime withValue(String value) {
  ...
  static ImmutableDateTime fromJson(String jsonValue) {
  ...
  public static final class Builder implements ValueBuildStage, BuildFinal {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new IllegalStateException("Builder of DateTime is strict, attribute is already set: ".concat(name));
    }
