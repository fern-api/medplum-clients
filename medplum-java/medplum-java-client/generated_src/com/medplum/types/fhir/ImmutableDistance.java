...
final class ImmutableDistance implements Distance {
  ...
  public final ImmutableDistance withSystem(Uri value) {
    ...
    return new ImmutableDistance(newValue, this.code, this.comparator, this.unit, this.id, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withSystem(Optional<? extends Uri> optional) {
    ...
    return new ImmutableDistance(value, this.code, this.comparator, this.unit, this.id, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withCode(Code value) {
    ...
    return new ImmutableDistance(this.system, newValue, this.comparator, this.unit, this.id, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withCode(Optional<? extends Code> optional) {
    ...
    return new ImmutableDistance(this.system, value, this.comparator, this.unit, this.id, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withComparator(DistanceComparator value) {
    ...
    return new ImmutableDistance(this.system, this.code, newValue, this.unit, this.id, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withComparator(Optional<? extends DistanceComparator> optional) {
    ...
    return new ImmutableDistance(this.system, this.code, value, this.unit, this.id, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withUnit(String value) {
    ...
    return new ImmutableDistance(this.system, this.code, this.comparator, newValue, this.id, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withUnit(Optional<String> optional) {
    ...
    return new ImmutableDistance(this.system, this.code, this.comparator, value, this.id, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withId(String value) {
    ...
    return new ImmutableDistance(this.system, this.code, this.comparator, this.unit, newValue, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withId(Optional<String> optional) {
    ...
    return new ImmutableDistance(this.system, this.code, this.comparator, this.unit, value, this.extension, this.value);
  }
  ...
  public final ImmutableDistance withExtension(List<Extension> value) {
    ...
    return new ImmutableDistance(this.system, this.code, this.comparator, this.unit, this.id, newValue, this.value);
  }
  ...
  public final ImmutableDistance withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableDistance(this.system, this.code, this.comparator, this.unit, this.id, value, this.value);
  }
  ...
  public final ImmutableDistance withValue(Decimal value) {
    ...
    return new ImmutableDistance(this.system, this.code, this.comparator, this.unit, this.id, this.extension, newValue);
  }
  ...
  public final ImmutableDistance withValue(Optional<? extends Decimal> optional) {
    ...
    return new ImmutableDistance(this.system, this.code, this.comparator, this.unit, this.id, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code system}, {@code code}, {@code comparator}, {@code unit}, {@code id}, {@code extension}, {@code value}.
   ...
   *    .system(com.medplum.types.fhir.Uri) // optional {@link Distance#system() system}
   *    .code(com.medplum.types.fhir.Code) // optional {@link Distance#code() code}
   *    .comparator(com.medplum.types.fhir.DistanceComparator) // optional {@link Distance#comparator() comparator}
   *    .unit(String) // optional {@link Distance#unit() unit}
   *    .id(String) // optional {@link Distance#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Distance#extension() extension}
   *    .value(com.medplum.types.fhir.Decimal) // optional {@link Distance#value() value}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Distance build() {
      return new ImmutableDistance(system, code, comparator, unit, id, extension, value);
    }
