...
final class ImmutableAppointment_Participant implements Appointment_Participant {
  ...
  public final ImmutableAppointment_Participant withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableAppointment_Participant(this.actor, value, this.period, this.id, this.extension, this.status, this.required, this.type);
  }
  ...
  private boolean equalTo(ImmutableAppointment_Participant another) {
    return Objects.equals(actor, another.actor)
  ...
  /**
   * Computes a hash code from attributes: {@code actor}, {@code modifierExtension}, {@code period}, {@code id}, {@code extension}, {@code status}, {@code required}, {@code type}.
   ...
   *    .actor(com.medplum.types.fhir.Reference) // optional {@link Appointment_Participant#actor() actor}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Appointment_Participant#modifierExtension() modifierExtension}
   *    .period(com.medplum.types.fhir.Period) // optional {@link Appointment_Participant#period() period}
   *    .id(String) // optional {@link Appointment_Participant#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Appointment_Participant#extension() extension}
   *    .status(com.medplum.types.fhir.Appointment_participantStatus) // optional {@link Appointment_Participant#status() status}
   *    .required(com.medplum.types.fhir.Appointment_participantRequired) // optional {@link Appointment_Participant#required() required}
   *    .type(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link Appointment_Participant#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Appointment_Participant build() {
      return new ImmutableAppointment_Participant(actor, modifierExtension, period, id, extension, status, required, type);
    }
