...
final class ImmutableEffectEvidenceSynthesis_SampleSize
  ...
  public final ImmutableEffectEvidenceSynthesis_SampleSize withNumberOfParticipants(Optional<Integer> optional) {
    ...
    return new ImmutableEffectEvidenceSynthesis_SampleSize(this.id, this.extension, this.modifierExtension, this.description, value, this.numberOfStudies);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code modifierExtension}, {@code description}, {@code numberOfParticipants}, {@code numberOfStudies}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link EffectEvidenceSynthesis_SampleSize#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link EffectEvidenceSynthesis_SampleSize#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_NUMBER_OF_PARTICIPANTS = 0x10L;
    private static final long OPT_BIT_NUMBER_OF_STUDIES = 0x20L;
    ...
    public EffectEvidenceSynthesis_SampleSize build() {
      return new ImmutableEffectEvidenceSynthesis_SampleSize(id, extension, modifierExtension, description, numberOfParticipants, numberOfStudies);
    }
