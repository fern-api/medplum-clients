...
final class ImmutableDataRequirement_DateFilter
  ...
  /**
   * Computes a hash code from attributes: {@code valuePeriod}, {@code valueDateTime}, {@code valueDuration}, {@code searchParam}, {@code extension}, {@code path}, {@code id}, {@code modifierExtension}.
   ...
   *    .valuePeriod(com.medplum.types.fhir.Period) // optional {@link DataRequirement_DateFilter#valuePeriod() valuePeriod}
   *    .valueDateTime(String) // optional {@link DataRequirement_DateFilter#valueDateTime() valueDateTime}
   *    .valueDuration(com.medplum.types.fhir.Duration) // optional {@link DataRequirement_DateFilter#valueDuration() valueDuration}
   *    .searchParam(String) // optional {@link DataRequirement_DateFilter#searchParam() searchParam}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link DataRequirement_DateFilter#extension() extension}
   *    .path(String) // optional {@link DataRequirement_DateFilter#path() path}
   *    .id(String) // optional {@link DataRequirement_DateFilter#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link DataRequirement_DateFilter#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
