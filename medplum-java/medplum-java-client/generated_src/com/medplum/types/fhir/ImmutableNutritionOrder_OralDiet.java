...
final class ImmutableNutritionOrder_OralDiet implements NutritionOrder_OralDiet {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code instruction}, {@code id}, {@code texture}, {@code fluidConsistencyType}, {@code schedule}, {@code type}, {@code modifierExtension}, {@code nutrient}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_OralDiet#extension() extension}
   ...
   *    .texture(List&amp;lt;com.medplum.types.fhir.NutritionOrder_Texture&amp;gt;) // optional {@link NutritionOrder_OralDiet#texture() texture}
   *    .fluidConsistencyType(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link NutritionOrder_OralDiet#fluidConsistencyType() fluidConsistencyType}
   *    .schedule(List&amp;lt;com.medplum.types.fhir.Timing&amp;gt;) // optional {@link NutritionOrder_OralDiet#schedule() schedule}
   *    .type(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link NutritionOrder_OralDiet#type() type}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_OralDiet#modifierExtension() modifierExtension}
   *    .nutrient(List&amp;lt;com.medplum.types.fhir.NutritionOrder_Nutrient&amp;gt;) // optional {@link NutritionOrder_OralDiet#nutrient() nutrient}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_TEXTURE = 0x8L;
    private static final long OPT_BIT_FLUID_CONSISTENCY_TYPE = 0x10L;
    ...
    private static final long OPT_BIT_NUTRIENT = 0x100L;
