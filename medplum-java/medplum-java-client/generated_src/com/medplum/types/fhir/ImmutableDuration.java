...
final class ImmutableDuration implements Duration {
  ...
  public final ImmutableDuration withExtension(List<Extension> value) {
    ...
    return new ImmutableDuration(newValue, this.value, this.code, this.system, this.comparator, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableDuration(value, this.value, this.code, this.system, this.comparator, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withValue(Decimal value) {
    ...
    return new ImmutableDuration(this.extension, newValue, this.code, this.system, this.comparator, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withValue(Optional<? extends Decimal> optional) {
    ...
    return new ImmutableDuration(this.extension, value, this.code, this.system, this.comparator, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withCode(Code value) {
    ...
    return new ImmutableDuration(this.extension, this.value, newValue, this.system, this.comparator, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withCode(Optional<? extends Code> optional) {
    ...
    return new ImmutableDuration(this.extension, this.value, value, this.system, this.comparator, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withSystem(Uri value) {
    ...
    return new ImmutableDuration(this.extension, this.value, this.code, newValue, this.comparator, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withSystem(Optional<? extends Uri> optional) {
    ...
    return new ImmutableDuration(this.extension, this.value, this.code, value, this.comparator, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withComparator(DurationComparator value) {
    ...
    return new ImmutableDuration(this.extension, this.value, this.code, this.system, newValue, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withComparator(Optional<? extends DurationComparator> optional) {
    ...
    return new ImmutableDuration(this.extension, this.value, this.code, this.system, value, this.unit, this.id);
  }
  ...
  public final ImmutableDuration withUnit(String value) {
    ...
    return new ImmutableDuration(this.extension, this.value, this.code, this.system, this.comparator, newValue, this.id);
  }
  ...
  public final ImmutableDuration withUnit(Optional<String> optional) {
    ...
    return new ImmutableDuration(this.extension, this.value, this.code, this.system, this.comparator, value, this.id);
  }
  ...
  public final ImmutableDuration withId(String value) {
    ...
    return new ImmutableDuration(this.extension, this.value, this.code, this.system, this.comparator, this.unit, newValue);
  }
  ...
  public final ImmutableDuration withId(Optional<String> optional) {
    ...
    return new ImmutableDuration(this.extension, this.value, this.code, this.system, this.comparator, this.unit, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code value}, {@code code}, {@code system}, {@code comparator}, {@code unit}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Duration#extension() extension}
   *    .value(com.medplum.types.fhir.Decimal) // optional {@link Duration#value() value}
   *    .code(com.medplum.types.fhir.Code) // optional {@link Duration#code() code}
   *    .system(com.medplum.types.fhir.Uri) // optional {@link Duration#system() system}
   *    .comparator(com.medplum.types.fhir.DurationComparator) // optional {@link Duration#comparator() comparator}
  ...
  public static final class Builder {
    ...
    public Duration build() {
      return new ImmutableDuration(extension, value, code, system, comparator, unit, id);
    }
