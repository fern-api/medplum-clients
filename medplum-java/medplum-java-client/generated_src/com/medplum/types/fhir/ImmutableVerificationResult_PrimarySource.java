...
final class ImmutableVerificationResult_PrimarySource
  ...
  private boolean equalTo(ImmutableVerificationResult_PrimarySource another) {
    return Objects.equals(canPushUpdates, another.canPushUpdates)
  ...
  /**
   * Computes a hash code from attributes: {@code canPushUpdates}, {@code who}, {@code validationDate}, {@code id}, {@code extension}, {@code validationStatus}, {@code communicationMethod}, {@code type}, {@code pushTypeAvailable}, {@code modifierExtension}.
   ...
   *    .canPushUpdates(com.medplum.types.fhir.CodeableConcept) // optional {@link VerificationResult_PrimarySource#canPushUpdates() canPushUpdates}
   *    .who(com.medplum.types.fhir.Reference) // optional {@link VerificationResult_PrimarySource#who() who}
   *    .validationDate(com.medplum.types.fhir.DateTime) // optional {@link VerificationResult_PrimarySource#validationDate() validationDate}
   *    .id(String) // optional {@link VerificationResult_PrimarySource#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link VerificationResult_PrimarySource#extension() extension}
   *    .validationStatus(com.medplum.types.fhir.CodeableConcept) // optional {@link VerificationResult_PrimarySource#validationStatus() validationStatus}
   *    .communicationMethod(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link VerificationResult_PrimarySource#communicationMethod() communicationMethod}
   *    .type(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link VerificationResult_PrimarySource#type() type}
   *    .pushTypeAvailable(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link VerificationResult_PrimarySource#pushTypeAvailable() pushTypeAvailable}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link VerificationResult_PrimarySource#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_CAN_PUSH_UPDATES = 0x1L;
    private static final long OPT_BIT_WHO = 0x2L;
    private static final long OPT_BIT_VALIDATION_DATE = 0x4L;
    private static final long OPT_BIT_ID = 0x8L;
    private static final long OPT_BIT_EXTENSION = 0x10L;
    private static final long OPT_BIT_VALIDATION_STATUS = 0x20L;
    private static final long OPT_BIT_COMMUNICATION_METHOD = 0x40L;
    private static final long OPT_BIT_TYPE = 0x80L;
    private static final long OPT_BIT_PUSH_TYPE_AVAILABLE = 0x100L;
