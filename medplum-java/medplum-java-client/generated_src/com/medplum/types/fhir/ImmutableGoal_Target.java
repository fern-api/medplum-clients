...
final class ImmutableGoal_Target implements Goal_Target {
  ...
  private boolean equalTo(ImmutableGoal_Target another) {
    return Objects.equals(detailRatio, another.detailRatio)
  ...
  /**
   * Computes a hash code from attributes: {@code detailRatio}, {@code detailCodeableConcept}, {@code extension}, {@code detailRange}, {@code detailString}, {@code detailQuantity}, {@code dueDate}, {@code dueDuration}, {@code measure}, {@code detailInteger}, {@code detailBoolean}, {@code modifierExtension}, {@code id}.
   ...
   *    .detailRatio(com.medplum.types.fhir.Ratio) // optional {@link Goal_Target#detailRatio() detailRatio}
   *    .detailCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link Goal_Target#detailCodeableConcept() detailCodeableConcept}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Goal_Target#extension() extension}
   *    .detailRange(com.medplum.types.fhir.Range) // optional {@link Goal_Target#detailRange() detailRange}
   *    .detailString(String) // optional {@link Goal_Target#detailString() detailString}
   *    .detailQuantity(com.medplum.types.fhir.Quantity) // optional {@link Goal_Target#detailQuantity() detailQuantity}
   *    .dueDate(String) // optional {@link Goal_Target#dueDate() dueDate}
   *    .dueDuration(com.medplum.types.fhir.Duration) // optional {@link Goal_Target#dueDuration() dueDuration}
   *    .measure(com.medplum.types.fhir.CodeableConcept) // optional {@link Goal_Target#measure() measure}
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Goal_Target#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    private static final long OPT_BIT_DETAIL_RATIO = 0x1L;
    private static final long OPT_BIT_DETAIL_CODEABLE_CONCEPT = 0x2L;
    private static final long OPT_BIT_EXTENSION = 0x4L;
    private static final long OPT_BIT_DETAIL_RANGE = 0x8L;
    private static final long OPT_BIT_DETAIL_STRING = 0x10L;
    private static final long OPT_BIT_DETAIL_QUANTITY = 0x20L;
    private static final long OPT_BIT_DUE_DATE = 0x40L;
    private static final long OPT_BIT_DUE_DURATION = 0x80L;
    private static final long OPT_BIT_MEASURE = 0x100L;
    private static final long OPT_BIT_DETAIL_INTEGER = 0x200L;
    private static final long OPT_BIT_DETAIL_BOOLEAN = 0x400L;
