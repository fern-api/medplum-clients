...
final class ImmutableSpecimenDefinition_Handling
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code extension}, {@code temperatureQualifier}, {@code maxDuration}, {@code instruction}, {@code temperatureRange}, {@code id}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_Handling#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_Handling#extension() extension}
   *    .temperatureQualifier(com.medplum.types.fhir.CodeableConcept) // optional {@link SpecimenDefinition_Handling#temperatureQualifier() temperatureQualifier}
   *    .maxDuration(com.medplum.types.fhir.Duration) // optional {@link SpecimenDefinition_Handling#maxDuration() maxDuration}
   *    .instruction(String) // optional {@link SpecimenDefinition_Handling#instruction() instruction}
   *    .temperatureRange(com.medplum.types.fhir.Range) // optional {@link SpecimenDefinition_Handling#temperatureRange() temperatureRange}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_TEMPERATURE_QUALIFIER = 0x4L;
    private static final long OPT_BIT_MAX_DURATION = 0x8L;
    private static final long OPT_BIT_INSTRUCTION = 0x10L;
    private static final long OPT_BIT_TEMPERATURE_RANGE = 0x20L;
