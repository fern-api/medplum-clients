...
final class ImmutableDocumentReference implements DocumentReference {
  ...
  private boolean equalTo(ImmutableDocumentReference another) {
    return Objects.equals(relatesTo, another.relatesTo)
  ...
  /**
   * Computes a hash code from attributes: {@code relatesTo}, {@code type}, {@code id}, {@code implicitRules}, {@code docStatus}, {@code description}, {@code status}, {@code date}, {@code securityLabel}, {@code language}, {@code resourceType}, {@code text}, {@code masterIdentifier}, {@code authenticator}, {@code author}, {@code modifierExtension}, {@code context}, {@code subject}, {@code content}, {@code category}, {@code identifier}, {@code contained}, {@code custodian}, {@code extension}, {@code meta}.
   ...
   *    .relatesTo(List&amp;lt;com.medplum.types.fhir.DocumentReference_RelatesTo&amp;gt;) // optional {@link DocumentReference#relatesTo() relatesTo}
   *    .type(com.medplum.types.fhir.CodeableConcept) // optional {@link DocumentReference#type() type}
   *    .id(com.medplum.types.fhir.Id) // optional {@link DocumentReference#id() id}
   *    .implicitRules(com.medplum.types.fhir.Uri) // optional {@link DocumentReference#implicitRules() implicitRules}
   *    .docStatus(com.medplum.types.fhir.Code) // optional {@link DocumentReference#docStatus() docStatus}
   *    .description(String) // optional {@link DocumentReference#description() description}
   *    .status(com.medplum.types.fhir.DocumentreferenceStatus) // optional {@link DocumentReference#status() status}
   *    .date(com.medplum.types.fhir.Instant) // optional {@link DocumentReference#date() date}
   *    .securityLabel(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link DocumentReference#securityLabel() securityLabel}
   *    .language(com.medplum.types.fhir.Code) // optional {@link DocumentReference#language() language}
   *    .resourceType(String) // required {@link DocumentReference#resourceType() resourceType}
   *    .text(com.medplum.types.fhir.Narrative) // optional {@link DocumentReference#text() text}
   *    .masterIdentifier(com.medplum.types.fhir.Identifier) // optional {@link DocumentReference#masterIdentifier() masterIdentifier}
   *    .authenticator(com.medplum.types.fhir.Reference) // optional {@link DocumentReference#authenticator() authenticator}
   *    .author(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link DocumentReference#author() author}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link DocumentReference#modifierExtension() modifierExtension}
   *    .context(com.medplum.types.fhir.DocumentReference_Context) // optional {@link DocumentReference#context() context}
   *    .subject(com.medplum.types.fhir.Reference) // optional {@link DocumentReference#subject() subject}
   *    .addContent|addAllContent(com.medplum.types.fhir.DocumentReference_Content) // {@link DocumentReference#content() content} elements
   *    .category(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link DocumentReference#category() category}
   *    .identifier(List&amp;lt;com.medplum.types.fhir.Identifier&amp;gt;) // optional {@link DocumentReference#identifier() identifier}
   *    .contained(List&amp;lt;com.medplum.types.fhir.ResourceList&amp;gt;) // optional {@link DocumentReference#contained() contained}
   *    .custodian(com.medplum.types.fhir.Reference) // optional {@link DocumentReference#custodian() custodian}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link DocumentReference#extension() extension}
   *    .meta(com.medplum.types.fhir.Meta) // optional {@link DocumentReference#meta() meta}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ResourceTypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_MASTER_IDENTIFIER = 0x800L;
    private static final long OPT_BIT_AUTHENTICATOR = 0x1000L;
    private static final long OPT_BIT_AUTHOR = 0x2000L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x4000L;
    private static final long OPT_BIT_CONTEXT = 0x8000L;
    ...
    private static final long OPT_BIT_CUSTODIAN = 0x100000L;
