...
final class ImmutableIdentifier implements Identifier {
  ...
  public final ImmutableIdentifier withExtension(List<Extension> value) {
    ...
    return new ImmutableIdentifier(newValue, this.system, this.period, this.value, this.assigner, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableIdentifier(value, this.system, this.period, this.value, this.assigner, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withSystem(Uri value) {
    ...
    return new ImmutableIdentifier(this.extension, newValue, this.period, this.value, this.assigner, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withSystem(Optional<? extends Uri> optional) {
    ...
    return new ImmutableIdentifier(this.extension, value, this.period, this.value, this.assigner, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withPeriod(Period value) {
    ...
    return new ImmutableIdentifier(this.extension, this.system, newValue, this.value, this.assigner, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withPeriod(Optional<? extends Period> optional) {
    ...
    return new ImmutableIdentifier(this.extension, this.system, value, this.value, this.assigner, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withValue(String value) {
    ...
    return new ImmutableIdentifier(this.extension, this.system, this.period, newValue, this.assigner, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withValue(Optional<String> optional) {
    ...
    return new ImmutableIdentifier(this.extension, this.system, this.period, value, this.assigner, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withAssigner(Reference value) {
    ...
    return new ImmutableIdentifier(this.extension, this.system, this.period, this.value, newValue, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withAssigner(Optional<? extends Reference> optional) {
    ...
    return new ImmutableIdentifier(this.extension, this.system, this.period, this.value, value, this.id, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withId(Optional<String> optional) {
    ...
    return new ImmutableIdentifier(this.extension, this.system, this.period, this.value, this.assigner, value, this.type, this.use);
  }
  ...
  public final ImmutableIdentifier withType(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableIdentifier(this.extension, this.system, this.period, this.value, this.assigner, this.id, value, this.use);
  }
  ...
  public final ImmutableIdentifier withUse(Optional<? extends IdentifierUse> optional) {
    ...
    return new ImmutableIdentifier(this.extension, this.system, this.period, this.value, this.assigner, this.id, this.type, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code system}, {@code period}, {@code value}, {@code assigner}, {@code id}, {@code type}, {@code use}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Identifier#extension() extension}
   *    .system(com.medplum.types.fhir.Uri) // optional {@link Identifier#system() system}
   *    .period(com.medplum.types.fhir.Period) // optional {@link Identifier#period() period}
   *    .value(String) // optional {@link Identifier#value() value}
   *    .assigner(com.medplum.types.fhir.Reference) // optional {@link Identifier#assigner() assigner}
   *    .id(String) // optional {@link Identifier#id() id}
   *    .type(com.medplum.types.fhir.CodeableConcept) // optional {@link Identifier#type() type}
   *    .use(com.medplum.types.fhir.IdentifierUse) // optional {@link Identifier#use() use}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_ASSIGNER = 0x10L;
    ...
    public Identifier build() {
      return new ImmutableIdentifier(extension, system, period, value, assigner, id, type, use);
    }
