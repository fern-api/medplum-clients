...
final class ImmutableCodeSystem_Concept implements CodeSystem_Concept {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code display}, {@code definition}, {@code extension}, {@code concept}, {@code code}, {@code modifierExtension}, {@code designation}, {@code property}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link CodeSystem_Concept#extension() extension}
   *    .concept(List&amp;lt;com.medplum.types.fhir.CodeSystem_Concept&amp;gt;) // optional {@link CodeSystem_Concept#concept() concept}
   *    .code(com.medplum.types.fhir.Code) // optional {@link CodeSystem_Concept#code() code}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link CodeSystem_Concept#modifierExtension() modifierExtension}
   *    .designation(List&amp;lt;com.medplum.types.fhir.CodeSystem_Designation&amp;gt;) // optional {@link CodeSystem_Concept#designation() designation}
   *    .property(List&amp;lt;com.medplum.types.fhir.CodeSystem_Property1&amp;gt;) // optional {@link CodeSystem_Concept#property() property}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DESIGNATION = 0x80L;
    private static final long OPT_BIT_PROPERTY = 0x100L;
    ...
    public CodeSystem_Concept build() {
      return new ImmutableCodeSystem_Concept(id, display, definition, extension, concept, code, modifierExtension, designation, property);
    }
