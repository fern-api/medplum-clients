...
final class ImmutableCommunication_Payload implements Communication_Payload {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code contentReference}, {@code contentAttachment}, {@code contentString}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Communication_Payload#extension() extension}
   *    .contentReference(com.medplum.types.fhir.Reference) // optional {@link Communication_Payload#contentReference() contentReference}
   *    .contentAttachment(com.medplum.types.fhir.Attachment) // optional {@link Communication_Payload#contentAttachment() contentAttachment}
   *    .contentString(String) // optional {@link Communication_Payload#contentString() contentString}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Communication_Payload#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Communication_Payload build() {
      return new ImmutableCommunication_Payload(id, extension, contentReference, contentAttachment, contentString, modifierExtension);
    }
