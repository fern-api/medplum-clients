...
final class ImmutableMedicationKnowledge_AdministrationGuidelines
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code indicationCodeableConcept}, {@code dosage}, {@code id}, {@code modifierExtension}, {@code patientCharacteristics}, {@code indicationReference}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_AdministrationGuidelines#extension() extension}
   *    .indicationCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicationKnowledge_AdministrationGuidelines#indicationCodeableConcept() indicationCodeableConcept}
   *    .dosage(List&amp;lt;com.medplum.types.fhir.MedicationKnowledge_Dosage&amp;gt;) // optional {@link MedicationKnowledge_AdministrationGuidelines#dosage() dosage}
   *    .id(String) // optional {@link MedicationKnowledge_AdministrationGuidelines#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_AdministrationGuidelines#modifierExtension() modifierExtension}
   *    .patientCharacteristics(List&amp;lt;com.medplum.types.fhir.MedicationKnowledge_PatientCharacteristics&amp;gt;) // optional {@link MedicationKnowledge_AdministrationGuidelines#patientCharacteristics() patientCharacteristics}
   *    .indicationReference(com.medplum.types.fhir.Reference) // optional {@link MedicationKnowledge_AdministrationGuidelines#indicationReference() indicationReference}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_PATIENT_CHARACTERISTICS = 0x20L;
    private static final long OPT_BIT_INDICATION_REFERENCE = 0x40L;
