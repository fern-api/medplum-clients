...
final class ImmutableImplementationGuide_Page1
    implements ImplementationGuide_Page1 {
  ...
  public final ImmutableImplementationGuide_Page1 withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableImplementationGuide_Page1(newValue, this.id, this.title, this.anchor, this.name, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableImplementationGuide_Page1(value, this.id, this.title, this.anchor, this.name, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withId(String value) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, newValue, this.title, this.anchor, this.name, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withId(Optional<String> optional) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, value, this.title, this.anchor, this.name, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withTitle(String value) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, this.id, newValue, this.anchor, this.name, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withTitle(Optional<String> optional) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, this.id, value, this.anchor, this.name, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withAnchor(List<String> value) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, this.id, this.title, newValue, this.name, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withAnchor(Optional<? extends List<String>> optional) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, this.id, this.title, value, this.name, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withName(String value) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, this.id, this.title, this.anchor, newValue, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withName(Optional<String> optional) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, this.id, this.title, this.anchor, value, this.extension);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withExtension(List<Extension> value) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, this.id, this.title, this.anchor, this.name, newValue);
  }
  ...
  public final ImmutableImplementationGuide_Page1 withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableImplementationGuide_Page1(this.modifierExtension, this.id, this.title, this.anchor, this.name, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code id}, {@code title}, {@code anchor}, {@code name}, {@code extension}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ImplementationGuide_Page1#modifierExtension() modifierExtension}
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ImplementationGuide_Page1#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_ANCHOR = 0x8L;
    ...
    public ImplementationGuide_Page1 build() {
      return new ImmutableImplementationGuide_Page1(modifierExtension, id, title, anchor, name, extension);
    }
