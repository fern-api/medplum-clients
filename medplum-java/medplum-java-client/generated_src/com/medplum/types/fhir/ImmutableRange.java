...
final class ImmutableRange implements Range {
  ...
  public final ImmutableRange withId(String value) {
    ...
    return new ImmutableRange(newValue, this.high, this.low, this.extension);
  }
  ...
  public final ImmutableRange withId(Optional<String> optional) {
    ...
    return new ImmutableRange(value, this.high, this.low, this.extension);
  }
  ...
  public final ImmutableRange withHigh(Quantity value) {
    ...
    return new ImmutableRange(this.id, newValue, this.low, this.extension);
  }
  ...
  public final ImmutableRange withHigh(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableRange(this.id, value, this.low, this.extension);
  }
  ...
  public final ImmutableRange withLow(Quantity value) {
    ...
    return new ImmutableRange(this.id, this.high, newValue, this.extension);
  }
  ...
  public final ImmutableRange withLow(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableRange(this.id, this.high, value, this.extension);
  }
  ...
  public final ImmutableRange withExtension(List<Extension> value) {
    ...
    return new ImmutableRange(this.id, this.high, this.low, newValue);
  }
  ...
  public final ImmutableRange withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableRange(this.id, this.high, this.low, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code high}, {@code low}, {@code extension}.
   ...
   *    .high(com.medplum.types.fhir.Quantity) // optional {@link Range#high() high}
   *    .low(com.medplum.types.fhir.Quantity) // optional {@link Range#low() low}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Range#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_HIGH = 0x2L;
     ...
     */
    public Range build() {
      return new ImmutableRange(id, high, low, extension);
    }
