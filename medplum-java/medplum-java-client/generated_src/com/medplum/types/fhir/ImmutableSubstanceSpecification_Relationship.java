...
final class ImmutableSubstanceSpecification_Relationship
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code substanceCodeableConcept}, {@code amountQuantity}, {@code amountString}, {@code amountType}, {@code substanceReference}, {@code relationship}, {@code amountRatio}, {@code extension}, {@code amountRange}, {@code source}, {@code isDefining}, {@code amountRatioLowLimit}, {@code id}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Relationship#modifierExtension() modifierExtension}
   *    .substanceCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Relationship#substanceCodeableConcept() substanceCodeableConcept}
   *    .amountQuantity(com.medplum.types.fhir.Quantity) // optional {@link SubstanceSpecification_Relationship#amountQuantity() amountQuantity}
   *    .amountString(String) // optional {@link SubstanceSpecification_Relationship#amountString() amountString}
   *    .amountType(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Relationship#amountType() amountType}
   *    .substanceReference(com.medplum.types.fhir.Reference) // optional {@link SubstanceSpecification_Relationship#substanceReference() substanceReference}
   *    .relationship(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Relationship#relationship() relationship}
   *    .amountRatio(com.medplum.types.fhir.Ratio) // optional {@link SubstanceSpecification_Relationship#amountRatio() amountRatio}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Relationship#extension() extension}
   *    .amountRange(com.medplum.types.fhir.Range) // optional {@link SubstanceSpecification_Relationship#amountRange() amountRange}
   *    .source(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link SubstanceSpecification_Relationship#source() source}
   *    .isDefining(Boolean) // optional {@link SubstanceSpecification_Relationship#isDefining() isDefining}
   *    .amountRatioLowLimit(com.medplum.types.fhir.Ratio) // optional {@link SubstanceSpecification_Relationship#amountRatioLowLimit() amountRatioLowLimit}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SUBSTANCE_CODEABLE_CONCEPT = 0x2L;
    private static final long OPT_BIT_AMOUNT_QUANTITY = 0x4L;
    private static final long OPT_BIT_AMOUNT_STRING = 0x8L;
    private static final long OPT_BIT_AMOUNT_TYPE = 0x10L;
    private static final long OPT_BIT_SUBSTANCE_REFERENCE = 0x20L;
    private static final long OPT_BIT_RELATIONSHIP = 0x40L;
    private static final long OPT_BIT_AMOUNT_RATIO = 0x80L;
    ...
    private static final long OPT_BIT_IS_DEFINING = 0x800L;
    private static final long OPT_BIT_AMOUNT_RATIO_LOW_LIMIT = 0x1000L;
