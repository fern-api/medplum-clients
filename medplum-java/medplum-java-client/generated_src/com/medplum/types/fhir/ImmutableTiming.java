...
final class ImmutableTiming implements Timing {
  ...
  public final ImmutableTiming withExtension(List<Extension> value) {
    ...
    return new ImmutableTiming(newValue, this.code, this.id, this.modifierExtension, this.repeat, this.event);
  }
  ...
  public final ImmutableTiming withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTiming(value, this.code, this.id, this.modifierExtension, this.repeat, this.event);
  }
  ...
  public final ImmutableTiming withCode(CodeableConcept value) {
    ...
    return new ImmutableTiming(this.extension, newValue, this.id, this.modifierExtension, this.repeat, this.event);
  }
  ...
  public final ImmutableTiming withCode(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableTiming(this.extension, value, this.id, this.modifierExtension, this.repeat, this.event);
  }
  ...
  public final ImmutableTiming withId(String value) {
    ...
    return new ImmutableTiming(this.extension, this.code, newValue, this.modifierExtension, this.repeat, this.event);
  }
  ...
  public final ImmutableTiming withId(Optional<String> optional) {
    ...
    return new ImmutableTiming(this.extension, this.code, value, this.modifierExtension, this.repeat, this.event);
  }
  ...
  public final ImmutableTiming withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTiming(this.extension, this.code, this.id, newValue, this.repeat, this.event);
  }
  ...
  public final ImmutableTiming withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTiming(this.extension, this.code, this.id, value, this.repeat, this.event);
  }
  ...
  public final ImmutableTiming withRepeat(Timing_Repeat value) {
    ...
    return new ImmutableTiming(this.extension, this.code, this.id, this.modifierExtension, newValue, this.event);
  }
  ...
  public final ImmutableTiming withRepeat(Optional<? extends Timing_Repeat> optional) {
    ...
    return new ImmutableTiming(this.extension, this.code, this.id, this.modifierExtension, value, this.event);
  }
  ...
  public final ImmutableTiming withEvent(List<DateTime> value) {
    ...
    return new ImmutableTiming(this.extension, this.code, this.id, this.modifierExtension, this.repeat, newValue);
  }
  ...
  public final ImmutableTiming withEvent(Optional<? extends List<DateTime>> optional) {
    ...
    return new ImmutableTiming(this.extension, this.code, this.id, this.modifierExtension, this.repeat, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code code}, {@code id}, {@code modifierExtension}, {@code repeat}, {@code event}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Timing#extension() extension}
   *    .code(com.medplum.types.fhir.CodeableConcept) // optional {@link Timing#code() code}
   *    .id(String) // optional {@link Timing#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Timing#modifierExtension() modifierExtension}
   *    .repeat(com.medplum.types.fhir.Timing_Repeat) // optional {@link Timing#repeat() repeat}
   *    .event(List&amp;lt;com.medplum.types.fhir.DateTime&amp;gt;) // optional {@link Timing#event() event}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_REPEAT = 0x10L;
    private static final long OPT_BIT_EVENT = 0x20L;
     ...
     */
    public Timing build() {
      return new ImmutableTiming(extension, code, id, modifierExtension, repeat, event);
    }
