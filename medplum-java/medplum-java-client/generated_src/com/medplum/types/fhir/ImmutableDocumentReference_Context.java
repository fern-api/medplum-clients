...
final class ImmutableDocumentReference_Context
    implements DocumentReference_Context {
  ...
  /**
   * Computes a hash code from attributes: {@code encounter}, {@code facilityType}, {@code related}, {@code id}, {@code practiceSetting}, {@code extension}, {@code event}, {@code sourcePatientInfo}, {@code period}, {@code modifierExtension}.
   ...
   *    .encounter(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link DocumentReference_Context#encounter() encounter}
   *    .facilityType(com.medplum.types.fhir.CodeableConcept) // optional {@link DocumentReference_Context#facilityType() facilityType}
   *    .related(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link DocumentReference_Context#related() related}
   *    .id(String) // optional {@link DocumentReference_Context#id() id}
   *    .practiceSetting(com.medplum.types.fhir.CodeableConcept) // optional {@link DocumentReference_Context#practiceSetting() practiceSetting}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link DocumentReference_Context#extension() extension}
   *    .event(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link DocumentReference_Context#event() event}
   *    .sourcePatientInfo(com.medplum.types.fhir.Reference) // optional {@link DocumentReference_Context#sourcePatientInfo() sourcePatientInfo}
   *    .period(com.medplum.types.fhir.Period) // optional {@link DocumentReference_Context#period() period}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link DocumentReference_Context#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
