...
final class ImmutableCapabilityStatement_Security
  ...
  public final ImmutableCapabilityStatement_Security withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableCapabilityStatement_Security(newValue, this.description, this.cors, this.id, this.extension, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCapabilityStatement_Security(value, this.description, this.cors, this.id, this.extension, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withDescription(Markdown value) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, newValue, this.cors, this.id, this.extension, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withDescription(Optional<? extends Markdown> optional) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, value, this.cors, this.id, this.extension, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withCors(boolean value) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, this.description, newValue, this.id, this.extension, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withCors(Optional<Boolean> optional) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, this.description, value, this.id, this.extension, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withId(String value) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, this.description, this.cors, newValue, this.extension, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withId(Optional<String> optional) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, this.description, this.cors, value, this.extension, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withExtension(List<Extension> value) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, this.description, this.cors, this.id, newValue, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, this.description, this.cors, this.id, value, this.service);
  }
  ...
  public final ImmutableCapabilityStatement_Security withService(List<CodeableConcept> value) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, this.description, this.cors, this.id, this.extension, newValue);
  }
  ...
  public final ImmutableCapabilityStatement_Security withService(Optional<? extends List<CodeableConcept>> optional) {
    ...
    return new ImmutableCapabilityStatement_Security(this.modifierExtension, this.description, this.cors, this.id, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code description}, {@code cors}, {@code id}, {@code extension}, {@code service}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link CapabilityStatement_Security#modifierExtension() modifierExtension}
   *    .description(com.medplum.types.fhir.Markdown) // optional {@link CapabilityStatement_Security#description() description}
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link CapabilityStatement_Security#extension() extension}
   *    .service(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link CapabilityStatement_Security#service() service}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_CORS = 0x4L;
    private static final long OPT_BIT_ID = 0x8L;
    private static final long OPT_BIT_EXTENSION = 0x10L;
    private static final long OPT_BIT_SERVICE = 0x20L;
    ...
    public CapabilityStatement_Security build() {
      return new ImmutableCapabilityStatement_Security(modifierExtension, description, cors, id, extension, service);
    }
