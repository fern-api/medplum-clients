...
final class ImmutableExampleScenario_Instance
    implements ExampleScenario_Instance {
  ...
  /**
   * Computes a hash code from attributes: {@code version}, {@code extension}, {@code resourceType}, {@code modifierExtension}, {@code name}, {@code id}, {@code containedInstance}, {@code resourceId}, {@code description}.
   ...
   *    .version(List&amp;lt;com.medplum.types.fhir.ExampleScenario_Version&amp;gt;) // optional {@link ExampleScenario_Instance#version() version}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Instance#extension() extension}
   *    .resourceType(com.medplum.types.fhir.Code) // optional {@link ExampleScenario_Instance#resourceType() resourceType}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Instance#modifierExtension() modifierExtension}
   *    .name(String) // optional {@link ExampleScenario_Instance#name() name}
   *    .id(String) // optional {@link ExampleScenario_Instance#id() id}
   *    .containedInstance(List&amp;lt;com.medplum.types.fhir.ExampleScenario_ContainedInstance&amp;gt;) // optional {@link ExampleScenario_Instance#containedInstance() containedInstance}
   *    .resourceId(String) // optional {@link ExampleScenario_Instance#resourceId() resourceId}
   *    .description(com.medplum.types.fhir.Markdown) // optional {@link ExampleScenario_Instance#description() description}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_CONTAINED_INSTANCE = 0x40L;
