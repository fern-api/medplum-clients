...
final class ImmutableContract_Legal implements Contract_Legal {
  ...
  public final ImmutableContract_Legal withContentAttachment(Attachment value) {
    ...
    return new ImmutableContract_Legal(newValue, this.modifierExtension, this.contentReference, this.id, this.extension);
  }
  ...
  public final ImmutableContract_Legal withContentAttachment(Optional<? extends Attachment> optional) {
    ...
    return new ImmutableContract_Legal(value, this.modifierExtension, this.contentReference, this.id, this.extension);
  }
  ...
  public final ImmutableContract_Legal withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableContract_Legal(this.contentAttachment, newValue, this.contentReference, this.id, this.extension);
  }
  ...
  public final ImmutableContract_Legal withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableContract_Legal(this.contentAttachment, value, this.contentReference, this.id, this.extension);
  }
  ...
  public final ImmutableContract_Legal withContentReference(Reference value) {
    ...
    return new ImmutableContract_Legal(this.contentAttachment, this.modifierExtension, newValue, this.id, this.extension);
  }
  ...
  public final ImmutableContract_Legal withContentReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableContract_Legal(this.contentAttachment, this.modifierExtension, value, this.id, this.extension);
  }
  ...
  public final ImmutableContract_Legal withId(String value) {
    ...
    return new ImmutableContract_Legal(this.contentAttachment, this.modifierExtension, this.contentReference, newValue, this.extension);
  }
  ...
  public final ImmutableContract_Legal withId(Optional<String> optional) {
    ...
    return new ImmutableContract_Legal(this.contentAttachment, this.modifierExtension, this.contentReference, value, this.extension);
  }
  ...
  public final ImmutableContract_Legal withExtension(List<Extension> value) {
    ...
    return new ImmutableContract_Legal(this.contentAttachment, this.modifierExtension, this.contentReference, this.id, newValue);
  }
  ...
  public final ImmutableContract_Legal withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableContract_Legal(this.contentAttachment, this.modifierExtension, this.contentReference, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code contentAttachment}, {@code modifierExtension}, {@code contentReference}, {@code id}, {@code extension}.
   ...
   *    .contentAttachment(com.medplum.types.fhir.Attachment) // optional {@link Contract_Legal#contentAttachment() contentAttachment}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Contract_Legal#modifierExtension() modifierExtension}
   *    .contentReference(com.medplum.types.fhir.Reference) // optional {@link Contract_Legal#contentReference() contentReference}
   *    .id(String) // optional {@link Contract_Legal#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Contract_Legal#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Contract_Legal build() {
      return new ImmutableContract_Legal(contentAttachment, modifierExtension, contentReference, id, extension);
    }
