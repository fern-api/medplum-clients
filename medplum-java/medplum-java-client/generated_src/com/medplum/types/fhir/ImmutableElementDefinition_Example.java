...
final class ImmutableElementDefinition_Example
    implements ElementDefinition_Example {
  ...
  private boolean equalTo(ImmutableElementDefinition_Example another) {
    return Objects.equals(valueMoney, another.valueMoney)
  ...
  /**
   * Computes a hash code from attributes: {@code valueMoney}, {@code valueDecimal}, {@code valueUrl}, {@code valueMarkdown}, {@code valuePeriod}, {@code valueDosage}, {@code valueDataRequirement}, {@code valueTime}, {@code valueAnnotation}, {@code valueContactDetail}, {@code valueOid}, {@code valueTriggerDefinition}, {@code valueUsageContext}, {@code valueCode}, {@code valueMeta}, {@code valueInstant}, {@code valueCanonical}, {@code valueUuid}, {@code valueSignature}, {@code valueAddress}, {@code valueTiming}, {@code valueRelatedArtifact}, {@code valueQuantity}, {@code valueBase64Binary}, {@code valueHumanName}, {@code id}, {@code valueContactPoint}, {@code valueInteger}, {@code valueCount}, {@code valueExpression}, {@code label}, {@code valueSampledData}, {@code valueUri}, {@code valueContributor}, {@code valueIdentifier}, {@code modifierExtension}, {@code valueParameterDefinition}, {@code valueCoding}, {@code extension}, {@code valueReference}, {@code valueRange}, {@code valueString}, {@code valueCodeableConcept}, {@code valuePositiveInt}, {@code valueUnsignedInt}, {@code valueId}, {@code valueDateTime}, {@code valueDistance}, {@code valueDuration}, {@code valueBoolean}, {@code valueDate}, {@code valueAge}, {@code valueRatio}, {@code valueAttachment}.
   ...
   *    .valueMoney(com.medplum.types.fhir.Money) // optional {@link ElementDefinition_Example#valueMoney() valueMoney}
   ...
   *    .valuePeriod(com.medplum.types.fhir.Period) // optional {@link ElementDefinition_Example#valuePeriod() valuePeriod}
   *    .valueDosage(com.medplum.types.fhir.Dosage) // optional {@link ElementDefinition_Example#valueDosage() valueDosage}
   *    .valueDataRequirement(com.medplum.types.fhir.DataRequirement) // optional {@link ElementDefinition_Example#valueDataRequirement() valueDataRequirement}
   *    .valueTime(String) // optional {@link ElementDefinition_Example#valueTime() valueTime}
   *    .valueAnnotation(com.medplum.types.fhir.Annotation) // optional {@link ElementDefinition_Example#valueAnnotation() valueAnnotation}
   *    .valueContactDetail(com.medplum.types.fhir.ContactDetail) // optional {@link ElementDefinition_Example#valueContactDetail() valueContactDetail}
   *    .valueOid(String) // optional {@link ElementDefinition_Example#valueOid() valueOid}
   *    .valueTriggerDefinition(com.medplum.types.fhir.TriggerDefinition) // optional {@link ElementDefinition_Example#valueTriggerDefinition() valueTriggerDefinition}
   *    .valueUsageContext(com.medplum.types.fhir.UsageContext) // optional {@link ElementDefinition_Example#valueUsageContext() valueUsageContext}
   *    .valueCode(String) // optional {@link ElementDefinition_Example#valueCode() valueCode}
   *    .valueMeta(com.medplum.types.fhir.Meta) // optional {@link ElementDefinition_Example#valueMeta() valueMeta}
   ...
   *    .valueSignature(com.medplum.types.fhir.Signature) // optional {@link ElementDefinition_Example#valueSignature() valueSignature}
   *    .valueAddress(com.medplum.types.fhir.Address) // optional {@link ElementDefinition_Example#valueAddress() valueAddress}
   *    .valueTiming(com.medplum.types.fhir.Timing) // optional {@link ElementDefinition_Example#valueTiming() valueTiming}
   *    .valueRelatedArtifact(com.medplum.types.fhir.RelatedArtifact) // optional {@link ElementDefinition_Example#valueRelatedArtifact() valueRelatedArtifact}
   *    .valueQuantity(com.medplum.types.fhir.Quantity) // optional {@link ElementDefinition_Example#valueQuantity() valueQuantity}
   *    .valueBase64Binary(String) // optional {@link ElementDefinition_Example#valueBase64Binary() valueBase64Binary}
   *    .valueHumanName(com.medplum.types.fhir.HumanName) // optional {@link ElementDefinition_Example#valueHumanName() valueHumanName}
   *    .id(String) // optional {@link ElementDefinition_Example#id() id}
   *    .valueContactPoint(com.medplum.types.fhir.ContactPoint) // optional {@link ElementDefinition_Example#valueContactPoint() valueContactPoint}
   *    .valueInteger(Double) // optional {@link ElementDefinition_Example#valueInteger() valueInteger}
   *    .valueCount(com.medplum.types.fhir.Count) // optional {@link ElementDefinition_Example#valueCount() valueCount}
   *    .valueExpression(com.medplum.types.fhir.Expression) // optional {@link ElementDefinition_Example#valueExpression() valueExpression}
   *    .label(String) // optional {@link ElementDefinition_Example#label() label}
   *    .valueSampledData(com.medplum.types.fhir.SampledData) // optional {@link ElementDefinition_Example#valueSampledData() valueSampledData}
   *    .valueUri(String) // optional {@link ElementDefinition_Example#valueUri() valueUri}
   *    .valueContributor(com.medplum.types.fhir.Contributor) // optional {@link ElementDefinition_Example#valueContributor() valueContributor}
   *    .valueIdentifier(com.medplum.types.fhir.Identifier) // optional {@link ElementDefinition_Example#valueIdentifier() valueIdentifier}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ElementDefinition_Example#modifierExtension() modifierExtension}
   *    .valueParameterDefinition(com.medplum.types.fhir.ParameterDefinition) // optional {@link ElementDefinition_Example#valueParameterDefinition() valueParameterDefinition}
   *    .valueCoding(com.medplum.types.fhir.Coding) // optional {@link ElementDefinition_Example#valueCoding() valueCoding}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ElementDefinition_Example#extension() extension}
   *    .valueReference(com.medplum.types.fhir.Reference) // optional {@link ElementDefinition_Example#valueReference() valueReference}
   *    .valueRange(com.medplum.types.fhir.Range) // optional {@link ElementDefinition_Example#valueRange() valueRange}
   *    .valueString(String) // optional {@link ElementDefinition_Example#valueString() valueString}
   *    .valueCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link ElementDefinition_Example#valueCodeableConcept() valueCodeableConcept}
   ...
   *    .valueDistance(com.medplum.types.fhir.Distance) // optional {@link ElementDefinition_Example#valueDistance() valueDistance}
   *    .valueDuration(com.medplum.types.fhir.Duration) // optional {@link ElementDefinition_Example#valueDuration() valueDuration}
   ...
   *    .valueAge(com.medplum.types.fhir.Age) // optional {@link ElementDefinition_Example#valueAge() valueAge}
   *    .valueRatio(com.medplum.types.fhir.Ratio) // optional {@link ElementDefinition_Example#valueRatio() valueRatio}
   *    .valueAttachment(com.medplum.types.fhir.Attachment) // optional {@link ElementDefinition_Example#valueAttachment() valueAttachment}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_VALUE_MONEY = 0x1L;
    private static final long OPT_BIT_VALUE_DECIMAL = 0x2L;
    private static final long OPT_BIT_VALUE_URL = 0x4L;
    private static final long OPT_BIT_VALUE_MARKDOWN = 0x8L;
    private static final long OPT_BIT_VALUE_PERIOD = 0x10L;
    private static final long OPT_BIT_VALUE_DOSAGE = 0x20L;
    private static final long OPT_BIT_VALUE_DATA_REQUIREMENT = 0x40L;
    private static final long OPT_BIT_VALUE_TIME = 0x80L;
    private static final long OPT_BIT_VALUE_ANNOTATION = 0x100L;
    private static final long OPT_BIT_VALUE_CONTACT_DETAIL = 0x200L;
    private static final long OPT_BIT_VALUE_OID = 0x400L;
    private static final long OPT_BIT_VALUE_TRIGGER_DEFINITION = 0x800L;
    private static final long OPT_BIT_VALUE_USAGE_CONTEXT = 0x1000L;
    private static final long OPT_BIT_VALUE_CODE = 0x2000L;
    private static final long OPT_BIT_VALUE_META = 0x4000L;
    private static final long OPT_BIT_VALUE_INSTANT = 0x8000L;
    private static final long OPT_BIT_VALUE_CANONICAL = 0x10000L;
    private static final long OPT_BIT_VALUE_UUID = 0x20000L;
    private static final long OPT_BIT_VALUE_SIGNATURE = 0x40000L;
    private static final long OPT_BIT_VALUE_ADDRESS = 0x80000L;
    private static final long OPT_BIT_VALUE_TIMING = 0x100000L;
    private static final long OPT_BIT_VALUE_RELATED_ARTIFACT = 0x200000L;
    private static final long OPT_BIT_VALUE_QUANTITY = 0x400000L;
    private static final long OPT_BIT_VALUE_BASE64_BINARY = 0x800000L;
    private static final long OPT_BIT_VALUE_HUMAN_NAME = 0x1000000L;
    private static final long OPT_BIT_ID = 0x2000000L;
    private static final long OPT_BIT_VALUE_CONTACT_POINT = 0x4000000L;
    private static final long OPT_BIT_VALUE_INTEGER = 0x8000000L;
    private static final long OPT_BIT_VALUE_COUNT = 0x10000000L;
    private static final long OPT_BIT_VALUE_EXPRESSION = 0x20000000L;
    private static final long OPT_BIT_LABEL = 0x40000000L;
    private static final long OPT_BIT_VALUE_SAMPLED_DATA = 0x80000000L;
    private static final long OPT_BIT_VALUE_URI = 0x100000000L;
    private static final long OPT_BIT_VALUE_CONTRIBUTOR = 0x200000000L;
    ...
    private static final long OPT_BIT_VALUE_PARAMETER_DEFINITION = 0x1000000000L;
    private static final long OPT_BIT_VALUE_CODING = 0x2000000000L;
    private static final long OPT_BIT_EXTENSION = 0x4000000000L;
    private static final long OPT_BIT_VALUE_REFERENCE = 0x8000000000L;
    ...
    private static final long OPT_BIT_VALUE_CODEABLE_CONCEPT = 0x40000000000L;
    private static final long OPT_BIT_VALUE_POSITIVE_INT = 0x80000000000L;
    private static final long OPT_BIT_VALUE_UNSIGNED_INT = 0x100000000000L;
    private static final long OPT_BIT_VALUE_ID = 0x200000000000L;
    private static final long OPT_BIT_VALUE_DATE_TIME = 0x400000000000L;
    private static final long OPT_BIT_VALUE_DISTANCE = 0x800000000000L;
    private static final long OPT_BIT_VALUE_DURATION = 0x1000000000000L;
    private static final long OPT_BIT_VALUE_BOOLEAN = 0x2000000000000L;
    private static final long OPT_BIT_VALUE_DATE = 0x4000000000000L;
    private static final long OPT_BIT_VALUE_AGE = 0x8000000000000L;
    private static final long OPT_BIT_VALUE_RATIO = 0x10000000000000L;
    private static final long OPT_BIT_VALUE_ATTACHMENT = 0x20000000000000L;
