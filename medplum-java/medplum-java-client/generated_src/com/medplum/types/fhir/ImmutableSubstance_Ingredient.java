...
final class ImmutableSubstance_Ingredient implements Substance_Ingredient {
  ...
  public final ImmutableSubstance_Ingredient withSubstanceCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstance_Ingredient(this.substanceReference, this.modifierExtension, value, this.id, this.extension, this.quantity);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code substanceReference}, {@code modifierExtension}, {@code substanceCodeableConcept}, {@code id}, {@code extension}, {@code quantity}.
   ...
   *    .substanceReference(com.medplum.types.fhir.Reference) // optional {@link Substance_Ingredient#substanceReference() substanceReference}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Substance_Ingredient#modifierExtension() modifierExtension}
   *    .substanceCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link Substance_Ingredient#substanceCodeableConcept() substanceCodeableConcept}
   *    .id(String) // optional {@link Substance_Ingredient#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Substance_Ingredient#extension() extension}
   *    .quantity(com.medplum.types.fhir.Ratio) // optional {@link Substance_Ingredient#quantity() quantity}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Substance_Ingredient build() {
      return new ImmutableSubstance_Ingredient(substanceReference, modifierExtension, substanceCodeableConcept, id, extension, quantity);
    }
