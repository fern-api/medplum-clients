...
final class ImmutableTestReport_Test implements TestReport_Test {
  ...
  public final ImmutableTestReport_Test withDescription(String value) {
    ...
    return new ImmutableTestReport_Test(newValue, this.name, this.extension, this.id, this.action, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Test withDescription(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Test(value, this.name, this.extension, this.id, this.action, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Test withName(String value) {
    ...
    return new ImmutableTestReport_Test(this.description, newValue, this.extension, this.id, this.action, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Test withName(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Test(this.description, value, this.extension, this.id, this.action, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Test withExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Test(this.description, this.name, newValue, this.id, this.action, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Test withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Test(this.description, this.name, value, this.id, this.action, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Test withId(String value) {
    ...
    return new ImmutableTestReport_Test(this.description, this.name, this.extension, newValue, this.action, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Test withId(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Test(this.description, this.name, this.extension, value, this.action, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Test withAction(TestReport_Action1... elements) {
    ...
    return new ImmutableTestReport_Test(this.description, this.name, this.extension, this.id, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableTestReport_Test withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Test(this.description, this.name, this.extension, this.id, this.action, newValue);
  }
  ...
  public final ImmutableTestReport_Test withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Test(this.description, this.name, this.extension, this.id, this.action, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code description}, {@code name}, {@code extension}, {@code id}, {@code action}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Test#extension() extension}
   *    .id(String) // optional {@link TestReport_Test#id() id}
   *    .addAction|addAllAction(com.medplum.types.fhir.TestReport_Action1) // {@link TestReport_Test#action() action} elements
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Test#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TestReport_Test build() {
      return new ImmutableTestReport_Test(description, name, extension, id, createUnmodifiableList(true, action), modifierExtension);
    }
