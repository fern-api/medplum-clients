...
final class ImmutableSupplyRequest_Parameter implements SupplyRequest_Parameter {
  ...
  private boolean equalTo(ImmutableSupplyRequest_Parameter another) {
    return Objects.equals(valueRange, another.valueRange)
  ...
  /**
   * Computes a hash code from attributes: {@code valueRange}, {@code modifierExtension}, {@code id}, {@code valueCodeableConcept}, {@code code}, {@code extension}, {@code valueQuantity}, {@code valueBoolean}.
   ...
   *    .valueRange(com.medplum.types.fhir.Range) // optional {@link SupplyRequest_Parameter#valueRange() valueRange}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SupplyRequest_Parameter#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link SupplyRequest_Parameter#id() id}
   *    .valueCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link SupplyRequest_Parameter#valueCodeableConcept() valueCodeableConcept}
   *    .code(com.medplum.types.fhir.CodeableConcept) // optional {@link SupplyRequest_Parameter#code() code}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SupplyRequest_Parameter#extension() extension}
   *    .valueQuantity(com.medplum.types.fhir.Quantity) // optional {@link SupplyRequest_Parameter#valueQuantity() valueQuantity}
  ...
  public static final class Builder {
    private static final long OPT_BIT_VALUE_RANGE = 0x1L;
