...
final class ImmutableDosage_DoseAndRate implements Dosage_DoseAndRate {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code doseRange}, {@code rateQuantity}, {@code modifierExtension}, {@code rateRange}, {@code type}, {@code doseQuantity}, {@code id}, {@code rateRatio}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Dosage_DoseAndRate#extension() extension}
   *    .doseRange(com.medplum.types.fhir.Range) // optional {@link Dosage_DoseAndRate#doseRange() doseRange}
   *    .rateQuantity(com.medplum.types.fhir.Quantity) // optional {@link Dosage_DoseAndRate#rateQuantity() rateQuantity}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Dosage_DoseAndRate#modifierExtension() modifierExtension}
   *    .rateRange(com.medplum.types.fhir.Range) // optional {@link Dosage_DoseAndRate#rateRange() rateRange}
   *    .type(com.medplum.types.fhir.CodeableConcept) // optional {@link Dosage_DoseAndRate#type() type}
   *    .doseQuantity(com.medplum.types.fhir.Quantity) // optional {@link Dosage_DoseAndRate#doseQuantity() doseQuantity}
   *    .id(String) // optional {@link Dosage_DoseAndRate#id() id}
   *    .rateRatio(com.medplum.types.fhir.Ratio) // optional {@link Dosage_DoseAndRate#rateRatio() rateRatio}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_RATE_QUANTITY = 0x4L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x8L;
    private static final long OPT_BIT_RATE_RANGE = 0x10L;
    private static final long OPT_BIT_TYPE = 0x20L;
    private static final long OPT_BIT_DOSE_QUANTITY = 0x40L;
    private static final long OPT_BIT_ID = 0x80L;
    private static final long OPT_BIT_RATE_RATIO = 0x100L;
