...
final class ImmutableQuantity implements Quantity {
  ...
  public final ImmutableQuantity withExtension(List<Extension> value) {
    ...
    return new ImmutableQuantity(newValue, this.code, this.comparator, this.unit, this.system, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableQuantity(value, this.code, this.comparator, this.unit, this.system, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withCode(Code value) {
    ...
    return new ImmutableQuantity(this.extension, newValue, this.comparator, this.unit, this.system, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withCode(Optional<? extends Code> optional) {
    ...
    return new ImmutableQuantity(this.extension, value, this.comparator, this.unit, this.system, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withComparator(QuantityComparator value) {
    ...
    return new ImmutableQuantity(this.extension, this.code, newValue, this.unit, this.system, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withComparator(Optional<? extends QuantityComparator> optional) {
    ...
    return new ImmutableQuantity(this.extension, this.code, value, this.unit, this.system, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withUnit(String value) {
    ...
    return new ImmutableQuantity(this.extension, this.code, this.comparator, newValue, this.system, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withUnit(Optional<String> optional) {
    ...
    return new ImmutableQuantity(this.extension, this.code, this.comparator, value, this.system, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withSystem(Uri value) {
    ...
    return new ImmutableQuantity(this.extension, this.code, this.comparator, this.unit, newValue, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withSystem(Optional<? extends Uri> optional) {
    ...
    return new ImmutableQuantity(this.extension, this.code, this.comparator, this.unit, value, this.value, this.id);
  }
  ...
  public final ImmutableQuantity withValue(Decimal value) {
    ...
    return new ImmutableQuantity(this.extension, this.code, this.comparator, this.unit, this.system, newValue, this.id);
  }
  ...
  public final ImmutableQuantity withValue(Optional<? extends Decimal> optional) {
    ...
    return new ImmutableQuantity(this.extension, this.code, this.comparator, this.unit, this.system, value, this.id);
  }
  ...
  public final ImmutableQuantity withId(String value) {
    ...
    return new ImmutableQuantity(this.extension, this.code, this.comparator, this.unit, this.system, this.value, newValue);
  }
  ...
  public final ImmutableQuantity withId(Optional<String> optional) {
    ...
    return new ImmutableQuantity(this.extension, this.code, this.comparator, this.unit, this.system, this.value, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code code}, {@code comparator}, {@code unit}, {@code system}, {@code value}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Quantity#extension() extension}
   *    .code(com.medplum.types.fhir.Code) // optional {@link Quantity#code() code}
   *    .comparator(com.medplum.types.fhir.QuantityComparator) // optional {@link Quantity#comparator() comparator}
   *    .unit(String) // optional {@link Quantity#unit() unit}
   *    .system(com.medplum.types.fhir.Uri) // optional {@link Quantity#system() system}
   *    .value(com.medplum.types.fhir.Decimal) // optional {@link Quantity#value() value}
  ...
  public static final class Builder {
    ...
    public Quantity build() {
      return new ImmutableQuantity(extension, code, comparator, unit, system, value, id);
    }
