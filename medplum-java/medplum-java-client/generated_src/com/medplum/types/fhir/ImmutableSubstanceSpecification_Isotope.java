...
final class ImmutableSubstanceSpecification_Isotope
  ...
  /**
   * Computes a hash code from attributes: {@code identifier}, {@code extension}, {@code modifierExtension}, {@code molecularWeight}, {@code id}, {@code substitution}, {@code name}, {@code halfLife}.
   ...
   *    .identifier(com.medplum.types.fhir.Identifier) // optional {@link SubstanceSpecification_Isotope#identifier() identifier}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Isotope#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Isotope#modifierExtension() modifierExtension}
   *    .molecularWeight(com.medplum.types.fhir.SubstanceSpecification_MolecularWeight) // optional {@link SubstanceSpecification_Isotope#molecularWeight() molecularWeight}
   *    .id(String) // optional {@link SubstanceSpecification_Isotope#id() id}
   *    .substitution(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Isotope#substitution() substitution}
   *    .name(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Isotope#name() name}
   *    .halfLife(com.medplum.types.fhir.Quantity) // optional {@link SubstanceSpecification_Isotope#halfLife() halfLife}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_HALF_LIFE = 0x80L;
    ...
    public SubstanceSpecification_Isotope build() {
      return new ImmutableSubstanceSpecification_Isotope(identifier, extension, modifierExtension, molecularWeight, id, substitution, name, halfLife);
    }
