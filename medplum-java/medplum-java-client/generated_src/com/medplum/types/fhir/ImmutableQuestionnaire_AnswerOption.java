...
final class ImmutableQuestionnaire_AnswerOption
  ...
  private boolean equalTo(ImmutableQuestionnaire_AnswerOption another) {
    return Objects.equals(valueDate, another.valueDate)
  ...
  /**
   * Computes a hash code from attributes: {@code valueDate}, {@code valueString}, {@code initialSelected}, {@code valueCoding}, {@code extension}, {@code valueInteger}, {@code valueTime}, {@code id}, {@code modifierExtension}, {@code valueReference}.
   ...
   *    .valueCoding(com.medplum.types.fhir.Coding) // optional {@link Questionnaire_AnswerOption#valueCoding() valueCoding}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Questionnaire_AnswerOption#extension() extension}
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Questionnaire_AnswerOption#modifierExtension() modifierExtension}
   *    .valueReference(com.medplum.types.fhir.Reference) // optional {@link Questionnaire_AnswerOption#valueReference() valueReference}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_VALUE_DATE = 0x1L;
    private static final long OPT_BIT_VALUE_STRING = 0x2L;
    private static final long OPT_BIT_INITIAL_SELECTED = 0x4L;
