...
final class ImmutableQuestionnaire_EnableWhen
    implements Questionnaire_EnableWhen {
  ...
  private boolean equalTo(ImmutableQuestionnaire_EnableWhen another) {
    return Objects.equals(answerInteger, another.answerInteger)
        ...
        && Objects.equals(answerDate, another.answerDate)
  ...
  /**
   * Computes a hash code from attributes: {@code answerInteger}, {@code modifierExtension}, {@code answerReference}, {@code answerQuantity}, {@code answerCoding}, {@code answerBoolean}, {@code operator}, {@code answerDateTime}, {@code answerString}, {@code id}, {@code answerDate}, {@code answerDecimal}, {@code question}, {@code answerTime}, {@code extension}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Questionnaire_EnableWhen#modifierExtension() modifierExtension}
   *    .answerReference(com.medplum.types.fhir.Reference) // optional {@link Questionnaire_EnableWhen#answerReference() answerReference}
   *    .answerQuantity(com.medplum.types.fhir.Quantity) // optional {@link Questionnaire_EnableWhen#answerQuantity() answerQuantity}
   *    .answerCoding(com.medplum.types.fhir.Coding) // optional {@link Questionnaire_EnableWhen#answerCoding() answerCoding}
   *    .answerBoolean(Boolean) // optional {@link Questionnaire_EnableWhen#answerBoolean() answerBoolean}
   *    .operator(com.medplum.types.fhir.Questionnaire_enablewhenOperator) // optional {@link Questionnaire_EnableWhen#operator() operator}
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Questionnaire_EnableWhen#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_ANSWER_INTEGER = 0x1L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x2L;
    private static final long OPT_BIT_ANSWER_REFERENCE = 0x4L;
    private static final long OPT_BIT_ANSWER_QUANTITY = 0x8L;
    private static final long OPT_BIT_ANSWER_CODING = 0x10L;
    private static final long OPT_BIT_ANSWER_BOOLEAN = 0x20L;
    private static final long OPT_BIT_OPERATOR = 0x40L;
    private static final long OPT_BIT_ANSWER_DATE_TIME = 0x80L;
    private static final long OPT_BIT_ANSWER_STRING = 0x100L;
    private static final long OPT_BIT_ID = 0x200L;
    private static final long OPT_BIT_ANSWER_DATE = 0x400L;
    private static final long OPT_BIT_ANSWER_DECIMAL = 0x800L;
    private static final long OPT_BIT_QUESTION = 0x1000L;
    private static final long OPT_BIT_ANSWER_TIME = 0x2000L;
