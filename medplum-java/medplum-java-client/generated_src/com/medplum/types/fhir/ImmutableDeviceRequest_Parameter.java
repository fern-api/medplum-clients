...
final class ImmutableDeviceRequest_Parameter implements DeviceRequest_Parameter {
  ...
  /**
   * Computes a hash code from attributes: {@code valueQuantity}, {@code valueRange}, {@code valueBoolean}, {@code valueCodeableConcept}, {@code id}, {@code extension}, {@code code}, {@code modifierExtension}.
   ...
   *    .valueQuantity(com.medplum.types.fhir.Quantity) // optional {@link DeviceRequest_Parameter#valueQuantity() valueQuantity}
   *    .valueRange(com.medplum.types.fhir.Range) // optional {@link DeviceRequest_Parameter#valueRange() valueRange}
   *    .valueBoolean(Boolean) // optional {@link DeviceRequest_Parameter#valueBoolean() valueBoolean}
   *    .valueCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link DeviceRequest_Parameter#valueCodeableConcept() valueCodeableConcept}
   *    .id(String) // optional {@link DeviceRequest_Parameter#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link DeviceRequest_Parameter#extension() extension}
   *    .code(com.medplum.types.fhir.CodeableConcept) // optional {@link DeviceRequest_Parameter#code() code}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link DeviceRequest_Parameter#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
