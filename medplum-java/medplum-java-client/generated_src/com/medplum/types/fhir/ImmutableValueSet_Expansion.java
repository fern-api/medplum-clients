...
final class ImmutableValueSet_Expansion implements ValueSet_Expansion {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code total}, {@code offset}, {@code identifier}, {@code contains}, {@code extension}, {@code modifierExtension}, {@code timestamp}, {@code parameter}.
   ...
   *    .identifier(com.medplum.types.fhir.Uri) // optional {@link ValueSet_Expansion#identifier() identifier}
   *    .contains(List&amp;lt;com.medplum.types.fhir.ValueSet_Contains&amp;gt;) // optional {@link ValueSet_Expansion#contains() contains}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ValueSet_Expansion#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ValueSet_Expansion#modifierExtension() modifierExtension}
   *    .timestamp(com.medplum.types.fhir.DateTime) // optional {@link ValueSet_Expansion#timestamp() timestamp}
   *    .parameter(List&amp;lt;com.medplum.types.fhir.ValueSet_Parameter&amp;gt;) // optional {@link ValueSet_Expansion#parameter() parameter}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_CONTAINS = 0x10L;
    private static final long OPT_BIT_EXTENSION = 0x20L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x40L;
    private static final long OPT_BIT_TIMESTAMP = 0x80L;
    ...
    public ValueSet_Expansion build() {
      return new ImmutableValueSet_Expansion(id, total, offset, identifier, contains, extension, modifierExtension, timestamp, parameter);
    }
