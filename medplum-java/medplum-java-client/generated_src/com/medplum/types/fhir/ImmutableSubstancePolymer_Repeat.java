...
final class ImmutableSubstancePolymer_Repeat implements SubstancePolymer_Repeat {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code id}, {@code repeatUnitAmountType}, {@code numberOfUnits}, {@code repeatUnit}, {@code modifierExtension}, {@code averageMolecularFormula}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_Repeat#extension() extension}
   *    .id(String) // optional {@link SubstancePolymer_Repeat#id() id}
   *    .repeatUnitAmountType(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstancePolymer_Repeat#repeatUnitAmountType() repeatUnitAmountType}
   *    .numberOfUnits(Integer) // optional {@link SubstancePolymer_Repeat#numberOfUnits() numberOfUnits}
   *    .repeatUnit(List&amp;lt;com.medplum.types.fhir.SubstancePolymer_RepeatUnit&amp;gt;) // optional {@link SubstancePolymer_Repeat#repeatUnit() repeatUnit}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_Repeat#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_REPEAT_UNIT_AMOUNT_TYPE = 0x4L;
    private static final long OPT_BIT_NUMBER_OF_UNITS = 0x8L;
    private static final long OPT_BIT_REPEAT_UNIT = 0x10L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x20L;
    private static final long OPT_BIT_AVERAGE_MOLECULAR_FORMULA = 0x40L;
