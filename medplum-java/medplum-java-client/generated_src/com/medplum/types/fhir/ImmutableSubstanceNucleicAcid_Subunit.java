...
final class ImmutableSubstanceNucleicAcid_Subunit
    implements SubstanceNucleicAcid_Subunit {
  ...
  private boolean equalTo(ImmutableSubstanceNucleicAcid_Subunit another) {
    return Objects.equals(sequenceAttachment, another.sequenceAttachment)
        ...
        && Objects.equals(linkage, another.linkage)
  ...
  /**
   * Computes a hash code from attributes: {@code sequenceAttachment}, {@code modifierExtension}, {@code sugar}, {@code id}, {@code extension}, {@code sequence}, {@code threePrime}, {@code linkage}, {@code length}, {@code subunit}, {@code fivePrime}.
   ...
   *    .sequenceAttachment(com.medplum.types.fhir.Attachment) // optional {@link SubstanceNucleicAcid_Subunit#sequenceAttachment() sequenceAttachment}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceNucleicAcid_Subunit#modifierExtension() modifierExtension}
   *    .sugar(List&amp;lt;com.medplum.types.fhir.SubstanceNucleicAcid_Sugar&amp;gt;) // optional {@link SubstanceNucleicAcid_Subunit#sugar() sugar}
   *    .id(String) // optional {@link SubstanceNucleicAcid_Subunit#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceNucleicAcid_Subunit#extension() extension}
   *    .sequence(String) // optional {@link SubstanceNucleicAcid_Subunit#sequence() sequence}
   *    .threePrime(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceNucleicAcid_Subunit#threePrime() threePrime}
   *    .linkage(List&amp;lt;com.medplum.types.fhir.SubstanceNucleicAcid_Linkage&amp;gt;) // optional {@link SubstanceNucleicAcid_Subunit#linkage() linkage}
   ...
   *    .fivePrime(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceNucleicAcid_Subunit#fivePrime() fivePrime}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SUGAR = 0x4L;
    private static final long OPT_BIT_ID = 0x8L;
    private static final long OPT_BIT_EXTENSION = 0x10L;
    private static final long OPT_BIT_SEQUENCE = 0x20L;
    private static final long OPT_BIT_THREE_PRIME = 0x40L;
    private static final long OPT_BIT_LINKAGE = 0x80L;
    private static final long OPT_BIT_LENGTH = 0x100L;
    private static final long OPT_BIT_SUBUNIT = 0x200L;
    private static final long OPT_BIT_FIVE_PRIME = 0x400L;
