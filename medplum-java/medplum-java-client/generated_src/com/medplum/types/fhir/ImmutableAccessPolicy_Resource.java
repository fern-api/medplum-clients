...
final class ImmutableAccessPolicy_Resource implements AccessPolicy_Resource {
  ...
  public final ImmutableAccessPolicy_Resource withReadonly(boolean value) {
    ...
    return new ImmutableAccessPolicy_Resource(newValue, this.hiddenFields, this.compartment, this.readonlyFields, this.resourceType);
  }
  ...
  public final ImmutableAccessPolicy_Resource withReadonly(Optional<Boolean> optional) {
    ...
    return new ImmutableAccessPolicy_Resource(value, this.hiddenFields, this.compartment, this.readonlyFields, this.resourceType);
  }
  ...
  public final ImmutableAccessPolicy_Resource withHiddenFields(List<String> value) {
    ...
    return new ImmutableAccessPolicy_Resource(this.readonly, newValue, this.compartment, this.readonlyFields, this.resourceType);
  }
  ...
  public final ImmutableAccessPolicy_Resource withHiddenFields(Optional<? extends List<String>> optional) {
    ...
    return new ImmutableAccessPolicy_Resource(this.readonly, value, this.compartment, this.readonlyFields, this.resourceType);
  }
  ...
  public final ImmutableAccessPolicy_Resource withCompartment(Reference value) {
    ...
    return new ImmutableAccessPolicy_Resource(this.readonly, this.hiddenFields, newValue, this.readonlyFields, this.resourceType);
  }
  ...
  public final ImmutableAccessPolicy_Resource withCompartment(Optional<? extends Reference> optional) {
    ...
    return new ImmutableAccessPolicy_Resource(this.readonly, this.hiddenFields, value, this.readonlyFields, this.resourceType);
  }
  ...
  public final ImmutableAccessPolicy_Resource withReadonlyFields(List<String> value) {
    ...
    return new ImmutableAccessPolicy_Resource(this.readonly, this.hiddenFields, this.compartment, newValue, this.resourceType);
  }
  ...
  public final ImmutableAccessPolicy_Resource withReadonlyFields(Optional<? extends List<String>> optional) {
    ...
    return new ImmutableAccessPolicy_Resource(this.readonly, this.hiddenFields, this.compartment, value, this.resourceType);
  }
  ...
  public final ImmutableAccessPolicy_Resource withResourceType(String value) {
    ...
    return new ImmutableAccessPolicy_Resource(this.readonly, this.hiddenFields, this.compartment, this.readonlyFields, newValue);
  }
  ...
  public final ImmutableAccessPolicy_Resource withResourceType(Optional<String> optional) {
    ...
    return new ImmutableAccessPolicy_Resource(this.readonly, this.hiddenFields, this.compartment, this.readonlyFields, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code readonly}, {@code hiddenFields}, {@code compartment}, {@code readonlyFields}, {@code resourceType}.
   ...
   *    .compartment(com.medplum.types.fhir.Reference) // optional {@link AccessPolicy_Resource#compartment() compartment}
  ...
  public static final class Builder {
    private static final long OPT_BIT_READONLY = 0x1L;
    private static final long OPT_BIT_HIDDEN_FIELDS = 0x2L;
    ...
    public AccessPolicy_Resource build() {
      return new ImmutableAccessPolicy_Resource(readonly, hiddenFields, compartment, readonlyFields, resourceType);
    }
