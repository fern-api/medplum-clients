...
final class ImmutableContract_Offer implements Contract_Offer {
  ...
  /**
   * Computes a hash code from attributes: {@code identifier}, {@code securityLabelNumber}, {@code answer}, {@code linkId}, {@code modifierExtension}, {@code id}, {@code extension}, {@code party}, {@code type}, {@code text}, {@code decision}, {@code topic}, {@code decisionMode}.
   ...
   *    .identifier(List&amp;lt;com.medplum.types.fhir.Identifier&amp;gt;) // optional {@link Contract_Offer#identifier() identifier}
   *    .securityLabelNumber(List&amp;lt;com.medplum.types.fhir.UnsignedInt&amp;gt;) // optional {@link Contract_Offer#securityLabelNumber() securityLabelNumber}
   *    .answer(List&amp;lt;com.medplum.types.fhir.Contract_Answer&amp;gt;) // optional {@link Contract_Offer#answer() answer}
   *    .linkId(List&amp;lt;String&amp;gt;) // optional {@link Contract_Offer#linkId() linkId}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Contract_Offer#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link Contract_Offer#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Contract_Offer#extension() extension}
   *    .party(List&amp;lt;com.medplum.types.fhir.Contract_Party&amp;gt;) // optional {@link Contract_Offer#party() party}
   *    .type(com.medplum.types.fhir.CodeableConcept) // optional {@link Contract_Offer#type() type}
   *    .text(String) // optional {@link Contract_Offer#text() text}
   *    .decision(com.medplum.types.fhir.CodeableConcept) // optional {@link Contract_Offer#decision() decision}
   *    .topic(com.medplum.types.fhir.Reference) // optional {@link Contract_Offer#topic() topic}
   *    .decisionMode(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link Contract_Offer#decisionMode() decisionMode}
   *    .build();
   * </pre>
