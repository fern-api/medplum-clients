...
final class ImmutableBundle_Link implements Bundle_Link {
  ...
  public final ImmutableBundle_Link withId(String value) {
    ...
    return new ImmutableBundle_Link(newValue, this.modifierExtension, this.url, this.relation, this.extension);
  }
  ...
  public final ImmutableBundle_Link withId(Optional<String> optional) {
    ...
    return new ImmutableBundle_Link(value, this.modifierExtension, this.url, this.relation, this.extension);
  }
  ...
  public final ImmutableBundle_Link withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableBundle_Link(this.id, newValue, this.url, this.relation, this.extension);
  }
  ...
  public final ImmutableBundle_Link withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableBundle_Link(this.id, value, this.url, this.relation, this.extension);
  }
  ...
  public final ImmutableBundle_Link withUrl(Uri value) {
    ...
    return new ImmutableBundle_Link(this.id, this.modifierExtension, newValue, this.relation, this.extension);
  }
  ...
  public final ImmutableBundle_Link withUrl(Optional<? extends Uri> optional) {
    ...
    return new ImmutableBundle_Link(this.id, this.modifierExtension, value, this.relation, this.extension);
  }
  ...
  public final ImmutableBundle_Link withRelation(String value) {
    ...
    return new ImmutableBundle_Link(this.id, this.modifierExtension, this.url, newValue, this.extension);
  }
  ...
  public final ImmutableBundle_Link withRelation(Optional<String> optional) {
    ...
    return new ImmutableBundle_Link(this.id, this.modifierExtension, this.url, value, this.extension);
  }
  ...
  public final ImmutableBundle_Link withExtension(List<Extension> value) {
    ...
    return new ImmutableBundle_Link(this.id, this.modifierExtension, this.url, this.relation, newValue);
  }
  ...
  public final ImmutableBundle_Link withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableBundle_Link(this.id, this.modifierExtension, this.url, this.relation, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code url}, {@code relation}, {@code extension}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Bundle_Link#modifierExtension() modifierExtension}
   *    .url(com.medplum.types.fhir.Uri) // optional {@link Bundle_Link#url() url}
   *    .relation(String) // optional {@link Bundle_Link#relation() relation}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Bundle_Link#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Bundle_Link build() {
      return new ImmutableBundle_Link(id, modifierExtension, url, relation, extension);
    }
