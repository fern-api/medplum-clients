...
final class ImmutableRatio implements Ratio {
  ...
  public final ImmutableRatio withDenominator(Quantity value) {
    ...
    return new ImmutableRatio(newValue, this.extension, this.numerator, this.id);
  }
  ...
  public final ImmutableRatio withDenominator(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableRatio(value, this.extension, this.numerator, this.id);
  }
  ...
  public final ImmutableRatio withExtension(List<Extension> value) {
    ...
    return new ImmutableRatio(this.denominator, newValue, this.numerator, this.id);
  }
  ...
  public final ImmutableRatio withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableRatio(this.denominator, value, this.numerator, this.id);
  }
  ...
  public final ImmutableRatio withNumerator(Quantity value) {
    ...
    return new ImmutableRatio(this.denominator, this.extension, newValue, this.id);
  }
  ...
  public final ImmutableRatio withNumerator(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableRatio(this.denominator, this.extension, value, this.id);
  }
  ...
  public final ImmutableRatio withId(String value) {
    ...
    return new ImmutableRatio(this.denominator, this.extension, this.numerator, newValue);
  }
  ...
  public final ImmutableRatio withId(Optional<String> optional) {
    ...
    return new ImmutableRatio(this.denominator, this.extension, this.numerator, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code denominator}, {@code extension}, {@code numerator}, {@code id}.
   ...
   *    .denominator(com.medplum.types.fhir.Quantity) // optional {@link Ratio#denominator() denominator}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Ratio#extension() extension}
   *    .numerator(com.medplum.types.fhir.Quantity) // optional {@link Ratio#numerator() numerator}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_NUMERATOR = 0x4L;
     ...
     */
    public Ratio build() {
      return new ImmutableRatio(denominator, extension, numerator, id);
    }
