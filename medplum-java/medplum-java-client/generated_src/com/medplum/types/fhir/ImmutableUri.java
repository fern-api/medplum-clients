 ...
 */
@Generated(from = "Uri", generator = "Immutables")
@SuppressWarnings({"all"})
@SuppressFBWarnings
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@Immutable
final class ImmutableUri implements Uri {
  private final String value;

  private ImmutableUri(String value) {
    this.value = value;
  }
   ...
   */
  public final ImmutableUri withValue(String value) {
  ...
  static ImmutableUri fromJson(String jsonValue) {
  ...
  public static final class Builder implements ValueBuildStage, BuildFinal {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new IllegalStateException("Builder of Uri is strict, attribute is already set: ".concat(name));
    }
