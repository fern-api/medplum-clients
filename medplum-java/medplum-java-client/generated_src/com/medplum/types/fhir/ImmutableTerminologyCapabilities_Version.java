...
final class ImmutableTerminologyCapabilities_Version
  ...
  /**
   * Computes a hash code from attributes: {@code code}, {@code isDefault}, {@code id}, {@code modifierExtension}, {@code extension}, {@code property}, {@code filter}, {@code compositional}, {@code language}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TerminologyCapabilities_Version#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TerminologyCapabilities_Version#extension() extension}
   *    .property(List&amp;lt;com.medplum.types.fhir.Code&amp;gt;) // optional {@link TerminologyCapabilities_Version#property() property}
   *    .filter(List&amp;lt;com.medplum.types.fhir.TerminologyCapabilities_Filter&amp;gt;) // optional {@link TerminologyCapabilities_Version#filter() filter}
   *    .compositional(Boolean) // optional {@link TerminologyCapabilities_Version#compositional() compositional}
   *    .language(List&amp;lt;com.medplum.types.fhir.Code&amp;gt;) // optional {@link TerminologyCapabilities_Version#language() language}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TerminologyCapabilities_Version build() {
      return new ImmutableTerminologyCapabilities_Version(code, isDefault, id, modifierExtension, extension, property, filter, compositional, language);
    }
