...
final class ImmutableExampleScenario_Actor implements ExampleScenario_Actor {
  ...
  public final ImmutableExampleScenario_Actor withDescription(Markdown value) {
    ...
    return new ImmutableExampleScenario_Actor(newValue, this.extension, this.actorId, this.name, this.type, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableExampleScenario_Actor withDescription(Optional<? extends Markdown> optional) {
    ...
    return new ImmutableExampleScenario_Actor(value, this.extension, this.actorId, this.name, this.type, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableExampleScenario_Actor withExtension(List<Extension> value) {
    ...
    return new ImmutableExampleScenario_Actor(this.description, newValue, this.actorId, this.name, this.type, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableExampleScenario_Actor withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableExampleScenario_Actor(this.description, value, this.actorId, this.name, this.type, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableExampleScenario_Actor withActorId(Optional<String> optional) {
    ...
    return new ImmutableExampleScenario_Actor(this.description, this.extension, value, this.name, this.type, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableExampleScenario_Actor withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableExampleScenario_Actor(this.description, this.extension, this.actorId, this.name, this.type, this.id, newValue);
  }
  ...
  public final ImmutableExampleScenario_Actor withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableExampleScenario_Actor(this.description, this.extension, this.actorId, this.name, this.type, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code description}, {@code extension}, {@code actorId}, {@code name}, {@code type}, {@code id}, {@code modifierExtension}.
   ...
   *    .description(com.medplum.types.fhir.Markdown) // optional {@link ExampleScenario_Actor#description() description}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Actor#extension() extension}
   ...
   *    .type(com.medplum.types.fhir.Examplescenario_actorType) // optional {@link ExampleScenario_Actor#type() type}
   *    .id(String) // optional {@link ExampleScenario_Actor#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Actor#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_ACTOR_ID = 0x4L;
    ...
    public ExampleScenario_Actor build() {
      return new ImmutableExampleScenario_Actor(description, extension, actorId, name, type, id, modifierExtension);
    }
