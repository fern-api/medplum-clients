...
final class ImmutableMedicationAdministration_Dosage
  ...
  /**
   * Computes a hash code from attributes: {@code method}, {@code route}, {@code id}, {@code modifierExtension}, {@code rateRatio}, {@code extension}, {@code dose}, {@code rateQuantity}, {@code text}, {@code site}.
   ...
   *    .method(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicationAdministration_Dosage#method() method}
   *    .route(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicationAdministration_Dosage#route() route}
   *    .id(String) // optional {@link MedicationAdministration_Dosage#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationAdministration_Dosage#modifierExtension() modifierExtension}
   *    .rateRatio(com.medplum.types.fhir.Ratio) // optional {@link MedicationAdministration_Dosage#rateRatio() rateRatio}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationAdministration_Dosage#extension() extension}
   *    .dose(com.medplum.types.fhir.Quantity) // optional {@link MedicationAdministration_Dosage#dose() dose}
   *    .rateQuantity(com.medplum.types.fhir.Quantity) // optional {@link MedicationAdministration_Dosage#rateQuantity() rateQuantity}
   *    .text(String) // optional {@link MedicationAdministration_Dosage#text() text}
   *    .site(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicationAdministration_Dosage#site() site}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_ROUTE = 0x2L;
    ...
    private static final long OPT_BIT_RATE_QUANTITY = 0x80L;
    private static final long OPT_BIT_TEXT = 0x100L;
    private static final long OPT_BIT_SITE = 0x200L;
    ...
    public MedicationAdministration_Dosage build() {
      return new ImmutableMedicationAdministration_Dosage(method, route, id, modifierExtension, rateRatio, extension, dose, rateQuantity, text, site);
    }
