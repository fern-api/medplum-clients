...
final class ImmutableQuestionnaire_Initial implements Questionnaire_Initial {
  ...
  /**
   * Computes a hash code from attributes: {@code valueCoding}, {@code modifierExtension}, {@code valueQuantity}, {@code id}, {@code extension}, {@code valueString}, {@code valueBoolean}, {@code valueTime}, {@code valueDate}, {@code valueInteger}, {@code valueAttachment}, {@code valueDateTime}, {@code valueDecimal}, {@code valueUri}, {@code valueReference}.
   ...
   *    .valueCoding(com.medplum.types.fhir.Coding) // optional {@link Questionnaire_Initial#valueCoding() valueCoding}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Questionnaire_Initial#modifierExtension() modifierExtension}
   *    .valueQuantity(com.medplum.types.fhir.Quantity) // optional {@link Questionnaire_Initial#valueQuantity() valueQuantity}
   *    .id(String) // optional {@link Questionnaire_Initial#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Questionnaire_Initial#extension() extension}
   ...
   *    .valueAttachment(com.medplum.types.fhir.Attachment) // optional {@link Questionnaire_Initial#valueAttachment() valueAttachment}
   ...
   *    .valueReference(com.medplum.types.fhir.Reference) // optional {@link Questionnaire_Initial#valueReference() valueReference}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_VALUE_DECIMAL = 0x1000L;
