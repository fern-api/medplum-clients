...
final class ImmutableRiskEvidenceSynthesis_SampleSize
  ...
  public final ImmutableRiskEvidenceSynthesis_SampleSize withNumberOfParticipants(Optional<Integer> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_SampleSize(this.id, this.description, this.modifierExtension, value, this.extension, this.numberOfStudies);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code description}, {@code modifierExtension}, {@code numberOfParticipants}, {@code extension}, {@code numberOfStudies}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_SampleSize#modifierExtension() modifierExtension}
   *    .numberOfParticipants(Integer) // optional {@link RiskEvidenceSynthesis_SampleSize#numberOfParticipants() numberOfParticipants}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_SampleSize#extension() extension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_NUMBER_OF_PARTICIPANTS = 0x8L;
    ...
    public RiskEvidenceSynthesis_SampleSize build() {
      return new ImmutableRiskEvidenceSynthesis_SampleSize(id, description, modifierExtension, numberOfParticipants, extension, numberOfStudies);
    }
