...
final class ImmutableAddress implements Address {
  ...
  /**
   * Computes a hash code from attributes: {@code state}, {@code type}, {@code use}, {@code extension}, {@code text}, {@code line}, {@code id}, {@code period}, {@code postalCode}, {@code district}, {@code city}, {@code country}.
   ...
   *    .type(com.medplum.types.fhir.AddressType) // optional {@link Address#type() type}
   *    .use(com.medplum.types.fhir.AddressUse) // optional {@link Address#use() use}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Address#extension() extension}
   ...
   *    .period(com.medplum.types.fhir.Period) // optional {@link Address#period() period}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_LINE = 0x20L;
    private static final long OPT_BIT_ID = 0x40L;
    private static final long OPT_BIT_PERIOD = 0x80L;
    private static final long OPT_BIT_POSTAL_CODE = 0x100L;
    private static final long OPT_BIT_DISTRICT = 0x200L;
    private static final long OPT_BIT_CITY = 0x400L;
    private static final long OPT_BIT_COUNTRY = 0x800L;
    ...
    public Address build() {
      return new ImmutableAddress(state, type, use, extension, text, line, id, period, postalCode, district, city, country);
    }
