...
final class ImmutableMedicationKnowledge_Dosage
    implements MedicationKnowledge_Dosage {
  ...
  public final ImmutableMedicationKnowledge_Dosage withType(CodeableConcept value) {
    ...
    return new ImmutableMedicationKnowledge_Dosage(newValue, this.extension, this.modifierExtension, this.id, this.dosage);
  }
  ...
  public final ImmutableMedicationKnowledge_Dosage withExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationKnowledge_Dosage(this.type, newValue, this.modifierExtension, this.id, this.dosage);
  }
  ...
  public final ImmutableMedicationKnowledge_Dosage withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationKnowledge_Dosage(this.type, value, this.modifierExtension, this.id, this.dosage);
  }
  ...
  public final ImmutableMedicationKnowledge_Dosage withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationKnowledge_Dosage(this.type, this.extension, newValue, this.id, this.dosage);
  }
  ...
  public final ImmutableMedicationKnowledge_Dosage withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationKnowledge_Dosage(this.type, this.extension, value, this.id, this.dosage);
  }
  ...
  public final ImmutableMedicationKnowledge_Dosage withId(String value) {
    ...
    return new ImmutableMedicationKnowledge_Dosage(this.type, this.extension, this.modifierExtension, newValue, this.dosage);
  }
  ...
  public final ImmutableMedicationKnowledge_Dosage withId(Optional<String> optional) {
    ...
    return new ImmutableMedicationKnowledge_Dosage(this.type, this.extension, this.modifierExtension, value, this.dosage);
  }
  ...
  public final ImmutableMedicationKnowledge_Dosage withDosage(Dosage... elements) {
    ...
    return new ImmutableMedicationKnowledge_Dosage(this.type, this.extension, this.modifierExtension, this.id, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code type}, {@code extension}, {@code modifierExtension}, {@code id}, {@code dosage}.
   ...
   *    .type(com.medplum.types.fhir.CodeableConcept) // required {@link MedicationKnowledge_Dosage#type() type}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Dosage#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Dosage#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link MedicationKnowledge_Dosage#id() id}
   *    .addDosage|addAllDosage(com.medplum.types.fhir.Dosage) // {@link MedicationKnowledge_Dosage#dosage() dosage} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder implements TypeBuildStage, BuildFinal {
    ...
    public MedicationKnowledge_Dosage build() {
      ...
      return new ImmutableMedicationKnowledge_Dosage(type, extension, modifierExtension, id, createUnmodifiableList(true, dosage));
    }
