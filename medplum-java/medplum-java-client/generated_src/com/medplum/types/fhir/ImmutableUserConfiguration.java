...
final class ImmutableUserConfiguration implements UserConfiguration {
  ...
  /**
   * Computes a hash code from attributes: {@code language}, {@code name}, {@code option}, {@code meta}, {@code resourceType}, {@code id}, {@code search}, {@code menu}, {@code implicitRules}.
   ...
   *    .language(com.medplum.types.fhir.Code) // optional {@link UserConfiguration#language() language}
   *    .name(String) // optional {@link UserConfiguration#name() name}
   *    .option(List&amp;lt;com.medplum.types.fhir.UserConfiguration_Option&amp;gt;) // optional {@link UserConfiguration#option() option}
   *    .meta(com.medplum.types.fhir.Meta) // optional {@link UserConfiguration#meta() meta}
   *    .resourceType(String) // optional {@link UserConfiguration#resourceType() resourceType}
   *    .id(com.medplum.types.fhir.Id) // optional {@link UserConfiguration#id() id}
   *    .search(List&amp;lt;com.medplum.types.fhir.UserConfiguration_Search&amp;gt;) // optional {@link UserConfiguration#search() search}
   *    .menu(List&amp;lt;com.medplum.types.fhir.UserConfiguration_Menu&amp;gt;) // optional {@link UserConfiguration#menu() menu}
   *    .implicitRules(com.medplum.types.fhir.Uri) // optional {@link UserConfiguration#implicitRules() implicitRules}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public UserConfiguration build() {
      return new ImmutableUserConfiguration(language, name, option, meta, resourceType, id, search, menu, implicitRules);
    }
