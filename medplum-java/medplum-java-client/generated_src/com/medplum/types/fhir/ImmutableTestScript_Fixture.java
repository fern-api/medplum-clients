...
final class ImmutableTestScript_Fixture implements TestScript_Fixture {
  ...
  public final ImmutableTestScript_Fixture withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Fixture(newValue, this.resource, this.autocreate, this.modifierExtension, this.autodelete, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Fixture(value, this.resource, this.autocreate, this.modifierExtension, this.autodelete, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withResource(Reference value) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, newValue, this.autocreate, this.modifierExtension, this.autodelete, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withResource(Optional<? extends Reference> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, value, this.autocreate, this.modifierExtension, this.autodelete, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withAutocreate(boolean value) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.resource, newValue, this.modifierExtension, this.autodelete, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withAutocreate(Optional<Boolean> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.resource, value, this.modifierExtension, this.autodelete, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.resource, this.autocreate, newValue, this.autodelete, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.resource, this.autocreate, value, this.autodelete, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withAutodelete(boolean value) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.resource, this.autocreate, this.modifierExtension, newValue, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withAutodelete(Optional<Boolean> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.resource, this.autocreate, this.modifierExtension, value, this.id);
  }
  ...
  public final ImmutableTestScript_Fixture withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Fixture(this.extension, this.resource, this.autocreate, this.modifierExtension, this.autodelete, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code resource}, {@code autocreate}, {@code modifierExtension}, {@code autodelete}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Fixture#extension() extension}
   *    .resource(com.medplum.types.fhir.Reference) // optional {@link TestScript_Fixture#resource() resource}
   *    .autocreate(Boolean) // optional {@link TestScript_Fixture#autocreate() autocreate}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Fixture#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_AUTOCREATE = 0x4L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x8L;
    private static final long OPT_BIT_AUTODELETE = 0x10L;
    ...
    public TestScript_Fixture build() {
      return new ImmutableTestScript_Fixture(extension, resource, autocreate, modifierExtension, autodelete, id);
    }
