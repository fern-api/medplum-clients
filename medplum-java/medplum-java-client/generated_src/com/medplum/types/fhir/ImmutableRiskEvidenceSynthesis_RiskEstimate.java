...
final class ImmutableRiskEvidenceSynthesis_RiskEstimate
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code denominatorCount}, {@code extension}, {@code value}, {@code description}, {@code unitOfMeasure}, {@code modifierExtension}, {@code type}, {@code numeratorCount}, {@code precisionEstimate}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_RiskEstimate#extension() extension}
   *    .value(com.medplum.types.fhir.Decimal) // optional {@link RiskEvidenceSynthesis_RiskEstimate#value() value}
   *    .description(String) // optional {@link RiskEvidenceSynthesis_RiskEstimate#description() description}
   *    .unitOfMeasure(com.medplum.types.fhir.CodeableConcept) // optional {@link RiskEvidenceSynthesis_RiskEstimate#unitOfMeasure() unitOfMeasure}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_RiskEstimate#modifierExtension() modifierExtension}
   *    .type(com.medplum.types.fhir.CodeableConcept) // optional {@link RiskEvidenceSynthesis_RiskEstimate#type() type}
   *    .numeratorCount(Integer) // optional {@link RiskEvidenceSynthesis_RiskEstimate#numeratorCount() numeratorCount}
   *    .precisionEstimate(List&amp;lt;com.medplum.types.fhir.RiskEvidenceSynthesis_PrecisionEstimate&amp;gt;) // optional {@link RiskEvidenceSynthesis_RiskEstimate#precisionEstimate() precisionEstimate}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DENOMINATOR_COUNT = 0x2L;
    ...
    private static final long OPT_BIT_PRECISION_ESTIMATE = 0x200L;
