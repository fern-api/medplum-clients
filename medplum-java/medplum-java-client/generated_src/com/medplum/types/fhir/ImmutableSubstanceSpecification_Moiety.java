...
final class ImmutableSubstanceSpecification_Moiety
  ...
  private boolean equalTo(ImmutableSubstanceSpecification_Moiety another) {
    return Objects.equals(amountQuantity, another.amountQuantity)
  ...
  /**
   * Computes a hash code from attributes: {@code amountQuantity}, {@code id}, {@code name}, {@code molecularFormula}, {@code opticalActivity}, {@code modifierExtension}, {@code role}, {@code extension}, {@code amountString}, {@code identifier}, {@code stereochemistry}.
   ...
   *    .amountQuantity(com.medplum.types.fhir.Quantity) // optional {@link SubstanceSpecification_Moiety#amountQuantity() amountQuantity}
   ...
   *    .opticalActivity(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Moiety#opticalActivity() opticalActivity}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Moiety#modifierExtension() modifierExtension}
   *    .role(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Moiety#role() role}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Moiety#extension() extension}
   *    .amountString(String) // optional {@link SubstanceSpecification_Moiety#amountString() amountString}
   *    .identifier(com.medplum.types.fhir.Identifier) // optional {@link SubstanceSpecification_Moiety#identifier() identifier}
   *    .stereochemistry(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Moiety#stereochemistry() stereochemistry}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_AMOUNT_QUANTITY = 0x1L;
    private static final long OPT_BIT_ID = 0x2L;
    private static final long OPT_BIT_NAME = 0x4L;
    private static final long OPT_BIT_MOLECULAR_FORMULA = 0x8L;
    private static final long OPT_BIT_OPTICAL_ACTIVITY = 0x10L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x20L;
    private static final long OPT_BIT_ROLE = 0x40L;
    ...
    private static final long OPT_BIT_STEREOCHEMISTRY = 0x400L;
