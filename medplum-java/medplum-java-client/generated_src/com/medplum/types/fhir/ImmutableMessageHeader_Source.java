...
final class ImmutableMessageHeader_Source implements MessageHeader_Source {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code name}, {@code software}, {@code endpoint}, {@code id}, {@code version}, {@code modifierExtension}, {@code contact}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MessageHeader_Source#extension() extension}
   ...
   *    .endpoint(com.medplum.types.fhir.Url) // optional {@link MessageHeader_Source#endpoint() endpoint}
   *    .id(String) // optional {@link MessageHeader_Source#id() id}
   *    .version(String) // optional {@link MessageHeader_Source#version() version}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MessageHeader_Source#modifierExtension() modifierExtension}
   *    .contact(com.medplum.types.fhir.ContactPoint) // optional {@link MessageHeader_Source#contact() contact}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SOFTWARE = 0x4L;
    ...
    public MessageHeader_Source build() {
      return new ImmutableMessageHeader_Source(extension, name, software, endpoint, id, version, modifierExtension, contact);
    }
