...
final class ImmutableImmunization_ProtocolApplied
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code doseNumberString}, {@code targetDisease}, {@code seriesDosesString}, {@code modifierExtension}, {@code extension}, {@code series}, {@code doseNumberPositiveInt}, {@code authority}, {@code seriesDosesPositiveInt}.
   ...
   *    .targetDisease(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link Immunization_ProtocolApplied#targetDisease() targetDisease}
   *    .seriesDosesString(String) // optional {@link Immunization_ProtocolApplied#seriesDosesString() seriesDosesString}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Immunization_ProtocolApplied#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Immunization_ProtocolApplied#extension() extension}
   ...
   *    .authority(com.medplum.types.fhir.Reference) // optional {@link Immunization_ProtocolApplied#authority() authority}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DOSE_NUMBER_STRING = 0x2L;
    ...
    private static final long OPT_BIT_SERIES = 0x40L;
    private static final long OPT_BIT_DOSE_NUMBER_POSITIVE_INT = 0x80L;
    private static final long OPT_BIT_AUTHORITY = 0x100L;
    private static final long OPT_BIT_SERIES_DOSES_POSITIVE_INT = 0x200L;
