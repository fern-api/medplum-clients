...
final class ImmutableOperationDefinition_ReferencedFrom
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withSource(String value) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(newValue, this.modifierExtension, this.sourceId, this.id, this.extension);
  }
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withSource(Optional<String> optional) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(value, this.modifierExtension, this.sourceId, this.id, this.extension);
  }
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(this.source, newValue, this.sourceId, this.id, this.extension);
  }
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(this.source, value, this.sourceId, this.id, this.extension);
  }
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withSourceId(String value) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(this.source, this.modifierExtension, newValue, this.id, this.extension);
  }
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withSourceId(Optional<String> optional) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(this.source, this.modifierExtension, value, this.id, this.extension);
  }
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withId(String value) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(this.source, this.modifierExtension, this.sourceId, newValue, this.extension);
  }
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withId(Optional<String> optional) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(this.source, this.modifierExtension, this.sourceId, value, this.extension);
  }
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withExtension(List<Extension> value) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(this.source, this.modifierExtension, this.sourceId, this.id, newValue);
  }
  ...
  public final ImmutableOperationDefinition_ReferencedFrom withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableOperationDefinition_ReferencedFrom(this.source, this.modifierExtension, this.sourceId, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code source}, {@code modifierExtension}, {@code sourceId}, {@code id}, {@code extension}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link OperationDefinition_ReferencedFrom#modifierExtension() modifierExtension}
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link OperationDefinition_ReferencedFrom#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SOURCE_ID = 0x4L;
    ...
    public OperationDefinition_ReferencedFrom build() {
      return new ImmutableOperationDefinition_ReferencedFrom(source, modifierExtension, sourceId, id, extension);
    }
