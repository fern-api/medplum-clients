...
final class ImmutableMedicationRequest_InitialFill
  ...
  public final ImmutableMedicationRequest_InitialFill withExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationRequest_InitialFill(newValue, this.duration, this.modifierExtension, this.quantity, this.id);
  }
  ...
  public final ImmutableMedicationRequest_InitialFill withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationRequest_InitialFill(value, this.duration, this.modifierExtension, this.quantity, this.id);
  }
  ...
  public final ImmutableMedicationRequest_InitialFill withDuration(Duration value) {
    ...
    return new ImmutableMedicationRequest_InitialFill(this.extension, newValue, this.modifierExtension, this.quantity, this.id);
  }
  ...
  public final ImmutableMedicationRequest_InitialFill withDuration(Optional<? extends Duration> optional) {
    ...
    return new ImmutableMedicationRequest_InitialFill(this.extension, value, this.modifierExtension, this.quantity, this.id);
  }
  ...
  public final ImmutableMedicationRequest_InitialFill withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationRequest_InitialFill(this.extension, this.duration, newValue, this.quantity, this.id);
  }
  ...
  public final ImmutableMedicationRequest_InitialFill withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationRequest_InitialFill(this.extension, this.duration, value, this.quantity, this.id);
  }
  ...
  public final ImmutableMedicationRequest_InitialFill withQuantity(Quantity value) {
    ...
    return new ImmutableMedicationRequest_InitialFill(this.extension, this.duration, this.modifierExtension, newValue, this.id);
  }
  ...
  public final ImmutableMedicationRequest_InitialFill withQuantity(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableMedicationRequest_InitialFill(this.extension, this.duration, this.modifierExtension, value, this.id);
  }
  ...
  public final ImmutableMedicationRequest_InitialFill withId(String value) {
    ...
    return new ImmutableMedicationRequest_InitialFill(this.extension, this.duration, this.modifierExtension, this.quantity, newValue);
  }
  ...
  public final ImmutableMedicationRequest_InitialFill withId(Optional<String> optional) {
    ...
    return new ImmutableMedicationRequest_InitialFill(this.extension, this.duration, this.modifierExtension, this.quantity, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code duration}, {@code modifierExtension}, {@code quantity}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationRequest_InitialFill#extension() extension}
   *    .duration(com.medplum.types.fhir.Duration) // optional {@link MedicationRequest_InitialFill#duration() duration}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationRequest_InitialFill#modifierExtension() modifierExtension}
   *    .quantity(com.medplum.types.fhir.Quantity) // optional {@link MedicationRequest_InitialFill#quantity() quantity}
  ...
  public static final class Builder {
    ...
    public MedicationRequest_InitialFill build() {
      return new ImmutableMedicationRequest_InitialFill(extension, duration, modifierExtension, quantity, id);
    }
