...
final class ImmutableExampleScenario_Operation
    implements ExampleScenario_Operation {
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code extension}, {@code number}, {@code response}, {@code receiver}, {@code type}, {@code name}, {@code initiatorActive}, {@code description}, {@code receiverActive}, {@code initiator}, {@code id}, {@code request}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Operation#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Operation#extension() extension}
   *    .number(String) // optional {@link ExampleScenario_Operation#number() number}
   *    .response(com.medplum.types.fhir.ExampleScenario_ContainedInstance) // optional {@link ExampleScenario_Operation#response() response}
   ...
   *    .description(com.medplum.types.fhir.Markdown) // optional {@link ExampleScenario_Operation#description() description}
   ...
   *    .request(com.medplum.types.fhir.ExampleScenario_ContainedInstance) // optional {@link ExampleScenario_Operation#request() request}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_RESPONSE = 0x8L;
    private static final long OPT_BIT_RECEIVER = 0x10L;
    private static final long OPT_BIT_TYPE = 0x20L;
    private static final long OPT_BIT_NAME = 0x40L;
    private static final long OPT_BIT_INITIATOR_ACTIVE = 0x80L;
    private static final long OPT_BIT_DESCRIPTION = 0x100L;
    private static final long OPT_BIT_RECEIVER_ACTIVE = 0x200L;
    private static final long OPT_BIT_INITIATOR = 0x400L;
