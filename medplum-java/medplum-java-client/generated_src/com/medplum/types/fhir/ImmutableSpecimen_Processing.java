...
final class ImmutableSpecimen_Processing implements Specimen_Processing {
  ...
  /**
   * Computes a hash code from attributes: {@code timePeriod}, {@code modifierExtension}, {@code id}, {@code description}, {@code timeDateTime}, {@code extension}, {@code procedure}, {@code additive}.
   ...
   *    .timePeriod(com.medplum.types.fhir.Period) // optional {@link Specimen_Processing#timePeriod() timePeriod}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Specimen_Processing#modifierExtension() modifierExtension}
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Specimen_Processing#extension() extension}
   *    .procedure(com.medplum.types.fhir.CodeableConcept) // optional {@link Specimen_Processing#procedure() procedure}
   *    .additive(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link Specimen_Processing#additive() additive}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Specimen_Processing build() {
      return new ImmutableSpecimen_Processing(timePeriod, modifierExtension, id, description, timeDateTime, extension, procedure, additive);
    }
