...
final class ImmutableMeasureReport_Stratum implements MeasureReport_Stratum {
  ...
  public final ImmutableMeasureReport_Stratum withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Stratum(this.measureScore, this.value, this.id, this.population, this.extension, value, this.component);
  }
  ...
  private boolean equalTo(ImmutableMeasureReport_Stratum another) {
    return Objects.equals(measureScore, another.measureScore)
  ...
  /**
   * Computes a hash code from attributes: {@code measureScore}, {@code value}, {@code id}, {@code population}, {@code extension}, {@code modifierExtension}, {@code component}.
   ...
   *    .measureScore(com.medplum.types.fhir.Quantity) // optional {@link MeasureReport_Stratum#measureScore() measureScore}
   *    .value(com.medplum.types.fhir.CodeableConcept) // optional {@link MeasureReport_Stratum#value() value}
   *    .id(String) // optional {@link MeasureReport_Stratum#id() id}
   *    .population(List&amp;lt;com.medplum.types.fhir.MeasureReport_Population1&amp;gt;) // optional {@link MeasureReport_Stratum#population() population}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Stratum#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Stratum#modifierExtension() modifierExtension}
   *    .component(List&amp;lt;com.medplum.types.fhir.MeasureReport_Component&amp;gt;) // optional {@link MeasureReport_Stratum#component() component}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_MEASURE_SCORE = 0x1L;
    ...
    public MeasureReport_Stratum build() {
      return new ImmutableMeasureReport_Stratum(measureScore, value, id, population, extension, modifierExtension, component);
    }
