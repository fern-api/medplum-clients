...
final class ImmutableAttachment implements Attachment {
  ...
  /**
   * Computes a hash code from attributes: {@code url}, {@code contentType}, {@code hash}, {@code data}, {@code id}, {@code extension}, {@code creation}, {@code language}, {@code size}, {@code title}.
   ...
   *    .url(com.medplum.types.fhir.Url) // optional {@link Attachment#url() url}
   *    .contentType(com.medplum.types.fhir.Code) // optional {@link Attachment#contentType() contentType}
   *    .hash(com.medplum.types.fhir.Base64Binary) // optional {@link Attachment#hash() hash}
   *    .data(com.medplum.types.fhir.Base64Binary) // optional {@link Attachment#data() data}
   *    .id(String) // optional {@link Attachment#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Attachment#extension() extension}
   *    .creation(com.medplum.types.fhir.DateTime) // optional {@link Attachment#creation() creation}
   *    .language(com.medplum.types.fhir.Code) // optional {@link Attachment#language() language}
   *    .size(com.medplum.types.fhir.UnsignedInt) // optional {@link Attachment#size() size}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_HASH = 0x4L;
    private static final long OPT_BIT_DATA = 0x8L;
    private static final long OPT_BIT_ID = 0x10L;
    private static final long OPT_BIT_EXTENSION = 0x20L;
    private static final long OPT_BIT_CREATION = 0x40L;
    private static final long OPT_BIT_LANGUAGE = 0x80L;
    private static final long OPT_BIT_SIZE = 0x100L;
    ...
    public Attachment build() {
      return new ImmutableAttachment(url, contentType, hash, data, id, extension, creation, language, size, title);
    }
