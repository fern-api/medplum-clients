...
final class ImmutableTask_Restriction implements Task_Restriction {
  ...
  public final ImmutableTask_Restriction withExtension(List<Extension> value) {
    ...
    return new ImmutableTask_Restriction(newValue, this.id, this.modifierExtension, this.recipient, this.repetitions, this.period);
  }
  ...
  public final ImmutableTask_Restriction withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTask_Restriction(value, this.id, this.modifierExtension, this.recipient, this.repetitions, this.period);
  }
  ...
  public final ImmutableTask_Restriction withId(String value) {
    ...
    return new ImmutableTask_Restriction(this.extension, newValue, this.modifierExtension, this.recipient, this.repetitions, this.period);
  }
  ...
  public final ImmutableTask_Restriction withId(Optional<String> optional) {
    ...
    return new ImmutableTask_Restriction(this.extension, value, this.modifierExtension, this.recipient, this.repetitions, this.period);
  }
  ...
  public final ImmutableTask_Restriction withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTask_Restriction(this.extension, this.id, newValue, this.recipient, this.repetitions, this.period);
  }
  ...
  public final ImmutableTask_Restriction withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTask_Restriction(this.extension, this.id, value, this.recipient, this.repetitions, this.period);
  }
  ...
  public final ImmutableTask_Restriction withRecipient(List<Reference> value) {
    ...
    return new ImmutableTask_Restriction(this.extension, this.id, this.modifierExtension, newValue, this.repetitions, this.period);
  }
  ...
  public final ImmutableTask_Restriction withRecipient(Optional<? extends List<Reference>> optional) {
    ...
    return new ImmutableTask_Restriction(this.extension, this.id, this.modifierExtension, value, this.repetitions, this.period);
  }
  ...
  public final ImmutableTask_Restriction withRepetitions(PositiveInt value) {
    ...
    return new ImmutableTask_Restriction(this.extension, this.id, this.modifierExtension, this.recipient, newValue, this.period);
  }
  ...
  public final ImmutableTask_Restriction withRepetitions(Optional<? extends PositiveInt> optional) {
    ...
    return new ImmutableTask_Restriction(this.extension, this.id, this.modifierExtension, this.recipient, value, this.period);
  }
  ...
  public final ImmutableTask_Restriction withPeriod(Period value) {
    ...
    return new ImmutableTask_Restriction(this.extension, this.id, this.modifierExtension, this.recipient, this.repetitions, newValue);
  }
  ...
  public final ImmutableTask_Restriction withPeriod(Optional<? extends Period> optional) {
    ...
    return new ImmutableTask_Restriction(this.extension, this.id, this.modifierExtension, this.recipient, this.repetitions, value);
  }
  ...
  private boolean equalTo(ImmutableTask_Restriction another) {
    return Objects.equals(extension, another.extension)
        ...
        && Objects.equals(repetitions, another.repetitions)
        && Objects.equals(period, another.period);
  }

  /**
   * Computes a hash code from attributes: {@code extension}, {@code id}, {@code modifierExtension}, {@code recipient}, {@code repetitions}, {@code period}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Task_Restriction#extension() extension}
   *    .id(String) // optional {@link Task_Restriction#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Task_Restriction#modifierExtension() modifierExtension}
   *    .recipient(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link Task_Restriction#recipient() recipient}
   *    .repetitions(com.medplum.types.fhir.PositiveInt) // optional {@link Task_Restriction#repetitions() repetitions}
   *    .period(com.medplum.types.fhir.Period) // optional {@link Task_Restriction#period() period}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_RECIPIENT = 0x8L;
    private static final long OPT_BIT_REPETITIONS = 0x10L;
    ...
    public Task_Restriction build() {
      return new ImmutableTask_Restriction(extension, id, modifierExtension, recipient, repetitions, period);
    }
