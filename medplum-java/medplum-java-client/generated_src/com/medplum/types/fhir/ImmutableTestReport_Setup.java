...
final class ImmutableTestReport_Setup implements TestReport_Setup {
  ...
  public final ImmutableTestReport_Setup withId(String value) {
    ...
    return new ImmutableTestReport_Setup(newValue, this.extension, this.modifierExtension, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withId(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Setup(value, this.extension, this.modifierExtension, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Setup(this.id, newValue, this.modifierExtension, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Setup(this.id, value, this.modifierExtension, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Setup(this.id, this.extension, newValue, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Setup(this.id, this.extension, value, this.action);
  }
  ...
  public final ImmutableTestReport_Setup withAction(TestReport_Action... elements) {
    ...
    return new ImmutableTestReport_Setup(this.id, this.extension, this.modifierExtension, newValue);
  }
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Setup#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Setup#modifierExtension() modifierExtension}
   *    .addAction|addAllAction(com.medplum.types.fhir.TestReport_Action) // {@link TestReport_Setup#action() action} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TestReport_Setup build() {
      return new ImmutableTestReport_Setup(id, extension, modifierExtension, createUnmodifiableList(true, action));
    }
