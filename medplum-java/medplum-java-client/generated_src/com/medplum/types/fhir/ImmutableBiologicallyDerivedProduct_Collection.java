...
final class ImmutableBiologicallyDerivedProduct_Collection
  ...
  /**
   * Computes a hash code from attributes: {@code source}, {@code extension}, {@code id}, {@code modifierExtension}, {@code collector}, {@code collectedDateTime}, {@code collectedPeriod}.
   ...
   *    .source(com.medplum.types.fhir.Reference) // optional {@link BiologicallyDerivedProduct_Collection#source() source}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link BiologicallyDerivedProduct_Collection#extension() extension}
   *    .id(String) // optional {@link BiologicallyDerivedProduct_Collection#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link BiologicallyDerivedProduct_Collection#modifierExtension() modifierExtension}
   *    .collector(com.medplum.types.fhir.Reference) // optional {@link BiologicallyDerivedProduct_Collection#collector() collector}
   *    .collectedDateTime(String) // optional {@link BiologicallyDerivedProduct_Collection#collectedDateTime() collectedDateTime}
   *    .collectedPeriod(com.medplum.types.fhir.Period) // optional {@link BiologicallyDerivedProduct_Collection#collectedPeriod() collectedPeriod}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_COLLECTOR = 0x10L;
    ...
    public BiologicallyDerivedProduct_Collection build() {
      return new ImmutableBiologicallyDerivedProduct_Collection(source, extension, id, modifierExtension, collector, collectedDateTime, collectedPeriod);
    }
