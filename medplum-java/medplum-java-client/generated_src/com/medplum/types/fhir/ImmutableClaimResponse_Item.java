...
final class ImmutableClaimResponse_Item implements ClaimResponse_Item {
  ...
  /**
   * Computes a hash code from attributes: {@code itemSequence}, {@code detail}, {@code noteNumber}, {@code extension}, {@code id}, {@code modifierExtension}, {@code adjudication}.
   ...
   *    .itemSequence(com.medplum.types.fhir.PositiveInt) // optional {@link ClaimResponse_Item#itemSequence() itemSequence}
   *    .detail(List&amp;lt;com.medplum.types.fhir.ClaimResponse_Detail&amp;gt;) // optional {@link ClaimResponse_Item#detail() detail}
   *    .noteNumber(List&amp;lt;com.medplum.types.fhir.PositiveInt&amp;gt;) // optional {@link ClaimResponse_Item#noteNumber() noteNumber}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_Item#extension() extension}
   *    .id(String) // optional {@link ClaimResponse_Item#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_Item#modifierExtension() modifierExtension}
   *    .addAdjudication|addAllAdjudication(com.medplum.types.fhir.ClaimResponse_Adjudication) // {@link ClaimResponse_Item#adjudication() adjudication} elements
   *    .build();
   * </pre>
