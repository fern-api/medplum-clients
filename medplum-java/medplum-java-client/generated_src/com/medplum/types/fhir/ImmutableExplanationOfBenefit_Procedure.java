...
final class ImmutableExplanationOfBenefit_Procedure
  ...
  private boolean equalTo(ImmutableExplanationOfBenefit_Procedure another) {
    return Objects.equals(procedureCodeableConcept, another.procedureCodeableConcept)
  ...
  /**
   * Computes a hash code from attributes: {@code procedureCodeableConcept}, {@code sequence}, {@code extension}, {@code type}, {@code date}, {@code id}, {@code procedureReference}, {@code udi}, {@code modifierExtension}.
   ...
   *    .procedureCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit_Procedure#procedureCodeableConcept() procedureCodeableConcept}
   *    .sequence(com.medplum.types.fhir.PositiveInt) // optional {@link ExplanationOfBenefit_Procedure#sequence() sequence}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_Procedure#extension() extension}
   *    .type(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link ExplanationOfBenefit_Procedure#type() type}
   *    .date(com.medplum.types.fhir.DateTime) // optional {@link ExplanationOfBenefit_Procedure#date() date}
   *    .id(String) // optional {@link ExplanationOfBenefit_Procedure#id() id}
   *    .procedureReference(com.medplum.types.fhir.Reference) // optional {@link ExplanationOfBenefit_Procedure#procedureReference() procedureReference}
   *    .udi(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link ExplanationOfBenefit_Procedure#udi() udi}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_Procedure#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_PROCEDURE_CODEABLE_CONCEPT = 0x1L;
    ...
    private static final long OPT_BIT_UDI = 0x80L;
