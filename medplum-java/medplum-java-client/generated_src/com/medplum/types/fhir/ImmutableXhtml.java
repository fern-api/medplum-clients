 ...
 */
@Generated(from = "Xhtml", generator = "Immutables")
@SuppressWarnings({"all"})
@SuppressFBWarnings
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@Immutable
final class ImmutableXhtml implements Xhtml {
  private final String value;

  private ImmutableXhtml(String value) {
    this.value = value;
  }
   ...
   */
  public final ImmutableXhtml withValue(String value) {
  ...
  static ImmutableXhtml fromJson(String jsonValue) {
  ...
  public static final class Builder implements ValueBuildStage, BuildFinal {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new IllegalStateException("Builder of Xhtml is strict, attribute is already set: ".concat(name));
    }
