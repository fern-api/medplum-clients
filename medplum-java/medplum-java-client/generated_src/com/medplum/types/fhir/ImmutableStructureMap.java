...
final class ImmutableStructureMap implements StructureMap {
  ...
  /**
   * Computes a hash code from attributes: {@code url}, {@code name}, {@code contained}, {@code structure}, {@code status}, {@code contact}, {@code purpose}, {@code jurisdiction}, {@code id}, {@code language}, {@code implicitRules}, {@code description}, {@code publisher}, {@code version}, {@code useContext}, {@code _import}, {@code title}, {@code identifier}, {@code meta}, {@code modifierExtension}, {@code extension}, {@code date}, {@code copyright}, {@code resourceType}, {@code text}, {@code experimental}, {@code group}.
   ...
   *    .url(com.medplum.types.fhir.Uri) // optional {@link StructureMap#url() url}
   *    .name(String) // optional {@link StructureMap#name() name}
   *    .contained(List&amp;lt;com.medplum.types.fhir.ResourceList&amp;gt;) // optional {@link StructureMap#contained() contained}
   *    .structure(List&amp;lt;com.medplum.types.fhir.StructureMap_Structure&amp;gt;) // optional {@link StructureMap#structure() structure}
   *    .status(com.medplum.types.fhir.StructuremapStatus) // optional {@link StructureMap#status() status}
   *    .contact(List&amp;lt;com.medplum.types.fhir.ContactDetail&amp;gt;) // optional {@link StructureMap#contact() contact}
   *    .purpose(com.medplum.types.fhir.Markdown) // optional {@link StructureMap#purpose() purpose}
   *    .jurisdiction(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link StructureMap#jurisdiction() jurisdiction}
   *    .id(com.medplum.types.fhir.Id) // optional {@link StructureMap#id() id}
   *    .language(com.medplum.types.fhir.Code) // optional {@link StructureMap#language() language}
   *    .implicitRules(com.medplum.types.fhir.Uri) // optional {@link StructureMap#implicitRules() implicitRules}
   *    .description(com.medplum.types.fhir.Markdown) // optional {@link StructureMap#description() description}
   *    .publisher(String) // optional {@link StructureMap#publisher() publisher}
   *    .version(String) // optional {@link StructureMap#version() version}
   *    .useContext(List&amp;lt;com.medplum.types.fhir.UsageContext&amp;gt;) // optional {@link StructureMap#useContext() useContext}
   *    ._import(List&amp;lt;com.medplum.types.fhir.Canonical&amp;gt;) // optional {@link StructureMap#_import() _import}
   *    .title(String) // optional {@link StructureMap#title() title}
   *    .identifier(List&amp;lt;com.medplum.types.fhir.Identifier&amp;gt;) // optional {@link StructureMap#identifier() identifier}
   *    .meta(com.medplum.types.fhir.Meta) // optional {@link StructureMap#meta() meta}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link StructureMap#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link StructureMap#extension() extension}
   *    .date(com.medplum.types.fhir.DateTime) // optional {@link StructureMap#date() date}
   *    .copyright(com.medplum.types.fhir.Markdown) // optional {@link StructureMap#copyright() copyright}
   *    .resourceType(String) // required {@link StructureMap#resourceType() resourceType}
   *    .text(com.medplum.types.fhir.Narrative) // optional {@link StructureMap#text() text}
   *    .experimental(Boolean) // optional {@link StructureMap#experimental() experimental}
   *    .addGroup|addAllGroup(com.medplum.types.fhir.StructureMap_Group) // {@link StructureMap#group() group} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ResourceTypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_STRUCTURE = 0x8L;
    ...
    private static final long OPT_BIT__IMPORT = 0x8000L;
