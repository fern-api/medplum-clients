...
final class ImmutableMeasureReport_Population1
    implements MeasureReport_Population1 {
  ...
  public final ImmutableMeasureReport_Population1 withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Population1(newValue, this.code, this.subjectResults, this.count, this.extension, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Population1(value, this.code, this.subjectResults, this.count, this.extension, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withCode(CodeableConcept value) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, newValue, this.subjectResults, this.count, this.extension, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withCode(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, value, this.subjectResults, this.count, this.extension, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withSubjectResults(Reference value) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, this.code, newValue, this.count, this.extension, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withSubjectResults(Optional<? extends Reference> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, this.code, value, this.count, this.extension, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withCount(int value) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, this.code, this.subjectResults, newValue, this.extension, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withCount(Optional<Integer> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, this.code, this.subjectResults, value, this.extension, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, this.code, this.subjectResults, this.count, newValue, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, this.code, this.subjectResults, this.count, value, this.id);
  }
  ...
  public final ImmutableMeasureReport_Population1 withId(String value) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, this.code, this.subjectResults, this.count, this.extension, newValue);
  }
  ...
  public final ImmutableMeasureReport_Population1 withId(Optional<String> optional) {
    ...
    return new ImmutableMeasureReport_Population1(this.modifierExtension, this.code, this.subjectResults, this.count, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code code}, {@code subjectResults}, {@code count}, {@code extension}, {@code id}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Population1#modifierExtension() modifierExtension}
   *    .code(com.medplum.types.fhir.CodeableConcept) // optional {@link MeasureReport_Population1#code() code}
   *    .subjectResults(com.medplum.types.fhir.Reference) // optional {@link MeasureReport_Population1#subjectResults() subjectResults}
   *    .count(Integer) // optional {@link MeasureReport_Population1#count() count}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Population1#extension() extension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_COUNT = 0x8L;
    ...
    public MeasureReport_Population1 build() {
      return new ImmutableMeasureReport_Population1(modifierExtension, code, subjectResults, count, extension, id);
    }
