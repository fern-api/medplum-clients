...
final class ImmutableTestScript_Metadata implements TestScript_Metadata {
  ...
  public final ImmutableTestScript_Metadata withId(String value) {
    ...
    return new ImmutableTestScript_Metadata(newValue, this.modifierExtension, this.link, this.extension, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Metadata(value, this.modifierExtension, this.link, this.extension, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Metadata(this.id, newValue, this.link, this.extension, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Metadata(this.id, value, this.link, this.extension, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withLink(List<TestScript_Link> value) {
    ...
    return new ImmutableTestScript_Metadata(this.id, this.modifierExtension, newValue, this.extension, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withLink(Optional<? extends List<TestScript_Link>> optional) {
    ...
    return new ImmutableTestScript_Metadata(this.id, this.modifierExtension, value, this.extension, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Metadata(this.id, this.modifierExtension, this.link, newValue, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Metadata(this.id, this.modifierExtension, this.link, value, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withCapability(TestScript_Capability... elements) {
    ...
    return new ImmutableTestScript_Metadata(this.id, this.modifierExtension, this.link, this.extension, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code link}, {@code extension}, {@code capability}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Metadata#modifierExtension() modifierExtension}
   *    .link(List&amp;lt;com.medplum.types.fhir.TestScript_Link&amp;gt;) // optional {@link TestScript_Metadata#link() link}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Metadata#extension() extension}
   *    .addCapability|addAllCapability(com.medplum.types.fhir.TestScript_Capability) // {@link TestScript_Metadata#capability() capability} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TestScript_Metadata build() {
      return new ImmutableTestScript_Metadata(id, modifierExtension, link, extension, createUnmodifiableList(true, capability));
    }
