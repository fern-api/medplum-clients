...
final class ImmutableImmunizationRecommendation
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code resourceType}, {@code recommendation}, {@code authority}, {@code implicitRules}, {@code language}, {@code identifier}, {@code modifierExtension}, {@code date}, {@code contained}, {@code meta}, {@code text}, {@code extension}, {@code patient}.
   ...
   *    .id(com.medplum.types.fhir.Id) // optional {@link ImmunizationRecommendation#id() id}
   *    .resourceType(String) // required {@link ImmunizationRecommendation#resourceType() resourceType}
   *    .addRecommendation|addAllRecommendation(com.medplum.types.fhir.ImmunizationRecommendation_Recommendation) // {@link ImmunizationRecommendation#recommendation() recommendation} elements
   *    .authority(com.medplum.types.fhir.Reference) // optional {@link ImmunizationRecommendation#authority() authority}
   *    .implicitRules(com.medplum.types.fhir.Uri) // optional {@link ImmunizationRecommendation#implicitRules() implicitRules}
   *    .language(com.medplum.types.fhir.Code) // optional {@link ImmunizationRecommendation#language() language}
   *    .identifier(List&amp;lt;com.medplum.types.fhir.Identifier&amp;gt;) // optional {@link ImmunizationRecommendation#identifier() identifier}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ImmunizationRecommendation#modifierExtension() modifierExtension}
   *    .date(com.medplum.types.fhir.DateTime) // optional {@link ImmunizationRecommendation#date() date}
   *    .contained(List&amp;lt;com.medplum.types.fhir.ResourceList&amp;gt;) // optional {@link ImmunizationRecommendation#contained() contained}
   *    .meta(com.medplum.types.fhir.Meta) // optional {@link ImmunizationRecommendation#meta() meta}
   *    .text(com.medplum.types.fhir.Narrative) // optional {@link ImmunizationRecommendation#text() text}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ImmunizationRecommendation#extension() extension}
   *    .patient(com.medplum.types.fhir.Reference) // required {@link ImmunizationRecommendation#patient() patient}
   *    .build();
   * </pre>
