...
final class ImmutableMedicationKnowledge_DrugCharacteristic
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code valueCodeableConcept}, {@code type}, {@code valueQuantity}, {@code valueBase64Binary}, {@code extension}, {@code valueString}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_DrugCharacteristic#modifierExtension() modifierExtension}
   *    .valueCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicationKnowledge_DrugCharacteristic#valueCodeableConcept() valueCodeableConcept}
   *    .type(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicationKnowledge_DrugCharacteristic#type() type}
   *    .valueQuantity(com.medplum.types.fhir.Quantity) // optional {@link MedicationKnowledge_DrugCharacteristic#valueQuantity() valueQuantity}
   *    .valueBase64Binary(String) // optional {@link MedicationKnowledge_DrugCharacteristic#valueBase64Binary() valueBase64Binary}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_DrugCharacteristic#extension() extension}
