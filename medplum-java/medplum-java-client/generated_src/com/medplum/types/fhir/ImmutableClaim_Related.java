...
final class ImmutableClaim_Related implements Claim_Related {
  ...
  public final ImmutableClaim_Related withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableClaim_Related(newValue, this.reference, this.id, this.claim, this.extension, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableClaim_Related(value, this.reference, this.id, this.claim, this.extension, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withReference(Identifier value) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, newValue, this.id, this.claim, this.extension, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withReference(Optional<? extends Identifier> optional) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, value, this.id, this.claim, this.extension, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withId(String value) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, this.reference, newValue, this.claim, this.extension, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withId(Optional<String> optional) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, this.reference, value, this.claim, this.extension, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withClaim(Reference value) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, this.reference, this.id, newValue, this.extension, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withClaim(Optional<? extends Reference> optional) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, this.reference, this.id, value, this.extension, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withExtension(List<Extension> value) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, this.reference, this.id, this.claim, newValue, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, this.reference, this.id, this.claim, value, this.relationship);
  }
  ...
  public final ImmutableClaim_Related withRelationship(CodeableConcept value) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, this.reference, this.id, this.claim, this.extension, newValue);
  }
  ...
  public final ImmutableClaim_Related withRelationship(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableClaim_Related(this.modifierExtension, this.reference, this.id, this.claim, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code reference}, {@code id}, {@code claim}, {@code extension}, {@code relationship}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Claim_Related#modifierExtension() modifierExtension}
   *    .reference(com.medplum.types.fhir.Identifier) // optional {@link Claim_Related#reference() reference}
   *    .id(String) // optional {@link Claim_Related#id() id}
   *    .claim(com.medplum.types.fhir.Reference) // optional {@link Claim_Related#claim() claim}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Claim_Related#extension() extension}
   *    .relationship(com.medplum.types.fhir.CodeableConcept) // optional {@link Claim_Related#relationship() relationship}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_REFERENCE = 0x2L;
    ...
    public Claim_Related build() {
      return new ImmutableClaim_Related(modifierExtension, reference, id, claim, extension, relationship);
    }
