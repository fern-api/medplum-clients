...
final class ImmutableStructureMap_Rule implements StructureMap_Rule {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code source}, {@code id}, {@code modifierExtension}, {@code rule}, {@code target}, {@code documentation}, {@code name}, {@code dependent}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link StructureMap_Rule#extension() extension}
   *    .addSource|addAllSource(com.medplum.types.fhir.StructureMap_Source) // {@link StructureMap_Rule#source() source} elements
   *    .id(String) // optional {@link StructureMap_Rule#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link StructureMap_Rule#modifierExtension() modifierExtension}
   *    .rule(List&amp;lt;com.medplum.types.fhir.StructureMap_Rule&amp;gt;) // optional {@link StructureMap_Rule#rule() rule}
   *    .target(List&amp;lt;com.medplum.types.fhir.StructureMap_Target&amp;gt;) // optional {@link StructureMap_Rule#target() target}
   *    .documentation(String) // optional {@link StructureMap_Rule#documentation() documentation}
   *    .name(com.medplum.types.fhir.Id) // optional {@link StructureMap_Rule#name() name}
   *    .dependent(List&amp;lt;com.medplum.types.fhir.StructureMap_Dependent&amp;gt;) // optional {@link StructureMap_Rule#dependent() dependent}
   *    .build();
   * </pre>
