...
final class ImmutableValueSet_Include implements ValueSet_Include {
  ...
  private boolean equalTo(ImmutableValueSet_Include another) {
    return Objects.equals(filter, another.filter)
  ...
  /**
   * Computes a hash code from attributes: {@code filter}, {@code extension}, {@code version}, {@code modifierExtension}, {@code concept}, {@code valueSet}, {@code system}, {@code id}.
   ...
   *    .filter(List&amp;lt;com.medplum.types.fhir.ValueSet_Filter&amp;gt;) // optional {@link ValueSet_Include#filter() filter}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ValueSet_Include#extension() extension}
   *    .version(String) // optional {@link ValueSet_Include#version() version}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ValueSet_Include#modifierExtension() modifierExtension}
   *    .concept(List&amp;lt;com.medplum.types.fhir.ValueSet_Concept&amp;gt;) // optional {@link ValueSet_Include#concept() concept}
   *    .valueSet(List&amp;lt;com.medplum.types.fhir.Canonical&amp;gt;) // optional {@link ValueSet_Include#valueSet() valueSet}
   *    .system(com.medplum.types.fhir.Uri) // optional {@link ValueSet_Include#system() system}
  ...
  public static final class Builder {
    private static final long OPT_BIT_FILTER = 0x1L;
    ...
    private static final long OPT_BIT_SYSTEM = 0x40L;
    ...
    public ValueSet_Include build() {
      return new ImmutableValueSet_Include(filter, extension, version, modifierExtension, concept, valueSet, system, id);
    }
