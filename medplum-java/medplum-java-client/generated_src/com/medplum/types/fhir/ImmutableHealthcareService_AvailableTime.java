...
final class ImmutableHealthcareService_AvailableTime
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code allDay}, {@code daysOfWeek}, {@code id}, {@code availableStartTime}, {@code availableEndTime}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link HealthcareService_AvailableTime#extension() extension}
   *    .allDay(Boolean) // optional {@link HealthcareService_AvailableTime#allDay() allDay}
   *    .daysOfWeek(List&amp;lt;com.medplum.types.fhir.Healthcareservice_availabletimeDaysofweekItem&amp;gt;) // optional {@link HealthcareService_AvailableTime#daysOfWeek() daysOfWeek}
   *    .id(String) // optional {@link HealthcareService_AvailableTime#id() id}
   *    .availableStartTime(com.medplum.types.fhir.Time) // optional {@link HealthcareService_AvailableTime#availableStartTime() availableStartTime}
   *    .availableEndTime(com.medplum.types.fhir.Time) // optional {@link HealthcareService_AvailableTime#availableEndTime() availableEndTime}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link HealthcareService_AvailableTime#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public HealthcareService_AvailableTime build() {
      return new ImmutableHealthcareService_AvailableTime(extension, allDay, daysOfWeek, id, availableStartTime, availableEndTime, modifierExtension);
    }
