...
final class ImmutableEffectEvidenceSynthesis_Certainty
  ...
  public final ImmutableEffectEvidenceSynthesis_Certainty withCertaintySubcomponent(List<EffectEvidenceSynthesis_CertaintySubcomponent> value) {
    ...
    return new ImmutableEffectEvidenceSynthesis_Certainty(newValue, this.id, this.rating, this.extension, this.modifierExtension, this.note);
  }
  ...
  public final ImmutableEffectEvidenceSynthesis_Certainty withCertaintySubcomponent(Optional<? extends List<EffectEvidenceSynthesis_CertaintySubcomponent>> optional) {
    ...
    return new ImmutableEffectEvidenceSynthesis_Certainty(value, this.id, this.rating, this.extension, this.modifierExtension, this.note);
  }
  ...
  public final ImmutableEffectEvidenceSynthesis_Certainty withRating(Optional<? extends List<CodeableConcept>> optional) {
    ...
    return new ImmutableEffectEvidenceSynthesis_Certainty(this.certaintySubcomponent, this.id, value, this.extension, this.modifierExtension, this.note);
  }
  ...
  public final ImmutableEffectEvidenceSynthesis_Certainty withExtension(List<Extension> value) {
    ...
    return new ImmutableEffectEvidenceSynthesis_Certainty(this.certaintySubcomponent, this.id, this.rating, newValue, this.modifierExtension, this.note);
  }
  ...
  public final ImmutableEffectEvidenceSynthesis_Certainty withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableEffectEvidenceSynthesis_Certainty(this.certaintySubcomponent, this.id, this.rating, value, this.modifierExtension, this.note);
  }
  ...
  public final ImmutableEffectEvidenceSynthesis_Certainty withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableEffectEvidenceSynthesis_Certainty(this.certaintySubcomponent, this.id, this.rating, this.extension, newValue, this.note);
  }
  ...
  public final ImmutableEffectEvidenceSynthesis_Certainty withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableEffectEvidenceSynthesis_Certainty(this.certaintySubcomponent, this.id, this.rating, this.extension, value, this.note);
  }
  ...
  public final ImmutableEffectEvidenceSynthesis_Certainty withNote(Optional<? extends List<Annotation>> optional) {
    ...
    return new ImmutableEffectEvidenceSynthesis_Certainty(this.certaintySubcomponent, this.id, this.rating, this.extension, this.modifierExtension, value);
  }
  ...
  private boolean equalTo(ImmutableEffectEvidenceSynthesis_Certainty another) {
    return Objects.equals(certaintySubcomponent, another.certaintySubcomponent)
  ...
  /**
   * Computes a hash code from attributes: {@code certaintySubcomponent}, {@code id}, {@code rating}, {@code extension}, {@code modifierExtension}, {@code note}.
   ...
   *    .certaintySubcomponent(List&amp;lt;com.medplum.types.fhir.EffectEvidenceSynthesis_CertaintySubcomponent&amp;gt;) // optional {@link EffectEvidenceSynthesis_Certainty#certaintySubcomponent() certaintySubcomponent}
   *    .id(String) // optional {@link EffectEvidenceSynthesis_Certainty#id() id}
   *    .rating(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link EffectEvidenceSynthesis_Certainty#rating() rating}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link EffectEvidenceSynthesis_Certainty#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link EffectEvidenceSynthesis_Certainty#modifierExtension() modifierExtension}
   *    .note(List&amp;lt;com.medplum.types.fhir.Annotation&amp;gt;) // optional {@link EffectEvidenceSynthesis_Certainty#note() note}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_CERTAINTY_SUBCOMPONENT = 0x1L;
    ...
    public EffectEvidenceSynthesis_Certainty build() {
      return new ImmutableEffectEvidenceSynthesis_Certainty(certaintySubcomponent, id, rating, extension, modifierExtension, note);
    }
