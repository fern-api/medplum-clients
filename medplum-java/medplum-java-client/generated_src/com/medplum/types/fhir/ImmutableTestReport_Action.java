...
final class ImmutableTestReport_Action implements TestReport_Action {
  ...
  public final ImmutableTestReport_Action withOperation(TestReport_Operation value) {
    ...
    return new ImmutableTestReport_Action(newValue, this.id, this.modifierExtension, this._assert, this.extension);
  }
  ...
  public final ImmutableTestReport_Action withOperation(Optional<? extends TestReport_Operation> optional) {
    ...
    return new ImmutableTestReport_Action(value, this.id, this.modifierExtension, this._assert, this.extension);
  }
  ...
  public final ImmutableTestReport_Action withId(String value) {
    ...
    return new ImmutableTestReport_Action(this.operation, newValue, this.modifierExtension, this._assert, this.extension);
  }
  ...
  public final ImmutableTestReport_Action withId(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Action(this.operation, value, this.modifierExtension, this._assert, this.extension);
  }
  ...
  public final ImmutableTestReport_Action withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Action(this.operation, this.id, newValue, this._assert, this.extension);
  }
  ...
  public final ImmutableTestReport_Action withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Action(this.operation, this.id, value, this._assert, this.extension);
  }
  ...
  public final ImmutableTestReport_Action with_assert(TestReport_Assert value) {
    ...
    return new ImmutableTestReport_Action(this.operation, this.id, this.modifierExtension, newValue, this.extension);
  }
  ...
  public final ImmutableTestReport_Action with_assert(Optional<? extends TestReport_Assert> optional) {
    ...
    return new ImmutableTestReport_Action(this.operation, this.id, this.modifierExtension, value, this.extension);
  }
  ...
  public final ImmutableTestReport_Action withExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Action(this.operation, this.id, this.modifierExtension, this._assert, newValue);
  }
  ...
  public final ImmutableTestReport_Action withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Action(this.operation, this.id, this.modifierExtension, this._assert, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code operation}, {@code id}, {@code modifierExtension}, {@code _assert}, {@code extension}.
   ...
   *    .operation(com.medplum.types.fhir.TestReport_Operation) // optional {@link TestReport_Action#operation() operation}
   *    .id(String) // optional {@link TestReport_Action#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Action#modifierExtension() modifierExtension}
   *    ._assert(com.medplum.types.fhir.TestReport_Assert) // optional {@link TestReport_Action#_assert() _assert}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Action#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT__ASSERT = 0x8L;
    ...
    public TestReport_Action build() {
      return new ImmutableTestReport_Action(operation, id, modifierExtension, _assert, extension);
    }
