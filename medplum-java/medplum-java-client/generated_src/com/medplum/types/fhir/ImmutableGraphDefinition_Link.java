...
final class ImmutableGraphDefinition_Link implements GraphDefinition_Link {
  ...
  /**
   * Computes a hash code from attributes: {@code min}, {@code sliceName}, {@code modifierExtension}, {@code path}, {@code max}, {@code extension}, {@code description}, {@code target}, {@code id}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link GraphDefinition_Link#modifierExtension() modifierExtension}
   *    .path(String) // optional {@link GraphDefinition_Link#path() path}
   *    .max(String) // optional {@link GraphDefinition_Link#max() max}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link GraphDefinition_Link#extension() extension}
   *    .description(String) // optional {@link GraphDefinition_Link#description() description}
   *    .target(List&amp;lt;com.medplum.types.fhir.GraphDefinition_Target&amp;gt;) // optional {@link GraphDefinition_Link#target() target}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SLICE_NAME = 0x2L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x4L;
    private static final long OPT_BIT_PATH = 0x8L;
    private static final long OPT_BIT_MAX = 0x10L;
    ...
    public GraphDefinition_Link build() {
      return new ImmutableGraphDefinition_Link(min, sliceName, modifierExtension, path, max, extension, description, target, id);
    }
