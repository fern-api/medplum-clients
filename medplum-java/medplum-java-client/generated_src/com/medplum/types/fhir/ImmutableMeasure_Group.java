...
final class ImmutableMeasure_Group implements Measure_Group {
  ...
  public final ImmutableMeasure_Group withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasure_Group(this.stratifier, this.id, this.code, this.population, this.extension, value, this.description);
  }
  ...
  private boolean equalTo(ImmutableMeasure_Group another) {
    return Objects.equals(stratifier, another.stratifier)
  ...
  /**
   * Computes a hash code from attributes: {@code stratifier}, {@code id}, {@code code}, {@code population}, {@code extension}, {@code modifierExtension}, {@code description}.
   ...
   *    .stratifier(List&amp;lt;com.medplum.types.fhir.Measure_Stratifier&amp;gt;) // optional {@link Measure_Group#stratifier() stratifier}
   *    .id(String) // optional {@link Measure_Group#id() id}
   *    .code(com.medplum.types.fhir.CodeableConcept) // optional {@link Measure_Group#code() code}
   *    .population(List&amp;lt;com.medplum.types.fhir.Measure_Population&amp;gt;) // optional {@link Measure_Group#population() population}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Measure_Group#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Measure_Group#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    private static final long OPT_BIT_STRATIFIER = 0x1L;
    ...
    public Measure_Group build() {
      return new ImmutableMeasure_Group(stratifier, id, code, population, extension, modifierExtension, description);
    }
