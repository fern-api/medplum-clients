...
final class ImmutableSubstanceSourceMaterial_FractionDescription
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withId(String value) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(newValue, this.materialType, this.fraction, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withId(Optional<String> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(value, this.materialType, this.fraction, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withMaterialType(CodeableConcept value) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(this.id, newValue, this.fraction, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withMaterialType(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(this.id, value, this.fraction, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withFraction(String value) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(this.id, this.materialType, newValue, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withFraction(Optional<String> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(this.id, this.materialType, value, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withExtension(List<Extension> value) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(this.id, this.materialType, this.fraction, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(this.id, this.materialType, this.fraction, value, this.modifierExtension);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(this.id, this.materialType, this.fraction, this.extension, newValue);
  }
  ...
  public final ImmutableSubstanceSourceMaterial_FractionDescription withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstanceSourceMaterial_FractionDescription(this.id, this.materialType, this.fraction, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code materialType}, {@code fraction}, {@code extension}, {@code modifierExtension}.
   ...
   *    .materialType(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSourceMaterial_FractionDescription#materialType() materialType}
   *    .fraction(String) // optional {@link SubstanceSourceMaterial_FractionDescription#fraction() fraction}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSourceMaterial_FractionDescription#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSourceMaterial_FractionDescription#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_MATERIAL_TYPE = 0x2L;
    private static final long OPT_BIT_FRACTION = 0x4L;
    ...
    public SubstanceSourceMaterial_FractionDescription build() {
      return new ImmutableSubstanceSourceMaterial_FractionDescription(id, materialType, fraction, extension, modifierExtension);
    }
