...
final class ImmutableContract_Answer implements Contract_Answer {
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code valueBoolean}, {@code extension}, {@code valueTime}, {@code valueInteger}, {@code valueString}, {@code valueCoding}, {@code valueDecimal}, {@code valueDate}, {@code valueUri}, {@code id}, {@code valueReference}, {@code valueDateTime}, {@code valueQuantity}, {@code valueAttachment}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Contract_Answer#modifierExtension() modifierExtension}
   *    .valueBoolean(Boolean) // optional {@link Contract_Answer#valueBoolean() valueBoolean}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Contract_Answer#extension() extension}
   ...
   *    .valueCoding(com.medplum.types.fhir.Coding) // optional {@link Contract_Answer#valueCoding() valueCoding}
   ...
   *    .valueReference(com.medplum.types.fhir.Reference) // optional {@link Contract_Answer#valueReference() valueReference}
   *    .valueDateTime(String) // optional {@link Contract_Answer#valueDateTime() valueDateTime}
   *    .valueQuantity(com.medplum.types.fhir.Quantity) // optional {@link Contract_Answer#valueQuantity() valueQuantity}
   *    .valueAttachment(com.medplum.types.fhir.Attachment) // optional {@link Contract_Answer#valueAttachment() valueAttachment}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_VALUE_REFERENCE = 0x800L;
    private static final long OPT_BIT_VALUE_DATE_TIME = 0x1000L;
    private static final long OPT_BIT_VALUE_QUANTITY = 0x2000L;
    private static final long OPT_BIT_VALUE_ATTACHMENT = 0x4000L;
