...
final class ImmutableSubstanceAmount implements SubstanceAmount {
  ...
  private boolean equalTo(ImmutableSubstanceAmount another) {
    return Objects.equals(referenceRange, another.referenceRange)
  ...
  /**
   * Computes a hash code from attributes: {@code referenceRange}, {@code id}, {@code amountType}, {@code amountRange}, {@code amountText}, {@code extension}, {@code amountString}, {@code amountQuantity}, {@code modifierExtension}.
   ...
   *    .referenceRange(com.medplum.types.fhir.SubstanceAmount_ReferenceRange) // optional {@link SubstanceAmount#referenceRange() referenceRange}
   *    .id(String) // optional {@link SubstanceAmount#id() id}
   *    .amountType(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceAmount#amountType() amountType}
   *    .amountRange(com.medplum.types.fhir.Range) // optional {@link SubstanceAmount#amountRange() amountRange}
   *    .amountText(String) // optional {@link SubstanceAmount#amountText() amountText}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceAmount#extension() extension}
   *    .amountString(String) // optional {@link SubstanceAmount#amountString() amountString}
   *    .amountQuantity(com.medplum.types.fhir.Quantity) // optional {@link SubstanceAmount#amountQuantity() amountQuantity}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceAmount#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_REFERENCE_RANGE = 0x1L;
    private static final long OPT_BIT_ID = 0x2L;
    private static final long OPT_BIT_AMOUNT_TYPE = 0x4L;
    private static final long OPT_BIT_AMOUNT_RANGE = 0x8L;
    private static final long OPT_BIT_AMOUNT_TEXT = 0x10L;
    private static final long OPT_BIT_EXTENSION = 0x20L;
    private static final long OPT_BIT_AMOUNT_STRING = 0x40L;
