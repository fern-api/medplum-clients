...
final class ImmutableSubstanceSourceMaterial_Hybrid
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code maternalOrganismId}, {@code hybridType}, {@code paternalOrganismId}, {@code paternalOrganismName}, {@code maternalOrganismName}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSourceMaterial_Hybrid#extension() extension}
   *    .maternalOrganismId(String) // optional {@link SubstanceSourceMaterial_Hybrid#maternalOrganismId() maternalOrganismId}
   *    .hybridType(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceSourceMaterial_Hybrid#hybridType() hybridType}
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceSourceMaterial_Hybrid#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_MATERNAL_ORGANISM_ID = 0x4L;
    private static final long OPT_BIT_HYBRID_TYPE = 0x8L;
    private static final long OPT_BIT_PATERNAL_ORGANISM_ID = 0x10L;
    private static final long OPT_BIT_PATERNAL_ORGANISM_NAME = 0x20L;
    private static final long OPT_BIT_MATERNAL_ORGANISM_NAME = 0x40L;
