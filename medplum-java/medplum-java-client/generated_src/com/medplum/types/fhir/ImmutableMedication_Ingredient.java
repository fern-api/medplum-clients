...
final class ImmutableMedication_Ingredient implements Medication_Ingredient {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code itemReference}, {@code isActive}, {@code itemCodeableConcept}, {@code strength}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Medication_Ingredient#extension() extension}
   *    .itemReference(com.medplum.types.fhir.Reference) // optional {@link Medication_Ingredient#itemReference() itemReference}
   *    .isActive(Boolean) // optional {@link Medication_Ingredient#isActive() isActive}
   *    .itemCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link Medication_Ingredient#itemCodeableConcept() itemCodeableConcept}
   *    .strength(com.medplum.types.fhir.Ratio) // optional {@link Medication_Ingredient#strength() strength}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Medication_Ingredient#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_IS_ACTIVE = 0x8L;
    ...
    public Medication_Ingredient build() {
      return new ImmutableMedication_Ingredient(id, extension, itemReference, isActive, itemCodeableConcept, strength, modifierExtension);
    }
