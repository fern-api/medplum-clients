...
final class ImmutableExplanationOfBenefit_Accident
  ...
  /**
   * Computes a hash code from attributes: {@code type}, {@code modifierExtension}, {@code locationAddress}, {@code locationReference}, {@code id}, {@code date}, {@code extension}.
   ...
   *    .type(com.medplum.types.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit_Accident#type() type}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_Accident#modifierExtension() modifierExtension}
   *    .locationAddress(com.medplum.types.fhir.Address) // optional {@link ExplanationOfBenefit_Accident#locationAddress() locationAddress}
   *    .locationReference(com.medplum.types.fhir.Reference) // optional {@link ExplanationOfBenefit_Accident#locationReference() locationReference}
   *    .id(String) // optional {@link ExplanationOfBenefit_Accident#id() id}
   *    .date(com.medplum.types.fhir.Date) // optional {@link ExplanationOfBenefit_Accident#date() date}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_Accident#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_LOCATION_ADDRESS = 0x4L;
    private static final long OPT_BIT_LOCATION_REFERENCE = 0x8L;
    ...
    public ExplanationOfBenefit_Accident build() {
      return new ImmutableExplanationOfBenefit_Accident(type, modifierExtension, locationAddress, locationReference, id, date, extension);
    }
