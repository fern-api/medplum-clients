...
final class ImmutableOperationOutcome_Issue implements OperationOutcome_Issue {
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code code}, {@code details}, {@code extension}, {@code location}, {@code expression}, {@code id}, {@code severity}, {@code diagnostics}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link OperationOutcome_Issue#modifierExtension() modifierExtension}
   *    .code(com.medplum.types.fhir.Operationoutcome_issueCode) // optional {@link OperationOutcome_Issue#code() code}
   *    .details(com.medplum.types.fhir.CodeableConcept) // optional {@link OperationOutcome_Issue#details() details}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link OperationOutcome_Issue#extension() extension}
   ...
   *    .severity(com.medplum.types.fhir.Operationoutcome_issueSeverity) // optional {@link OperationOutcome_Issue#severity() severity}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DIAGNOSTICS = 0x100L;
    ...
    public OperationOutcome_Issue build() {
      return new ImmutableOperationOutcome_Issue(modifierExtension, code, details, extension, location, expression, id, severity, diagnostics);
    }
