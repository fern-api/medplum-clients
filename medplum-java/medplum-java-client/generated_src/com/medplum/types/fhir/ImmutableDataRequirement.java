...
final class ImmutableDataRequirement implements DataRequirement {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code limit}, {@code id}, {@code mustSupport}, {@code subjectCodeableConcept}, {@code subjectReference}, {@code profile}, {@code codeFilter}, {@code dateFilter}, {@code sort}, {@code type}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link DataRequirement#extension() extension}
   *    .limit(com.medplum.types.fhir.PositiveInt) // optional {@link DataRequirement#limit() limit}
   ...
   *    .subjectCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link DataRequirement#subjectCodeableConcept() subjectCodeableConcept}
   *    .subjectReference(com.medplum.types.fhir.Reference) // optional {@link DataRequirement#subjectReference() subjectReference}
   *    .profile(List&amp;lt;com.medplum.types.fhir.Canonical&amp;gt;) // optional {@link DataRequirement#profile() profile}
   *    .codeFilter(List&amp;lt;com.medplum.types.fhir.DataRequirement_CodeFilter&amp;gt;) // optional {@link DataRequirement#codeFilter() codeFilter}
   *    .dateFilter(List&amp;lt;com.medplum.types.fhir.DataRequirement_DateFilter&amp;gt;) // optional {@link DataRequirement#dateFilter() dateFilter}
   *    .sort(List&amp;lt;com.medplum.types.fhir.DataRequirement_Sort&amp;gt;) // optional {@link DataRequirement#sort() sort}
   *    .type(com.medplum.types.fhir.Code) // optional {@link DataRequirement#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_MUST_SUPPORT = 0x8L;
    private static final long OPT_BIT_SUBJECT_CODEABLE_CONCEPT = 0x10L;
    private static final long OPT_BIT_SUBJECT_REFERENCE = 0x20L;
    private static final long OPT_BIT_PROFILE = 0x40L;
    private static final long OPT_BIT_CODE_FILTER = 0x80L;
    private static final long OPT_BIT_DATE_FILTER = 0x100L;
    private static final long OPT_BIT_SORT = 0x200L;
