...
final class ImmutableMedicationDispense_Substitution
  ...
  private boolean equalTo(ImmutableMedicationDispense_Substitution another) {
    return Objects.equals(extension, another.extension)
        ...
        && Objects.equals(responsibleParty, another.responsibleParty)
        && Objects.equals(wasSubstituted, another.wasSubstituted)
        && Objects.equals(type, another.type);
  }

  /**
   * Computes a hash code from attributes: {@code extension}, {@code reason}, {@code modifierExtension}, {@code id}, {@code responsibleParty}, {@code wasSubstituted}, {@code type}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationDispense_Substitution#extension() extension}
   *    .reason(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link MedicationDispense_Substitution#reason() reason}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicationDispense_Substitution#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link MedicationDispense_Substitution#id() id}
   *    .responsibleParty(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link MedicationDispense_Substitution#responsibleParty() responsibleParty}
   *    .wasSubstituted(Boolean) // optional {@link MedicationDispense_Substitution#wasSubstituted() wasSubstituted}
   *    .type(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicationDispense_Substitution#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_RESPONSIBLE_PARTY = 0x10L;
    ...
    public MedicationDispense_Substitution build() {
      return new ImmutableMedicationDispense_Substitution(extension, reason, modifierExtension, id, responsibleParty, wasSubstituted, type);
    }
