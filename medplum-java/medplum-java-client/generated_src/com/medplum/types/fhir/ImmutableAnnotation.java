...
final class ImmutableAnnotation implements Annotation {
  ...
  public final ImmutableAnnotation withText(Markdown value) {
    ...
    return new ImmutableAnnotation(newValue, this.authorString, this.time, this.id, this.extension, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withText(Optional<? extends Markdown> optional) {
    ...
    return new ImmutableAnnotation(value, this.authorString, this.time, this.id, this.extension, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withAuthorString(String value) {
    ...
    return new ImmutableAnnotation(this.text, newValue, this.time, this.id, this.extension, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withAuthorString(Optional<String> optional) {
    ...
    return new ImmutableAnnotation(this.text, value, this.time, this.id, this.extension, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withTime(DateTime value) {
    ...
    return new ImmutableAnnotation(this.text, this.authorString, newValue, this.id, this.extension, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withTime(Optional<? extends DateTime> optional) {
    ...
    return new ImmutableAnnotation(this.text, this.authorString, value, this.id, this.extension, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withId(String value) {
    ...
    return new ImmutableAnnotation(this.text, this.authorString, this.time, newValue, this.extension, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withId(Optional<String> optional) {
    ...
    return new ImmutableAnnotation(this.text, this.authorString, this.time, value, this.extension, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withExtension(List<Extension> value) {
    ...
    return new ImmutableAnnotation(this.text, this.authorString, this.time, this.id, newValue, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableAnnotation(this.text, this.authorString, this.time, this.id, value, this.authorReference);
  }
  ...
  public final ImmutableAnnotation withAuthorReference(Reference value) {
    ...
    return new ImmutableAnnotation(this.text, this.authorString, this.time, this.id, this.extension, newValue);
  }
  ...
  public final ImmutableAnnotation withAuthorReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableAnnotation(this.text, this.authorString, this.time, this.id, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code text}, {@code authorString}, {@code time}, {@code id}, {@code extension}, {@code authorReference}.
   ...
   *    .text(com.medplum.types.fhir.Markdown) // optional {@link Annotation#text() text}
   *    .authorString(String) // optional {@link Annotation#authorString() authorString}
   *    .time(com.medplum.types.fhir.DateTime) // optional {@link Annotation#time() time}
   *    .id(String) // optional {@link Annotation#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Annotation#extension() extension}
   *    .authorReference(com.medplum.types.fhir.Reference) // optional {@link Annotation#authorReference() authorReference}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_TIME = 0x4L;
    ...
    public Annotation build() {
      return new ImmutableAnnotation(text, authorString, time, id, extension, authorReference);
    }
