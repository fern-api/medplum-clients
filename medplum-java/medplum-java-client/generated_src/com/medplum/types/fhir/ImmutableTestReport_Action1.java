...
final class ImmutableTestReport_Action1 implements TestReport_Action1 {
  ...
  public final ImmutableTestReport_Action1 withExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Action1(newValue, this._assert, this.modifierExtension, this.operation, this.id);
  }
  ...
  public final ImmutableTestReport_Action1 withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Action1(value, this._assert, this.modifierExtension, this.operation, this.id);
  }
  ...
  public final ImmutableTestReport_Action1 with_assert(TestReport_Assert value) {
    ...
    return new ImmutableTestReport_Action1(this.extension, newValue, this.modifierExtension, this.operation, this.id);
  }
  ...
  public final ImmutableTestReport_Action1 with_assert(Optional<? extends TestReport_Assert> optional) {
    ...
    return new ImmutableTestReport_Action1(this.extension, value, this.modifierExtension, this.operation, this.id);
  }
  ...
  public final ImmutableTestReport_Action1 withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Action1(this.extension, this._assert, newValue, this.operation, this.id);
  }
  ...
  public final ImmutableTestReport_Action1 withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Action1(this.extension, this._assert, value, this.operation, this.id);
  }
  ...
  public final ImmutableTestReport_Action1 withOperation(TestReport_Operation value) {
    ...
    return new ImmutableTestReport_Action1(this.extension, this._assert, this.modifierExtension, newValue, this.id);
  }
  ...
  public final ImmutableTestReport_Action1 withOperation(Optional<? extends TestReport_Operation> optional) {
    ...
    return new ImmutableTestReport_Action1(this.extension, this._assert, this.modifierExtension, value, this.id);
  }
  ...
  public final ImmutableTestReport_Action1 withId(String value) {
    ...
    return new ImmutableTestReport_Action1(this.extension, this._assert, this.modifierExtension, this.operation, newValue);
  }
  ...
  public final ImmutableTestReport_Action1 withId(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Action1(this.extension, this._assert, this.modifierExtension, this.operation, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code _assert}, {@code modifierExtension}, {@code operation}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Action1#extension() extension}
   *    ._assert(com.medplum.types.fhir.TestReport_Assert) // optional {@link TestReport_Action1#_assert() _assert}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestReport_Action1#modifierExtension() modifierExtension}
   *    .operation(com.medplum.types.fhir.TestReport_Operation) // optional {@link TestReport_Action1#operation() operation}
  ...
  public static final class Builder {
    ...
    public TestReport_Action1 build() {
      return new ImmutableTestReport_Action1(extension, _assert, modifierExtension, operation, id);
    }
