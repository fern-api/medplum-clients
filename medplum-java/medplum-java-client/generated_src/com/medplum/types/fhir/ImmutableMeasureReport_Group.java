...
final class ImmutableMeasureReport_Group implements MeasureReport_Group {
  ...
  public final ImmutableMeasureReport_Group withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Group(this.code, this.stratifier, this.id, value, this.population, this.extension, this.measureScore);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code code}, {@code stratifier}, {@code id}, {@code modifierExtension}, {@code population}, {@code extension}, {@code measureScore}.
   ...
   *    .code(com.medplum.types.fhir.CodeableConcept) // optional {@link MeasureReport_Group#code() code}
   *    .stratifier(List&amp;lt;com.medplum.types.fhir.MeasureReport_Stratifier&amp;gt;) // optional {@link MeasureReport_Group#stratifier() stratifier}
   *    .id(String) // optional {@link MeasureReport_Group#id() id}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Group#modifierExtension() modifierExtension}
   *    .population(List&amp;lt;com.medplum.types.fhir.MeasureReport_Population&amp;gt;) // optional {@link MeasureReport_Group#population() population}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Group#extension() extension}
   *    .measureScore(com.medplum.types.fhir.Quantity) // optional {@link MeasureReport_Group#measureScore() measureScore}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_STRATIFIER = 0x2L;
    private static final long OPT_BIT_ID = 0x4L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x8L;
    private static final long OPT_BIT_POPULATION = 0x10L;
    ...
    public MeasureReport_Group build() {
      return new ImmutableMeasureReport_Group(code, stratifier, id, modifierExtension, population, extension, measureScore);
    }
