...
final class ImmutableTestScript_Action implements TestScript_Action {
  ...
  public final ImmutableTestScript_Action withOperation(TestScript_Operation value) {
    ...
    return new ImmutableTestScript_Action(newValue, this.extension, this.modifierExtension, this._assert, this.id);
  }
  ...
  public final ImmutableTestScript_Action withOperation(Optional<? extends TestScript_Operation> optional) {
    ...
    return new ImmutableTestScript_Action(value, this.extension, this.modifierExtension, this._assert, this.id);
  }
  ...
  public final ImmutableTestScript_Action withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Action(this.operation, newValue, this.modifierExtension, this._assert, this.id);
  }
  ...
  public final ImmutableTestScript_Action withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Action(this.operation, value, this.modifierExtension, this._assert, this.id);
  }
  ...
  public final ImmutableTestScript_Action withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Action(this.operation, this.extension, newValue, this._assert, this.id);
  }
  ...
  public final ImmutableTestScript_Action withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Action(this.operation, this.extension, value, this._assert, this.id);
  }
  ...
  public final ImmutableTestScript_Action with_assert(TestScript_Assert value) {
    ...
    return new ImmutableTestScript_Action(this.operation, this.extension, this.modifierExtension, newValue, this.id);
  }
  ...
  public final ImmutableTestScript_Action with_assert(Optional<? extends TestScript_Assert> optional) {
    ...
    return new ImmutableTestScript_Action(this.operation, this.extension, this.modifierExtension, value, this.id);
  }
  ...
  public final ImmutableTestScript_Action withId(String value) {
    ...
    return new ImmutableTestScript_Action(this.operation, this.extension, this.modifierExtension, this._assert, newValue);
  }
  ...
  public final ImmutableTestScript_Action withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Action(this.operation, this.extension, this.modifierExtension, this._assert, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code operation}, {@code extension}, {@code modifierExtension}, {@code _assert}, {@code id}.
   ...
   *    .operation(com.medplum.types.fhir.TestScript_Operation) // optional {@link TestScript_Action#operation() operation}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Action#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link TestScript_Action#modifierExtension() modifierExtension}
   *    ._assert(com.medplum.types.fhir.TestScript_Assert) // optional {@link TestScript_Action#_assert() _assert}
  ...
  public static final class Builder {
    ...
    public TestScript_Action build() {
      return new ImmutableTestScript_Action(operation, extension, modifierExtension, _assert, id);
    }
