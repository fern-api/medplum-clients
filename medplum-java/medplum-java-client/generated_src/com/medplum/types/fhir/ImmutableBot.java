...
final class ImmutableBot implements Bot {
  ...
  /**
   * Computes a hash code from attributes: {@code meta}, {@code language}, {@code name}, {@code runAsUser}, {@code runtimeVersion}, {@code photo}, {@code id}, {@code description}, {@code implicitRules}, {@code code}, {@code resourceType}.
   ...
   *    .meta(com.medplum.types.fhir.Meta) // optional {@link Bot#meta() meta}
   *    .language(com.medplum.types.fhir.Code) // optional {@link Bot#language() language}
   ...
   *    .photo(com.medplum.types.fhir.Attachment) // optional {@link Bot#photo() photo}
   *    .id(com.medplum.types.fhir.Id) // optional {@link Bot#id() id}
   *    .description(String) // optional {@link Bot#description() description}
   *    .implicitRules(com.medplum.types.fhir.Uri) // optional {@link Bot#implicitRules() implicitRules}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_PHOTO = 0x20L;
    ...
    private static final long OPT_BIT_RESOURCE_TYPE = 0x400L;
