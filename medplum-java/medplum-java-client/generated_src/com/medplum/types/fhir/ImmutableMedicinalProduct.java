...
final class ImmutableMedicinalProduct implements MedicinalProduct {
  ...
  private boolean equalTo(ImmutableMedicinalProduct another) {
    return Objects.equals(pharmaceuticalProduct, another.pharmaceuticalProduct)
  ...
  /**
   * Computes a hash code from attributes: {@code pharmaceuticalProduct}, {@code text}, {@code crossReference}, {@code marketingStatus}, {@code paediatricUseIndicator}, {@code contact}, {@code type}, {@code contained}, {@code masterFile}, {@code productClassification}, {@code combinedPharmaceuticalDoseForm}, {@code legalStatusOfSupply}, {@code domain}, {@code manufacturingBusinessOperation}, {@code specialMeasures}, {@code resourceType}, {@code implicitRules}, {@code modifierExtension}, {@code packagedMedicinalProduct}, {@code attachedDocument}, {@code name}, {@code extension}, {@code additionalMonitoringIndicator}, {@code id}, {@code clinicalTrial}, {@code identifier}, {@code meta}, {@code language}, {@code specialDesignation}.
   ...
   *    .pharmaceuticalProduct(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link MedicinalProduct#pharmaceuticalProduct() pharmaceuticalProduct}
   *    .text(com.medplum.types.fhir.Narrative) // optional {@link MedicinalProduct#text() text}
   *    .crossReference(List&amp;lt;com.medplum.types.fhir.Identifier&amp;gt;) // optional {@link MedicinalProduct#crossReference() crossReference}
   *    .marketingStatus(List&amp;lt;com.medplum.types.fhir.MarketingStatus&amp;gt;) // optional {@link MedicinalProduct#marketingStatus() marketingStatus}
   *    .paediatricUseIndicator(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicinalProduct#paediatricUseIndicator() paediatricUseIndicator}
   *    .contact(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link MedicinalProduct#contact() contact}
   *    .type(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicinalProduct#type() type}
   *    .contained(List&amp;lt;com.medplum.types.fhir.ResourceList&amp;gt;) // optional {@link MedicinalProduct#contained() contained}
   *    .masterFile(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link MedicinalProduct#masterFile() masterFile}
   *    .productClassification(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link MedicinalProduct#productClassification() productClassification}
   *    .combinedPharmaceuticalDoseForm(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicinalProduct#combinedPharmaceuticalDoseForm() combinedPharmaceuticalDoseForm}
   *    .legalStatusOfSupply(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicinalProduct#legalStatusOfSupply() legalStatusOfSupply}
   *    .domain(com.medplum.types.fhir.Coding) // optional {@link MedicinalProduct#domain() domain}
   *    .manufacturingBusinessOperation(List&amp;lt;com.medplum.types.fhir.MedicinalProduct_ManufacturingBusinessOperation&amp;gt;) // optional {@link MedicinalProduct#manufacturingBusinessOperation() manufacturingBusinessOperation}
   ...
   *    .implicitRules(com.medplum.types.fhir.Uri) // optional {@link MedicinalProduct#implicitRules() implicitRules}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicinalProduct#modifierExtension() modifierExtension}
   *    .packagedMedicinalProduct(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link MedicinalProduct#packagedMedicinalProduct() packagedMedicinalProduct}
   *    .attachedDocument(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link MedicinalProduct#attachedDocument() attachedDocument}
   *    .addName|addAllName(com.medplum.types.fhir.MedicinalProduct_Name) // {@link MedicinalProduct#name() name} elements
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link MedicinalProduct#extension() extension}
   *    .additionalMonitoringIndicator(com.medplum.types.fhir.CodeableConcept) // optional {@link MedicinalProduct#additionalMonitoringIndicator() additionalMonitoringIndicator}
   *    .id(com.medplum.types.fhir.Id) // optional {@link MedicinalProduct#id() id}
   *    .clinicalTrial(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link MedicinalProduct#clinicalTrial() clinicalTrial}
   *    .identifier(List&amp;lt;com.medplum.types.fhir.Identifier&amp;gt;) // optional {@link MedicinalProduct#identifier() identifier}
   *    .meta(com.medplum.types.fhir.Meta) // optional {@link MedicinalProduct#meta() meta}
   *    .language(com.medplum.types.fhir.Code) // optional {@link MedicinalProduct#language() language}
   *    .specialDesignation(List&amp;lt;com.medplum.types.fhir.MedicinalProduct_SpecialDesignation&amp;gt;) // optional {@link MedicinalProduct#specialDesignation() specialDesignation}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ResourceTypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_PHARMACEUTICAL_PRODUCT = 0x1L;
    private static final long OPT_BIT_TEXT = 0x2L;
    private static final long OPT_BIT_CROSS_REFERENCE = 0x4L;
    private static final long OPT_BIT_MARKETING_STATUS = 0x8L;
    private static final long OPT_BIT_PAEDIATRIC_USE_INDICATOR = 0x10L;
    ...
    private static final long OPT_BIT_MASTER_FILE = 0x100L;
    private static final long OPT_BIT_PRODUCT_CLASSIFICATION = 0x200L;
    private static final long OPT_BIT_COMBINED_PHARMACEUTICAL_DOSE_FORM = 0x400L;
    private static final long OPT_BIT_LEGAL_STATUS_OF_SUPPLY = 0x800L;
    private static final long OPT_BIT_DOMAIN = 0x1000L;
    private static final long OPT_BIT_MANUFACTURING_BUSINESS_OPERATION = 0x2000L;
    private static final long OPT_BIT_SPECIAL_MEASURES = 0x4000L;
    private static final long OPT_BIT_IMPLICIT_RULES = 0x8000L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x10000L;
    private static final long OPT_BIT_PACKAGED_MEDICINAL_PRODUCT = 0x20000L;
    private static final long OPT_BIT_ATTACHED_DOCUMENT = 0x40000L;
    private static final long OPT_BIT_EXTENSION = 0x80000L;
    private static final long OPT_BIT_ADDITIONAL_MONITORING_INDICATOR = 0x100000L;
    private static final long OPT_BIT_ID = 0x200000L;
    private static final long OPT_BIT_CLINICAL_TRIAL = 0x400000L;
    ...
    private static final long OPT_BIT_SPECIAL_DESIGNATION = 0x4000000L;
