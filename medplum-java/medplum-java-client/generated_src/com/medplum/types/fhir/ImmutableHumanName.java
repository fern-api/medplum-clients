...
final class ImmutableHumanName implements HumanName {
  ...
  private boolean equalTo(ImmutableHumanName another) {
    return Objects.equals(prefix, another.prefix)
  ...
  /**
   * Computes a hash code from attributes: {@code prefix}, {@code suffix}, {@code id}, {@code family}, {@code extension}, {@code period}, {@code text}, {@code given}, {@code use}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link HumanName#extension() extension}
   *    .period(com.medplum.types.fhir.Period) // optional {@link HumanName#period() period}
   *    .text(String) // optional {@link HumanName#text() text}
   *    .given(List&amp;lt;String&amp;gt;) // optional {@link HumanName#given() given}
   *    .use(com.medplum.types.fhir.HumannameUse) // optional {@link HumanName#use() use}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_PREFIX = 0x1L;
    private static final long OPT_BIT_SUFFIX = 0x2L;
    ...
    private static final long OPT_BIT_GIVEN = 0x80L;
    private static final long OPT_BIT_USE = 0x100L;
    ...
    public HumanName build() {
      return new ImmutableHumanName(prefix, suffix, id, family, extension, period, text, given, use);
    }
