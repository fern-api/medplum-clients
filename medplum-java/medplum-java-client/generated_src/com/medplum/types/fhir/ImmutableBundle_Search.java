...
final class ImmutableBundle_Search implements Bundle_Search {
  ...
  public final ImmutableBundle_Search withScore(Decimal value) {
    ...
    return new ImmutableBundle_Search(newValue, this.modifierExtension, this.id, this.mode, this.extension);
  }
  ...
  public final ImmutableBundle_Search withScore(Optional<? extends Decimal> optional) {
    ...
    return new ImmutableBundle_Search(value, this.modifierExtension, this.id, this.mode, this.extension);
  }
  ...
  public final ImmutableBundle_Search withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableBundle_Search(this.score, newValue, this.id, this.mode, this.extension);
  }
  ...
  public final ImmutableBundle_Search withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableBundle_Search(this.score, value, this.id, this.mode, this.extension);
  }
  ...
  public final ImmutableBundle_Search withId(String value) {
    ...
    return new ImmutableBundle_Search(this.score, this.modifierExtension, newValue, this.mode, this.extension);
  }
  ...
  public final ImmutableBundle_Search withId(Optional<String> optional) {
    ...
    return new ImmutableBundle_Search(this.score, this.modifierExtension, value, this.mode, this.extension);
  }
  ...
  public final ImmutableBundle_Search withMode(Bundle_searchMode value) {
    ...
    return new ImmutableBundle_Search(this.score, this.modifierExtension, this.id, newValue, this.extension);
  }
  ...
  public final ImmutableBundle_Search withMode(Optional<? extends Bundle_searchMode> optional) {
    ...
    return new ImmutableBundle_Search(this.score, this.modifierExtension, this.id, value, this.extension);
  }
  ...
  public final ImmutableBundle_Search withExtension(List<Extension> value) {
    ...
    return new ImmutableBundle_Search(this.score, this.modifierExtension, this.id, this.mode, newValue);
  }
  ...
  public final ImmutableBundle_Search withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableBundle_Search(this.score, this.modifierExtension, this.id, this.mode, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code score}, {@code modifierExtension}, {@code id}, {@code mode}, {@code extension}.
   ...
   *    .score(com.medplum.types.fhir.Decimal) // optional {@link Bundle_Search#score() score}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Bundle_Search#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link Bundle_Search#id() id}
   *    .mode(com.medplum.types.fhir.Bundle_searchMode) // optional {@link Bundle_Search#mode() mode}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Bundle_Search#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Bundle_Search build() {
      return new ImmutableBundle_Search(score, modifierExtension, id, mode, extension);
    }
