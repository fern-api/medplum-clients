...
final class ImmutableSubstanceReferenceInformation_Classification
  ...
  public final ImmutableSubstanceReferenceInformation_Classification withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSubstanceReferenceInformation_Classification(newValue, this.domain, this.id, this.extension, this.classification, this.source, this.subtype);
  }
  ...
  public final ImmutableSubstanceReferenceInformation_Classification withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstanceReferenceInformation_Classification(value, this.domain, this.id, this.extension, this.classification, this.source, this.subtype);
  }
  ...
  public final ImmutableSubstanceReferenceInformation_Classification withClassification(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstanceReferenceInformation_Classification(this.modifierExtension, this.domain, this.id, this.extension, value, this.source, this.subtype);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code domain}, {@code id}, {@code extension}, {@code classification}, {@code source}, {@code subtype}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceReferenceInformation_Classification#modifierExtension() modifierExtension}
   *    .domain(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceReferenceInformation_Classification#domain() domain}
   *    .id(String) // optional {@link SubstanceReferenceInformation_Classification#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstanceReferenceInformation_Classification#extension() extension}
   *    .classification(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstanceReferenceInformation_Classification#classification() classification}
   *    .source(List&amp;lt;com.medplum.types.fhir.Reference&amp;gt;) // optional {@link SubstanceReferenceInformation_Classification#source() source}
   *    .subtype(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link SubstanceReferenceInformation_Classification#subtype() subtype}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DOMAIN = 0x2L;
    private static final long OPT_BIT_ID = 0x4L;
    private static final long OPT_BIT_EXTENSION = 0x8L;
    private static final long OPT_BIT_CLASSIFICATION = 0x10L;
    ...
    public SubstanceReferenceInformation_Classification build() {
      return new ImmutableSubstanceReferenceInformation_Classification(modifierExtension, domain, id, extension, classification, source, subtype);
    }
