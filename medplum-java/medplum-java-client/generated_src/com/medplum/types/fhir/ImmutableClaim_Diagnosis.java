...
final class ImmutableClaim_Diagnosis implements Claim_Diagnosis {
  ...
  /**
   * Computes a hash code from attributes: {@code diagnosisReference}, {@code onAdmission}, {@code id}, {@code extension}, {@code modifierExtension}, {@code type}, {@code packageCode}, {@code sequence}, {@code diagnosisCodeableConcept}.
   ...
   *    .diagnosisReference(com.medplum.types.fhir.Reference) // optional {@link Claim_Diagnosis#diagnosisReference() diagnosisReference}
   *    .onAdmission(com.medplum.types.fhir.CodeableConcept) // optional {@link Claim_Diagnosis#onAdmission() onAdmission}
   *    .id(String) // optional {@link Claim_Diagnosis#id() id}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Claim_Diagnosis#extension() extension}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link Claim_Diagnosis#modifierExtension() modifierExtension}
   *    .type(List&amp;lt;com.medplum.types.fhir.CodeableConcept&amp;gt;) // optional {@link Claim_Diagnosis#type() type}
   *    .packageCode(com.medplum.types.fhir.CodeableConcept) // optional {@link Claim_Diagnosis#packageCode() packageCode}
   *    .sequence(com.medplum.types.fhir.PositiveInt) // optional {@link Claim_Diagnosis#sequence() sequence}
   *    .diagnosisCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link Claim_Diagnosis#diagnosisCodeableConcept() diagnosisCodeableConcept}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_ON_ADMISSION = 0x2L;
    ...
    private static final long OPT_BIT_DIAGNOSIS_CODEABLE_CONCEPT = 0x100L;
