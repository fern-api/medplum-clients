...
final class ImmutableSubstancePolymer_RepeatUnit
    implements SubstancePolymer_RepeatUnit {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code degreeOfPolymerisation}, {@code repeatUnit}, {@code id}, {@code orientationOfPolymerisation}, {@code amount}, {@code structuralRepresentation}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_RepeatUnit#extension() extension}
   *    .degreeOfPolymerisation(List&amp;lt;com.medplum.types.fhir.SubstancePolymer_DegreeOfPolymerisation&amp;gt;) // optional {@link SubstancePolymer_RepeatUnit#degreeOfPolymerisation() degreeOfPolymerisation}
   ...
   *    .orientationOfPolymerisation(com.medplum.types.fhir.CodeableConcept) // optional {@link SubstancePolymer_RepeatUnit#orientationOfPolymerisation() orientationOfPolymerisation}
   *    .amount(com.medplum.types.fhir.SubstanceAmount) // optional {@link SubstancePolymer_RepeatUnit#amount() amount}
   *    .structuralRepresentation(List&amp;lt;com.medplum.types.fhir.SubstancePolymer_StructuralRepresentation&amp;gt;) // optional {@link SubstancePolymer_RepeatUnit#structuralRepresentation() structuralRepresentation}
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_RepeatUnit#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DEGREE_OF_POLYMERISATION = 0x2L;
    private static final long OPT_BIT_REPEAT_UNIT = 0x4L;
    private static final long OPT_BIT_ID = 0x8L;
    private static final long OPT_BIT_ORIENTATION_OF_POLYMERISATION = 0x10L;
    private static final long OPT_BIT_AMOUNT = 0x20L;
    private static final long OPT_BIT_STRUCTURAL_REPRESENTATION = 0x40L;
