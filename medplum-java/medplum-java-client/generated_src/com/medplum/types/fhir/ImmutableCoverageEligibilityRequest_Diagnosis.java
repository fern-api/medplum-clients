...
final class ImmutableCoverageEligibilityRequest_Diagnosis
  ...
  public final ImmutableCoverageEligibilityRequest_Diagnosis withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableCoverageEligibilityRequest_Diagnosis(this.id, newValue, this.diagnosisReference, this.diagnosisCodeableConcept, this.extension);
  }
  ...
  public final ImmutableCoverageEligibilityRequest_Diagnosis withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCoverageEligibilityRequest_Diagnosis(this.id, value, this.diagnosisReference, this.diagnosisCodeableConcept, this.extension);
  }
  ...
  public final ImmutableCoverageEligibilityRequest_Diagnosis withDiagnosisReference(Reference value) {
    ...
    return new ImmutableCoverageEligibilityRequest_Diagnosis(this.id, this.modifierExtension, newValue, this.diagnosisCodeableConcept, this.extension);
  }
  ...
  public final ImmutableCoverageEligibilityRequest_Diagnosis withDiagnosisReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableCoverageEligibilityRequest_Diagnosis(this.id, this.modifierExtension, value, this.diagnosisCodeableConcept, this.extension);
  }
  ...
  public final ImmutableCoverageEligibilityRequest_Diagnosis withDiagnosisCodeableConcept(CodeableConcept value) {
    ...
    return new ImmutableCoverageEligibilityRequest_Diagnosis(this.id, this.modifierExtension, this.diagnosisReference, newValue, this.extension);
  }
  ...
  public final ImmutableCoverageEligibilityRequest_Diagnosis withDiagnosisCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableCoverageEligibilityRequest_Diagnosis(this.id, this.modifierExtension, this.diagnosisReference, value, this.extension);
  }
  ...
  public final ImmutableCoverageEligibilityRequest_Diagnosis withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCoverageEligibilityRequest_Diagnosis(this.id, this.modifierExtension, this.diagnosisReference, this.diagnosisCodeableConcept, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code diagnosisReference}, {@code diagnosisCodeableConcept}, {@code extension}.
   ...
   *    .modifierExtension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link CoverageEligibilityRequest_Diagnosis#modifierExtension() modifierExtension}
   *    .diagnosisReference(com.medplum.types.fhir.Reference) // optional {@link CoverageEligibilityRequest_Diagnosis#diagnosisReference() diagnosisReference}
   *    .diagnosisCodeableConcept(com.medplum.types.fhir.CodeableConcept) // optional {@link CoverageEligibilityRequest_Diagnosis#diagnosisCodeableConcept() diagnosisCodeableConcept}
   *    .extension(List&amp;lt;com.medplum.types.fhir.Extension&amp;gt;) // optional {@link CoverageEligibilityRequest_Diagnosis#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DIAGNOSIS_REFERENCE = 0x4L;
    ...
    public CoverageEligibilityRequest_Diagnosis build() {
      return new ImmutableCoverageEligibilityRequest_Diagnosis(id, modifierExtension, diagnosisReference, diagnosisCodeableConcept, extension);
    }
