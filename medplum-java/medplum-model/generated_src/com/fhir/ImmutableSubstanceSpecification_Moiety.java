...
final class ImmutableSubstanceSpecification_Moiety implements SubstanceSpecification_Moiety {
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code molecularFormula}, {@code opticalActivity}, {@code amountQuantity}, {@code name}, {@code id}, {@code extension}, {@code amountString}, {@code role}, {@code stereochemistry}, {@code identifier}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Moiety#modifierExtension() modifierExtension}
   *    .molecularFormula(String) // optional {@link SubstanceSpecification_Moiety#molecularFormula() molecularFormula}
   *    .opticalActivity(com.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Moiety#opticalActivity() opticalActivity}
   *    .amountQuantity(com.fhir.Quantity) // optional {@link SubstanceSpecification_Moiety#amountQuantity() amountQuantity}
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Moiety#extension() extension}
   *    .amountString(String) // optional {@link SubstanceSpecification_Moiety#amountString() amountString}
   *    .role(com.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Moiety#role() role}
   *    .stereochemistry(com.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Moiety#stereochemistry() stereochemistry}
   *    .identifier(com.fhir.Identifier) // optional {@link SubstanceSpecification_Moiety#identifier() identifier}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_MOLECULAR_FORMULA = 0x2L;
    ...
    private static final long OPT_BIT_AMOUNT_STRING = 0x80L;
    private static final long OPT_BIT_ROLE = 0x100L;
    private static final long OPT_BIT_STEREOCHEMISTRY = 0x200L;
