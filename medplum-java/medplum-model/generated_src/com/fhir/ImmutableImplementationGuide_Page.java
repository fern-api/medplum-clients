...
final class ImmutableImplementationGuide_Page implements ImplementationGuide_Page {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code nameReference}, {@code modifierExtension}, {@code page}, {@code extension}, {@code generation}, {@code title}, {@code nameUrl}.
   ...
   *    .nameReference(com.fhir.Reference) // optional {@link ImplementationGuide_Page#nameReference() nameReference}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ImplementationGuide_Page#modifierExtension() modifierExtension}
   *    .page(List&amp;lt;com.fhir.ImplementationGuide_Page&amp;gt;) // optional {@link ImplementationGuide_Page#page() page}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ImplementationGuide_Page#extension() extension}
   *    .generation(com.fhir.Implementationguide_pageGeneration) // optional {@link ImplementationGuide_Page#generation() generation}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_NAME_REFERENCE = 0x2L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x4L;
    private static final long OPT_BIT_PAGE = 0x8L;
    private static final long OPT_BIT_EXTENSION = 0x10L;
    private static final long OPT_BIT_GENERATION = 0x20L;
    ...
    public ImplementationGuide_Page build() {
      return new ImmutableImplementationGuide_Page(id, nameReference, modifierExtension, page, extension, generation, title, nameUrl);
    }
