...
final class ImmutableSpecimenDefinition_TypeTested implements SpecimenDefinition_TypeTested {
  ...
  /**
   * Computes a hash code from attributes: {@code type}, {@code container}, {@code retentionTime}, {@code preference}, {@code rejectionCriterion}, {@code id}, {@code requirement}, {@code modifierExtension}, {@code extension}, {@code isDerived}, {@code handling}.
   ...
   *    .type(com.fhir.CodeableConcept) // optional {@link SpecimenDefinition_TypeTested#type() type}
   *    .container(com.fhir.SpecimenDefinition_Container) // optional {@link SpecimenDefinition_TypeTested#container() container}
   *    .retentionTime(com.fhir.Duration) // optional {@link SpecimenDefinition_TypeTested#retentionTime() retentionTime}
   *    .preference(com.fhir.Specimendefinition_typetestedPreference) // optional {@link SpecimenDefinition_TypeTested#preference() preference}
   *    .rejectionCriterion(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link SpecimenDefinition_TypeTested#rejectionCriterion() rejectionCriterion}
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_TypeTested#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_TypeTested#extension() extension}
   *    .isDerived(Boolean) // optional {@link SpecimenDefinition_TypeTested#isDerived() isDerived}
   *    .handling(List&amp;lt;com.fhir.SpecimenDefinition_Handling&amp;gt;) // optional {@link SpecimenDefinition_TypeTested#handling() handling}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_REJECTION_CRITERION = 0x10L;
    private static final long OPT_BIT_ID = 0x20L;
    private static final long OPT_BIT_REQUIREMENT = 0x40L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x80L;
    private static final long OPT_BIT_EXTENSION = 0x100L;
    private static final long OPT_BIT_IS_DERIVED = 0x200L;
    private static final long OPT_BIT_HANDLING = 0x400L;
