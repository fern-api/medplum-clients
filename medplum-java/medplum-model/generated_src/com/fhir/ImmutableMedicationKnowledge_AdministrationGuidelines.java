...
final class ImmutableMedicationKnowledge_AdministrationGuidelines
  ...
  private boolean equalTo(ImmutableMedicationKnowledge_AdministrationGuidelines another) {
    return Objects.equals(dosage, another.dosage)
  ...
  /**
   * Computes a hash code from attributes: {@code dosage}, {@code patientCharacteristics}, {@code indicationReference}, {@code indicationCodeableConcept}, {@code id}, {@code modifierExtension}, {@code extension}.
   ...
   *    .dosage(List&amp;lt;com.fhir.MedicationKnowledge_Dosage&amp;gt;) // optional {@link MedicationKnowledge_AdministrationGuidelines#dosage() dosage}
   *    .patientCharacteristics(List&amp;lt;com.fhir.MedicationKnowledge_PatientCharacteristics&amp;gt;) // optional {@link MedicationKnowledge_AdministrationGuidelines#patientCharacteristics() patientCharacteristics}
   *    .indicationReference(com.fhir.Reference) // optional {@link MedicationKnowledge_AdministrationGuidelines#indicationReference() indicationReference}
   *    .indicationCodeableConcept(com.fhir.CodeableConcept) // optional {@link MedicationKnowledge_AdministrationGuidelines#indicationCodeableConcept() indicationCodeableConcept}
   *    .id(String) // optional {@link MedicationKnowledge_AdministrationGuidelines#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_AdministrationGuidelines#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_AdministrationGuidelines#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_DOSAGE = 0x1L;
    private static final long OPT_BIT_PATIENT_CHARACTERISTICS = 0x2L;
    private static final long OPT_BIT_INDICATION_REFERENCE = 0x4L;
    private static final long OPT_BIT_INDICATION_CODEABLE_CONCEPT = 0x8L;
