...
final class ImmutableChargeItemDefinition_PropertyGroup
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withExtension(List<Extension> value) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(newValue, this.modifierExtension, this.applicability, this.id, this.priceComponent);
  }
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(value, this.modifierExtension, this.applicability, this.id, this.priceComponent);
  }
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(this.extension, newValue, this.applicability, this.id, this.priceComponent);
  }
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(this.extension, value, this.applicability, this.id, this.priceComponent);
  }
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withApplicability(List<ChargeItemDefinition_Applicability> value) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(this.extension, this.modifierExtension, newValue, this.id, this.priceComponent);
  }
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withApplicability(Optional<? extends List<ChargeItemDefinition_Applicability>> optional) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(this.extension, this.modifierExtension, value, this.id, this.priceComponent);
  }
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withId(String value) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(this.extension, this.modifierExtension, this.applicability, newValue, this.priceComponent);
  }
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withId(Optional<String> optional) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(this.extension, this.modifierExtension, this.applicability, value, this.priceComponent);
  }
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withPriceComponent(List<ChargeItemDefinition_PriceComponent> value) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(this.extension, this.modifierExtension, this.applicability, this.id, newValue);
  }
  ...
  public final ImmutableChargeItemDefinition_PropertyGroup withPriceComponent(Optional<? extends List<ChargeItemDefinition_PriceComponent>> optional) {
    ...
    return new ImmutableChargeItemDefinition_PropertyGroup(this.extension, this.modifierExtension, this.applicability, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code modifierExtension}, {@code applicability}, {@code id}, {@code priceComponent}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ChargeItemDefinition_PropertyGroup#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ChargeItemDefinition_PropertyGroup#modifierExtension() modifierExtension}
   *    .applicability(List&amp;lt;com.fhir.ChargeItemDefinition_Applicability&amp;gt;) // optional {@link ChargeItemDefinition_PropertyGroup#applicability() applicability}
   *    .id(String) // optional {@link ChargeItemDefinition_PropertyGroup#id() id}
   *    .priceComponent(List&amp;lt;com.fhir.ChargeItemDefinition_PriceComponent&amp;gt;) // optional {@link ChargeItemDefinition_PropertyGroup#priceComponent() priceComponent}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_APPLICABILITY = 0x4L;
    private static final long OPT_BIT_ID = 0x8L;
    private static final long OPT_BIT_PRICE_COMPONENT = 0x10L;
    ...
    public ChargeItemDefinition_PropertyGroup build() {
      return new ImmutableChargeItemDefinition_PropertyGroup(extension, modifierExtension, applicability, id, priceComponent);
    }
