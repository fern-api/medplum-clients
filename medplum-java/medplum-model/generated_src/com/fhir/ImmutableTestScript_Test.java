...
final class ImmutableTestScript_Test implements TestScript_Test {
  ...
  public final ImmutableTestScript_Test withAction(TestScript_Action1... elements) {
    ...
    return new ImmutableTestScript_Test(newValue, this.description, this.modifierExtension, this.name, this.extension, this.id);
  }
  ...
  public final ImmutableTestScript_Test withDescription(String value) {
    ...
    return new ImmutableTestScript_Test(this.action, newValue, this.modifierExtension, this.name, this.extension, this.id);
  }
  ...
  public final ImmutableTestScript_Test withDescription(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Test(this.action, value, this.modifierExtension, this.name, this.extension, this.id);
  }
  ...
  public final ImmutableTestScript_Test withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Test(this.action, this.description, newValue, this.name, this.extension, this.id);
  }
  ...
  public final ImmutableTestScript_Test withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Test(this.action, this.description, value, this.name, this.extension, this.id);
  }
  ...
  public final ImmutableTestScript_Test withName(String value) {
    ...
    return new ImmutableTestScript_Test(this.action, this.description, this.modifierExtension, newValue, this.extension, this.id);
  }
  ...
  public final ImmutableTestScript_Test withName(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Test(this.action, this.description, this.modifierExtension, value, this.extension, this.id);
  }
  ...
  public final ImmutableTestScript_Test withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Test(this.action, this.description, this.modifierExtension, this.name, newValue, this.id);
  }
  ...
  public final ImmutableTestScript_Test withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Test(this.action, this.description, this.modifierExtension, this.name, value, this.id);
  }
  ...
  public final ImmutableTestScript_Test withId(String value) {
    ...
    return new ImmutableTestScript_Test(this.action, this.description, this.modifierExtension, this.name, this.extension, newValue);
  }
  ...
  public final ImmutableTestScript_Test withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Test(this.action, this.description, this.modifierExtension, this.name, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code action}, {@code description}, {@code modifierExtension}, {@code name}, {@code extension}, {@code id}.
   ...
   *    .addAction|addAllAction(com.fhir.TestScript_Action1) // {@link TestScript_Test#action() action} elements
   *    .description(String) // optional {@link TestScript_Test#description() description}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestScript_Test#modifierExtension() modifierExtension}
   *    .name(String) // optional {@link TestScript_Test#name() name}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestScript_Test#extension() extension}
  ...
  public static final class Builder {
    ...
    public TestScript_Test build() {
      return new ImmutableTestScript_Test(createUnmodifiableList(true, action), description, modifierExtension, name, extension, id);
    }
