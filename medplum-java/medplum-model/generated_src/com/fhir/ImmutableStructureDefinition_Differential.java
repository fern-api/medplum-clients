...
final class ImmutableStructureDefinition_Differential
  ...
  public final ImmutableStructureDefinition_Differential withExtension(List<Extension> value) {
    ...
    return new ImmutableStructureDefinition_Differential(newValue, this.modifierExtension, this.id, this.element);
  }
  ...
  public final ImmutableStructureDefinition_Differential withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableStructureDefinition_Differential(value, this.modifierExtension, this.id, this.element);
  }
  ...
  public final ImmutableStructureDefinition_Differential withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableStructureDefinition_Differential(this.extension, newValue, this.id, this.element);
  }
  ...
  public final ImmutableStructureDefinition_Differential withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableStructureDefinition_Differential(this.extension, value, this.id, this.element);
  }
  ...
  public final ImmutableStructureDefinition_Differential withId(String value) {
    ...
    return new ImmutableStructureDefinition_Differential(this.extension, this.modifierExtension, newValue, this.element);
  }
  ...
  public final ImmutableStructureDefinition_Differential withId(Optional<String> optional) {
    ...
    return new ImmutableStructureDefinition_Differential(this.extension, this.modifierExtension, value, this.element);
  }
  ...
  public final ImmutableStructureDefinition_Differential withElement(ElementDefinition... elements) {
    ...
    return new ImmutableStructureDefinition_Differential(this.extension, this.modifierExtension, this.id, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code modifierExtension}, {@code id}, {@code element}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link StructureDefinition_Differential#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link StructureDefinition_Differential#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link StructureDefinition_Differential#id() id}
   *    .addElement|addAllElement(com.fhir.ElementDefinition) // {@link StructureDefinition_Differential#element() element} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public StructureDefinition_Differential build() {
      return new ImmutableStructureDefinition_Differential(extension, modifierExtension, id, createUnmodifiableList(true, element));
    }
