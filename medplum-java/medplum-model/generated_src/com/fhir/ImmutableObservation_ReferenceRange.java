...
final class ImmutableObservation_ReferenceRange implements Observation_ReferenceRange {
  ...
  /**
   * Computes a hash code from attributes: {@code text}, {@code extension}, {@code low}, {@code id}, {@code type}, {@code high}, {@code age}, {@code modifierExtension}, {@code appliesTo}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Observation_ReferenceRange#extension() extension}
   *    .low(com.fhir.Quantity) // optional {@link Observation_ReferenceRange#low() low}
   *    .id(String) // optional {@link Observation_ReferenceRange#id() id}
   *    .type(com.fhir.CodeableConcept) // optional {@link Observation_ReferenceRange#type() type}
   *    .high(com.fhir.Quantity) // optional {@link Observation_ReferenceRange#high() high}
   *    .age(com.fhir.Range) // optional {@link Observation_ReferenceRange#age() age}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Observation_ReferenceRange#modifierExtension() modifierExtension}
   *    .appliesTo(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link Observation_ReferenceRange#appliesTo() appliesTo}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Observation_ReferenceRange build() {
      return new ImmutableObservation_ReferenceRange(text, extension, low, id, type, high, age, modifierExtension, appliesTo);
    }
