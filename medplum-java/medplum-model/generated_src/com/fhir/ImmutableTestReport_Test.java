...
final class ImmutableTestReport_Test implements TestReport_Test {
  ...
  public final ImmutableTestReport_Test withName(String value) {
    ...
    return new ImmutableTestReport_Test(newValue, this.modifierExtension, this.action, this.description, this.extension, this.id);
  }
  ...
  public final ImmutableTestReport_Test withName(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Test(value, this.modifierExtension, this.action, this.description, this.extension, this.id);
  }
  ...
  public final ImmutableTestReport_Test withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Test(this.name, newValue, this.action, this.description, this.extension, this.id);
  }
  ...
  public final ImmutableTestReport_Test withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Test(this.name, value, this.action, this.description, this.extension, this.id);
  }
  ...
  public final ImmutableTestReport_Test withAction(TestReport_Action1... elements) {
    ...
    return new ImmutableTestReport_Test(this.name, this.modifierExtension, newValue, this.description, this.extension, this.id);
  }
  ...
  public final ImmutableTestReport_Test withDescription(String value) {
    ...
    return new ImmutableTestReport_Test(this.name, this.modifierExtension, this.action, newValue, this.extension, this.id);
  }
  ...
  public final ImmutableTestReport_Test withDescription(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Test(this.name, this.modifierExtension, this.action, value, this.extension, this.id);
  }
  ...
  public final ImmutableTestReport_Test withExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Test(this.name, this.modifierExtension, this.action, this.description, newValue, this.id);
  }
  ...
  public final ImmutableTestReport_Test withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Test(this.name, this.modifierExtension, this.action, this.description, value, this.id);
  }
  ...
  public final ImmutableTestReport_Test withId(String value) {
    ...
    return new ImmutableTestReport_Test(this.name, this.modifierExtension, this.action, this.description, this.extension, newValue);
  }
  ...
  public final ImmutableTestReport_Test withId(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Test(this.name, this.modifierExtension, this.action, this.description, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code name}, {@code modifierExtension}, {@code action}, {@code description}, {@code extension}, {@code id}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestReport_Test#modifierExtension() modifierExtension}
   *    .addAction|addAllAction(com.fhir.TestReport_Action1) // {@link TestReport_Test#action() action} elements
   *    .description(String) // optional {@link TestReport_Test#description() description}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestReport_Test#extension() extension}
  ...
  public static final class Builder {
    ...
    public TestReport_Test build() {
      return new ImmutableTestReport_Test(name, modifierExtension, createUnmodifiableList(true, action), description, extension, id);
    }
