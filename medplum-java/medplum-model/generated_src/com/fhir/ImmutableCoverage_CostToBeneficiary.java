...
final class ImmutableCoverage_CostToBeneficiary implements Coverage_CostToBeneficiary {
  ...
  public final ImmutableCoverage_CostToBeneficiary withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCoverage_CostToBeneficiary(this.id, value, this.valueMoney, this.exception, this.type, this.extension, this.valueQuantity);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code valueMoney}, {@code exception}, {@code type}, {@code extension}, {@code valueQuantity}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Coverage_CostToBeneficiary#modifierExtension() modifierExtension}
   *    .valueMoney(com.fhir.Money) // optional {@link Coverage_CostToBeneficiary#valueMoney() valueMoney}
   *    .exception(List&amp;lt;com.fhir.Coverage_Exception&amp;gt;) // optional {@link Coverage_CostToBeneficiary#exception() exception}
   *    .type(com.fhir.CodeableConcept) // optional {@link Coverage_CostToBeneficiary#type() type}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Coverage_CostToBeneficiary#extension() extension}
   *    .valueQuantity(com.fhir.Quantity) // optional {@link Coverage_CostToBeneficiary#valueQuantity() valueQuantity}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_VALUE_MONEY = 0x4L;
    private static final long OPT_BIT_EXCEPTION = 0x8L;
    private static final long OPT_BIT_TYPE = 0x10L;
    private static final long OPT_BIT_EXTENSION = 0x20L;
    private static final long OPT_BIT_VALUE_QUANTITY = 0x40L;
    ...
    public Coverage_CostToBeneficiary build() {
      return new ImmutableCoverage_CostToBeneficiary(id, modifierExtension, valueMoney, exception, type, extension, valueQuantity);
    }
