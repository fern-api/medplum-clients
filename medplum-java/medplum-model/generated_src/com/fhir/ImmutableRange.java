...
final class ImmutableRange implements Range {
  ...
  public final ImmutableRange withLow(Quantity value) {
    ...
    return new ImmutableRange(newValue, this.id, this.high, this.extension);
  }
  ...
  public final ImmutableRange withLow(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableRange(value, this.id, this.high, this.extension);
  }
  ...
  public final ImmutableRange withId(String value) {
    ...
    return new ImmutableRange(this.low, newValue, this.high, this.extension);
  }
  ...
  public final ImmutableRange withId(Optional<String> optional) {
    ...
    return new ImmutableRange(this.low, value, this.high, this.extension);
  }
  ...
  public final ImmutableRange withHigh(Quantity value) {
    ...
    return new ImmutableRange(this.low, this.id, newValue, this.extension);
  }
  ...
  public final ImmutableRange withHigh(Optional<? extends Quantity> optional) {
    ...
    return new ImmutableRange(this.low, this.id, value, this.extension);
  }
  ...
  public final ImmutableRange withExtension(List<Extension> value) {
    ...
    return new ImmutableRange(this.low, this.id, this.high, newValue);
  }
  ...
  public final ImmutableRange withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableRange(this.low, this.id, this.high, value);
  }
  ...
  private boolean equalTo(ImmutableRange another) {
    return Objects.equals(low, another.low)
  ...
  /**
   * Computes a hash code from attributes: {@code low}, {@code id}, {@code high}, {@code extension}.
   ...
   *    .low(com.fhir.Quantity) // optional {@link Range#low() low}
   *    .id(String) // optional {@link Range#id() id}
   *    .high(com.fhir.Quantity) // optional {@link Range#high() high}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Range#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_LOW = 0x1L;
     ...
     */
    public Range build() {
      return new ImmutableRange(low, id, high, extension);
    }
