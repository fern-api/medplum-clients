...
final class ImmutableProdCharacteristic implements ProdCharacteristic {
  ...
  /**
   * Computes a hash code from attributes: {@code image}, {@code scoring}, {@code extension}, {@code width}, {@code modifierExtension}, {@code externalDiameter}, {@code depth}, {@code shape}, {@code color}, {@code weight}, {@code nominalVolume}, {@code imprint}, {@code id}, {@code height}.
   ...
   *    .image(List&amp;lt;com.fhir.Attachment&amp;gt;) // optional {@link ProdCharacteristic#image() image}
   *    .scoring(com.fhir.CodeableConcept) // optional {@link ProdCharacteristic#scoring() scoring}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ProdCharacteristic#extension() extension}
   *    .width(com.fhir.Quantity) // optional {@link ProdCharacteristic#width() width}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ProdCharacteristic#modifierExtension() modifierExtension}
   *    .externalDiameter(com.fhir.Quantity) // optional {@link ProdCharacteristic#externalDiameter() externalDiameter}
   *    .depth(com.fhir.Quantity) // optional {@link ProdCharacteristic#depth() depth}
   *    .shape(String) // optional {@link ProdCharacteristic#shape() shape}
   *    .color(List&amp;lt;String&amp;gt;) // optional {@link ProdCharacteristic#color() color}
   *    .weight(com.fhir.Quantity) // optional {@link ProdCharacteristic#weight() weight}
   *    .nominalVolume(com.fhir.Quantity) // optional {@link ProdCharacteristic#nominalVolume() nominalVolume}
   *    .imprint(List&amp;lt;String&amp;gt;) // optional {@link ProdCharacteristic#imprint() imprint}
   *    .id(String) // optional {@link ProdCharacteristic#id() id}
   *    .height(com.fhir.Quantity) // optional {@link ProdCharacteristic#height() height}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_WIDTH = 0x8L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x10L;
    private static final long OPT_BIT_EXTERNAL_DIAMETER = 0x20L;
    private static final long OPT_BIT_DEPTH = 0x40L;
    private static final long OPT_BIT_SHAPE = 0x80L;
    private static final long OPT_BIT_COLOR = 0x100L;
    private static final long OPT_BIT_WEIGHT = 0x200L;
    private static final long OPT_BIT_NOMINAL_VOLUME = 0x400L;
    private static final long OPT_BIT_IMPRINT = 0x800L;
    private static final long OPT_BIT_ID = 0x1000L;
    private static final long OPT_BIT_HEIGHT = 0x2000L;
