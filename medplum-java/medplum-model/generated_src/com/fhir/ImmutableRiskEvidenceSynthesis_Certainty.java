...
final class ImmutableRiskEvidenceSynthesis_Certainty
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withNote(Optional<? extends List<Annotation>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(value, this.id, this.extension, this.modifierExtension, this.rating, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withExtension(List<Extension> value) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.note, this.id, newValue, this.modifierExtension, this.rating, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.note, this.id, value, this.modifierExtension, this.rating, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.note, this.id, this.extension, newValue, this.rating, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.note, this.id, this.extension, value, this.rating, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withRating(Optional<? extends List<CodeableConcept>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.note, this.id, this.extension, this.modifierExtension, value, this.certaintySubcomponent);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withCertaintySubcomponent(List<RiskEvidenceSynthesis_CertaintySubcomponent> value) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.note, this.id, this.extension, this.modifierExtension, this.rating, newValue);
  }
  ...
  public final ImmutableRiskEvidenceSynthesis_Certainty withCertaintySubcomponent(Optional<? extends List<RiskEvidenceSynthesis_CertaintySubcomponent>> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_Certainty(this.note, this.id, this.extension, this.modifierExtension, this.rating, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code note}, {@code id}, {@code extension}, {@code modifierExtension}, {@code rating}, {@code certaintySubcomponent}.
   ...
   *    .note(List&amp;lt;com.fhir.Annotation&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#note() note}
   *    .id(String) // optional {@link RiskEvidenceSynthesis_Certainty#id() id}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#modifierExtension() modifierExtension}
   *    .rating(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#rating() rating}
   *    .certaintySubcomponent(List&amp;lt;com.fhir.RiskEvidenceSynthesis_CertaintySubcomponent&amp;gt;) // optional {@link RiskEvidenceSynthesis_Certainty#certaintySubcomponent() certaintySubcomponent}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_RATING = 0x10L;
    ...
    public RiskEvidenceSynthesis_Certainty build() {
      return new ImmutableRiskEvidenceSynthesis_Certainty(note, id, extension, modifierExtension, rating, certaintySubcomponent);
    }
