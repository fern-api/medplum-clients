 ...
 */
@org.immutables.value.Generated(from = "time", generator = "Immutables")
@SuppressWarnings({"all"})
@edu.umd.cs.findbugs.annotations.SuppressFBWarnings
@javax.annotation.ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@javax.annotation.concurrent.Immutable
final class ImmutableTime implements com.fhir.time {
  private final java.lang.String value;

  private ImmutableTime(java.lang.String value) {
    this.value = value;
  }
   ...
   */
  public final ImmutableTime withValue(java.lang.String value) {
  ...
  static ImmutableTime fromJson(java.lang.String jsonValue) {
  ...
  public static final class Builder implements ValueBuildStage, BuildFinal {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new java.lang.IllegalStateException("Builder of time is strict, attribute is already set: ".concat(name));
    }
