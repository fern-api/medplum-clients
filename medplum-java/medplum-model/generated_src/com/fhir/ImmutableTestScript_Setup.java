...
final class ImmutableTestScript_Setup implements TestScript_Setup {
  ...
  public final ImmutableTestScript_Setup withId(String value) {
    ...
    return new ImmutableTestScript_Setup(newValue, this.action, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Setup withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Setup(value, this.action, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Setup withAction(TestScript_Action... elements) {
    ...
    return new ImmutableTestScript_Setup(this.id, newValue, this.extension, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Setup withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Setup(this.id, this.action, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Setup withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Setup(this.id, this.action, value, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Setup withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Setup(this.id, this.action, this.extension, newValue);
  }
  ...
  public final ImmutableTestScript_Setup withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Setup(this.id, this.action, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code action}, {@code extension}, {@code modifierExtension}.
   ...
   *    .addAction|addAllAction(com.fhir.TestScript_Action) // {@link TestScript_Setup#action() action} elements
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestScript_Setup#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestScript_Setup#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TestScript_Setup build() {
      return new ImmutableTestScript_Setup(id, createUnmodifiableList(true, action), extension, modifierExtension);
    }
