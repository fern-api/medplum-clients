 ...
 */
@org.immutables.value.Generated(from = "ClaimResponse_Detail1", generator = "Immutables")
...
final class ImmutableClaimResponse_Detail1 implements com.fhir.ClaimResponse_Detail1 {
  ...
  private final @javax.annotation.Nullable java.util.List<com.fhir.ClaimResponse_SubDetail1> subDetail;
  ...
  private ImmutableClaimResponse_Detail1(
      ...
      @javax.annotation.Nullable java.util.List<com.fhir.ClaimResponse_SubDetail1> subDetail,
  ...
  @Override
  public java.util.Optional<java.util.List<com.fhir.ClaimResponse_SubDetail1>> subDetail() {
   ...
   */
  public final ImmutableClaimResponse_Detail1 withUnitPrice(com.fhir.Money value) {
  ...
  public final ImmutableClaimResponse_Detail1 withUnitPrice(java.util.Optional<? extends com.fhir.Money> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withNet(com.fhir.Money value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableClaimResponse_Detail1 withNet(java.util.Optional<? extends com.fhir.Money> optional) {
    @javax.annotation.Nullable com.fhir.Money value = optional.orElse(null);
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withSubDetail(java.util.List<com.fhir.ClaimResponse_SubDetail1> value) {
    @javax.annotation.Nullable java.util.List<com.fhir.ClaimResponse_SubDetail1> newValue = java.util.Objects.requireNonNull(value, "subDetail");
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableClaimResponse_Detail1 withSubDetail(java.util.Optional<? extends java.util.List<com.fhir.ClaimResponse_SubDetail1>> optional) {
    @javax.annotation.Nullable java.util.List<com.fhir.ClaimResponse_SubDetail1> value = optional.orElse(null);
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withAdjudication(com.fhir.ClaimResponse_Adjudication... elements) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withAdjudication(Iterable<? extends com.fhir.ClaimResponse_Adjudication> elements) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withModifierExtension(java.util.List<com.fhir.Extension> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableClaimResponse_Detail1 withModifierExtension(java.util.Optional<? extends java.util.List<com.fhir.Extension>> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withQuantity(com.fhir.Quantity value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableClaimResponse_Detail1 withQuantity(java.util.Optional<? extends com.fhir.Quantity> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withNoteNumber(java.util.List<com.fhir.positiveInt> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableClaimResponse_Detail1 withNoteNumber(java.util.Optional<? extends java.util.List<com.fhir.positiveInt>> optional) {
   ...
   */
  public final ImmutableClaimResponse_Detail1 withProductOrService(com.fhir.CodeableConcept value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withExtension(java.util.List<com.fhir.Extension> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableClaimResponse_Detail1 withExtension(java.util.Optional<? extends java.util.List<com.fhir.Extension>> optional) {
    @javax.annotation.Nullable java.util.List<com.fhir.Extension> value = optional.orElse(null);
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withId(java.lang.String value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withId(java.util.Optional<java.lang.String> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withModifier(java.util.List<com.fhir.CodeableConcept> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableClaimResponse_Detail1 withModifier(java.util.Optional<? extends java.util.List<com.fhir.CodeableConcept>> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableClaimResponse_Detail1 withFactor(com.fhir.decimal value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableClaimResponse_Detail1 withFactor(java.util.Optional<? extends com.fhir.decimal> optional) {
  ...
  private boolean equalTo(ImmutableClaimResponse_Detail1 another) {
    return java.util.Objects.equals(unitPrice, another.unitPrice)
  ...
  /**
   * Computes a hash code from attributes: {@code unitPrice}, {@code net}, {@code subDetail}, {@code adjudication}, {@code modifierExtension}, {@code quantity}, {@code noteNumber}, {@code productOrService}, {@code extension}, {@code id}, {@code modifier}, {@code factor}.
  ...
  public String toString() {
    java.lang.StringBuilder builder = new java.lang.StringBuilder("ClaimResponse_Detail1{");
    if (unitPrice != null) {
  ...
  static final class Json implements com.fhir.ClaimResponse_Detail1 {
    ...
    boolean netIsSet;
    @javax.annotation.Nullable java.util.Optional<java.util.List<com.fhir.ClaimResponse_SubDetail1>> subDetail = java.util.Optional.empty();
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("subDetail")
    public void setSubDetail(java.util.Optional<java.util.List<com.fhir.ClaimResponse_SubDetail1>> subDetail) {
      this.subDetail = subDetail;
    ...
    @Override
    public java.util.Optional<java.util.List<com.fhir.ClaimResponse_SubDetail1>> subDetail() { throw new UnsupportedOperationException(); }
    @Override
   ...
   *    .unitPrice(com.fhir.Money) // optional {@link ClaimResponse_Detail1#unitPrice() unitPrice}
   *    .net(com.fhir.Money) // optional {@link ClaimResponse_Detail1#net() net}
   *    .subDetail(List&amp;lt;com.fhir.ClaimResponse_SubDetail1&amp;gt;) // optional {@link ClaimResponse_Detail1#subDetail() subDetail}
   *    .addAdjudication|addAllAdjudication(com.fhir.ClaimResponse_Adjudication) // {@link ClaimResponse_Detail1#adjudication() adjudication} elements
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_Detail1#modifierExtension() modifierExtension}
   *    .quantity(com.fhir.Quantity) // optional {@link ClaimResponse_Detail1#quantity() quantity}
   *    .noteNumber(List&amp;lt;com.fhir.positiveInt&amp;gt;) // optional {@link ClaimResponse_Detail1#noteNumber() noteNumber}
   *    .productOrService(com.fhir.CodeableConcept) // required {@link ClaimResponse_Detail1#productOrService() productOrService}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ClaimResponse_Detail1#extension() extension}
   *    .id(String) // optional {@link ClaimResponse_Detail1#id() id}
   *    .modifier(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link ClaimResponse_Detail1#modifier() modifier}
   *    .factor(com.fhir.decimal) // optional {@link ClaimResponse_Detail1#factor() factor}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ProductOrServiceBuildStage, BuildFinal {
    ...
    private @javax.annotation.Nullable java.util.List<com.fhir.ClaimResponse_SubDetail1> subDetail;
     ...
     * @return {@code this} builder for chained invocation
     */
    public final Builder subDetail(java.util.List<com.fhir.ClaimResponse_SubDetail1> subDetail) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("subDetail")
    public final Builder subDetail(java.util.Optional<? extends java.util.List<com.fhir.ClaimResponse_SubDetail1>> subDetail) {
      checkNotIsSet(subDetailIsSet(), "subDetail");
     ...
     */
    public com.fhir.ClaimResponse_Detail1 build() {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new java.lang.IllegalStateException("Builder of ClaimResponse_Detail1 is strict, attribute is already set: ".concat(name));
    }
  ...
  public interface BuildFinal {
     ...
     * @return {@code this} builder for chained invocation
     */
    BuildFinal subDetail(java.util.List<com.fhir.ClaimResponse_SubDetail1> subDetail);
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    BuildFinal subDetail(java.util.Optional<? extends java.util.List<com.fhir.ClaimResponse_SubDetail1>> subDetail);
