...
final class ImmutableTestScript_Teardown implements TestScript_Teardown {
  ...
  public final ImmutableTestScript_Teardown withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Teardown(newValue, this.action, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Teardown withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Teardown(value, this.action, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Teardown withAction(TestScript_Action2... elements) {
    ...
    return new ImmutableTestScript_Teardown(this.extension, newValue, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Teardown withId(String value) {
    ...
    return new ImmutableTestScript_Teardown(this.extension, this.action, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Teardown withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Teardown(this.extension, this.action, value, this.modifierExtension);
  }
  ...
  public final ImmutableTestScript_Teardown withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Teardown(this.extension, this.action, this.id, newValue);
  }
  ...
  public final ImmutableTestScript_Teardown withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Teardown(this.extension, this.action, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code action}, {@code id}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestScript_Teardown#extension() extension}
   *    .addAction|addAllAction(com.fhir.TestScript_Action2) // {@link TestScript_Teardown#action() action} elements
   *    .id(String) // optional {@link TestScript_Teardown#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestScript_Teardown#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TestScript_Teardown build() {
      return new ImmutableTestScript_Teardown(extension, createUnmodifiableList(true, action), id, modifierExtension);
    }
