...
final class ImmutableSubstanceNucleicAcid_Linkage implements SubstanceNucleicAcid_Linkage {
  ...
  public final ImmutableSubstanceNucleicAcid_Linkage withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstanceNucleicAcid_Linkage(this.connectivity, this.identifier, this.id, this.name, this.residueSite, value, this.extension);
  }
  ...
  private boolean equalTo(ImmutableSubstanceNucleicAcid_Linkage another) {
    return Objects.equals(connectivity, another.connectivity)
  ...
  /**
   * Computes a hash code from attributes: {@code connectivity}, {@code identifier}, {@code id}, {@code name}, {@code residueSite}, {@code modifierExtension}, {@code extension}.
   ...
   *    .identifier(com.fhir.Identifier) // optional {@link SubstanceNucleicAcid_Linkage#identifier() identifier}
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceNucleicAcid_Linkage#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceNucleicAcid_Linkage#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_CONNECTIVITY = 0x1L;
    ...
    public SubstanceNucleicAcid_Linkage build() {
      return new ImmutableSubstanceNucleicAcid_Linkage(connectivity, identifier, id, name, residueSite, modifierExtension, extension);
    }
