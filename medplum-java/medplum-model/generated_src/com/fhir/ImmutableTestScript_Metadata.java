...
final class ImmutableTestScript_Metadata implements TestScript_Metadata {
  ...
  public final ImmutableTestScript_Metadata withLink(List<TestScript_Link> value) {
    ...
    return new ImmutableTestScript_Metadata(newValue, this.extension, this.modifierExtension, this.id, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withLink(Optional<? extends List<TestScript_Link>> optional) {
    ...
    return new ImmutableTestScript_Metadata(value, this.extension, this.modifierExtension, this.id, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Metadata(this.link, newValue, this.modifierExtension, this.id, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Metadata(this.link, value, this.modifierExtension, this.id, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestScript_Metadata(this.link, this.extension, newValue, this.id, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestScript_Metadata(this.link, this.extension, value, this.id, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withId(String value) {
    ...
    return new ImmutableTestScript_Metadata(this.link, this.extension, this.modifierExtension, newValue, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withId(Optional<String> optional) {
    ...
    return new ImmutableTestScript_Metadata(this.link, this.extension, this.modifierExtension, value, this.capability);
  }
  ...
  public final ImmutableTestScript_Metadata withCapability(TestScript_Capability... elements) {
    ...
    return new ImmutableTestScript_Metadata(this.link, this.extension, this.modifierExtension, this.id, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code link}, {@code extension}, {@code modifierExtension}, {@code id}, {@code capability}.
   ...
   *    .link(List&amp;lt;com.fhir.TestScript_Link&amp;gt;) // optional {@link TestScript_Metadata#link() link}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestScript_Metadata#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestScript_Metadata#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link TestScript_Metadata#id() id}
   *    .addCapability|addAllCapability(com.fhir.TestScript_Capability) // {@link TestScript_Metadata#capability() capability} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TestScript_Metadata build() {
      return new ImmutableTestScript_Metadata(link, extension, modifierExtension, id, createUnmodifiableList(true, capability));
    }
