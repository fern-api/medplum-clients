...
final class ImmutableSubstancePolymer_StartingMaterial
  ...
  public final ImmutableSubstancePolymer_StartingMaterial withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSubstancePolymer_StartingMaterial(newValue, this.isDefining, this.extension, this.material, this.amount, this.id, this.type);
  }
  ...
  public final ImmutableSubstancePolymer_StartingMaterial withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstancePolymer_StartingMaterial(value, this.isDefining, this.extension, this.material, this.amount, this.id, this.type);
  }
  ...
  public final ImmutableSubstancePolymer_StartingMaterial withIsDefining(Optional<Boolean> optional) {
    ...
    return new ImmutableSubstancePolymer_StartingMaterial(this.modifierExtension, value, this.extension, this.material, this.amount, this.id, this.type);
  }
  ...
  public final ImmutableSubstancePolymer_StartingMaterial withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSubstancePolymer_StartingMaterial(this.modifierExtension, this.isDefining, value, this.material, this.amount, this.id, this.type);
  }
  ...
  public final ImmutableSubstancePolymer_StartingMaterial withMaterial(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSubstancePolymer_StartingMaterial(this.modifierExtension, this.isDefining, this.extension, value, this.amount, this.id, this.type);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code isDefining}, {@code extension}, {@code material}, {@code amount}, {@code id}, {@code type}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_StartingMaterial#modifierExtension() modifierExtension}
   *    .isDefining(Boolean) // optional {@link SubstancePolymer_StartingMaterial#isDefining() isDefining}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_StartingMaterial#extension() extension}
   *    .material(com.fhir.CodeableConcept) // optional {@link SubstancePolymer_StartingMaterial#material() material}
   *    .amount(com.fhir.SubstanceAmount) // optional {@link SubstancePolymer_StartingMaterial#amount() amount}
   *    .id(String) // optional {@link SubstancePolymer_StartingMaterial#id() id}
   *    .type(com.fhir.CodeableConcept) // optional {@link SubstancePolymer_StartingMaterial#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_IS_DEFINING = 0x2L;
    ...
    public SubstancePolymer_StartingMaterial build() {
      return new ImmutableSubstancePolymer_StartingMaterial(modifierExtension, isDefining, extension, material, amount, id, type);
    }
