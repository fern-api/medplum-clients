...
final class ImmutableCoverageEligibilityRequest_Item
  ...
  private final @Nullable List<com.fhir.positiveInt> supportingInfoSequence;
  ...
  private ImmutableCoverageEligibilityRequest_Item(
      ...
      @Nullable List<com.fhir.positiveInt> supportingInfoSequence,
  ...
  @Override
  public Optional<List<com.fhir.positiveInt>> supportingInfoSequence() {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableCoverageEligibilityRequest_Item withSupportingInfoSequence(List<com.fhir.positiveInt> value) {
    @Nullable List<com.fhir.positiveInt> newValue = Objects.requireNonNull(value, "supportingInfoSequence");
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableCoverageEligibilityRequest_Item withSupportingInfoSequence(Optional<? extends List<com.fhir.positiveInt>> optional) {
    @Nullable List<com.fhir.positiveInt> value = optional.orElse(null);
  ...
  private boolean equalTo(ImmutableCoverageEligibilityRequest_Item another) {
    return Objects.equals(provider, another.provider)
  ...
  /**
   * Computes a hash code from attributes: {@code provider}, {@code facility}, {@code quantity}, {@code modifier}, {@code diagnosis}, {@code unitPrice}, {@code supportingInfoSequence}, {@code extension}, {@code modifierExtension}, {@code detail}, {@code category}, {@code productOrService}, {@code id}.
  ...
  static final class Json implements CoverageEligibilityRequest_Item {
    ...
    @Nullable Optional<List<com.fhir.positiveInt>> supportingInfoSequence = Optional.empty();
    ...
    @JsonProperty("supportingInfoSequence")
    public void setSupportingInfoSequence(Optional<List<com.fhir.positiveInt>> supportingInfoSequence) {
      this.supportingInfoSequence = supportingInfoSequence;
    ...
    @Override
    public Optional<List<com.fhir.positiveInt>> supportingInfoSequence() { throw new UnsupportedOperationException(); }
    @Override
   ...
   *    .provider(com.fhir.Reference) // optional {@link CoverageEligibilityRequest_Item#provider() provider}
   *    .facility(com.fhir.Reference) // optional {@link CoverageEligibilityRequest_Item#facility() facility}
   *    .quantity(com.fhir.Quantity) // optional {@link CoverageEligibilityRequest_Item#quantity() quantity}
   *    .modifier(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#modifier() modifier}
   *    .diagnosis(List&amp;lt;com.fhir.CoverageEligibilityRequest_Diagnosis&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#diagnosis() diagnosis}
   *    .unitPrice(com.fhir.Money) // optional {@link CoverageEligibilityRequest_Item#unitPrice() unitPrice}
   *    .supportingInfoSequence(List&amp;lt;com.fhir.positiveInt&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#supportingInfoSequence() supportingInfoSequence}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#modifierExtension() modifierExtension}
   *    .detail(List&amp;lt;com.fhir.Reference&amp;gt;) // optional {@link CoverageEligibilityRequest_Item#detail() detail}
   *    .category(com.fhir.CodeableConcept) // optional {@link CoverageEligibilityRequest_Item#category() category}
   *    .productOrService(com.fhir.CodeableConcept) // optional {@link CoverageEligibilityRequest_Item#productOrService() productOrService}
  ...
  public static final class Builder {
    private static final long OPT_BIT_PROVIDER = 0x1L;
    private static final long OPT_BIT_FACILITY = 0x2L;
    ...
    private static final long OPT_BIT_SUPPORTING_INFO_SEQUENCE = 0x40L;
    ...
    private static final long OPT_BIT_PRODUCT_OR_SERVICE = 0x800L;
    ...
    private @Nullable List<com.fhir.positiveInt> supportingInfoSequence;
     ...
     * @return {@code this} builder for chained invocation
     */
    public final Builder supportingInfoSequence(List<com.fhir.positiveInt> supportingInfoSequence) {
     ...
     */
    @JsonProperty("supportingInfoSequence")
    public final Builder supportingInfoSequence(Optional<? extends List<com.fhir.positiveInt>> supportingInfoSequence) {
      checkNotIsSet(supportingInfoSequenceIsSet(), "supportingInfoSequence");
