...
final class ImmutableNutritionOrder_Texture implements NutritionOrder_Texture {
  ...
  public final ImmutableNutritionOrder_Texture withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableNutritionOrder_Texture(newValue, this.extension, this.modifier, this.id, this.foodType);
  }
  ...
  public final ImmutableNutritionOrder_Texture withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(value, this.extension, this.modifier, this.id, this.foodType);
  }
  ...
  public final ImmutableNutritionOrder_Texture withExtension(List<Extension> value) {
    ...
    return new ImmutableNutritionOrder_Texture(this.modifierExtension, newValue, this.modifier, this.id, this.foodType);
  }
  ...
  public final ImmutableNutritionOrder_Texture withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(this.modifierExtension, value, this.modifier, this.id, this.foodType);
  }
  ...
  public final ImmutableNutritionOrder_Texture withModifier(CodeableConcept value) {
    ...
    return new ImmutableNutritionOrder_Texture(this.modifierExtension, this.extension, newValue, this.id, this.foodType);
  }
  ...
  public final ImmutableNutritionOrder_Texture withModifier(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(this.modifierExtension, this.extension, value, this.id, this.foodType);
  }
  ...
  public final ImmutableNutritionOrder_Texture withId(String value) {
    ...
    return new ImmutableNutritionOrder_Texture(this.modifierExtension, this.extension, this.modifier, newValue, this.foodType);
  }
  ...
  public final ImmutableNutritionOrder_Texture withId(Optional<String> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(this.modifierExtension, this.extension, this.modifier, value, this.foodType);
  }
  ...
  public final ImmutableNutritionOrder_Texture withFoodType(CodeableConcept value) {
    ...
    return new ImmutableNutritionOrder_Texture(this.modifierExtension, this.extension, this.modifier, this.id, newValue);
  }
  ...
  public final ImmutableNutritionOrder_Texture withFoodType(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableNutritionOrder_Texture(this.modifierExtension, this.extension, this.modifier, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code extension}, {@code modifier}, {@code id}, {@code foodType}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_Texture#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_Texture#extension() extension}
   *    .modifier(com.fhir.CodeableConcept) // optional {@link NutritionOrder_Texture#modifier() modifier}
   *    .id(String) // optional {@link NutritionOrder_Texture#id() id}
   *    .foodType(com.fhir.CodeableConcept) // optional {@link NutritionOrder_Texture#foodType() foodType}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_FOOD_TYPE = 0x10L;
    ...
    public NutritionOrder_Texture build() {
      return new ImmutableNutritionOrder_Texture(modifierExtension, extension, modifier, id, foodType);
    }
