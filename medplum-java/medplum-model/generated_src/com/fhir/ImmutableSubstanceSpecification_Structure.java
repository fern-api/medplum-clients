...
final class ImmutableSubstanceSpecification_Structure
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code source}, {@code representation}, {@code molecularWeight}, {@code molecularFormula}, {@code isotope}, {@code id}, {@code stereochemistry}, {@code molecularFormulaByMoiety}, {@code modifierExtension}, {@code opticalActivity}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Structure#extension() extension}
   *    .source(List&amp;lt;com.fhir.Reference&amp;gt;) // optional {@link SubstanceSpecification_Structure#source() source}
   *    .representation(List&amp;lt;com.fhir.SubstanceSpecification_Representation&amp;gt;) // optional {@link SubstanceSpecification_Structure#representation() representation}
   *    .molecularWeight(com.fhir.SubstanceSpecification_MolecularWeight) // optional {@link SubstanceSpecification_Structure#molecularWeight() molecularWeight}
   *    .molecularFormula(String) // optional {@link SubstanceSpecification_Structure#molecularFormula() molecularFormula}
   *    .isotope(List&amp;lt;com.fhir.SubstanceSpecification_Isotope&amp;gt;) // optional {@link SubstanceSpecification_Structure#isotope() isotope}
   *    .id(String) // optional {@link SubstanceSpecification_Structure#id() id}
   *    .stereochemistry(com.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Structure#stereochemistry() stereochemistry}
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Structure#modifierExtension() modifierExtension}
   *    .opticalActivity(com.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Structure#opticalActivity() opticalActivity}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_REPRESENTATION = 0x4L;
    private static final long OPT_BIT_MOLECULAR_WEIGHT = 0x8L;
    private static final long OPT_BIT_MOLECULAR_FORMULA = 0x10L;
    private static final long OPT_BIT_ISOTOPE = 0x20L;
    private static final long OPT_BIT_ID = 0x40L;
    private static final long OPT_BIT_STEREOCHEMISTRY = 0x80L;
    private static final long OPT_BIT_MOLECULAR_FORMULA_BY_MOIETY = 0x100L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x200L;
    private static final long OPT_BIT_OPTICAL_ACTIVITY = 0x400L;
