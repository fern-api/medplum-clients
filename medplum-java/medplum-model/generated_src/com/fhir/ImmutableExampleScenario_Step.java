...
final class ImmutableExampleScenario_Step implements ExampleScenario_Step {
  ...
  public final ImmutableExampleScenario_Step withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableExampleScenario_Step(newValue, this.process, this.extension, this.pause, this.id, this.alternative, this.operation);
  }
  ...
  public final ImmutableExampleScenario_Step withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableExampleScenario_Step(value, this.process, this.extension, this.pause, this.id, this.alternative, this.operation);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code process}, {@code extension}, {@code pause}, {@code id}, {@code alternative}, {@code operation}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Step#modifierExtension() modifierExtension}
   *    .process(List&amp;lt;com.fhir.ExampleScenario_Process&amp;gt;) // optional {@link ExampleScenario_Step#process() process}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ExampleScenario_Step#extension() extension}
   *    .pause(Boolean) // optional {@link ExampleScenario_Step#pause() pause}
   *    .id(String) // optional {@link ExampleScenario_Step#id() id}
   *    .alternative(List&amp;lt;com.fhir.ExampleScenario_Alternative&amp;gt;) // optional {@link ExampleScenario_Step#alternative() alternative}
   *    .operation(com.fhir.ExampleScenario_Operation) // optional {@link ExampleScenario_Step#operation() operation}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_PAUSE = 0x8L;
    private static final long OPT_BIT_ID = 0x10L;
    private static final long OPT_BIT_ALTERNATIVE = 0x20L;
    private static final long OPT_BIT_OPERATION = 0x40L;
    ...
    public ExampleScenario_Step build() {
      return new ImmutableExampleScenario_Step(modifierExtension, process, extension, pause, id, alternative, operation);
    }
