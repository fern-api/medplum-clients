...
final class ImmutableTerminologyCapabilities_ValidateCode
  ...
  public final ImmutableTerminologyCapabilities_ValidateCode withTranslations(boolean value) {
    ...
    return new ImmutableTerminologyCapabilities_ValidateCode(newValue, this.modifierExtension, this.id, this.extension);
  }
  ...
  public final ImmutableTerminologyCapabilities_ValidateCode withTranslations(Optional<Boolean> optional) {
    ...
    return new ImmutableTerminologyCapabilities_ValidateCode(value, this.modifierExtension, this.id, this.extension);
  }
  ...
  public final ImmutableTerminologyCapabilities_ValidateCode withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTerminologyCapabilities_ValidateCode(this.translations, newValue, this.id, this.extension);
  }
  ...
  public final ImmutableTerminologyCapabilities_ValidateCode withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTerminologyCapabilities_ValidateCode(this.translations, value, this.id, this.extension);
  }
  ...
  public final ImmutableTerminologyCapabilities_ValidateCode withId(String value) {
    ...
    return new ImmutableTerminologyCapabilities_ValidateCode(this.translations, this.modifierExtension, newValue, this.extension);
  }
  ...
  public final ImmutableTerminologyCapabilities_ValidateCode withId(Optional<String> optional) {
    ...
    return new ImmutableTerminologyCapabilities_ValidateCode(this.translations, this.modifierExtension, value, this.extension);
  }
  ...
  public final ImmutableTerminologyCapabilities_ValidateCode withExtension(List<Extension> value) {
    ...
    return new ImmutableTerminologyCapabilities_ValidateCode(this.translations, this.modifierExtension, this.id, newValue);
  }
  ...
  public final ImmutableTerminologyCapabilities_ValidateCode withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTerminologyCapabilities_ValidateCode(this.translations, this.modifierExtension, this.id, value);
  }
  ...
  private boolean equalTo(ImmutableTerminologyCapabilities_ValidateCode another) {
    return Objects.equals(translations, another.translations)
  ...
  /**
   * Computes a hash code from attributes: {@code translations}, {@code modifierExtension}, {@code id}, {@code extension}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TerminologyCapabilities_ValidateCode#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link TerminologyCapabilities_ValidateCode#id() id}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TerminologyCapabilities_ValidateCode#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_TRANSLATIONS = 0x1L;
    ...
    public TerminologyCapabilities_ValidateCode build() {
      return new ImmutableTerminologyCapabilities_ValidateCode(translations, modifierExtension, id, extension);
    }
