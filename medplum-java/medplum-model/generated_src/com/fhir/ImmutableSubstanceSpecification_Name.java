...
final class ImmutableSubstanceSpecification_Name implements SubstanceSpecification_Name {
  ...
  /**
   * Computes a hash code from attributes: {@code language}, {@code id}, {@code domain}, {@code modifierExtension}, {@code source}, {@code name}, {@code synonym}, {@code preferred}, {@code translation}, {@code official}, {@code status}, {@code extension}, {@code jurisdiction}, {@code type}.
   ...
   *    .language(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link SubstanceSpecification_Name#language() language}
   *    .id(String) // optional {@link SubstanceSpecification_Name#id() id}
   *    .domain(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link SubstanceSpecification_Name#domain() domain}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Name#modifierExtension() modifierExtension}
   *    .source(List&amp;lt;com.fhir.Reference&amp;gt;) // optional {@link SubstanceSpecification_Name#source() source}
   *    .name(String) // optional {@link SubstanceSpecification_Name#name() name}
   *    .synonym(List&amp;lt;com.fhir.SubstanceSpecification_Name&amp;gt;) // optional {@link SubstanceSpecification_Name#synonym() synonym}
   *    .preferred(Boolean) // optional {@link SubstanceSpecification_Name#preferred() preferred}
   *    .translation(List&amp;lt;com.fhir.SubstanceSpecification_Name&amp;gt;) // optional {@link SubstanceSpecification_Name#translation() translation}
   *    .official(List&amp;lt;com.fhir.SubstanceSpecification_Official&amp;gt;) // optional {@link SubstanceSpecification_Name#official() official}
   *    .status(com.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Name#status() status}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Name#extension() extension}
   *    .jurisdiction(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link SubstanceSpecification_Name#jurisdiction() jurisdiction}
   *    .type(com.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Name#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SYNONYM = 0x40L;
    private static final long OPT_BIT_PREFERRED = 0x80L;
    private static final long OPT_BIT_TRANSLATION = 0x100L;
    private static final long OPT_BIT_OFFICIAL = 0x200L;
    private static final long OPT_BIT_STATUS = 0x400L;
    private static final long OPT_BIT_EXTENSION = 0x800L;
    private static final long OPT_BIT_JURISDICTION = 0x1000L;
