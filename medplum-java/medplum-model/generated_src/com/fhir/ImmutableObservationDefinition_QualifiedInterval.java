...
final class ImmutableObservationDefinition_QualifiedInterval
  ...
  private boolean equalTo(ImmutableObservationDefinition_QualifiedInterval another) {
    return Objects.equals(range, another.range)
  ...
  /**
   * Computes a hash code from attributes: {@code range}, {@code condition}, {@code modifierExtension}, {@code gender}, {@code extension}, {@code gestationalAge}, {@code category}, {@code appliesTo}, {@code context}, {@code age}, {@code id}.
   ...
   *    .range(com.fhir.Range) // optional {@link ObservationDefinition_QualifiedInterval#range() range}
   *    .condition(String) // optional {@link ObservationDefinition_QualifiedInterval#condition() condition}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ObservationDefinition_QualifiedInterval#modifierExtension() modifierExtension}
   *    .gender(com.fhir.Observationdefinition_qualifiedintervalGender) // optional {@link ObservationDefinition_QualifiedInterval#gender() gender}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ObservationDefinition_QualifiedInterval#extension() extension}
   *    .gestationalAge(com.fhir.Range) // optional {@link ObservationDefinition_QualifiedInterval#gestationalAge() gestationalAge}
   *    .category(com.fhir.Observationdefinition_qualifiedintervalCategory) // optional {@link ObservationDefinition_QualifiedInterval#category() category}
   *    .appliesTo(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link ObservationDefinition_QualifiedInterval#appliesTo() appliesTo}
   *    .context(com.fhir.CodeableConcept) // optional {@link ObservationDefinition_QualifiedInterval#context() context}
   *    .age(com.fhir.Range) // optional {@link ObservationDefinition_QualifiedInterval#age() age}
