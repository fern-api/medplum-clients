...
final class ImmutableMeasure_Group implements Measure_Group {
  ...
  public final ImmutableMeasure_Group withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasure_Group(this.code, this.stratifier, this.extension, value, this.population, this.description, this.id);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code code}, {@code stratifier}, {@code extension}, {@code modifierExtension}, {@code population}, {@code description}, {@code id}.
   ...
   *    .code(com.fhir.CodeableConcept) // optional {@link Measure_Group#code() code}
   *    .stratifier(List&amp;lt;com.fhir.Measure_Stratifier&amp;gt;) // optional {@link Measure_Group#stratifier() stratifier}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Measure_Group#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Measure_Group#modifierExtension() modifierExtension}
   *    .population(List&amp;lt;com.fhir.Measure_Population&amp;gt;) // optional {@link Measure_Group#population() population}
  ...
  public static final class Builder {
    ...
    public Measure_Group build() {
      return new ImmutableMeasure_Group(code, stratifier, extension, modifierExtension, population, description, id);
    }
