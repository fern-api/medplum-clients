...
final class ImmutableUserConfiguration_Menu_Link implements UserConfiguration_Menu_Link {
  ...
  public final ImmutableUserConfiguration_Menu_Link withTarget(String value) {
    ...
    return new ImmutableUserConfiguration_Menu_Link(newValue, this.name);
  }
  ...
  public final ImmutableUserConfiguration_Menu_Link withTarget(Optional<String> optional) {
    ...
    return new ImmutableUserConfiguration_Menu_Link(value, this.name);
  }
  ...
  public final ImmutableUserConfiguration_Menu_Link withName(String value) {
    ...
    return new ImmutableUserConfiguration_Menu_Link(this.target, newValue);
  }
  ...
  public final ImmutableUserConfiguration_Menu_Link withName(Optional<String> optional) {
    ...
    return new ImmutableUserConfiguration_Menu_Link(this.target, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code target}, {@code name}.
  ...
  public static final class Builder {
    ...
    public UserConfiguration_Menu_Link build() {
      return new ImmutableUserConfiguration_Menu_Link(target, name);
    }
