 ...
 */
@org.immutables.value.Generated(from = "markdown", generator = "Immutables")
@SuppressWarnings({"all"})
@edu.umd.cs.findbugs.annotations.SuppressFBWarnings
@javax.annotation.ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@javax.annotation.concurrent.Immutable
final class ImmutableMarkdown implements com.fhir.markdown {
  private final java.lang.String value;

  private ImmutableMarkdown(java.lang.String value) {
    this.value = value;
  }
   ...
   */
  public final ImmutableMarkdown withValue(java.lang.String value) {
  ...
  static ImmutableMarkdown fromJson(java.lang.String jsonValue) {
  ...
  public static final class Builder implements ValueBuildStage, BuildFinal {
     ...
     */
    public com.fhir.markdown build() {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new java.lang.IllegalStateException("Builder of markdown is strict, attribute is already set: ".concat(name));
    }
