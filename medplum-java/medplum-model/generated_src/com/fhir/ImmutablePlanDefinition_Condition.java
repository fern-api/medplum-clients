...
final class ImmutablePlanDefinition_Condition implements PlanDefinition_Condition {
  ...
  public final ImmutablePlanDefinition_Condition withModifierExtension(List<Extension> value) {
    ...
    return new ImmutablePlanDefinition_Condition(newValue, this.extension, this.id, this.expression, this.kind);
  }
  ...
  public final ImmutablePlanDefinition_Condition withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutablePlanDefinition_Condition(value, this.extension, this.id, this.expression, this.kind);
  }
  ...
  public final ImmutablePlanDefinition_Condition withExtension(List<Extension> value) {
    ...
    return new ImmutablePlanDefinition_Condition(this.modifierExtension, newValue, this.id, this.expression, this.kind);
  }
  ...
  public final ImmutablePlanDefinition_Condition withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutablePlanDefinition_Condition(this.modifierExtension, value, this.id, this.expression, this.kind);
  }
  ...
  public final ImmutablePlanDefinition_Condition withId(String value) {
    ...
    return new ImmutablePlanDefinition_Condition(this.modifierExtension, this.extension, newValue, this.expression, this.kind);
  }
  ...
  public final ImmutablePlanDefinition_Condition withId(Optional<String> optional) {
    ...
    return new ImmutablePlanDefinition_Condition(this.modifierExtension, this.extension, value, this.expression, this.kind);
  }
  ...
  public final ImmutablePlanDefinition_Condition withExpression(Expression value) {
    ...
    return new ImmutablePlanDefinition_Condition(this.modifierExtension, this.extension, this.id, newValue, this.kind);
  }
  ...
  public final ImmutablePlanDefinition_Condition withExpression(Optional<? extends Expression> optional) {
    ...
    return new ImmutablePlanDefinition_Condition(this.modifierExtension, this.extension, this.id, value, this.kind);
  }
  ...
  public final ImmutablePlanDefinition_Condition withKind(Plandefinition_conditionKind value) {
    ...
    return new ImmutablePlanDefinition_Condition(this.modifierExtension, this.extension, this.id, this.expression, newValue);
  }
  ...
  public final ImmutablePlanDefinition_Condition withKind(Optional<? extends Plandefinition_conditionKind> optional) {
    ...
    return new ImmutablePlanDefinition_Condition(this.modifierExtension, this.extension, this.id, this.expression, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code extension}, {@code id}, {@code expression}, {@code kind}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link PlanDefinition_Condition#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link PlanDefinition_Condition#extension() extension}
   *    .id(String) // optional {@link PlanDefinition_Condition#id() id}
   *    .expression(com.fhir.Expression) // optional {@link PlanDefinition_Condition#expression() expression}
   *    .kind(com.fhir.Plandefinition_conditionKind) // optional {@link PlanDefinition_Condition#kind() kind}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_KIND = 0x10L;
    ...
    public PlanDefinition_Condition build() {
      return new ImmutablePlanDefinition_Condition(modifierExtension, extension, id, expression, kind);
    }
