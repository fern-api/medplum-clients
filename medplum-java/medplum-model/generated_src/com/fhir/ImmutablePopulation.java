...
final class ImmutablePopulation implements Population {
  ...
  private boolean equalTo(ImmutablePopulation another) {
    return Objects.equals(ageCodeableConcept, another.ageCodeableConcept)
  ...
  /**
   * Computes a hash code from attributes: {@code ageCodeableConcept}, {@code ageRange}, {@code race}, {@code extension}, {@code physiologicalCondition}, {@code gender}, {@code id}, {@code modifierExtension}.
   ...
   *    .ageCodeableConcept(com.fhir.CodeableConcept) // optional {@link Population#ageCodeableConcept() ageCodeableConcept}
   *    .ageRange(com.fhir.Range) // optional {@link Population#ageRange() ageRange}
   *    .race(com.fhir.CodeableConcept) // optional {@link Population#race() race}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Population#extension() extension}
   *    .physiologicalCondition(com.fhir.CodeableConcept) // optional {@link Population#physiologicalCondition() physiologicalCondition}
   *    .gender(com.fhir.CodeableConcept) // optional {@link Population#gender() gender}
   *    .id(String) // optional {@link Population#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Population#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_AGE_CODEABLE_CONCEPT = 0x1L;
    private static final long OPT_BIT_AGE_RANGE = 0x2L;
    private static final long OPT_BIT_RACE = 0x4L;
    private static final long OPT_BIT_EXTENSION = 0x8L;
    private static final long OPT_BIT_PHYSIOLOGICAL_CONDITION = 0x10L;
