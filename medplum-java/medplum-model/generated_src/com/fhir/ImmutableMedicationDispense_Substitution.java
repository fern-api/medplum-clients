...
final class ImmutableMedicationDispense_Substitution
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code extension}, {@code reason}, {@code type}, {@code wasSubstituted}, {@code responsibleParty}, {@code id}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationDispense_Substitution#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationDispense_Substitution#extension() extension}
   *    .reason(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link MedicationDispense_Substitution#reason() reason}
   *    .type(com.fhir.CodeableConcept) // optional {@link MedicationDispense_Substitution#type() type}
   *    .wasSubstituted(Boolean) // optional {@link MedicationDispense_Substitution#wasSubstituted() wasSubstituted}
   *    .responsibleParty(List&amp;lt;com.fhir.Reference&amp;gt;) // optional {@link MedicationDispense_Substitution#responsibleParty() responsibleParty}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_WAS_SUBSTITUTED = 0x10L;
    private static final long OPT_BIT_RESPONSIBLE_PARTY = 0x20L;
    ...
    public MedicationDispense_Substitution build() {
      return new ImmutableMedicationDispense_Substitution(modifierExtension, extension, reason, type, wasSubstituted, responsibleParty, id);
    }
