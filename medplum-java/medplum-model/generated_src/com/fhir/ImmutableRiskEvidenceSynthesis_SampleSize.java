...
final class ImmutableRiskEvidenceSynthesis_SampleSize
  ...
  public final ImmutableRiskEvidenceSynthesis_SampleSize withNumberOfParticipants(Optional<Integer> optional) {
    ...
    return new ImmutableRiskEvidenceSynthesis_SampleSize(this.description, value, this.numberOfStudies, this.modifierExtension, this.extension, this.id);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code description}, {@code numberOfParticipants}, {@code numberOfStudies}, {@code modifierExtension}, {@code extension}, {@code id}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_SampleSize#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link RiskEvidenceSynthesis_SampleSize#extension() extension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_NUMBER_OF_STUDIES = 0x4L;
    ...
    public RiskEvidenceSynthesis_SampleSize build() {
      return new ImmutableRiskEvidenceSynthesis_SampleSize(description, numberOfParticipants, numberOfStudies, modifierExtension, extension, id);
    }
