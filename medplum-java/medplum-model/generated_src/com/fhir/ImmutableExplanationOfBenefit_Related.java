...
final class ImmutableExplanationOfBenefit_Related implements ExplanationOfBenefit_Related {
  ...
  public final ImmutableExplanationOfBenefit_Related withRelationship(CodeableConcept value) {
    ...
    return new ImmutableExplanationOfBenefit_Related(newValue, this.extension, this.modifierExtension, this.id, this.claim, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withRelationship(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Related(value, this.extension, this.modifierExtension, this.id, this.claim, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withExtension(List<Extension> value) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, newValue, this.modifierExtension, this.id, this.claim, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, value, this.modifierExtension, this.id, this.claim, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, this.extension, newValue, this.id, this.claim, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, this.extension, value, this.id, this.claim, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withId(String value) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, this.extension, this.modifierExtension, newValue, this.claim, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withId(Optional<String> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, this.extension, this.modifierExtension, value, this.claim, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withClaim(Reference value) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, this.extension, this.modifierExtension, this.id, newValue, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withClaim(Optional<? extends Reference> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, this.extension, this.modifierExtension, this.id, value, this.reference);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withReference(Identifier value) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, this.extension, this.modifierExtension, this.id, this.claim, newValue);
  }
  ...
  public final ImmutableExplanationOfBenefit_Related withReference(Optional<? extends Identifier> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Related(this.relationship, this.extension, this.modifierExtension, this.id, this.claim, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code relationship}, {@code extension}, {@code modifierExtension}, {@code id}, {@code claim}, {@code reference}.
   ...
   *    .relationship(com.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit_Related#relationship() relationship}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_Related#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_Related#modifierExtension() modifierExtension}
   *    .id(String) // optional {@link ExplanationOfBenefit_Related#id() id}
   *    .claim(com.fhir.Reference) // optional {@link ExplanationOfBenefit_Related#claim() claim}
   *    .reference(com.fhir.Identifier) // optional {@link ExplanationOfBenefit_Related#reference() reference}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_CLAIM = 0x10L;
    private static final long OPT_BIT_REFERENCE = 0x20L;
    ...
    public ExplanationOfBenefit_Related build() {
      return new ImmutableExplanationOfBenefit_Related(relationship, extension, modifierExtension, id, claim, reference);
    }
