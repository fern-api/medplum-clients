...
final class ImmutableDosage_DoseAndRate implements Dosage_DoseAndRate {
  ...
  private boolean equalTo(ImmutableDosage_DoseAndRate another) {
    return Objects.equals(doseRange, another.doseRange)
  ...
  /**
   * Computes a hash code from attributes: {@code doseRange}, {@code type}, {@code extension}, {@code id}, {@code rateRatio}, {@code rateRange}, {@code rateQuantity}, {@code doseQuantity}, {@code modifierExtension}.
   ...
   *    .doseRange(com.fhir.Range) // optional {@link Dosage_DoseAndRate#doseRange() doseRange}
   *    .type(com.fhir.CodeableConcept) // optional {@link Dosage_DoseAndRate#type() type}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Dosage_DoseAndRate#extension() extension}
   *    .id(String) // optional {@link Dosage_DoseAndRate#id() id}
   *    .rateRatio(com.fhir.Ratio) // optional {@link Dosage_DoseAndRate#rateRatio() rateRatio}
   *    .rateRange(com.fhir.Range) // optional {@link Dosage_DoseAndRate#rateRange() rateRange}
   *    .rateQuantity(com.fhir.Quantity) // optional {@link Dosage_DoseAndRate#rateQuantity() rateQuantity}
   *    .doseQuantity(com.fhir.Quantity) // optional {@link Dosage_DoseAndRate#doseQuantity() doseQuantity}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Dosage_DoseAndRate#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_DOSE_RANGE = 0x1L;
