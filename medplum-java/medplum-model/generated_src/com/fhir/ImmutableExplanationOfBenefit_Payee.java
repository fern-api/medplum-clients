...
final class ImmutableExplanationOfBenefit_Payee implements ExplanationOfBenefit_Payee {
  ...
  public final ImmutableExplanationOfBenefit_Payee withExtension(List<Extension> value) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(newValue, this.modifierExtension, this.party, this.type, this.id);
  }
  ...
  public final ImmutableExplanationOfBenefit_Payee withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(value, this.modifierExtension, this.party, this.type, this.id);
  }
  ...
  public final ImmutableExplanationOfBenefit_Payee withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(this.extension, newValue, this.party, this.type, this.id);
  }
  ...
  public final ImmutableExplanationOfBenefit_Payee withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(this.extension, value, this.party, this.type, this.id);
  }
  ...
  public final ImmutableExplanationOfBenefit_Payee withParty(Reference value) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(this.extension, this.modifierExtension, newValue, this.type, this.id);
  }
  ...
  public final ImmutableExplanationOfBenefit_Payee withParty(Optional<? extends Reference> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(this.extension, this.modifierExtension, value, this.type, this.id);
  }
  ...
  public final ImmutableExplanationOfBenefit_Payee withType(CodeableConcept value) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(this.extension, this.modifierExtension, this.party, newValue, this.id);
  }
  ...
  public final ImmutableExplanationOfBenefit_Payee withType(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(this.extension, this.modifierExtension, this.party, value, this.id);
  }
  ...
  public final ImmutableExplanationOfBenefit_Payee withId(String value) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(this.extension, this.modifierExtension, this.party, this.type, newValue);
  }
  ...
  public final ImmutableExplanationOfBenefit_Payee withId(Optional<String> optional) {
    ...
    return new ImmutableExplanationOfBenefit_Payee(this.extension, this.modifierExtension, this.party, this.type, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code modifierExtension}, {@code party}, {@code type}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_Payee#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_Payee#modifierExtension() modifierExtension}
   *    .party(com.fhir.Reference) // optional {@link ExplanationOfBenefit_Payee#party() party}
   *    .type(com.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit_Payee#type() type}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_PARTY = 0x4L;
    ...
    public ExplanationOfBenefit_Payee build() {
      return new ImmutableExplanationOfBenefit_Payee(extension, modifierExtension, party, type, id);
    }
