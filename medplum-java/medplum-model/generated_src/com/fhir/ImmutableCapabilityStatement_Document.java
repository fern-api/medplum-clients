 ...
 */
@org.immutables.value.Generated(from = "CapabilityStatement_Document", generator = "Immutables")
...
final class ImmutableCapabilityStatement_Document implements com.fhir.CapabilityStatement_Document {
  private final @javax.annotation.Nullable java.util.List<com.fhir.Extension> modifierExtension;
  private final @javax.annotation.Nullable com.fhir.markdown documentation;
  private final @javax.annotation.Nullable java.lang.String id;
  private final @javax.annotation.Nullable com.fhir.Capabilitystatement_documentMode mode;
  ...
  private ImmutableCapabilityStatement_Document(
      ...
      @javax.annotation.Nullable com.fhir.Capabilitystatement_documentMode mode,
  ...
  @Override
  public java.util.Optional<com.fhir.Capabilitystatement_documentMode> mode() {
   ...
   */
  public final ImmutableCapabilityStatement_Document withModifierExtension(java.util.List<com.fhir.Extension> value) {
    @javax.annotation.Nullable java.util.List<com.fhir.Extension> newValue = java.util.Objects.requireNonNull(value, "modifierExtension");
    if (this.modifierExtension == newValue) return this;
    return new ImmutableCapabilityStatement_Document(newValue, this.documentation, this.id, this.mode, this.extension, this.profile);
  }
  ...
  public final ImmutableCapabilityStatement_Document withModifierExtension(java.util.Optional<? extends java.util.List<com.fhir.Extension>> optional) {
    @javax.annotation.Nullable java.util.List<com.fhir.Extension> value = optional.orElse(null);
    if (this.modifierExtension == value) return this;
    return new ImmutableCapabilityStatement_Document(value, this.documentation, this.id, this.mode, this.extension, this.profile);
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableCapabilityStatement_Document withDocumentation(com.fhir.markdown value) {
    ...
    return new ImmutableCapabilityStatement_Document(this.modifierExtension, newValue, this.id, this.mode, this.extension, this.profile);
  }
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableCapabilityStatement_Document withDocumentation(java.util.Optional<? extends com.fhir.markdown> optional) {
    @javax.annotation.Nullable com.fhir.markdown value = optional.orElse(null);
    if (this.documentation == value) return this;
    return new ImmutableCapabilityStatement_Document(this.modifierExtension, value, this.id, this.mode, this.extension, this.profile);
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableCapabilityStatement_Document withId(java.lang.String value) {
    @javax.annotation.Nullable java.lang.String newValue = java.util.Objects.requireNonNull(value, "id");
    if (java.util.Objects.equals(this.id, newValue)) return this;
    return new ImmutableCapabilityStatement_Document(this.modifierExtension, this.documentation, newValue, this.mode, this.extension, this.profile);
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableCapabilityStatement_Document withId(java.util.Optional<java.lang.String> optional) {
    @javax.annotation.Nullable java.lang.String value = optional.orElse(null);
    if (java.util.Objects.equals(this.id, value)) return this;
    return new ImmutableCapabilityStatement_Document(this.modifierExtension, this.documentation, value, this.mode, this.extension, this.profile);
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableCapabilityStatement_Document withMode(com.fhir.Capabilitystatement_documentMode value) {
    @javax.annotation.Nullable com.fhir.Capabilitystatement_documentMode newValue = java.util.Objects.requireNonNull(value, "mode");
    if (this.mode == newValue) return this;
    return new ImmutableCapabilityStatement_Document(this.modifierExtension, this.documentation, this.id, newValue, this.extension, this.profile);
  }
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableCapabilityStatement_Document withMode(java.util.Optional<? extends com.fhir.Capabilitystatement_documentMode> optional) {
    @javax.annotation.Nullable com.fhir.Capabilitystatement_documentMode value = optional.orElse(null);
    if (this.mode == value) return this;
    return new ImmutableCapabilityStatement_Document(this.modifierExtension, this.documentation, this.id, value, this.extension, this.profile);
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableCapabilityStatement_Document withExtension(java.util.List<com.fhir.Extension> value) {
    @javax.annotation.Nullable java.util.List<com.fhir.Extension> newValue = java.util.Objects.requireNonNull(value, "extension");
    if (this.extension == newValue) return this;
    return new ImmutableCapabilityStatement_Document(this.modifierExtension, this.documentation, this.id, this.mode, newValue, this.profile);
  }
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableCapabilityStatement_Document withExtension(java.util.Optional<? extends java.util.List<com.fhir.Extension>> optional) {
    @javax.annotation.Nullable java.util.List<com.fhir.Extension> value = optional.orElse(null);
    if (this.extension == value) return this;
    return new ImmutableCapabilityStatement_Document(this.modifierExtension, this.documentation, this.id, this.mode, value, this.profile);
  }
   ...
   */
  public final ImmutableCapabilityStatement_Document withProfile(com.fhir.canonical value) {
    if (this.profile == value) return this;
    com.fhir.canonical newValue = java.util.Objects.requireNonNull(value, "profile");
    return new ImmutableCapabilityStatement_Document(this.modifierExtension, this.documentation, this.id, this.mode, this.extension, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code documentation}, {@code id}, {@code mode}, {@code extension}, {@code profile}.
  ...
  public String toString() {
    java.lang.StringBuilder builder = new java.lang.StringBuilder("CapabilityStatement_Document{");
  ...
  static final class Json implements com.fhir.CapabilityStatement_Document {
    ...
    boolean idIsSet;
    @javax.annotation.Nullable java.util.Optional<com.fhir.Capabilitystatement_documentMode> mode = java.util.Optional.empty();
    boolean modeIsSet;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("mode")
    public void setMode(java.util.Optional<com.fhir.Capabilitystatement_documentMode> mode) {
      this.mode = mode;
      this.modeIsSet = true;
    }
    @com.fasterxml.jackson.annotation.JsonProperty("extension")
    ...
    @Override
    public java.util.Optional<com.fhir.Capabilitystatement_documentMode> mode() { throw new UnsupportedOperationException(); }
    @Override
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link CapabilityStatement_Document#modifierExtension() modifierExtension}
   *    .documentation(com.fhir.markdown) // optional {@link CapabilityStatement_Document#documentation() documentation}
   *    .id(String) // optional {@link CapabilityStatement_Document#id() id}
   *    .mode(com.fhir.Capabilitystatement_documentMode) // optional {@link CapabilityStatement_Document#mode() mode}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link CapabilityStatement_Document#extension() extension}
   *    .profile(com.fhir.canonical) // required {@link CapabilityStatement_Document#profile() profile}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ProfileBuildStage, BuildFinal {
    ...
    private @javax.annotation.Nullable com.fhir.Capabilitystatement_documentMode mode;
     ...
     * @return {@code this} builder for chained invocation
     */
    public final Builder mode(com.fhir.Capabilitystatement_documentMode mode) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("mode")
    public final Builder mode(java.util.Optional<? extends com.fhir.Capabilitystatement_documentMode> mode) {
      checkNotIsSet(modeIsSet(), "mode");
     ...
     */
    public com.fhir.CapabilityStatement_Document build() {
      checkRequiredAttributes();
      return new ImmutableCapabilityStatement_Document(modifierExtension, documentation, id, mode, extension, profile);
    }
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new java.lang.IllegalStateException("Builder of CapabilityStatement_Document is strict, attribute is already set: ".concat(name));
    }
  ...
  public interface BuildFinal {
     ...
     * @return {@code this} builder for chained invocation
     */
    BuildFinal mode(com.fhir.Capabilitystatement_documentMode mode);
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    BuildFinal mode(java.util.Optional<? extends com.fhir.Capabilitystatement_documentMode> mode);
