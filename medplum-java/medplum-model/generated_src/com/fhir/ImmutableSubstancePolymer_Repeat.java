...
final class ImmutableSubstancePolymer_Repeat implements SubstancePolymer_Repeat {
  ...
  private boolean equalTo(ImmutableSubstancePolymer_Repeat another) {
    return Objects.equals(repeatUnitAmountType, another.repeatUnitAmountType)
  ...
  /**
   * Computes a hash code from attributes: {@code repeatUnitAmountType}, {@code numberOfUnits}, {@code averageMolecularFormula}, {@code extension}, {@code id}, {@code modifierExtension}, {@code repeatUnit}.
   ...
   *    .repeatUnitAmountType(com.fhir.CodeableConcept) // optional {@link SubstancePolymer_Repeat#repeatUnitAmountType() repeatUnitAmountType}
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_Repeat#extension() extension}
   *    .id(String) // optional {@link SubstancePolymer_Repeat#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstancePolymer_Repeat#modifierExtension() modifierExtension}
   *    .repeatUnit(List&amp;lt;com.fhir.SubstancePolymer_RepeatUnit&amp;gt;) // optional {@link SubstancePolymer_Repeat#repeatUnit() repeatUnit}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_REPEAT_UNIT_AMOUNT_TYPE = 0x1L;
    private static final long OPT_BIT_NUMBER_OF_UNITS = 0x2L;
    private static final long OPT_BIT_AVERAGE_MOLECULAR_FORMULA = 0x4L;
