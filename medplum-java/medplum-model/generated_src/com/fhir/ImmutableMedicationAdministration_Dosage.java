...
final class ImmutableMedicationAdministration_Dosage
  ...
  private boolean equalTo(ImmutableMedicationAdministration_Dosage another) {
    return Objects.equals(site, another.site)
  ...
  /**
   * Computes a hash code from attributes: {@code site}, {@code extension}, {@code modifierExtension}, {@code text}, {@code dose}, {@code rateRatio}, {@code id}, {@code route}, {@code method}, {@code rateQuantity}.
   ...
   *    .site(com.fhir.CodeableConcept) // optional {@link MedicationAdministration_Dosage#site() site}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationAdministration_Dosage#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationAdministration_Dosage#modifierExtension() modifierExtension}
   *    .text(String) // optional {@link MedicationAdministration_Dosage#text() text}
   *    .dose(com.fhir.Quantity) // optional {@link MedicationAdministration_Dosage#dose() dose}
   *    .rateRatio(com.fhir.Ratio) // optional {@link MedicationAdministration_Dosage#rateRatio() rateRatio}
   *    .id(String) // optional {@link MedicationAdministration_Dosage#id() id}
   *    .route(com.fhir.CodeableConcept) // optional {@link MedicationAdministration_Dosage#route() route}
   *    .method(com.fhir.CodeableConcept) // optional {@link MedicationAdministration_Dosage#method() method}
   *    .rateQuantity(com.fhir.Quantity) // optional {@link MedicationAdministration_Dosage#rateQuantity() rateQuantity}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_SITE = 0x1L;
    private static final long OPT_BIT_EXTENSION = 0x2L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x4L;
    private static final long OPT_BIT_TEXT = 0x8L;
    private static final long OPT_BIT_DOSE = 0x10L;
    private static final long OPT_BIT_RATE_RATIO = 0x20L;
    private static final long OPT_BIT_ID = 0x40L;
    private static final long OPT_BIT_ROUTE = 0x80L;
    ...
    public MedicationAdministration_Dosage build() {
      return new ImmutableMedicationAdministration_Dosage(site, extension, modifierExtension, text, dose, rateRatio, id, route, method, rateQuantity);
    }
