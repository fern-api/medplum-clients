...
final class ImmutableSubstanceSpecification_Isotope implements SubstanceSpecification_Isotope {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code identifier}, {@code name}, {@code modifierExtension}, {@code substitution}, {@code molecularWeight}, {@code halfLife}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Isotope#extension() extension}
   *    .identifier(com.fhir.Identifier) // optional {@link SubstanceSpecification_Isotope#identifier() identifier}
   *    .name(com.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Isotope#name() name}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceSpecification_Isotope#modifierExtension() modifierExtension}
   *    .substitution(com.fhir.CodeableConcept) // optional {@link SubstanceSpecification_Isotope#substitution() substitution}
   *    .molecularWeight(com.fhir.SubstanceSpecification_MolecularWeight) // optional {@link SubstanceSpecification_Isotope#molecularWeight() molecularWeight}
   *    .halfLife(com.fhir.Quantity) // optional {@link SubstanceSpecification_Isotope#halfLife() halfLife}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_MOLECULAR_WEIGHT = 0x40L;
    ...
    public SubstanceSpecification_Isotope build() {
      return new ImmutableSubstanceSpecification_Isotope(id, extension, identifier, name, modifierExtension, substitution, molecularWeight, halfLife);
    }
