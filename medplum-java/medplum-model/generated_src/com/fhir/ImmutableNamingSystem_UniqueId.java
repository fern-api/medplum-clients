...
final class ImmutableNamingSystem_UniqueId implements NamingSystem_UniqueId {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code preferred}, {@code type}, {@code id}, {@code comment}, {@code modifierExtension}, {@code period}, {@code value}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link NamingSystem_UniqueId#extension() extension}
   *    .preferred(Boolean) // optional {@link NamingSystem_UniqueId#preferred() preferred}
   *    .type(com.fhir.Namingsystem_uniqueidType) // optional {@link NamingSystem_UniqueId#type() type}
   *    .id(String) // optional {@link NamingSystem_UniqueId#id() id}
   *    .comment(String) // optional {@link NamingSystem_UniqueId#comment() comment}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link NamingSystem_UniqueId#modifierExtension() modifierExtension}
   *    .period(com.fhir.Period) // optional {@link NamingSystem_UniqueId#period() period}
  ...
  public static final class Builder {
    ...
    public NamingSystem_UniqueId build() {
      return new ImmutableNamingSystem_UniqueId(extension, preferred, type, id, comment, modifierExtension, period, value);
    }
