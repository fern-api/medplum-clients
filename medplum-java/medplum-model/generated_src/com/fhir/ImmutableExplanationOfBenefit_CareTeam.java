 ...
 */
@org.immutables.value.Generated(from = "ExplanationOfBenefit_CareTeam", generator = "Immutables")
...
final class ImmutableExplanationOfBenefit_CareTeam implements com.fhir.ExplanationOfBenefit_CareTeam {
   ...
   */
  public final ImmutableExplanationOfBenefit_CareTeam withId(java.lang.String value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableExplanationOfBenefit_CareTeam withId(java.util.Optional<java.lang.String> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableExplanationOfBenefit_CareTeam withSequence(com.fhir.positiveInt value) {
  ...
  public final ImmutableExplanationOfBenefit_CareTeam withSequence(java.util.Optional<? extends com.fhir.positiveInt> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableExplanationOfBenefit_CareTeam withExtension(java.util.List<com.fhir.Extension> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableExplanationOfBenefit_CareTeam withExtension(java.util.Optional<? extends java.util.List<com.fhir.Extension>> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableExplanationOfBenefit_CareTeam withRole(com.fhir.CodeableConcept value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableExplanationOfBenefit_CareTeam withRole(java.util.Optional<? extends com.fhir.CodeableConcept> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableExplanationOfBenefit_CareTeam withModifierExtension(java.util.List<com.fhir.Extension> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableExplanationOfBenefit_CareTeam withModifierExtension(java.util.Optional<? extends java.util.List<com.fhir.Extension>> optional) {
    @javax.annotation.Nullable java.util.List<com.fhir.Extension> value = optional.orElse(null);
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableExplanationOfBenefit_CareTeam withQualification(com.fhir.CodeableConcept value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableExplanationOfBenefit_CareTeam withQualification(java.util.Optional<? extends com.fhir.CodeableConcept> optional) {
    @javax.annotation.Nullable com.fhir.CodeableConcept value = optional.orElse(null);
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableExplanationOfBenefit_CareTeam withResponsible(java.util.Optional<java.lang.Boolean> optional) {
   ...
   */
  public final ImmutableExplanationOfBenefit_CareTeam withProvider(com.fhir.Reference value) {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code sequence}, {@code extension}, {@code role}, {@code modifierExtension}, {@code qualification}, {@code responsible}, {@code provider}.
  ...
  public String toString() {
    java.lang.StringBuilder builder = new java.lang.StringBuilder("ExplanationOfBenefit_CareTeam{");
    if (id != null) {
  ...
  static final class Json implements com.fhir.ExplanationOfBenefit_CareTeam {
   ...
   *    .sequence(com.fhir.positiveInt) // optional {@link ExplanationOfBenefit_CareTeam#sequence() sequence}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_CareTeam#extension() extension}
   *    .role(com.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit_CareTeam#role() role}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ExplanationOfBenefit_CareTeam#modifierExtension() modifierExtension}
   *    .qualification(com.fhir.CodeableConcept) // optional {@link ExplanationOfBenefit_CareTeam#qualification() qualification}
   *    .responsible(Boolean) // optional {@link ExplanationOfBenefit_CareTeam#responsible() responsible}
   *    .provider(com.fhir.Reference) // required {@link ExplanationOfBenefit_CareTeam#provider() provider}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ProviderBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_QUALIFICATION = 0x20L;
     ...
     */
    public com.fhir.ExplanationOfBenefit_CareTeam build() {
      checkRequiredAttributes();
      return new ImmutableExplanationOfBenefit_CareTeam(id, sequence, extension, role, modifierExtension, qualification, responsible, provider);
    }
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new java.lang.IllegalStateException("Builder of ExplanationOfBenefit_CareTeam is strict, attribute is already set: ".concat(name));
    }
