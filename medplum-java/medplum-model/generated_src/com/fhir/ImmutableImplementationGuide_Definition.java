...
final class ImmutableImplementationGuide_Definition implements ImplementationGuide_Definition {
  ...
  private boolean equalTo(ImmutableImplementationGuide_Definition another) {
    return Objects.equals(parameter, another.parameter)
  ...
  /**
   * Computes a hash code from attributes: {@code parameter}, {@code grouping}, {@code page}, {@code id}, {@code resource}, {@code template}, {@code extension}, {@code modifierExtension}.
   ...
   *    .parameter(List&amp;lt;com.fhir.ImplementationGuide_Parameter&amp;gt;) // optional {@link ImplementationGuide_Definition#parameter() parameter}
   *    .grouping(List&amp;lt;com.fhir.ImplementationGuide_Grouping&amp;gt;) // optional {@link ImplementationGuide_Definition#grouping() grouping}
   *    .page(com.fhir.ImplementationGuide_Page) // optional {@link ImplementationGuide_Definition#page() page}
   *    .id(String) // optional {@link ImplementationGuide_Definition#id() id}
   *    .addResource|addAllResource(com.fhir.ImplementationGuide_Resource) // {@link ImplementationGuide_Definition#resource() resource} elements
   *    .template(List&amp;lt;com.fhir.ImplementationGuide_Template&amp;gt;) // optional {@link ImplementationGuide_Definition#template() template}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ImplementationGuide_Definition#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ImplementationGuide_Definition#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_PARAMETER = 0x1L;
    private static final long OPT_BIT_GROUPING = 0x2L;
