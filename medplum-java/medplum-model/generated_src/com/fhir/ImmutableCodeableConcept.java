...
final class ImmutableCodeableConcept implements CodeableConcept {
  ...
  public final ImmutableCodeableConcept withExtension(List<Extension> value) {
    ...
    return new ImmutableCodeableConcept(newValue, this.text, this.id, this.coding);
  }
  ...
  public final ImmutableCodeableConcept withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCodeableConcept(value, this.text, this.id, this.coding);
  }
  ...
  public final ImmutableCodeableConcept withText(String value) {
    ...
    return new ImmutableCodeableConcept(this.extension, newValue, this.id, this.coding);
  }
  ...
  public final ImmutableCodeableConcept withText(Optional<String> optional) {
    ...
    return new ImmutableCodeableConcept(this.extension, value, this.id, this.coding);
  }
  ...
  public final ImmutableCodeableConcept withId(String value) {
    ...
    return new ImmutableCodeableConcept(this.extension, this.text, newValue, this.coding);
  }
  ...
  public final ImmutableCodeableConcept withId(Optional<String> optional) {
    ...
    return new ImmutableCodeableConcept(this.extension, this.text, value, this.coding);
  }
  ...
  public final ImmutableCodeableConcept withCoding(List<Coding> value) {
    ...
    return new ImmutableCodeableConcept(this.extension, this.text, this.id, newValue);
  }
  ...
  public final ImmutableCodeableConcept withCoding(Optional<? extends List<Coding>> optional) {
    ...
    return new ImmutableCodeableConcept(this.extension, this.text, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code text}, {@code id}, {@code coding}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link CodeableConcept#extension() extension}
   *    .text(String) // optional {@link CodeableConcept#text() text}
   *    .id(String) // optional {@link CodeableConcept#id() id}
   *    .coding(List&amp;lt;com.fhir.Coding&amp;gt;) // optional {@link CodeableConcept#coding() coding}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_CODING = 0x8L;
    ...
    public CodeableConcept build() {
      return new ImmutableCodeableConcept(extension, text, id, coding);
    }
