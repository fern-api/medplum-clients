...
final class ImmutableGraphDefinition_Link implements GraphDefinition_Link {
  ...
  /**
   * Computes a hash code from attributes: {@code path}, {@code extension}, {@code min}, {@code max}, {@code sliceName}, {@code id}, {@code modifierExtension}, {@code target}, {@code description}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link GraphDefinition_Link#extension() extension}
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link GraphDefinition_Link#modifierExtension() modifierExtension}
   *    .target(List&amp;lt;com.fhir.GraphDefinition_Target&amp;gt;) // optional {@link GraphDefinition_Link#target() target}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SLICE_NAME = 0x10L;
    ...
    public GraphDefinition_Link build() {
      return new ImmutableGraphDefinition_Link(path, extension, min, max, sliceName, id, modifierExtension, target, description);
    }
