...
final class ImmutableMedicationKnowledge_Kinetics implements MedicationKnowledge_Kinetics {
  ...
  public final ImmutableMedicationKnowledge_Kinetics withAreaUnderCurve(Optional<? extends List<Quantity>> optional) {
    ...
    return new ImmutableMedicationKnowledge_Kinetics(this.extension, value, this.modifierExtension, this.lethalDose50, this.halfLifePeriod, this.id);
  }
  ...
  public final ImmutableMedicationKnowledge_Kinetics withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedicationKnowledge_Kinetics(this.extension, this.areaUnderCurve, newValue, this.lethalDose50, this.halfLifePeriod, this.id);
  }
  ...
  public final ImmutableMedicationKnowledge_Kinetics withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicationKnowledge_Kinetics(this.extension, this.areaUnderCurve, value, this.lethalDose50, this.halfLifePeriod, this.id);
  }
  ...
  public final ImmutableMedicationKnowledge_Kinetics withHalfLifePeriod(Optional<? extends Duration> optional) {
    ...
    return new ImmutableMedicationKnowledge_Kinetics(this.extension, this.areaUnderCurve, this.modifierExtension, this.lethalDose50, value, this.id);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code areaUnderCurve}, {@code modifierExtension}, {@code lethalDose50}, {@code halfLifePeriod}, {@code id}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Kinetics#extension() extension}
   *    .areaUnderCurve(List&amp;lt;com.fhir.Quantity&amp;gt;) // optional {@link MedicationKnowledge_Kinetics#areaUnderCurve() areaUnderCurve}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Kinetics#modifierExtension() modifierExtension}
   *    .lethalDose50(List&amp;lt;com.fhir.Quantity&amp;gt;) // optional {@link MedicationKnowledge_Kinetics#lethalDose50() lethalDose50}
   *    .halfLifePeriod(com.fhir.Duration) // optional {@link MedicationKnowledge_Kinetics#halfLifePeriod() halfLifePeriod}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_AREA_UNDER_CURVE = 0x2L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x4L;
    private static final long OPT_BIT_LETHAL_DOSE50 = 0x8L;
    ...
    public MedicationKnowledge_Kinetics build() {
      return new ImmutableMedicationKnowledge_Kinetics(extension, areaUnderCurve, modifierExtension, lethalDose50, halfLifePeriod, id);
    }
