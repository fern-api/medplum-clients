...
final class ImmutableSupplyDelivery_SuppliedItem implements SupplyDelivery_SuppliedItem {
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withItemReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(value, this.extension, this.id, this.quantity, this.itemCodeableConcept, this.modifierExtension);
  }
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withItemCodeableConcept(CodeableConcept value) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(this.itemReference, this.extension, this.id, this.quantity, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withItemCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(this.itemReference, this.extension, this.id, this.quantity, value, this.modifierExtension);
  }
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(this.itemReference, this.extension, this.id, this.quantity, this.itemCodeableConcept, newValue);
  }
  ...
  public final ImmutableSupplyDelivery_SuppliedItem withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSupplyDelivery_SuppliedItem(this.itemReference, this.extension, this.id, this.quantity, this.itemCodeableConcept, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code itemReference}, {@code extension}, {@code id}, {@code quantity}, {@code itemCodeableConcept}, {@code modifierExtension}.
   ...
   *    .itemReference(com.fhir.Reference) // optional {@link SupplyDelivery_SuppliedItem#itemReference() itemReference}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SupplyDelivery_SuppliedItem#extension() extension}
   *    .id(String) // optional {@link SupplyDelivery_SuppliedItem#id() id}
   *    .quantity(com.fhir.Quantity) // optional {@link SupplyDelivery_SuppliedItem#quantity() quantity}
   *    .itemCodeableConcept(com.fhir.CodeableConcept) // optional {@link SupplyDelivery_SuppliedItem#itemCodeableConcept() itemCodeableConcept}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SupplyDelivery_SuppliedItem#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public SupplyDelivery_SuppliedItem build() {
      return new ImmutableSupplyDelivery_SuppliedItem(itemReference, extension, id, quantity, itemCodeableConcept, modifierExtension);
    }
