...
final class ImmutableEncounter_Hospitalization implements Encounter_Hospitalization {
  ...
  private boolean equalTo(ImmutableEncounter_Hospitalization another) {
    return Objects.equals(admitSource, another.admitSource)
  ...
  /**
   * Computes a hash code from attributes: {@code admitSource}, {@code specialArrangement}, {@code extension}, {@code preAdmissionIdentifier}, {@code specialCourtesy}, {@code dischargeDisposition}, {@code destination}, {@code dietPreference}, {@code origin}, {@code reAdmission}, {@code id}, {@code modifierExtension}.
   ...
   *    .admitSource(com.fhir.CodeableConcept) // optional {@link Encounter_Hospitalization#admitSource() admitSource}
   *    .specialArrangement(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link Encounter_Hospitalization#specialArrangement() specialArrangement}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Encounter_Hospitalization#extension() extension}
   *    .preAdmissionIdentifier(com.fhir.Identifier) // optional {@link Encounter_Hospitalization#preAdmissionIdentifier() preAdmissionIdentifier}
   *    .specialCourtesy(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link Encounter_Hospitalization#specialCourtesy() specialCourtesy}
   *    .dischargeDisposition(com.fhir.CodeableConcept) // optional {@link Encounter_Hospitalization#dischargeDisposition() dischargeDisposition}
   *    .destination(com.fhir.Reference) // optional {@link Encounter_Hospitalization#destination() destination}
   *    .dietPreference(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link Encounter_Hospitalization#dietPreference() dietPreference}
   *    .origin(com.fhir.Reference) // optional {@link Encounter_Hospitalization#origin() origin}
   *    .reAdmission(com.fhir.CodeableConcept) // optional {@link Encounter_Hospitalization#reAdmission() reAdmission}
   *    .id(String) // optional {@link Encounter_Hospitalization#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Encounter_Hospitalization#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_ADMIT_SOURCE = 0x1L;
    private static final long OPT_BIT_SPECIAL_ARRANGEMENT = 0x2L;
    private static final long OPT_BIT_EXTENSION = 0x4L;
    private static final long OPT_BIT_PRE_ADMISSION_IDENTIFIER = 0x8L;
    private static final long OPT_BIT_SPECIAL_COURTESY = 0x10L;
    private static final long OPT_BIT_DISCHARGE_DISPOSITION = 0x20L;
    private static final long OPT_BIT_DESTINATION = 0x40L;
    private static final long OPT_BIT_DIET_PREFERENCE = 0x80L;
    private static final long OPT_BIT_ORIGIN = 0x100L;
