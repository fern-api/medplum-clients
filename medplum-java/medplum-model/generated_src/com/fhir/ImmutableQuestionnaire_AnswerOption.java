...
final class ImmutableQuestionnaire_AnswerOption implements Questionnaire_AnswerOption {
  ...
  /**
   * Computes a hash code from attributes: {@code valueCoding}, {@code valueTime}, {@code valueInteger}, {@code valueReference}, {@code extension}, {@code initialSelected}, {@code modifierExtension}, {@code valueDate}, {@code valueString}, {@code id}.
   ...
   *    .valueCoding(com.fhir.Coding) // optional {@link Questionnaire_AnswerOption#valueCoding() valueCoding}
   ...
   *    .valueReference(com.fhir.Reference) // optional {@link Questionnaire_AnswerOption#valueReference() valueReference}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Questionnaire_AnswerOption#extension() extension}
   *    .initialSelected(Boolean) // optional {@link Questionnaire_AnswerOption#initialSelected() initialSelected}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Questionnaire_AnswerOption#modifierExtension() modifierExtension}
