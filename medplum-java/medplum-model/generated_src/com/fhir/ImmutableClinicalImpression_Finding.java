...
final class ImmutableClinicalImpression_Finding implements ClinicalImpression_Finding {
  ...
  public final ImmutableClinicalImpression_Finding withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableClinicalImpression_Finding(this.extension, newValue, this.itemCodeableConcept, this.id, this.itemReference, this.basis);
  }
  ...
  public final ImmutableClinicalImpression_Finding withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableClinicalImpression_Finding(this.extension, value, this.itemCodeableConcept, this.id, this.itemReference, this.basis);
  }
  ...
  public final ImmutableClinicalImpression_Finding withItemCodeableConcept(CodeableConcept value) {
    ...
    return new ImmutableClinicalImpression_Finding(this.extension, this.modifierExtension, newValue, this.id, this.itemReference, this.basis);
  }
  ...
  public final ImmutableClinicalImpression_Finding withItemCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableClinicalImpression_Finding(this.extension, this.modifierExtension, value, this.id, this.itemReference, this.basis);
  }
  ...
  public final ImmutableClinicalImpression_Finding withItemReference(Reference value) {
    ...
    return new ImmutableClinicalImpression_Finding(this.extension, this.modifierExtension, this.itemCodeableConcept, this.id, newValue, this.basis);
  }
  ...
  public final ImmutableClinicalImpression_Finding withItemReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableClinicalImpression_Finding(this.extension, this.modifierExtension, this.itemCodeableConcept, this.id, value, this.basis);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code modifierExtension}, {@code itemCodeableConcept}, {@code id}, {@code itemReference}, {@code basis}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ClinicalImpression_Finding#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link ClinicalImpression_Finding#modifierExtension() modifierExtension}
   *    .itemCodeableConcept(com.fhir.CodeableConcept) // optional {@link ClinicalImpression_Finding#itemCodeableConcept() itemCodeableConcept}
   *    .id(String) // optional {@link ClinicalImpression_Finding#id() id}
   *    .itemReference(com.fhir.Reference) // optional {@link ClinicalImpression_Finding#itemReference() itemReference}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_BASIS = 0x20L;
    ...
    public ClinicalImpression_Finding build() {
      return new ImmutableClinicalImpression_Finding(extension, modifierExtension, itemCodeableConcept, id, itemReference, basis);
    }
