...
final class ImmutableNutritionOrder_EnteralFormula implements NutritionOrder_EnteralFormula {
  ...
  /**
   * Computes a hash code from attributes: {@code additiveType}, {@code additiveProductName}, {@code caloricDensity}, {@code modifierExtension}, {@code extension}, {@code administration}, {@code id}, {@code baseFormulaProductName}, {@code routeofAdministration}, {@code baseFormulaType}, {@code maxVolumeToDeliver}, {@code administrationInstruction}.
   ...
   *    .additiveType(com.fhir.CodeableConcept) // optional {@link NutritionOrder_EnteralFormula#additiveType() additiveType}
   *    .additiveProductName(String) // optional {@link NutritionOrder_EnteralFormula#additiveProductName() additiveProductName}
   *    .caloricDensity(com.fhir.Quantity) // optional {@link NutritionOrder_EnteralFormula#caloricDensity() caloricDensity}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_EnteralFormula#modifierExtension() modifierExtension}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_EnteralFormula#extension() extension}
   *    .administration(List&amp;lt;com.fhir.NutritionOrder_Administration&amp;gt;) // optional {@link NutritionOrder_EnteralFormula#administration() administration}
   ...
   *    .routeofAdministration(com.fhir.CodeableConcept) // optional {@link NutritionOrder_EnteralFormula#routeofAdministration() routeofAdministration}
   *    .baseFormulaType(com.fhir.CodeableConcept) // optional {@link NutritionOrder_EnteralFormula#baseFormulaType() baseFormulaType}
   *    .maxVolumeToDeliver(com.fhir.Quantity) // optional {@link NutritionOrder_EnteralFormula#maxVolumeToDeliver() maxVolumeToDeliver}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_ADDITIVE_PRODUCT_NAME = 0x2L;
    private static final long OPT_BIT_CALORIC_DENSITY = 0x4L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x8L;
    private static final long OPT_BIT_EXTENSION = 0x10L;
    private static final long OPT_BIT_ADMINISTRATION = 0x20L;
    private static final long OPT_BIT_ID = 0x40L;
    private static final long OPT_BIT_BASE_FORMULA_PRODUCT_NAME = 0x80L;
    private static final long OPT_BIT_ROUTEOF_ADMINISTRATION = 0x100L;
    private static final long OPT_BIT_BASE_FORMULA_TYPE = 0x200L;
    private static final long OPT_BIT_MAX_VOLUME_TO_DELIVER = 0x400L;
    private static final long OPT_BIT_ADMINISTRATION_INSTRUCTION = 0x800L;
