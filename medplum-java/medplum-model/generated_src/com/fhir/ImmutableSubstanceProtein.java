 ...
 */
@org.immutables.value.Generated(from = "SubstanceProtein", generator = "Immutables")
...
final class ImmutableSubstanceProtein implements com.fhir.SubstanceProtein {
  private final @javax.annotation.Nullable com.fhir.code language;
  private final @javax.annotation.Nullable java.util.List<java.lang.String> disulfideLinkage;
  ...
  private final @javax.annotation.Nullable java.util.List<com.fhir.SubstanceProtein_Subunit> subunit;
  private final @javax.annotation.Nullable java.util.List<com.fhir.Extension> extension;
  private final @javax.annotation.Nullable com.fhir.Narrative text;

  private ImmutableSubstanceProtein(
      @javax.annotation.Nullable com.fhir.code language,
      @javax.annotation.Nullable java.util.List<java.lang.String> disulfideLinkage,
      ...
      @javax.annotation.Nullable java.util.List<com.fhir.SubstanceProtein_Subunit> subunit,
   ...
   */
  @com.fasterxml.jackson.annotation.JsonProperty("disulfideLinkage")
  @Override
  public java.util.Optional<java.util.List<java.lang.String>> disulfideLinkage() {
    return java.util.Optional.ofNullable(disulfideLinkage);
  }
  ...
  @Override
  public java.util.Optional<java.util.List<com.fhir.SubstanceProtein_Subunit>> subunit() {
   ...
   */
  public final ImmutableSubstanceProtein withLanguage(com.fhir.code value) {
  ...
  public final ImmutableSubstanceProtein withLanguage(java.util.Optional<? extends com.fhir.code> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withDisulfideLinkage(java.util.List<java.lang.String> value) {
    @javax.annotation.Nullable java.util.List<java.lang.String> newValue = java.util.Objects.requireNonNull(value, "disulfideLinkage");
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withDisulfideLinkage(java.util.Optional<? extends java.util.List<java.lang.String>> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withContained(java.util.List<com.fhir.ResourceList> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withContained(java.util.Optional<? extends java.util.List<com.fhir.ResourceList>> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withNumberOfSubunits(java.util.Optional<java.lang.Integer> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withMeta(com.fhir.Meta value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withMeta(java.util.Optional<? extends com.fhir.Meta> optional) {
   ...
   */
  public final ImmutableSubstanceProtein withResourceType(java.lang.String value) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withImplicitRules(com.fhir.uri value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withImplicitRules(java.util.Optional<? extends com.fhir.uri> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withModifierExtension(java.util.List<com.fhir.Extension> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withModifierExtension(java.util.Optional<? extends java.util.List<com.fhir.Extension>> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withId(com.fhir.id value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withId(java.util.Optional<? extends com.fhir.id> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withSequenceType(com.fhir.CodeableConcept value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withSequenceType(java.util.Optional<? extends com.fhir.CodeableConcept> optional) {
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withSubunit(java.util.List<com.fhir.SubstanceProtein_Subunit> value) {
    @javax.annotation.Nullable java.util.List<com.fhir.SubstanceProtein_Subunit> newValue = java.util.Objects.requireNonNull(value, "subunit");
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withSubunit(java.util.Optional<? extends java.util.List<com.fhir.SubstanceProtein_Subunit>> optional) {
    @javax.annotation.Nullable java.util.List<com.fhir.SubstanceProtein_Subunit> value = optional.orElse(null);
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withExtension(java.util.List<com.fhir.Extension> value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withExtension(java.util.Optional<? extends java.util.List<com.fhir.Extension>> optional) {
    @javax.annotation.Nullable java.util.List<com.fhir.Extension> value = optional.orElse(null);
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableSubstanceProtein withText(com.fhir.Narrative value) {
   ...
   */
  @SuppressWarnings("unchecked") // safe covariant cast
  public final ImmutableSubstanceProtein withText(java.util.Optional<? extends com.fhir.Narrative> optional) {
  ...
  private boolean equalTo(ImmutableSubstanceProtein another) {
    return java.util.Objects.equals(language, another.language)
        && java.util.Objects.equals(disulfideLinkage, another.disulfideLinkage)
  ...
  /**
   * Computes a hash code from attributes: {@code language}, {@code disulfideLinkage}, {@code contained}, {@code numberOfSubunits}, {@code meta}, {@code resourceType}, {@code implicitRules}, {@code modifierExtension}, {@code id}, {@code sequenceType}, {@code subunit}, {@code extension}, {@code text}.
  ...
  public int hashCode() {
    ...
    h += (h << 5) + java.util.Objects.hashCode(disulfideLinkage);
  ...
  public String toString() {
    java.lang.StringBuilder builder = new java.lang.StringBuilder("SubstanceProtein{");
    if (language != null) {
  ...
  static final class Json implements com.fhir.SubstanceProtein {
    @javax.annotation.Nullable java.util.Optional<com.fhir.code> language = java.util.Optional.empty();
    boolean languageIsSet;
    @javax.annotation.Nullable java.util.Optional<java.util.List<java.lang.String>> disulfideLinkage = java.util.Optional.empty();
    ...
    @javax.annotation.Nullable java.util.Optional<java.util.List<com.fhir.SubstanceProtein_Subunit>> subunit = java.util.Optional.empty();
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("disulfideLinkage")
    public void setDisulfideLinkage(java.util.Optional<java.util.List<java.lang.String>> disulfideLinkage) {
      this.disulfideLinkage = disulfideLinkage;
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("subunit")
    public void setSubunit(java.util.Optional<java.util.List<com.fhir.SubstanceProtein_Subunit>> subunit) {
      this.subunit = subunit;
    ...
    @Override
    public java.util.Optional<java.util.List<java.lang.String>> disulfideLinkage() { throw new UnsupportedOperationException(); }
    @Override
    ...
    @Override
    public java.util.Optional<java.util.List<com.fhir.SubstanceProtein_Subunit>> subunit() { throw new UnsupportedOperationException(); }
    @Override
   ...
   *    .language(com.fhir.code) // optional {@link SubstanceProtein#language() language}
   *    .disulfideLinkage(List&amp;lt;String&amp;gt;) // optional {@link SubstanceProtein#disulfideLinkage() disulfideLinkage}
   *    .contained(List&amp;lt;com.fhir.ResourceList&amp;gt;) // optional {@link SubstanceProtein#contained() contained}
   *    .numberOfSubunits(Integer) // optional {@link SubstanceProtein#numberOfSubunits() numberOfSubunits}
   *    .meta(com.fhir.Meta) // optional {@link SubstanceProtein#meta() meta}
   *    .resourceType(String) // required {@link SubstanceProtein#resourceType() resourceType}
   *    .implicitRules(com.fhir.uri) // optional {@link SubstanceProtein#implicitRules() implicitRules}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceProtein#modifierExtension() modifierExtension}
   *    .id(com.fhir.id) // optional {@link SubstanceProtein#id() id}
   *    .sequenceType(com.fhir.CodeableConcept) // optional {@link SubstanceProtein#sequenceType() sequenceType}
   *    .subunit(List&amp;lt;com.fhir.SubstanceProtein_Subunit&amp;gt;) // optional {@link SubstanceProtein#subunit() subunit}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceProtein#extension() extension}
   *    .text(com.fhir.Narrative) // optional {@link SubstanceProtein#text() text}
   *    .build();
   * </pre>
  ...
  public static final class Builder implements ResourceTypeBuildStage, BuildFinal {
    ...
    private static final long OPT_BIT_DISULFIDE_LINKAGE = 0x2L;
    private static final long OPT_BIT_CONTAINED = 0x4L;
    private static final long OPT_BIT_NUMBER_OF_SUBUNITS = 0x8L;
    ...
    private static final long OPT_BIT_SEQUENCE_TYPE = 0x100L;
    ...
    private @javax.annotation.Nullable java.util.List<java.lang.String> disulfideLinkage;
    ...
    private @javax.annotation.Nullable java.util.List<com.fhir.SubstanceProtein_Subunit> subunit;
     ...
     * @return {@code this} builder for chained invocation
     */
    public final Builder disulfideLinkage(java.util.List<java.lang.String> disulfideLinkage) {
      checkNotIsSet(disulfideLinkageIsSet(), "disulfideLinkage");
      this.disulfideLinkage = java.util.Objects.requireNonNull(disulfideLinkage, "disulfideLinkage");
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("disulfideLinkage")
    public final Builder disulfideLinkage(java.util.Optional<? extends java.util.List<java.lang.String>> disulfideLinkage) {
      checkNotIsSet(disulfideLinkageIsSet(), "disulfideLinkage");
     ...
     * @return {@code this} builder for chained invocation
     */
    public final Builder subunit(java.util.List<com.fhir.SubstanceProtein_Subunit> subunit) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("subunit")
    public final Builder subunit(java.util.Optional<? extends java.util.List<com.fhir.SubstanceProtein_Subunit>> subunit) {
      checkNotIsSet(subunitIsSet(), "subunit");
     ...
     */
    public com.fhir.SubstanceProtein build() {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new java.lang.IllegalStateException("Builder of SubstanceProtein is strict, attribute is already set: ".concat(name));
    }
  ...
  public interface BuildFinal {
     ...
     * @return {@code this} builder for chained invocation
     */
    BuildFinal disulfideLinkage(java.util.List<java.lang.String> disulfideLinkage);
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    BuildFinal disulfideLinkage(java.util.Optional<? extends java.util.List<java.lang.String>> disulfideLinkage);
     ...
     * @return {@code this} builder for chained invocation
     */
    BuildFinal subunit(java.util.List<com.fhir.SubstanceProtein_Subunit> subunit);
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    BuildFinal subunit(java.util.Optional<? extends java.util.List<com.fhir.SubstanceProtein_Subunit>> subunit);
