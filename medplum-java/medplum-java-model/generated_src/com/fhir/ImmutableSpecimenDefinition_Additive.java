...
final class ImmutableSpecimenDefinition_Additive implements SpecimenDefinition_Additive {
  ...
  public final ImmutableSpecimenDefinition_Additive withExtension(List<Extension> value) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.id, newValue, this.modifierExtension, this.additiveCodeableConcept, this.additiveReference);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.id, value, this.modifierExtension, this.additiveCodeableConcept, this.additiveReference);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.id, this.extension, newValue, this.additiveCodeableConcept, this.additiveReference);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.id, this.extension, value, this.additiveCodeableConcept, this.additiveReference);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withAdditiveCodeableConcept(CodeableConcept value) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.id, this.extension, this.modifierExtension, newValue, this.additiveReference);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withAdditiveCodeableConcept(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.id, this.extension, this.modifierExtension, value, this.additiveReference);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withAdditiveReference(Reference value) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.id, this.extension, this.modifierExtension, this.additiveCodeableConcept, newValue);
  }
  ...
  public final ImmutableSpecimenDefinition_Additive withAdditiveReference(Optional<? extends Reference> optional) {
    ...
    return new ImmutableSpecimenDefinition_Additive(this.id, this.extension, this.modifierExtension, this.additiveCodeableConcept, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code extension}, {@code modifierExtension}, {@code additiveCodeableConcept}, {@code additiveReference}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_Additive#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SpecimenDefinition_Additive#modifierExtension() modifierExtension}
   *    .additiveCodeableConcept(com.fhir.CodeableConcept) // optional {@link SpecimenDefinition_Additive#additiveCodeableConcept() additiveCodeableConcept}
   *    .additiveReference(com.fhir.Reference) // optional {@link SpecimenDefinition_Additive#additiveReference() additiveReference}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public SpecimenDefinition_Additive build() {
      return new ImmutableSpecimenDefinition_Additive(id, extension, modifierExtension, additiveCodeableConcept, additiveReference);
    }
