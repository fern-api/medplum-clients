...
final class ImmutableCondition_Stage implements Condition_Stage {
  ...
  public final ImmutableCondition_Stage withId(String value) {
    ...
    return new ImmutableCondition_Stage(newValue, this.modifierExtension, this.summary, this.type, this.extension, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withId(Optional<String> optional) {
    ...
    return new ImmutableCondition_Stage(value, this.modifierExtension, this.summary, this.type, this.extension, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableCondition_Stage(this.id, newValue, this.summary, this.type, this.extension, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCondition_Stage(this.id, value, this.summary, this.type, this.extension, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withSummary(CodeableConcept value) {
    ...
    return new ImmutableCondition_Stage(this.id, this.modifierExtension, newValue, this.type, this.extension, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withSummary(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableCondition_Stage(this.id, this.modifierExtension, value, this.type, this.extension, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withType(CodeableConcept value) {
    ...
    return new ImmutableCondition_Stage(this.id, this.modifierExtension, this.summary, newValue, this.extension, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withType(Optional<? extends CodeableConcept> optional) {
    ...
    return new ImmutableCondition_Stage(this.id, this.modifierExtension, this.summary, value, this.extension, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withExtension(List<Extension> value) {
    ...
    return new ImmutableCondition_Stage(this.id, this.modifierExtension, this.summary, this.type, newValue, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableCondition_Stage(this.id, this.modifierExtension, this.summary, this.type, value, this.assessment);
  }
  ...
  public final ImmutableCondition_Stage withAssessment(List<Reference> value) {
    ...
    return new ImmutableCondition_Stage(this.id, this.modifierExtension, this.summary, this.type, this.extension, newValue);
  }
  ...
  public final ImmutableCondition_Stage withAssessment(Optional<? extends List<Reference>> optional) {
    ...
    return new ImmutableCondition_Stage(this.id, this.modifierExtension, this.summary, this.type, this.extension, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code summary}, {@code type}, {@code extension}, {@code assessment}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Condition_Stage#modifierExtension() modifierExtension}
   *    .summary(com.fhir.CodeableConcept) // optional {@link Condition_Stage#summary() summary}
   *    .type(com.fhir.CodeableConcept) // optional {@link Condition_Stage#type() type}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Condition_Stage#extension() extension}
   *    .assessment(List&amp;lt;com.fhir.Reference&amp;gt;) // optional {@link Condition_Stage#assessment() assessment}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SUMMARY = 0x4L;
    private static final long OPT_BIT_TYPE = 0x8L;
    private static final long OPT_BIT_EXTENSION = 0x10L;
    private static final long OPT_BIT_ASSESSMENT = 0x20L;
    ...
    public Condition_Stage build() {
      return new ImmutableCondition_Stage(id, modifierExtension, summary, type, extension, assessment);
    }
