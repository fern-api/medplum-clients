 ...
 */
@org.immutables.value.Generated(from = "id", generator = "Immutables")
@SuppressWarnings({"all"})
@edu.umd.cs.findbugs.annotations.SuppressFBWarnings
@javax.annotation.ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@javax.annotation.concurrent.Immutable
final class ImmutableId implements com.fhir.id {
  private final java.lang.String value;

  private ImmutableId(java.lang.String value) {
    this.value = value;
  }
   ...
   */
  public final ImmutableId withValue(java.lang.String value) {
  ...
  static ImmutableId fromJson(java.lang.String jsonValue) {
  ...
  public static final class Builder implements ValueBuildStage, BuildFinal {
    ...
    private static void checkNotIsSet(boolean isSet, String name) {
      if (isSet) throw new java.lang.IllegalStateException("Builder of id is strict, attribute is already set: ".concat(name));
    }
