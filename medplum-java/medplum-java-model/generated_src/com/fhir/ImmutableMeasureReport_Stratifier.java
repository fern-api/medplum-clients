...
final class ImmutableMeasureReport_Stratifier implements MeasureReport_Stratifier {
  ...
  public final ImmutableMeasureReport_Stratifier withExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Stratifier(newValue, this.code, this.stratum, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(value, this.code, this.stratum, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withCode(List<CodeableConcept> value) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.extension, newValue, this.stratum, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withCode(Optional<? extends List<CodeableConcept>> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.extension, value, this.stratum, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withStratum(List<MeasureReport_Stratum> value) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.extension, this.code, newValue, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withStratum(Optional<? extends List<MeasureReport_Stratum>> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.extension, this.code, value, this.id, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withId(String value) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.extension, this.code, this.stratum, newValue, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withId(Optional<String> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.extension, this.code, this.stratum, value, this.modifierExtension);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.extension, this.code, this.stratum, this.id, newValue);
  }
  ...
  public final ImmutableMeasureReport_Stratifier withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMeasureReport_Stratifier(this.extension, this.code, this.stratum, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code code}, {@code stratum}, {@code id}, {@code modifierExtension}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Stratifier#extension() extension}
   *    .code(List&amp;lt;com.fhir.CodeableConcept&amp;gt;) // optional {@link MeasureReport_Stratifier#code() code}
   *    .stratum(List&amp;lt;com.fhir.MeasureReport_Stratum&amp;gt;) // optional {@link MeasureReport_Stratifier#stratum() stratum}
   *    .id(String) // optional {@link MeasureReport_Stratifier#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MeasureReport_Stratifier#modifierExtension() modifierExtension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_STRATUM = 0x4L;
    ...
    public MeasureReport_Stratifier build() {
      return new ImmutableMeasureReport_Stratifier(extension, code, stratum, id, modifierExtension);
    }
