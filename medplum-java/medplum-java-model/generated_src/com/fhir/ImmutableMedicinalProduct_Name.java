...
final class ImmutableMedicinalProduct_Name implements MedicinalProduct_Name {
  ...
  public final ImmutableMedicinalProduct_Name withCountryLanguage(List<MedicinalProduct_CountryLanguage> value) {
    ...
    return new ImmutableMedicinalProduct_Name(newValue, this.id, this.productName, this.extension, this.modifierExtension, this.namePart);
  }
  ...
  public final ImmutableMedicinalProduct_Name withCountryLanguage(Optional<? extends List<MedicinalProduct_CountryLanguage>> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(value, this.id, this.productName, this.extension, this.modifierExtension, this.namePart);
  }
  ...
  public final ImmutableMedicinalProduct_Name withProductName(String value) {
    ...
    return new ImmutableMedicinalProduct_Name(this.countryLanguage, this.id, newValue, this.extension, this.modifierExtension, this.namePart);
  }
  ...
  public final ImmutableMedicinalProduct_Name withProductName(Optional<String> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(this.countryLanguage, this.id, value, this.extension, this.modifierExtension, this.namePart);
  }
  ...
  public final ImmutableMedicinalProduct_Name withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(this.countryLanguage, this.id, this.productName, value, this.modifierExtension, this.namePart);
  }
  ...
  public final ImmutableMedicinalProduct_Name withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableMedicinalProduct_Name(this.countryLanguage, this.id, this.productName, this.extension, newValue, this.namePart);
  }
  ...
  public final ImmutableMedicinalProduct_Name withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(this.countryLanguage, this.id, this.productName, this.extension, value, this.namePart);
  }
  ...
  public final ImmutableMedicinalProduct_Name withNamePart(Optional<? extends List<MedicinalProduct_NamePart>> optional) {
    ...
    return new ImmutableMedicinalProduct_Name(this.countryLanguage, this.id, this.productName, this.extension, this.modifierExtension, value);
  }
  ...
  private boolean equalTo(ImmutableMedicinalProduct_Name another) {
    return Objects.equals(countryLanguage, another.countryLanguage)
  ...
  /**
   * Computes a hash code from attributes: {@code countryLanguage}, {@code id}, {@code productName}, {@code extension}, {@code modifierExtension}, {@code namePart}.
   ...
   *    .countryLanguage(List&amp;lt;com.fhir.MedicinalProduct_CountryLanguage&amp;gt;) // optional {@link MedicinalProduct_Name#countryLanguage() countryLanguage}
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicinalProduct_Name#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicinalProduct_Name#modifierExtension() modifierExtension}
   *    .namePart(List&amp;lt;com.fhir.MedicinalProduct_NamePart&amp;gt;) // optional {@link MedicinalProduct_Name#namePart() namePart}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_COUNTRY_LANGUAGE = 0x1L;
    private static final long OPT_BIT_ID = 0x2L;
    private static final long OPT_BIT_PRODUCT_NAME = 0x4L;
    private static final long OPT_BIT_EXTENSION = 0x8L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x10L;
    private static final long OPT_BIT_NAME_PART = 0x20L;
    ...
    public MedicinalProduct_Name build() {
      return new ImmutableMedicinalProduct_Name(countryLanguage, id, productName, extension, modifierExtension, namePart);
    }
