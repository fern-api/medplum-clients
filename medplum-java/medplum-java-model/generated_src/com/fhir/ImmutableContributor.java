...
final class ImmutableContributor implements Contributor {
  ...
  public final ImmutableContributor withExtension(List<Extension> value) {
    ...
    return new ImmutableContributor(newValue, this.contact, this.name, this.id, this.type);
  }
  ...
  public final ImmutableContributor withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableContributor(value, this.contact, this.name, this.id, this.type);
  }
  ...
  public final ImmutableContributor withContact(List<ContactDetail> value) {
    ...
    return new ImmutableContributor(this.extension, newValue, this.name, this.id, this.type);
  }
  ...
  public final ImmutableContributor withContact(Optional<? extends List<ContactDetail>> optional) {
    ...
    return new ImmutableContributor(this.extension, value, this.name, this.id, this.type);
  }
  ...
  public final ImmutableContributor withName(String value) {
    ...
    return new ImmutableContributor(this.extension, this.contact, newValue, this.id, this.type);
  }
  ...
  public final ImmutableContributor withName(Optional<String> optional) {
    ...
    return new ImmutableContributor(this.extension, this.contact, value, this.id, this.type);
  }
  ...
  public final ImmutableContributor withId(String value) {
    ...
    return new ImmutableContributor(this.extension, this.contact, this.name, newValue, this.type);
  }
  ...
  public final ImmutableContributor withId(Optional<String> optional) {
    ...
    return new ImmutableContributor(this.extension, this.contact, this.name, value, this.type);
  }
  ...
  public final ImmutableContributor withType(ContributorType value) {
    ...
    return new ImmutableContributor(this.extension, this.contact, this.name, this.id, newValue);
  }
  ...
  public final ImmutableContributor withType(Optional<? extends ContributorType> optional) {
    ...
    return new ImmutableContributor(this.extension, this.contact, this.name, this.id, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code contact}, {@code name}, {@code id}, {@code type}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Contributor#extension() extension}
   *    .contact(List&amp;lt;com.fhir.ContactDetail&amp;gt;) // optional {@link Contributor#contact() contact}
   *    .name(String) // optional {@link Contributor#name() name}
   *    .id(String) // optional {@link Contributor#id() id}
   *    .type(com.fhir.ContributorType) // optional {@link Contributor#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public Contributor build() {
      return new ImmutableContributor(extension, contact, name, id, type);
    }
