...
final class ImmutableInsurancePlan_Plan implements InsurancePlan_Plan {
  ...
  /**
   * Computes a hash code from attributes: {@code id}, {@code modifierExtension}, {@code specificCost}, {@code network}, {@code type}, {@code coverageArea}, {@code extension}, {@code identifier}, {@code generalCost}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link InsurancePlan_Plan#modifierExtension() modifierExtension}
   *    .specificCost(List&amp;lt;com.fhir.InsurancePlan_SpecificCost&amp;gt;) // optional {@link InsurancePlan_Plan#specificCost() specificCost}
   *    .network(List&amp;lt;com.fhir.Reference&amp;gt;) // optional {@link InsurancePlan_Plan#network() network}
   *    .type(com.fhir.CodeableConcept) // optional {@link InsurancePlan_Plan#type() type}
   *    .coverageArea(List&amp;lt;com.fhir.Reference&amp;gt;) // optional {@link InsurancePlan_Plan#coverageArea() coverageArea}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link InsurancePlan_Plan#extension() extension}
   *    .identifier(List&amp;lt;com.fhir.Identifier&amp;gt;) // optional {@link InsurancePlan_Plan#identifier() identifier}
   *    .generalCost(List&amp;lt;com.fhir.InsurancePlan_GeneralCost&amp;gt;) // optional {@link InsurancePlan_Plan#generalCost() generalCost}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_SPECIFIC_COST = 0x4L;
