...
final class ImmutableAdverseEvent_Causality implements AdverseEvent_Causality {
  ...
  /**
   * Computes a hash code from attributes: {@code productRelatedness}, {@code author}, {@code method}, {@code id}, {@code modifierExtension}, {@code assessment}, {@code extension}.
   ...
   *    .author(com.fhir.Reference) // optional {@link AdverseEvent_Causality#author() author}
   *    .method(com.fhir.CodeableConcept) // optional {@link AdverseEvent_Causality#method() method}
   *    .id(String) // optional {@link AdverseEvent_Causality#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link AdverseEvent_Causality#modifierExtension() modifierExtension}
   *    .assessment(com.fhir.CodeableConcept) // optional {@link AdverseEvent_Causality#assessment() assessment}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link AdverseEvent_Causality#extension() extension}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public AdverseEvent_Causality build() {
      return new ImmutableAdverseEvent_Causality(productRelatedness, author, method, id, modifierExtension, assessment, extension);
    }
