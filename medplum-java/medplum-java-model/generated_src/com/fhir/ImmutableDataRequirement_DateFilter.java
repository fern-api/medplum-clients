...
final class ImmutableDataRequirement_DateFilter implements DataRequirement_DateFilter {
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code path}, {@code valueDateTime}, {@code id}, {@code modifierExtension}, {@code valueDuration}, {@code searchParam}, {@code valuePeriod}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link DataRequirement_DateFilter#extension() extension}
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link DataRequirement_DateFilter#modifierExtension() modifierExtension}
   *    .valueDuration(com.fhir.Duration) // optional {@link DataRequirement_DateFilter#valueDuration() valueDuration}
   *    .searchParam(String) // optional {@link DataRequirement_DateFilter#searchParam() searchParam}
   *    .valuePeriod(com.fhir.Period) // optional {@link DataRequirement_DateFilter#valuePeriod() valuePeriod}
   *    .build();
   * </pre>
