...
final class ImmutableMedicationKnowledge_Ingredient implements MedicationKnowledge_Ingredient {
  ...
  /**
   * Computes a hash code from attributes: {@code strength}, {@code extension}, {@code itemCodeableConcept}, {@code modifierExtension}, {@code itemReference}, {@code id}, {@code isActive}.
   ...
   *    .strength(com.fhir.Ratio) // optional {@link MedicationKnowledge_Ingredient#strength() strength}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Ingredient#extension() extension}
   *    .itemCodeableConcept(com.fhir.CodeableConcept) // optional {@link MedicationKnowledge_Ingredient#itemCodeableConcept() itemCodeableConcept}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link MedicationKnowledge_Ingredient#modifierExtension() modifierExtension}
   *    .itemReference(com.fhir.Reference) // optional {@link MedicationKnowledge_Ingredient#itemReference() itemReference}
  ...
  public static final class Builder {
    ...
    public MedicationKnowledge_Ingredient build() {
      return new ImmutableMedicationKnowledge_Ingredient(strength, extension, itemCodeableConcept, modifierExtension, itemReference, id, isActive);
    }
