...
final class ImmutableNutritionOrder_Supplement implements NutritionOrder_Supplement {
  ...
  /**
   * Computes a hash code from attributes: {@code modifierExtension}, {@code instruction}, {@code productName}, {@code schedule}, {@code id}, {@code quantity}, {@code extension}, {@code type}.
   ...
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_Supplement#modifierExtension() modifierExtension}
   ...
   *    .schedule(List&amp;lt;com.fhir.Timing&amp;gt;) // optional {@link NutritionOrder_Supplement#schedule() schedule}
   *    .id(String) // optional {@link NutritionOrder_Supplement#id() id}
   *    .quantity(com.fhir.Quantity) // optional {@link NutritionOrder_Supplement#quantity() quantity}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link NutritionOrder_Supplement#extension() extension}
   *    .type(com.fhir.CodeableConcept) // optional {@link NutritionOrder_Supplement#type() type}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public NutritionOrder_Supplement build() {
      return new ImmutableNutritionOrder_Supplement(modifierExtension, instruction, productName, schedule, id, quantity, extension, type);
    }
