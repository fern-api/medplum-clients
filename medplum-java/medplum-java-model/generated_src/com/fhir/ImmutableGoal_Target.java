...
final class ImmutableGoal_Target implements Goal_Target {
  ...
  /**
   * Computes a hash code from attributes: {@code detailQuantity}, {@code dueDate}, {@code extension}, {@code detailBoolean}, {@code measure}, {@code dueDuration}, {@code modifierExtension}, {@code detailInteger}, {@code detailRange}, {@code detailRatio}, {@code detailCodeableConcept}, {@code id}, {@code detailString}.
   ...
   *    .detailQuantity(com.fhir.Quantity) // optional {@link Goal_Target#detailQuantity() detailQuantity}
   *    .dueDate(String) // optional {@link Goal_Target#dueDate() dueDate}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Goal_Target#extension() extension}
   *    .detailBoolean(Boolean) // optional {@link Goal_Target#detailBoolean() detailBoolean}
   *    .measure(com.fhir.CodeableConcept) // optional {@link Goal_Target#measure() measure}
   *    .dueDuration(com.fhir.Duration) // optional {@link Goal_Target#dueDuration() dueDuration}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Goal_Target#modifierExtension() modifierExtension}
   *    .detailInteger(Double) // optional {@link Goal_Target#detailInteger() detailInteger}
   *    .detailRange(com.fhir.Range) // optional {@link Goal_Target#detailRange() detailRange}
   *    .detailRatio(com.fhir.Ratio) // optional {@link Goal_Target#detailRatio() detailRatio}
   *    .detailCodeableConcept(com.fhir.CodeableConcept) // optional {@link Goal_Target#detailCodeableConcept() detailCodeableConcept}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_DUE_DATE = 0x2L;
    private static final long OPT_BIT_EXTENSION = 0x4L;
    private static final long OPT_BIT_DETAIL_BOOLEAN = 0x8L;
    private static final long OPT_BIT_MEASURE = 0x10L;
    private static final long OPT_BIT_DUE_DURATION = 0x20L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x40L;
    private static final long OPT_BIT_DETAIL_INTEGER = 0x80L;
    private static final long OPT_BIT_DETAIL_RANGE = 0x100L;
    private static final long OPT_BIT_DETAIL_RATIO = 0x200L;
    private static final long OPT_BIT_DETAIL_CODEABLE_CONCEPT = 0x400L;
    private static final long OPT_BIT_ID = 0x800L;
    private static final long OPT_BIT_DETAIL_STRING = 0x1000L;
