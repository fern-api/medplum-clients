...
final class ImmutableMedication_Ingredient implements Medication_Ingredient {
  ...
  /**
   * Computes a hash code from attributes: {@code itemCodeableConcept}, {@code strength}, {@code extension}, {@code itemReference}, {@code isActive}, {@code modifierExtension}, {@code id}.
   ...
   *    .itemCodeableConcept(com.fhir.CodeableConcept) // optional {@link Medication_Ingredient#itemCodeableConcept() itemCodeableConcept}
   *    .strength(com.fhir.Ratio) // optional {@link Medication_Ingredient#strength() strength}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Medication_Ingredient#extension() extension}
   *    .itemReference(com.fhir.Reference) // optional {@link Medication_Ingredient#itemReference() itemReference}
   *    .isActive(Boolean) // optional {@link Medication_Ingredient#isActive() isActive}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link Medication_Ingredient#modifierExtension() modifierExtension}
  ...
  public static final class Builder {
    ...
    private static final long OPT_BIT_IS_ACTIVE = 0x10L;
    ...
    public Medication_Ingredient build() {
      return new ImmutableMedication_Ingredient(itemCodeableConcept, strength, extension, itemReference, isActive, modifierExtension, id);
    }
