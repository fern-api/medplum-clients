...
final class ImmutableSubstanceAmount implements SubstanceAmount {
  ...
  private boolean equalTo(ImmutableSubstanceAmount another) {
    return Objects.equals(amountType, another.amountType)
  ...
  /**
   * Computes a hash code from attributes: {@code amountType}, {@code amountText}, {@code referenceRange}, {@code amountString}, {@code amountQuantity}, {@code id}, {@code extension}, {@code modifierExtension}, {@code amountRange}.
   ...
   *    .amountType(com.fhir.CodeableConcept) // optional {@link SubstanceAmount#amountType() amountType}
   *    .amountText(String) // optional {@link SubstanceAmount#amountText() amountText}
   *    .referenceRange(com.fhir.SubstanceAmount_ReferenceRange) // optional {@link SubstanceAmount#referenceRange() referenceRange}
   *    .amountString(String) // optional {@link SubstanceAmount#amountString() amountString}
   *    .amountQuantity(com.fhir.Quantity) // optional {@link SubstanceAmount#amountQuantity() amountQuantity}
   *    .id(String) // optional {@link SubstanceAmount#id() id}
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceAmount#extension() extension}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link SubstanceAmount#modifierExtension() modifierExtension}
   *    .amountRange(com.fhir.Range) // optional {@link SubstanceAmount#amountRange() amountRange}
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    private static final long OPT_BIT_AMOUNT_TYPE = 0x1L;
    private static final long OPT_BIT_AMOUNT_TEXT = 0x2L;
    private static final long OPT_BIT_REFERENCE_RANGE = 0x4L;
    private static final long OPT_BIT_AMOUNT_STRING = 0x8L;
    private static final long OPT_BIT_AMOUNT_QUANTITY = 0x10L;
    private static final long OPT_BIT_ID = 0x20L;
    private static final long OPT_BIT_EXTENSION = 0x40L;
    private static final long OPT_BIT_MODIFIER_EXTENSION = 0x80L;
    private static final long OPT_BIT_AMOUNT_RANGE = 0x100L;
