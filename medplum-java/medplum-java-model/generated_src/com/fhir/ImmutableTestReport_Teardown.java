...
final class ImmutableTestReport_Teardown implements TestReport_Teardown {
  ...
  public final ImmutableTestReport_Teardown withExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Teardown(newValue, this.id, this.modifierExtension, this.action);
  }
  ...
  public final ImmutableTestReport_Teardown withExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Teardown(value, this.id, this.modifierExtension, this.action);
  }
  ...
  public final ImmutableTestReport_Teardown withId(String value) {
    ...
    return new ImmutableTestReport_Teardown(this.extension, newValue, this.modifierExtension, this.action);
  }
  ...
  public final ImmutableTestReport_Teardown withId(Optional<String> optional) {
    ...
    return new ImmutableTestReport_Teardown(this.extension, value, this.modifierExtension, this.action);
  }
  ...
  public final ImmutableTestReport_Teardown withModifierExtension(List<Extension> value) {
    ...
    return new ImmutableTestReport_Teardown(this.extension, this.id, newValue, this.action);
  }
  ...
  public final ImmutableTestReport_Teardown withModifierExtension(Optional<? extends List<Extension>> optional) {
    ...
    return new ImmutableTestReport_Teardown(this.extension, this.id, value, this.action);
  }
  ...
  public final ImmutableTestReport_Teardown withAction(TestReport_Action2... elements) {
    ...
    return new ImmutableTestReport_Teardown(this.extension, this.id, this.modifierExtension, newValue);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code extension}, {@code id}, {@code modifierExtension}, {@code action}.
   ...
   *    .extension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestReport_Teardown#extension() extension}
   *    .id(String) // optional {@link TestReport_Teardown#id() id}
   *    .modifierExtension(List&amp;lt;com.fhir.Extension&amp;gt;) // optional {@link TestReport_Teardown#modifierExtension() modifierExtension}
   *    .addAction|addAllAction(com.fhir.TestReport_Action2) // {@link TestReport_Teardown#action() action} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder {
    ...
    public TestReport_Teardown build() {
      return new ImmutableTestReport_Teardown(extension, id, modifierExtension, createUnmodifiableList(true, action));
    }
